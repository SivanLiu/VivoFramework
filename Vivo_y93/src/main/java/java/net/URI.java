...
public final class URI implements Comparable<URI>, Serializable {
    ...
    static final /* synthetic */ boolean f15-assertionsDisabled = (URI.class.desiredAssertionStatus() ^ 1);
    ...
    private class Parser {
        ...
        private boolean requireServerAuthority = URI.f15-assertionsDisabled;
        ...
        private boolean at(int start, int end, char c) {
            return (start >= end || charAt(start) != c) ? URI.f15-assertionsDisabled : true;
        }

        private boolean at(int start, int end, String s) {
            boolean z = URI.f15-assertionsDisabled;
            int p = start;
            int sn = s.length();
            if (sn > end - start) {
                return URI.f15-assertionsDisabled;
            }
            int i = 0;
            int p2 = p;
            while (i < sn) {
        ...
        private int parseAuthority(int start, int n) throws URISyntaxException {
            ...
            if (scan(start, n, "", "]") > start) {
                serverChars = scan(start, n, URI.L_SERVER_PERCENT, URI.H_SERVER_PERCENT) == n ? true : URI.f15-assertionsDisabled;
            } else {
                serverChars = scan(start, n, URI.L_SERVER, URI.H_SERVER) == n ? true : URI.f15-assertionsDisabled;
            }
            boolean regChars = scan(start, n, URI.L_REG_NAME, URI.H_REG_NAME) == n ? true : URI.f15-assertionsDisabled;
        ...
        private int parseIPv4Address(int start, int n) {
            try {
                int p = scanIPv4Address(start, n, URI.f15-assertionsDisabled);
        ...
        private int parseIPv6Reference(int start, int n) throws URISyntaxException {
            int p = start;
            boolean compressedZeros = URI.f15-assertionsDisabled;
    ...
    public URI(String str) throws URISyntaxException {
        ...
        new Parser(str).parse(f15-assertionsDisabled);
    }
    ...
    public URI(String scheme, String authority, String path, String query, String fragment) throws URISyntaxException {
        ...
        checkPath(s, scheme, path);
        new Parser(s).parse(f15-assertionsDisabled);
    }
    ...
    public URI(String scheme, String ssp, String fragment) throws URISyntaxException {
        ...
        this.decodedFragment = null;
        this.decodedSchemeSpecificPart = null;
        new Parser(toString(scheme, ssp, null, null, null, -1, null, null, fragment)).parse(f15-assertionsDisabled);
    }
    ...
    public boolean isAbsolute() {
        return this.scheme != null ? true : f15-assertionsDisabled;
    }

    public boolean isOpaque() {
        return this.path == null ? true : f15-assertionsDisabled;
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (this.host != null) {
            return (equal(this.userInfo, that.userInfo) && equalIgnoringCase(this.host, that.host) && this.port == that.port) ? true : f15-assertionsDisabled;
        } else {
    ...
    private void readObject(ObjectInputStream is) throws ClassNotFoundException, IOException {
        ...
        try {
            new Parser(this.string).parse(f15-assertionsDisabled);
        } catch (URISyntaxException x) {
    ...
    private static String normalize(String ps) {
        return normalize(ps, f15-assertionsDisabled);
    }
    ...
    private static String quote(String s, long lowMask, long highMask) {
        ...
        boolean allowNonASCII = (L_ESCAPED & lowMask) != 0 ? true : f15-assertionsDisabled;
        for (int i = 0; i < s.length(); i++) {
            char c = s.charAt(i);
            if (c < 128) {
    ...
    private static String decode(String s) {
        ...
        char c = s.charAt(0);
        boolean betweenBrackets = f15-assertionsDisabled;
        int i = 0;
        while (i < n) {
            if (f15-assertionsDisabled || c == s.charAt(i)) {
                if (c == '[') {
                    betweenBrackets = true;
                } else if (betweenBrackets && c == ']') {
                    betweenBrackets = f15-assertionsDisabled;
                }
                if (c != '%' || betweenBrackets) {
                    ...
                    int ui = i;
                    do {
                        if (f15-assertionsDisabled || n - i >= 2) {
                            i++;
                    ...
                    if (f15-assertionsDisabled || cr.isUnderflow()) {
                        cr = dec.flush(cb);
                        if (f15-assertionsDisabled || cr.isUnderflow()) {

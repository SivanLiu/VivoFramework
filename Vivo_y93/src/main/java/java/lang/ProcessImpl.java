...
final class ProcessImpl {
    ...
    static final /* synthetic */ boolean f31-assertionsDisabled = (ProcessImpl.class.desiredAssertionStatus() ^ 1);
    ...
    static Process start(String[] cmdarray, Map<String, String> environment, String dir, Redirect[] redirects, boolean redirectErrorStream) throws IOException {
        Throwable th;
        if (f31-assertionsDisabled || (cmdarray != null && cmdarray.length > 0)) {
            int i;
            int[] std_fds;

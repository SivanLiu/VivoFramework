...
public class File implements Serializable, Comparable<File> {
    ...
    static final /* synthetic */ boolean f9-assertionsDisabled = (File.class.desiredAssertionStatus() ^ 1);
    ...
    final boolean isInvalid() {
        ...
        return this.status == PathStatus.INVALID ? true : f9-assertionsDisabled;
    }
    ...
    private File(String child, File parent) {
        if (!f9-assertionsDisabled && parent.path == null) {
            throw new AssertionError();
        } else if (f9-assertionsDisabled || !parent.path.equals("")) {
    ...
    public boolean isDirectory() {
        boolean z = f9-assertionsDisabled;
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
            security.checkRead(this.path);
        }

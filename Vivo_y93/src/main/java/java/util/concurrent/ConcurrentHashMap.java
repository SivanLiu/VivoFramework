...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final class TreeBin<K, V> extends Node<K, V> {
        ...
        static final /* synthetic */ boolean f91-assertionsDisabled = (TreeBin.class.desiredAssertionStatus() ^ 1);
     ...
     */
        ...
        TreeBin(TreeNode<K, V> b) {
            ...
            this.root = r;
            if (!f91-assertionsDisabled && !checkInvariants(this.root)) {
        ...
        private final void contendedLock() {
            boolean waiting = f91-assertionsDisabled;
            while (true) {
     ...
     */
        ...
        final TreeNode<K, V> putTreeVal(int h, K k, V v) {
            Class kc = null;
            boolean searched = f91-assertionsDisabled;
                ...
                if (xp != null) {
                    ...
                    if (xp == xppl) {
                        ...
                        if (xppr == null || !xppr.red) {
                            ...
                            xppr.red = f91-assertionsDisabled;
                            xp.red = f91-assertionsDisabled;
                            xpp.red = true;
                            x = xpp;
                        }
                        ...
                        xppl.red = f91-assertionsDisabled;
                        xp.red = f91-assertionsDisabled;
                        xpp.red = true;
                        x = xpp;
                    }
            ...
            while (x != null && x != root) {
                ...
                if (xp == null) {
                    ...
                    if (xpl == x) {
                        ...
                        if (xpr != null && xpr.red) {
                            xpr.red = f91-assertionsDisabled;
                            xp.red = true;
                            root = rotateLeft(root, xp);
                            xp = x.parent;
                        ...
                        if (xpr == null) {
                            ...
                            if ((sr == null || (sr.red ^ 1) != 0) && (sl == null || (sl.red ^ 1) != 0)) {
                                ...
                                if (xpr != null) {
                                    xpr.red = xp == null ? f91-assertionsDisabled : xp.red;
                                    sr = xpr.right;
                                    if (sr != null) {
                                        sr.red = f91-assertionsDisabled;
                                    }
                                }
                                if (xp != null) {
                                    xp.red = f91-assertionsDisabled;
                        ...
                        if (xpl != null && xpl.red) {
                            xpl.red = f91-assertionsDisabled;
                            xp.red = true;
                            root = rotateRight(root, xp);
                            xp = x.parent;
                        ...
                        if (xpl == null) {
                            ...
                            if ((sl == null || (sl.red ^ 1) != 0) && (sr == null || (sr.red ^ 1) != 0)) {
                                ...
                                if (xpl != null) {
                                    xpl.red = xp == null ? f91-assertionsDisabled : xp.red;
                                    sl = xpl.left;
                                    if (sl != null) {
                                        sl.red = f91-assertionsDisabled;
                                    }

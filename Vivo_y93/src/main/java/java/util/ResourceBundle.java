...
public abstract class ResourceBundle {
    ...
    static final /* synthetic */ boolean f149-assertionsDisabled = (ResourceBundle.class.desiredAssertionStatus() ^ 1);
        ...
        public boolean equals(Object other) {
            ...
            try {
                ...
                if (this.hashCodeCache != otherEntry.hashCodeCache || !this.name.equals(otherEntry.name) || !this.locale.equals(otherEntry.locale)) {
                    return ResourceBundle.f149-assertionsDisabled;
                }
                if (this.loaderRef == null) {
                    if (otherEntry.loaderRef != null) {
                        z = ResourceBundle.f149-assertionsDisabled;
                    }
                    return z;
                }
    ...
    public static class Control {
        ...
        private static class CandidateListCache extends LocaleObjectCache<BaseLocale, List<Locale>> {
            ...
            protected List<Locale> createObject(BaseLocale base) {
                ...
                boolean isNorwegianBokmal = ResourceBundle.f149-assertionsDisabled;
                boolean isNorwegianNynorsk = ResourceBundle.f149-assertionsDisabled;
                    ...
                    try {
                        ...
                        InputStream stream = (InputStream) AccessController.doPrivileged(new PrivilegedExceptionAction<InputStream>() {
                            public InputStream run() throws IOException {
                                ...
                                connection.setUseCaches(ResourceBundle.f149-assertionsDisabled);
     ...
     */
        ...
        public boolean needsReload(String baseName, Locale locale, String format, ClassLoader loader, ResourceBundle bundle, long loadTime) {
            ...
            boolean result = ResourceBundle.f149-assertionsDisabled;
            try {
                ...
                if (url != null) {
                    ...
                    result = lastModified >= loadTime ? true : ResourceBundle.f149-assertionsDisabled;
                }
                return result;
    ...
    protected void setParent(ResourceBundle parent) {
        if (f149-assertionsDisabled || parent != NONEXISTENT_BUNDLE) {
            this.parent = parent;
            return;
        }
    ...
    private static boolean checkList(List<?> a) {
        boolean valid = a != null ? a.isEmpty() ^ 1 : f149-assertionsDisabled;
        if (valid) {
            int size = a.size();
            int i = 0;
            while (valid && i < size) {
                valid = a.get(i) != null ? true : f149-assertionsDisabled;
                i++;
            }
        }
        return valid;
    ...
    private static ResourceBundle findBundle(CacheKey cacheKey, List<Locale> candidateLocales, List<String> formats, int index, Control control, ResourceBundle baseBundle) {
        ...
        boolean expiredBundle = f149-assertionsDisabled;
    ...
    private static ResourceBundle loadBundle(CacheKey cacheKey, List<String> formats, Control control, boolean reload) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (bundle != null) {
                ...
                bundle.locale = targetLocale;
                bundle.expired = f149-assertionsDisabled;
                break;
            }
        }
        return bundle;
    ...
    private static boolean isValidBundle(ResourceBundle bundle) {
        return (bundle == null || bundle == NONEXISTENT_BUNDLE) ? f149-assertionsDisabled : true;
    }
    ...
    private static ResourceBundle findBundleInCache(CacheKey cacheKey, Control control) {
        ...
        if (f149-assertionsDisabled || p != NONEXISTENT_BUNDLE) {
            if (p == null || !p.expired) {
            ...
            } else if (f149-assertionsDisabled || bundle != NONEXISTENT_BUNDLE) {
                bundle.expired = true;
                bundle.cacheKey = null;
                cacheList.remove(cacheKey, bundleRef);
                bundle = null;

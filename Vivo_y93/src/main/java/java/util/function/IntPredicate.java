...
public interface IntPredicate {
    ...
    /* synthetic */ boolean m89lambda$-java_util_function_IntPredicate_2831(IntPredicate other, int value) {
        return test(value) ? other.test(value) : false;
    }

    /* renamed from: lambda$-java_util_function_IntPredicate_3136 */
    /* synthetic */ boolean m90lambda$-java_util_function_IntPredicate_3136(int value) {
        return test(value) ^ 1;
    }
    ...
    /* synthetic */ boolean m91lambda$-java_util_function_IntPredicate_4072(IntPredicate other, int value) {

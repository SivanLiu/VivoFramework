...
class JapaneseImperialCalendar extends Calendar {
    ...
    static final /* synthetic */ boolean f148-assertionsDisabled = (JapaneseImperialCalendar.class.desiredAssertionStatus() ^ 1);
    public static final int BEFORE_MEIJI = 0;
    private static final Era BEFORE_MEIJI_ERA = new Era("BeforeMeiji", "BM", Long.MIN_VALUE, f148-assertionsDisabled);
        ...
        if (amount != 0) {
            ...
            switch (field) {
                ...
                case 5:
                    ...
                    if (f148-assertionsDisabled || (getEraIndex(d2) == internalGetEra() && d2.getYear() == internalGet(1) && d2.getMonth() - 1 == internalGet(2))) {
                        set(5, d2.getDayOfMonth());
                        return;
                    }
                ...
                case 6:
                    ...
                    if (isTransitionYear(this.jdate.getNormalizedYear())) {
                        ...
                        if (f148-assertionsDisabled || (getEraIndex(d2) == internalGetEra() && d2.getYear() == internalGet(1))) {
                            set(2, d2.getMonth() - 1);
                            set(5, d2.getDayOfMonth());
                            return;
                        }
                ...
                case 11:
                    ...
                    if (internalGet(5) != d.getDayOfMonth()) {
                        ...
                        if (field == 10) {
                            if (f148-assertionsDisabled || internalGet(9) == 1) {
                                d.addHours(12);
                            } else {
                                throw new AssertionError();
                            }
    ...
    public int getActualMinimum(int field) {
        ...
        switch (field) {
            case 1:
                ...
                jcal.normalize(jd);
                if (f148-assertionsDisabled || jd.isLeapYear() == d.isLeapYear()) {
                    if (getYearOffsetInMillis(jd) < getYearOffsetInMillis(d)) {
                        value = 2;
                        break;
                    }
    ...
    public int getActualMaximum(int field) {
        ...
        switch (field) {
            ...
            case 2:
                ...
                if (date.getYear() != 1) {
                    eraIndex++;
                    if (!f148-assertionsDisabled && eraIndex >= eras.length) {
                        throw new AssertionError();
                    }
                }
    ...
    protected void computeFields() {
        ...
        if (isPartiallyNormalized()) {
            ...
            if (fieldMask != 0 || this.cachedFixedDate == Long.MIN_VALUE) {
                ...
                if (!(f148-assertionsDisabled || mask == 131071)) {
                    throw new AssertionError();
                }
            }
        }
    ...
    private int getWeekNumber(long fixedDay1, long fixedDate) {
        ...
        if (f148-assertionsDisabled || ndays <= 7) {
    ...
    private int monthLength(int month) {
        if (f148-assertionsDisabled || this.jdate.isNormalized()) {
    ...
    private static int getRolledValue(int value, int amount, int min, int max) {
        if (f148-assertionsDisabled || (value >= min && value <= max)) {
            int range = (max - min) + 1;
            ...
            if (f148-assertionsDisabled || (n >= min && n <= max)) {
                return n;
            }
            throw new AssertionError();
        }

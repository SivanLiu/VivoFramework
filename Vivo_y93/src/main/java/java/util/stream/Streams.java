...
final class Streams {
    ...
    static final class RangeLongSpliterator implements OfLong {
        ...
        static final /* synthetic */ boolean f238-assertionsDisabled = (RangeLongSpliterator.class.desiredAssertionStatus() ^ 1);
        ...
        private RangeLongSpliterator(long from, long upTo, int last) {
            if (f238-assertionsDisabled || (upTo - from) + ((long) last) > 0) {
                this.from = from;
                this.upTo = upTo;
                this.last = last;
                return;
        ...
        public boolean tryAdvance(LongConsumer consumer) {
            ...
            if (i < this.upTo) {
                ...
                return f238-assertionsDisabled;
            } else {
                this.last = 0;
                consumer.accept(i);
                return true;

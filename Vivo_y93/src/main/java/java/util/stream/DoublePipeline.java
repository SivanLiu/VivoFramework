...
public abstract class DoublePipeline<E_IN> extends AbstractPipeline<E_IN, Double, DoubleStream> implements DoubleStream {
        ...
        return new StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE, (StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) | StreamOpFlag.NOT_SIZED) {
            public Sink<Double> opWrapSink(int flags, Sink<Double> sink) {
                ...
                return new ChainedDouble<Double>(sink) {
                    ...
                    /* synthetic */ void m107lambda$-java_util_stream_DoublePipeline$5$1_10563(double i) {
    ...
    static /* synthetic */ void m103lambda$-java_util_stream_DoublePipeline_14331(double[] ll, double d) {
        Collectors.sumWithCompensation(ll, d);
        ll[2] = ll[2] + d;
    }

    /* renamed from: lambda$-java_util_stream_DoublePipeline_14530 */
    static /* synthetic */ void m104lambda$-java_util_stream_DoublePipeline_14530(double[] ll, double[] rr) {
    ...
    static /* synthetic */ void m105lambda$-java_util_stream_DoublePipeline_15880(double[] ll, double d) {
        ll[2] = ll[2] + 1.0d;
        Collectors.sumWithCompensation(ll, d);
        ll[3] = ll[3] + d;
    }
    ...
    static /* synthetic */ void m106lambda$-java_util_stream_DoublePipeline_16123(double[] ll, double[] rr) {
        Collectors.sumWithCompensation(ll, rr[0]);
        Collectors.sumWithCompensation(ll, rr[1]);
        ll[2] = ll[2] + rr[2];
        ll[3] = ll[3] + rr[3];

...
final class SliceOps {
    ...
    static final /* synthetic */ boolean f219-assertionsDisabled = (SliceOps.class.desiredAssertionStatus() ^ 1);
    /* renamed from: -java-util-stream-StreamShapeSwitchesValues */
    private static final /* synthetic */ int[] f220-java-util-stream-StreamShapeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m139-getjava-util-stream-StreamShapeSwitchesValues() {
        if (f220-java-util-stream-StreamShapeSwitchesValues != null) {
            return f220-java-util-stream-StreamShapeSwitchesValues;
        }
        ...
        f220-java-util-stream-StreamShapeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static <P_IN> Spliterator<P_IN> sliceSpliterator(StreamShape shape, Spliterator<P_IN> s, long skip, long limit) {
        if (f219-assertionsDisabled || s.hasCharacteristics(16384)) {
            long sliceFence = calcSliceFence(skip, limit);
            switch (m139-getjava-util-stream-StreamShapeSwitchesValues()[shape.ordinal()]) {
                case 1:

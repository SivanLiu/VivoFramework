...
final /* synthetic */ class -$Lambda$F2FxWS-_sj37qqP78wv60F_s_Zw implements Supplier {
    ...
    private final /* synthetic */ Object $m$0() {
        return ((AbstractPipeline) this.f199-$f0).m102lambda$-java_util_stream_AbstractPipeline_14339();
    }

    private final /* synthetic */ Object $m$1() {
        return AbstractPipeline.m101lambda$-java_util_stream_AbstractPipeline_20439((Spliterator) this.f199-$f0);
    }
    ...
    private final /* synthetic */ Object $m$3() {
        return new Partition(((Collector) this.f199-$f0).supplier().get(), ((Collector) this.f199-$f0).supplier().get());
    }

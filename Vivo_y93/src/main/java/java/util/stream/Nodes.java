...
final class Nodes {
    ...
    private static final /* synthetic */ int[] f205-java-util-stream-StreamShapeSwitchesValues = null;
    ...
    private static final class DoubleFixedNodeBuilder extends DoubleArrayNode implements Builder.OfDouble {
        ...
        static final /* synthetic */ boolean f206-assertionsDisabled = (DoubleFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class DoubleSpinedNodeBuilder extends SpinedBuffer.OfDouble implements OfDouble, Builder.OfDouble {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f207-assertionsDisabled = (DoubleSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        ...
        public Spliterator.OfDouble spliterator() {
            if (f207-assertionsDisabled || !this.building) {
    ...
    private static final class FixedNodeBuilder<T> extends ArrayNode<T> implements Builder<T> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f208-assertionsDisabled = (FixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        FixedNodeBuilder(long size, IntFunction<T[]> generator) {
            super(size, generator);
            if (!f208-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
                throw new AssertionError();
            }
        }
    ...
    private static final class IntFixedNodeBuilder extends IntArrayNode implements Builder.OfInt {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f209-assertionsDisabled = (IntFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class IntSpinedNodeBuilder extends SpinedBuffer.OfInt implements OfInt, Builder.OfInt {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f210-assertionsDisabled = (IntSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
    ...
    private static final class LongFixedNodeBuilder extends LongArrayNode implements Builder.OfLong {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f211-assertionsDisabled = (LongFixedNodeBuilder.class.desiredAssertionStatus() ^ 1);

        LongFixedNodeBuilder(long size) {
            super(size);
            if (!f211-assertionsDisabled && size >= Nodes.MAX_ARRAY_SIZE) {
                throw new AssertionError();
            }
        }
    ...
    private static final class LongSpinedNodeBuilder extends SpinedBuffer.OfLong implements OfLong, Builder.OfLong {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f212-assertionsDisabled = (LongSpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>, K extends SizedCollectorTask<P_IN, P_OUT, T_SINK, K>> extends CountedCompleter<Void> implements Sink<P_OUT> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f213-assertionsDisabled = (SizedCollectorTask.class.desiredAssertionStatus() ^ 1);
        protected int fence;
        protected final PipelineHelper<P_OUT> helper;
        protected int index;
        ...
        SizedCollectorTask(Spliterator<P_IN> spliterator, PipelineHelper<P_OUT> helper, int arrayLength) {
            if (f213-assertionsDisabled || spliterator.hasCharacteristics(16384)) {
        ...
        public void compute() {
            ...
            if (f213-assertionsDisabled || task.offset + task.length < Nodes.MAX_ARRAY_SIZE) {
    ...
    private static final class SpinedNodeBuilder<T> extends SpinedBuffer<T> implements Node<T>, Builder<T> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f214-assertionsDisabled = (SpinedNodeBuilder.class.desiredAssertionStatus() ^ 1);
        private boolean building = false;
        ...
        public Spliterator<T> spliterator() {
            if (f214-assertionsDisabled || !this.building) {
                return super.spliterator();
            }
            throw new AssertionError((Object) "during building");
        }
    ...
    private static /* synthetic */ int[] m130-getjava-util-stream-StreamShapeSwitchesValues() {
        if (f205-java-util-stream-StreamShapeSwitchesValues != null) {
            return f205-java-util-stream-StreamShapeSwitchesValues;
        }
        ...
        f205-java-util-stream-StreamShapeSwitchesValues = iArr;
        return iArr;
    }
    ...
    static <T> Node<T> emptyNode(StreamShape shape) {
        switch (m130-getjava-util-stream-StreamShapeSwitchesValues()[shape.ordinal()]) {
            case 1:

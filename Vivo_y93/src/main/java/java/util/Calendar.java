...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    static final /* synthetic */ boolean f85-assertionsDisabled = (Calendar.class.desiredAssertionStatus() ^ 1);
    ...
    public static class Builder {
        ...
        public Calendar build() {
            ...
            if (this.fields != null) {
                boolean weekDate = isSet(17) ? this.fields[17] > this.fields[1] ? true : Calendar.f85-assertionsDisabled : Calendar.f85-assertionsDisabled;
        ...
        private boolean isInstantSet() {
            return this.nextStamp == 1 ? true : Calendar.f85-assertionsDisabled;
        }

        private boolean isSet(int index) {
            return (this.fields == null || this.fields[index] <= 0) ? Calendar.f85-assertionsDisabled : true;
        }

        private boolean isValidWeekParameter(int value) {
            return (value <= 0 || value > 7) ? Calendar.f85-assertionsDisabled : true;
        }
    }
    ...
    protected Calendar(TimeZone zone, Locale aLocale) {
        this.lenient = true;
        this.sharedZone = f85-assertionsDisabled;
        this.nextStamp = 2;
    ...
    public void setTimeInMillis(long millis) {
        if (this.time != millis || !this.isTimeSet || !this.areFieldsSet || !this.areAllFieldsSet) {
            this.time = millis;
            this.isTimeSet = true;
            this.areFieldsSet = f85-assertionsDisabled;
            computeFields();
    ...
    public void set(int field, int value) {
        ...
        internalSet(field, value);
        this.isTimeSet = f85-assertionsDisabled;
        this.areFieldsSet = f85-assertionsDisabled;
    ...
    public final void clear() {
        ...
        while (i < this.fields.length) {
            ...
            iArr[i] = 0;
            int i2 = i + 1;
            this.isSet[i] = f85-assertionsDisabled;
            i = i2;
        }
        this.areFieldsSet = f85-assertionsDisabled;
        this.areAllFieldsSet = f85-assertionsDisabled;
        this.isTimeSet = f85-assertionsDisabled;
    }
    ...
    public final void clear(int field) {
        this.fields[field] = 0;
        this.stamp[field] = 0;
        this.isSet[field] = f85-assertionsDisabled;
        this.areFieldsSet = f85-assertionsDisabled;
        this.areAllFieldsSet = f85-assertionsDisabled;
        this.isTimeSet = f85-assertionsDisabled;
    }
    ...
    public final boolean isSet(int field) {
        return this.stamp[field] != 0 ? true : f85-assertionsDisabled;
    }
    ...
    final boolean isExternallySet(int field) {
        return this.stamp[field] >= 2 ? true : f85-assertionsDisabled;
    }
    ...
    final boolean isPartiallyNormalized() {
        return this.areFieldsSet ? this.areAllFieldsSet ^ 1 : f85-assertionsDisabled;
    }

    final boolean isFullyNormalized() {
        return this.areFieldsSet ? this.areAllFieldsSet : f85-assertionsDisabled;
    }
    ...
    static boolean isFieldSet(int fieldMask, int field) {
        return ((1 << field) & fieldMask) != 0 ? true : f85-assertionsDisabled;
    }
    ...
    final int selectFields() {
        ...
        if (bestStamp == domStamp || ((bestStamp == womStamp && this.stamp[4] >= this.stamp[3]) || (bestStamp == dowimStamp && this.stamp[8] >= this.stamp[3]))) {
            ...
            if (bestStamp == domStamp) {
                fieldMask |= 32;
            } else if (f85-assertionsDisabled || bestStamp == womStamp || bestStamp == dowimStamp) {
                if (dowStamp != 0) {
                    fieldMask |= 128;
                }
                if (womStamp == dowimStamp) {
                    ...
                    fieldMask |= 16;
                } else if (!f85-assertionsDisabled && bestStamp != dowimStamp) {
        ...
        } else if (!f85-assertionsDisabled && bestStamp != doyStamp && bestStamp != woyStamp && bestStamp != 0) {
            throw new AssertionError();
        } else if (bestStamp == doyStamp) {
            fieldMask |= 64;
        } else if (f85-assertionsDisabled || bestStamp == woyStamp) {
            if (dowStamp != 0) {
                fieldMask |= 128;
            }
            fieldMask |= 8;
    ...
    private boolean isStandaloneStyle(int style) {
        return (NumericShaper.MYANMAR & style) != 0 ? true : f85-assertionsDisabled;
    }

    private boolean isNarrowStyle(int style) {
        return (style == 4 || style == NARROW_STANDALONE) ? true : f85-assertionsDisabled;
    }

    private boolean isNarrowFormatStyle(int style) {
        return style == 4 ? true : f85-assertionsDisabled;
    }
    ...
    public boolean equals(Object obj) {
        boolean z = f85-assertionsDisabled;
        if (this == obj) {
            return true;
        }
        try {
    ...
    public void roll(int field, int amount) {
        ...
        while (amount < 0) {
            roll(field, (boolean) f85-assertionsDisabled);
            amount++;
        }
    }

...
public class DecimalFormat extends NumberFormat {
    ...
    private static final /* synthetic */ int[] f86-java-math-RoundingModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m38-getjava-math-RoundingModeSwitchesValues() {
        if (f86-java-math-RoundingModeSwitchesValues != null) {
            return f86-java-math-RoundingModeSwitchesValues;
        }
        ...
        f86-java-math-RoundingModeSwitchesValues = iArr;
        return iArr;
    }

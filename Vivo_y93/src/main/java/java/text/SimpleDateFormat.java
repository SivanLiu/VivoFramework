...
public class SimpleDateFormat extends DateFormat {
    ...
    static final /* synthetic */ boolean f87-assertionsDisabled = (SimpleDateFormat.class.desiredAssertionStatus() ^ 1);
    ...
    public SimpleDateFormat(String pattern, Locale locale) {
        ...
        this.minusSign = '-';
        this.hasFollowingMinusSign = f87-assertionsDisabled;
    ...
    private void initialize(Locale loc) {
        ...
        if (this.numberFormat == null) {
            ...
            this.numberFormat.setGroupingUsed(f87-assertionsDisabled);
    ...
    private void initializeCalendar(Locale loc) {
        ...
        if (f87-assertionsDisabled || loc != null) {
    ...
    private char[] compile(String pattern) {
        ...
        boolean inQuote = f87-assertionsDisabled;
        ...
        while (i < length) {
            ...
            if (c == '\'') {
                ...
                if (inQuote) {
                    ...
                    inQuote = f87-assertionsDisabled;
                } else {
                    if (count != 0) {
                        encode(lastTag, count, compiledCode);
                        lastTag = -1;
    ...
    private void subFormat(int patternCharIndex, int count, FieldDelegate delegate, StringBuffer buffer, boolean useDateFormatSymbols) {
        ...
        switch (patternCharIndex) {
            ...
            case 2:
                if (useDateFormatSymbols) {
                    current = formatMonth(count, value, Integer.MAX_VALUE, buffer, useDateFormatSymbols, f87-assertionsDisabled);
                    break;
                }
                break;
            case 4:
            ...
            case 9:
                if (current == null) {
                    current = formatWeekday(count, value, useDateFormatSymbols, f87-assertionsDisabled);
                    break;
                }
                break;
            case 14:
            ...
            case 17:
                if (current == null) {
                    ...
                    boolean daylight = this.calendar.get(16) != 0 ? true : f87-assertionsDisabled;
            ...
            case 18:
                ...
                buffer.append(TimeZone.createGmtOffsetString(count == 4 ? true : f87-assertionsDisabled, count >= 4 ? true : f87-assertionsDisabled, value));
                break;
            case 21:
                value = this.calendar.get(15) + this.calendar.get(16);
                if (value != 0) {
    ...
    private Date parseInternal(String text, ParsePosition pos) {
        ...
        boolean[] ambiguousYear = new boolean[]{f87-assertionsDisabled};
        ...
        while (i < this.compiledPattern.length) {
            ...
            switch (tag) {
                ...
                default:
                    boolean obeyCount = f87-assertionsDisabled;
                    boolean useFollowingMinusSignAsDelimiter = f87-assertionsDisabled;
...
*/
    ...
    private int subParseZoneStringFromSymbols(String text, int start, CalendarBuilder calb) {
        boolean useSameName = f87-assertionsDisabled;
    ...
    private boolean isDigit(char c) {
        return (c < '0' || c > '9') ? f87-assertionsDisabled : true;
    }
            ...
            if (c == ' ' || c == 9) {
                ...
                switch (patternCharIndex) {
                    ...
                    case 19:
                        if (this.calendar instanceof GregorianCalendar) {
                            if (count <= 2 && pos.index - start == 2 && Character.isDigit(text.charAt(start))) {
                                if (Character.isDigit(text.charAt(start + 1))) {
                                    ...
                                    ambiguousYear[0] = value == ambiguousTwoDigitYear ? true : f87-assertionsDisabled;
                        ...
                        return pos.index;
                    case 2:
                        idx = parseMonth(text, count, value, start, field, pos, useDateFormatSymbols, f87-assertionsDisabled, calb);
                        if (idx > 0) {
                            return idx;
                        }
                        break;
                    ...
                    case 9:
                        idx = parseWeekday(text, start, field, useDateFormatSymbols, f87-assertionsDisabled, calb);
                        if (idx > 0) {
                            return idx;
                        }
                        break;
                    ...
                    case 18:
                        try {
                            ...
                            if (sign != 0) {
                                int i4 = pos.index + 1;
                                pos.index = i4;
                                i = subParseNumericZone(text, i4, sign, 0, f87-assertionsDisabled, calb);
                                if (i <= 0) {
                                    pos.index = -i;
                                    i2 = sign;
                                    break;
                                        ...
                                        if (text.regionMatches(true, start, GMT, 0, GMT.length())) {
                                            ...
                                            if (text.length() - pos.index > 0) {
                                                ...
                                                if (i2 == 0) {
                                                    i3 = pos.index + 1;
                                                    pos.index = i3;
                                                    i = subParseNumericZone(text, i3, i2, 0, f87-assertionsDisabled, calb);
                                                    if (i <= 0) {
                                                        pos.index = -i;
                                                        break;
                                                    }
                    ...
                    case 21:
                        if (text.length() - pos.index > 0) {
                            ...
                            if (c != 'Z') {
                                ...
                                i3 = pos.index + 1;
                                pos.index = i3;
                                i = subParseNumericZone(text, i3, i2, count, count == 3 ? true : f87-assertionsDisabled, calb);
                                if (i <= 0) {
                                    pos.index = -i;
                                    break;
                                }
    ...
    public boolean equals(Object obj) {
        boolean z = f87-assertionsDisabled;
        if (!super.equals(obj)) {
            return f87-assertionsDisabled;
        }

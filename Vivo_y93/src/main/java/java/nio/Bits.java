...
class Bits {
    ...
    static final /* synthetic */ boolean f50-assertionsDisabled = (Bits.class.desiredAssertionStatus() ^ 1);
    ...
    private static boolean memoryLimitSet = f50-assertionsDisabled;
    private static int pageSize = -1;
    private static volatile long reservedMemory;
    private static volatile long totalCapacity;
    private static boolean unaligned;
    private static boolean unalignedKnown = f50-assertionsDisabled;
    ...
    static synchronized void unreserveMemory(long size, int cap) {
        synchronized (Bits.class) {
            if (reservedMemory > 0) {
                ...
                totalCapacity -= (long) cap;
                count--;
                if (!f50-assertionsDisabled && reservedMemory <= -1) {

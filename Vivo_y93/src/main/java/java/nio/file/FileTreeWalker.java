...
class FileTreeWalker implements Closeable {
    ...
    static final /* synthetic */ boolean f68-assertionsDisabled = (FileTreeWalker.class.desiredAssertionStatus() ^ 1);
    /* renamed from: -java-nio-file-FileVisitOptionSwitchesValues */
    private static final /* synthetic */ int[] f69-java-nio-file-FileVisitOptionSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m28-getjava-nio-file-FileVisitOptionSwitchesValues() {
        if (f69-java-nio-file-FileVisitOptionSwitchesValues != null) {
            return f69-java-nio-file-FileVisitOptionSwitchesValues;
        }
        ...
        f69-java-nio-file-FileVisitOptionSwitchesValues = iArr;
        return iArr;
    }
    ...
    Event walk(Path file) {
        ...
        if (f68-assertionsDisabled || ev != null) {
            return ev;
        }

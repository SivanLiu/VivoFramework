...
public class CoderResult {
    ...
    static final /* synthetic */ boolean f34-assertionsDisabled = (CoderResult.class.desiredAssertionStatus() ^ 1);
    ...
    public boolean isUnderflow() {
        return this.type == 0 ? true : f34-assertionsDisabled;
    }

    public boolean isOverflow() {
        return this.type == 1 ? true : f34-assertionsDisabled;
    }

    public boolean isError() {
        return this.type >= 2 ? true : f34-assertionsDisabled;
    }
    ...
    public boolean isUnmappable() {
        return this.type == 3 ? true : f34-assertionsDisabled;
    }

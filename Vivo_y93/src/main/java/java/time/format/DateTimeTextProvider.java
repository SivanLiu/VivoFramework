...
class DateTimeTextProvider {
    ...
    private static /* synthetic */ int[] m78-getjava-time-temporal-ChronoFieldSwitchesValues() {
    ...
    public Iterator<Entry<String, Long>> getTextIterator(Chronology chrono, TemporalField field, TextStyle style, Locale locale) {
        ...
        int fieldIndex;
        switch (m78-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
                fieldIndex = 9;
                break;
            case 2:

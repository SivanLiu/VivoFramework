...
public final class ZonedDateTime implements Temporal, ChronoZonedDateTime<LocalDate>, Serializable {
    ...
    private static final /* synthetic */ int[] f92-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m42-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f92-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f92-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f92-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }

...
public final class ThaiBuddhistDate extends ChronoLocalDateImpl<ThaiBuddhistDate> implements ChronoLocalDate, Serializable {
    ...
    private static final /* synthetic */ int[] f114-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m77-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f114-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f114-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f114-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ValueRange range(TemporalField field) {
        ...
        if (isSupported(field)) {
            ...
            switch (m77-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
                case 1:
                case 2:
                case 3:

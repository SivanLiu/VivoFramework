...
final class ChronoLocalDateTimeImpl<D extends ChronoLocalDate> implements ChronoLocalDateTime<D>, Temporal, TemporalAdjuster, Serializable {
    ...
    private static final /* synthetic */ int[] f103-java-time-temporal-ChronoUnitSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m60-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f103-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f103-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f103-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public ChronoLocalDateTimeImpl<D> plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m60-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:

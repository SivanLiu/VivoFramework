...
abstract class ChronoLocalDateImpl<D extends ChronoLocalDate> implements ChronoLocalDate, Temporal, TemporalAdjuster, Serializable {
    ...
    private static final /* synthetic */ int[] f102-java-time-temporal-ChronoUnitSwitchesValues = null;
    private static final long serialVersionUID = 6282433883239719096L;

    /* renamed from: -getjava-time-temporal-ChronoUnitSwitchesValues */
    private static /* synthetic */ int[] m59-getjava-time-temporal-ChronoUnitSwitchesValues() {
        if (f102-java-time-temporal-ChronoUnitSwitchesValues != null) {
            return f102-java-time-temporal-ChronoUnitSwitchesValues;
        }
        ...
        f102-java-time-temporal-ChronoUnitSwitchesValues = iArr;
        return iArr;
    }
    ...
    public D plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m59-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:

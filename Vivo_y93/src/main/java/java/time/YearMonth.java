...
public final class YearMonth implements Temporal, TemporalAdjuster, Comparable<YearMonth>, Serializable {
    ...
    private static final /* synthetic */ int[] f99-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m52-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f99-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f99-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f99-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getjava-time-temporal-ChronoUnitSwitchesValues */
    private static /* synthetic */ int[] m53-getjava-time-temporal-ChronoUnitSwitchesValues() {
    ...
    public long getLong(TemporalField field) {
        ...
        switch (m52-getjava-time-temporal-ChronoFieldSwitchesValues()[((ChronoField) field).ordinal()]) {
            case 1:
    ...
    public YearMonth with(TemporalField field, long newValue) {
        ...
        switch (m52-getjava-time-temporal-ChronoFieldSwitchesValues()[f.ordinal()]) {
            case 1:
    ...
    public YearMonth plus(long amountToAdd, TemporalUnit unit) {
        ...
        switch (m53-getjava-time-temporal-ChronoUnitSwitchesValues()[((ChronoUnit) unit).ordinal()]) {
            case 1:

...
public final class MonthDay implements TemporalAccessor, TemporalAdjuster, Comparable<MonthDay>, Serializable {
    ...
    private static final /* synthetic */ int[] f90-java-time-temporal-ChronoFieldSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m41-getjava-time-temporal-ChronoFieldSwitchesValues() {
        if (f90-java-time-temporal-ChronoFieldSwitchesValues != null) {
            return f90-java-time-temporal-ChronoFieldSwitchesValues;
        }
        ...
        f90-java-time-temporal-ChronoFieldSwitchesValues = iArr;
        return iArr;
    }

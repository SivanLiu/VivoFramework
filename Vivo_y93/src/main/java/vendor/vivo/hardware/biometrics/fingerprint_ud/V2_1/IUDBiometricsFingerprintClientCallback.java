...
public interface IUDBiometricsFingerprintClientCallback extends IBiometricsFingerprintClientCallback {
    public static final String kInterfaceName = "vendor.vivo.hardware.biometrics.fingerprint_ud@2.1::IUDBiometricsFingerprintClientCallback";

    public static final class Proxy implements IUDBiometricsFingerprintClientCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.vivo.hardware.biometrics.fingerprint_ud@2.1::IUDBiometricsFingerprintClientCallback]@Proxy";
            }
        }
        ...
        public void onCommandResult(long deviceId, int command, int result, int extras) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IUDBiometricsFingerprintClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
    ...
    public static abstract class Stub extends HwBinder implements IUDBiometricsFingerprintClientCallback {
        public IHwBinder asBinder() {
            return this;
        }

        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IUDBiometricsFingerprintClientCallback.kInterfaceName, "android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprintClientCallback", "android.hidl.base@1.0::IBase"}));
        }

        public final String interfaceDescriptor() {
            return IUDBiometricsFingerprintClientCallback.kInterfaceName;
        }

        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList(Arrays.asList(new byte[][]{new byte[]{(byte) -45, (byte) 94, (byte) -81, (byte) -93, (byte) -25, (byte) -46, (byte) 42, (byte) -66, (byte) 54, (byte) 12, (byte) 48, (byte) -4, (byte) -88, (byte) -86, (byte) 103, (byte) -84, (byte) 117, (byte) 69, (byte) -84, (byte) -75, (byte) -44, (byte) 58, (byte) -69, (byte) 115, (byte) -68, (byte) -83, (byte) 121, (byte) -14, (byte) -67, (byte) 41, (byte) -32, (byte) 29}, new byte[]{(byte) -86, (byte) -69, (byte) 92, (byte) 60, (byte) 88, (byte) 85, (byte) -110, (byte) -41, (byte) 30, (byte) -27, (byte) 123, (byte) 119, (byte) 41, (byte) -116, (byte) 20, (byte) -103, (byte) 61, (byte) 119, (byte) -111, (byte) 77, (byte) -34, (byte) -86, (byte) 100, (byte) -78, (byte) -59, (byte) 16, (byte) -102, (byte) 96, (byte) 43, (byte) 2, (byte) -22, (byte) 71}, new byte[]{(byte) -67, (byte) -38, (byte) -74, (byte) 24, (byte) 77, (byte) 122, (byte) 52, (byte) 109, (byte) -90, (byte) -96, (byte) 125, (byte) -64, (byte) -126, (byte) -116, (byte) -15, (byte) -102, (byte) 105, (byte) 111, (byte) 76, (byte) -86, (byte) 54, (byte) 17, (byte) -59, (byte) 31, (byte) 46, (byte) 20, (byte) 86, (byte) 90, (byte) 20, (byte) -76, (byte) 15, (byte) -39}}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (IUDBiometricsFingerprintClientCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case FingerprintMsgType.ENGINEER_COMMAND_RESULT /*7*/:
                    _hidl_request.enforceInterface(IUDBiometricsFingerprintClientCallback.kInterfaceName);
    ...
    static IUDBiometricsFingerprintClientCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IUDBiometricsFingerprintClientCallback)) {
            return (IUDBiometricsFingerprintClientCallback) iface;
        }
        IUDBiometricsFingerprintClientCallback proxy = new Proxy(binder);
        try {
    ...
    static IUDBiometricsFingerprintClientCallback castFrom(IHwInterface iface) {
        return iface == null ? null : asInterface(iface.asBinder());
    }

    static IUDBiometricsFingerprintClientCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IUDBiometricsFingerprintClientCallback getService() throws RemoteException {

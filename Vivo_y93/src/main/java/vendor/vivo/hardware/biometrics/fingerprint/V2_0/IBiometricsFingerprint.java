...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
    public static final String kInterfaceName = "vendor.vivo.hardware.biometrics.fingerprint@2.0::IBiometricsFingerprint";
    ...
    public static final class Proxy implements IBiometricsFingerprint {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.vivo.hardware.biometrics.fingerprint@2.0::IBiometricsFingerprint]@Proxy";
            }
        }
        ...
        public long setNotify2(IBiometricsFingerprintClientCallback clientCallback) throws RemoteException {
            IHwBinder iHwBinder = null;
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFingerprint {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IBiometricsFingerprint.kInterfaceName, "android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint", "android.hidl.base@1.0::IBase"}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 11:
                    ...
                    _hidl_out_deviceId = setNotify2(IBiometricsFingerprintClientCallback.asInterface(_hidl_request.readStrongBinder()));
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt64(_hidl_out_deviceId);
                    _hidl_reply.send();
                    return;
    ...
    long setNotify2(IBiometricsFingerprintClientCallback iBiometricsFingerprintClientCallback) throws RemoteException;

...
public interface ILocationManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILocationManager {
        ...
        static final int TRANSACTION_setVSNSListener = 43;
        ...
        private static class Proxy implements ILocationManager {
            ...
            public boolean setVSNSListener(IVSNSListener listener) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setVSNSListener(android.location.IVSNSListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
    ...
    boolean setVSNSListener(IVSNSListener iVSNSListener) throws RemoteException;

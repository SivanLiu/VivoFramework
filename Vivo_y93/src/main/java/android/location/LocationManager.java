...
public class LocationManager {
    ...
    private class ListenerTransport extends ILocationListener.Stub {
        ...
        public void onLocationChanged(Location location) {
            ...
            if (!this.mListenerHandler.sendMessage(msg)) {
                try {
                    Log.d(LocationManager.TAG, "onLocationChanged start false to send msg locationCallbackFinished");
                    LocationManager.this.mService.locationCallbackFinished(this);
                    Log.d(LocationManager.TAG, "onLocationChanged end false to send msg locationCallbackFinished");
        ...
        public void onStatusChanged(String provider, int status, Bundle extras) {
            ...
            if (!this.mListenerHandler.sendMessage(msg)) {
                try {
                    Log.d(LocationManager.TAG, "onStatusChanged start false to send msg locationCallbackFinished");
                    LocationManager.this.mService.locationCallbackFinished(this);
                    Log.d(LocationManager.TAG, "onStatusChanged end false to send msg locationCallbackFinished");
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
            }
        ...
        public void onProviderEnabled(String provider) {
            ...
            if (!this.mListenerHandler.sendMessage(msg)) {
                try {
                    Log.d(LocationManager.TAG, "onProviderEnabled start false to send msg locationCallbackFinished");
                    LocationManager.this.mService.locationCallbackFinished(this);
                    Log.d(LocationManager.TAG, "onProviderEnabled end false to send msg locationCallbackFinished");
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
            }
        ...
        public void onProviderDisabled(String provider) {
            ...
            if (!this.mListenerHandler.sendMessage(msg)) {
                try {
                    Log.d(LocationManager.TAG, "onProviderDisabled start false to send msg locationCallbackFinished");
                    LocationManager.this.mService.locationCallbackFinished(this);
                    Log.d(LocationManager.TAG, "onProviderDisabled end false to send msg locationCallbackFinished");
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
            }
    ...
    private class VSNSListenerTransport extends IVSNSListener.Stub {
        private VSNSListener mListener;

        VSNSListenerTransport(VSNSListener listener) {
            this.mListener = listener;
        }

        public void onRequestLocation(String packageName) {
            this.mListener.onRequestLocation(packageName);
        }

        public boolean onReportLocation(int pid, int uid) {
            return this.mListener.onReportLocation(pid, uid);
        }
    }
    ...
    public boolean setVSNSListener(VSNSListener listener) {
        try {
            this.mService.setVSNSListener(new VSNSListenerTransport(listener));
            return false;
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }

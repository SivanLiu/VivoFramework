...
public class Environment {
    ...
    private static UserEnvironment sDoubleAppUser;
    ...
    public static void mayInitForDoubleAppUser(int doubleAppUserId) {
        if (sCurrentUser.mUserId != doubleAppUserId) {
            if (sDoubleAppUser == null || sDoubleAppUser.mUserId != doubleAppUserId) {
                sDoubleAppUser = new UserEnvironment(doubleAppUserId);
            }
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public static File getExternalStorageDirectoryForDoubleAppUser() {
        if (sDoubleAppUser == null) {
            return getExternalStorageDirectory();
        }
        return sDoubleAppUser.getExternalDirs()[0];
    }
    ...
    public static String getInternalStorageState() {
        return getExternalStorageState(getInternalStorageDirectory());
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public static String getSecondaryStorageState() {
        return getExternalStorageState(getSecondaryStorageDirectory());
    }

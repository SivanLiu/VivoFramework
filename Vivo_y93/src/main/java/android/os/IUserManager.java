...
public interface IUserManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUserManager {
        ...
        static final int TRANSACTION_getDoubleAppUserId = 57;
        ...
        static final int TRANSACTION_isDoubleAppUserExist = 56;
        ...
        private static class Proxy implements IUserManager {
            ...
            public boolean isDoubleAppUserExist() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getDoubleAppUserId() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 56:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isDoubleAppUserExist();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 57:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getDoubleAppUserId();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
    ...
    int getDoubleAppUserId() throws RemoteException;
    ...
    boolean isDoubleAppUserExist() throws RemoteException;

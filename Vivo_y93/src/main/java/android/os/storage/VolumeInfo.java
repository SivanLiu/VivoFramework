...
public class VolumeInfo implements Parcelable {
    ...
    static {
        ...
        sStateToDescrip.put(0, 17039904);
        sStateToDescrip.put(1, 17039896);
        sStateToDescrip.put(2, 17039900);
        sStateToDescrip.put(3, 17039901);
        sStateToDescrip.put(4, 17039898);
        sStateToDescrip.put(5, 17039897);
        sStateToDescrip.put(6, 17039903);
        sStateToDescrip.put(7, 17039902);
        sStateToDescrip.put(8, 17039895);
    }
    ...
    public String getDescription() {
        if (ID_PRIVATE_INTERNAL.equals(this.id) || ID_EMULATED_INTERNAL.equals(this.id)) {
            return Resources.getSystem().getString(17041374);
        }
    ...
    public File getInternalPathForUser(int userId) {
        ...
        if (this.path.startsWith("/storage/otg/")) {
            return new File(this.path.replace("/storage/otg/", "/mnt/media_rw/"));
        }
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        pw.printPair(AudioFeatures.KEY_STATE, DebugUtils.valueToString(getClass(), "STATE_", this.state));
        pw.println();

...
public final class MessageQueue {
    ...
    public static boolean DEBUG_MAX_MSG = false;
                        ...
                        while (true) {
                            if (DEBUG_MAX_MSG) {
                                ...
                                if (count > 1000 && count < 1005) {
                                    Slog.w(TAG, "Too many messages: index = " + count + ", msg = " + p);
                                } else if (count > 1000) {
                                    if (p.next == null || when < p.next.when) {
                                        Slog.w(TAG, "Total message count: " + count);
                                    }
                                }
                            }
                            prev = p;

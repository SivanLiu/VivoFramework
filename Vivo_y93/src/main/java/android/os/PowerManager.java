...
public final class PowerManager {
    ...
    public static final int GO_TO_SLEEP_REASON_THIRD_PART_APP_PROXIMITY = 10000;
    ...
    public final class WakeLock {
        ...
        private IRemoteCallback mReleaseWakelockCallback;
        ...
        private void acquireLocked() {
            ...
            if (!this.mRefCounted || this.mInternalCount == 1) {
                ...
                try {
                    PowerManager.this.mService.acquireWakeLock(this.mToken, this.mFlags, this.mTag, this.mPackageName, this.mWorkSource, this.mHistoryTag, createCallback());
                    this.mHeld = true;
                } catch (RemoteException e) {
                    throw e.rethrowFromSystemServer();
                }
        ...
        private IRemoteCallback createCallback() {
            if (this.mReleaseWakelockCallback == null) {
                this.mReleaseWakelockCallback = new Stub() {
                    public void sendResult(Bundle data) throws RemoteException {
                        WakeLock.this.frozenRelease(0);
                    }
                };
            }
            return this.mReleaseWakelockCallback;
        }

        private void frozenRelease(int flags) {
            synchronized (this.mToken) {
                if (this.mHeld) {
                    Trace.asyncTraceEnd(131072, this.mTraceName, 0);
                    try {
        ...
        /* renamed from: lambda$-android_os_PowerManager$WakeLock_59345 */
        /* synthetic */ void m26lambda$-android_os_PowerManager$WakeLock_59345(Runnable r) {
            try {
                r.run();
            } finally {
                release();
    ...
    public int getPlugType() {
        try {
            return this.mService.getPlugType();
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void setButtonLightMode(int buttonLightMode) {
        try {
            this.mService.setButtonLightMode(buttonLightMode);
        } catch (RemoteException e) {
        }
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void notifyKeyguardActive(boolean active) {
        try {
            this.mService.notifyKeyguardActive(active);
        } catch (RemoteException e) {
        }
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void setHasUnansweredCall(boolean has) {
        try {
            this.mService.setHasUnansweredCall(has);
        } catch (RemoteException e) {
        }
    }
    ...
    public void notifyPhoneState(int state) {
        try {
            this.mService.notifyPhoneState(state);
        } catch (RemoteException e) {
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void lightupNow() {
        try {
            this.mService.lightupNow();
        } catch (RemoteException e) {
        }
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public int notifyCameraParamLuma(String keyval) {
        try {
            return this.mService.notifyCameraParamLuma(keyval);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void setColorFadeOffAnimationDurationMillis(int offtime) {
        try {
            this.mService.setColorFadeOffAnimationDurationMillis(offtime);
        } catch (RemoteException e) {
        }
    }
    ...
    public void sendFingerprintResult(int result) {
        try {
            this.mService.sendFingerprintResult(result);
        } catch (RemoteException e) {
        }
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void wakeUpByWho(long time, String who) {
        try {
            this.mService.wakeUpByWho(time, who);
        } catch (RemoteException e) {
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean isUseProximitySensorLocked() {
        try {
            return this.mService.isUseProximitySensorLocked();
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setWakefullnessOverride(int doze) {
        try {
            return this.mService.setWakefullnessOverride(doze);
        } catch (RemoteException e) {
            return false;
        }
    }

    public void setDozeOverrideFromNightPearl(int screenState, int screenBrightness) {
        try {
            this.mService.setDozeOverrideFromNightPearl(screenState, screenBrightness);
        } catch (RemoteException e) {
            Log.e(TAG, "setDozeOverrideFromNightPearl: ", e);
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean blockReallyGoToSleepFromDozing(boolean blocked) {
        try {
            return this.mService.blockReallyGoToSleepFromDozing(blocked);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void setIsNightPearlShowing(boolean isShowing) {
        try {
            this.mService.setIsNightPearlShowing(isShowing);
        } catch (RemoteException e) {
            Log.e(TAG, "setIsNightPearlShowing: " + e);
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void blockSleepFromDozingByFingerprint(boolean blocked) {
        try {
            this.mService.blockSleepFromDozingByFingerprint(blocked);
        } catch (RemoteException e) {
            Log.e(TAG, "blockSleepFromDozingByFingerprint: ", e);
        }
    }

    public void setFingerprintOverlayEnable(boolean enable) {
        try {
            this.mService.setFingerprintOverlayEnable(enable);
        } catch (RemoteException e) {
            Log.e(TAG, "setFingerprintOverlayEnable: ", e);
        }
    }

    public void setFingerprintShooterVisible(int visibility) {
        try {
            this.mService.setFingerprintShooterVisible(visibility);
        } catch (RemoteException e) {
            Log.e(TAG, "setFingerprintShooterVisible: ", e);
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean onFronzenPackage(String packageName) {
        if (packageName == null) {
            return false;
        }
        try {
            return this.mService.onFronzenPackage(packageName);
        } catch (RemoteException e) {
            return false;
        }
    }

...
public interface INetworkManagementService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkManagementService {
        ...
        static final int TRANSACTION_clearFirewallChain = 93;
        ...
        static final int TRANSACTION_getInterfaceRxThrottle = 90;
        static final int TRANSACTION_getInterfaceTxThrottle = 91;
        ...
        static final int TRANSACTION_sendFlushDnsCacheCmd = 94;
        ...
        static final int TRANSACTION_setFirewallUidChainRule = 92;
        ...
        static final int TRANSACTION_setInterfaceThrottle = 89;
        ...
        static final int TRANSACTION_vivoGetNetworkStatsUidDetailWithPackInfo = 95;
        ...
        private static class Proxy implements INetworkManagementService {
            ...
            public void sendFlushDnsCacheCmd(int netId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public NetworkStats vivoGetNetworkStatsUidDetailWithPackInfo(int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    NetworkStats _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    sendFlushDnsCacheCmd(data.readInt());
                    reply.writeNoException();
                    return true;
                case 95:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = vivoGetNetworkStatsUidDetailWithPackInfo(data.readInt());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
    ...
    void sendFlushDnsCacheCmd(int i) throws RemoteException;
    ...
    NetworkStats vivoGetNetworkStatsUidDetailWithPackInfo(int i) throws RemoteException;
}

...
public final class CursorJoiner implements Iterator<Result>, Iterable<Result> {
    ...
    private static /* synthetic */ int[] m32-getandroid-database-CursorJoiner$ResultSwitchesValues() {
    ...
    public boolean hasNext() {
        ...
        if (this.mCompareResultIsValid) {
            switch (m32-getandroid-database-CursorJoiner$ResultSwitchesValues()[this.mCompareResult.ordinal()]) {
                case 1:

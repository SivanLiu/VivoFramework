...
public class ZenModeConfig implements Parcelable {
    ...
    private static final String ZEN_ATT_GROUPID = "groupid";
    private static final String ZEN_ATT_MESSAGE_GROUPID = "messageGroupId";
    ...
    public boolean downtimeEnable = false;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public boolean manualZen;
    public long messageGroupId = -1;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public long onceEndTime;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public long onceStartTime;
    public int user = 0;
    ...
    public ZenModeConfig(Parcel source) {
        ...
        this.messageGroupId = source.readLong();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeLong(this.messageGroupId);
    ...
    private Diff diff(ZenModeConfig to) {
        ...
        if (this.groupid != to.groupid) {
            d.addLine(ZEN_ATT_GROUPID, Long.valueOf(this.groupid), Long.valueOf(to.groupid));
        }
        if (this.messageGroupId != to.messageGroupId) {
            d.addLine(ZEN_ATT_MESSAGE_GROUPID, Long.valueOf(this.messageGroupId), Long.valueOf(to.messageGroupId));
        }
    ...
    public static ZenModeConfig readXml(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        rt.groupid = safeLong(parser, ZEN_ATT_GROUPID, rt.groupid);
        rt.messageGroupId = safeLong(parser, ZEN_ATT_MESSAGE_GROUPID, rt.messageGroupId);
        while (true) {
    ...
    public void writeXml(XmlSerializer out) throws IOException {
        ...
        out.attribute(null, ZEN_ATT_GROUPID, Long.toString(this.groupid));
        out.attribute(null, ZEN_ATT_MESSAGE_GROUPID, Long.toString(this.messageGroupId));

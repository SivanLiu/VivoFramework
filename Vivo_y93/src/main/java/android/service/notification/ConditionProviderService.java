...
public abstract class ConditionProviderService extends Service {
    ...
    private final INotificationManager getNotificationInterface() {
        if (this.mNoMan == null) {
            this.mNoMan = INotificationManager.Stub.asInterface(ServiceManager.getService(ThreadsColumns.NOTIFICATION));
        }
        return this.mNoMan;
    }
    ...
    public static final void requestRebind(ComponentName componentName) {
        try {
            INotificationManager.Stub.asInterface(ServiceManager.getService(ThreadsColumns.NOTIFICATION)).requestBindProvider(componentName);

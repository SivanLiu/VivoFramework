...
public class StatusBarNotification implements Parcelable {
    ...
    public String toString() {
        return String.format("StatusBarNotification(pkg=%s user=%s id=%d tag=%s key=%s modified=%s: %s)", new Object[]{this.pkg, this.user, Integer.valueOf(this.id), this.tag, this.key, Boolean.valueOf(this.modified), this.notification});
    }

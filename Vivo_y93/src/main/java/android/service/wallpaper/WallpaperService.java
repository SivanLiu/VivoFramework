...
public abstract class WallpaperService extends Service {
    ...
    class IWallpaperEngineWrapper extends Stub implements HandlerCaller.Callback {
        ...
        public void requestWallpaperColors() {
            this.mCaller.sendMessage(this.mCaller.obtainMessage(WallpaperService.MSG_REQUEST_WALLPAPER_COLORS));
        }
        ...
        public void executeMessage(Message message) {
            switch (message.what) {
                ...
                case WallpaperService.MSG_TOUCH_EVENT /*10040*/:
                    ...
                    ev.recycle();
                    break;
                case WallpaperService.MSG_REQUEST_WALLPAPER_COLORS /*10050*/:
                    if (this.mConnection != null) {
                        try {

...
public class GrantCredentialsPermissionActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final TextView authTokenTypeView = (TextView) findViewById(16908723);
            ...
            findViewById(16908704).setOnClickListener(this);
            findViewById(16908832).setOnClickListener(this);
            LinearLayout packagesListView = (LinearLayout) findViewById(16909132);
            ...
            ((TextView) findViewById(16908655)).setText(this.mAccount.name);
            ((TextView) findViewById(16908658)).setText(accountTypeLabel);
    ...
    private View newPackageView(String packageLabel) {
        ...
        ((TextView) view.findViewById(16909131)).setText(packageLabel);
        return view;
    }

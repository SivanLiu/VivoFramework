...
public abstract class BaseKeyListener extends MetaKeyKeyListener implements KeyListener {
    ...
    private static /* synthetic */ int[] m31-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues() {
    ...
    static int makeTextContentType(Capitalize caps, boolean autoText) {
        int contentType = 1;
        switch (m31-getandroid-text-method-TextKeyListener$CapitalizeSwitchesValues()[caps.ordinal()]) {
            case 1:

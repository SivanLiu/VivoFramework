...
public class ProgramFragmentFixedFunction extends ProgramFragment {
    ...
    public static class Builder {
        ...
        private static final /* synthetic */ int[] f26xfae8e800 = null;
        /* renamed from: -android-renderscript-ProgramFragmentFixedFunction$Builder$FormatSwitchesValues */
        private static final /* synthetic */ int[] f27x8940bbef = null;
        ...
        private static /* synthetic */ int[] m13x537010a4() {
            if (f26xfae8e800 != null) {
                return f26xfae8e800;
            }
        ...
        private static /* synthetic */ int[] m14x9c9feecb() {
            if (f27x8940bbef != null) {
                return f27x8940bbef;
            }
        ...
        private void buildShaderString() {
            ...
            for (int i = 0; i < this.mNumTextures; i++) {
                switch (m13x537010a4()[this.mSlots[i].env.ordinal()]) {
                    case 1:
                        this.mShader += "  col = texture2D(UNI_Tex0, t0);\n";
                        break;
                    case 2:
                        switch (m14x9c9feecb()[this.mSlots[i].format.ordinal()]) {
                            case 1:

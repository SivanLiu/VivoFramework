...
public class Font extends BaseObj {
    ...
    private static final /* synthetic */ int[] f25-android-renderscript-Font$StyleSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m12-getandroid-renderscript-Font$StyleSwitchesValues() {
        if (f25-android-renderscript-Font$StyleSwitchesValues != null) {
            return f25-android-renderscript-Font$StyleSwitchesValues;
        }
        ...
        f25-android-renderscript-Font$StyleSwitchesValues = iArr;
        return iArr;
    }
    ...
    static String getFontFileName(String familyName, Style style) {
        ...
        if (family != null) {
            switch (m12-getandroid-renderscript-Font$StyleSwitchesValues()[style.ordinal()]) {
                case 1:

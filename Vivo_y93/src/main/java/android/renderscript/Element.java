...
public class Element extends BaseObj {
    ...
    private static final /* synthetic */ int[] f22-android-renderscript-Element$DataKindSwitchesValues = null;
    /* renamed from: -android-renderscript-Element$DataTypeSwitchesValues */
    private static final /* synthetic */ int[] f23-android-renderscript-Element$DataTypeSwitchesValues = null;
    int[] mArraySizes;
    ...
    private static /* synthetic */ int[] m9-getandroid-renderscript-Element$DataKindSwitchesValues() {
        if (f22-android-renderscript-Element$DataKindSwitchesValues != null) {
            return f22-android-renderscript-Element$DataKindSwitchesValues;
        }
        ...
        f22-android-renderscript-Element$DataKindSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-renderscript-Element$DataTypeSwitchesValues */
    private static /* synthetic */ int[] m10-getandroid-renderscript-Element$DataTypeSwitchesValues() {
        if (f23-android-renderscript-Element$DataTypeSwitchesValues != null) {
            return f23-android-renderscript-Element$DataTypeSwitchesValues;
        }
        ...
        f23-android-renderscript-Element$DataTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static Element createVector(RenderScript rs, DataType dt, int size) {
        ...
        switch (m10-getandroid-renderscript-Element$DataTypeSwitchesValues()[dt.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public static Element createPixel(RenderScript rs, DataType dt, DataKind dk) {
        if (dk != DataKind.PIXEL_L && dk != DataKind.PIXEL_A && dk != DataKind.PIXEL_LA && dk != DataKind.PIXEL_RGB && dk != DataKind.PIXEL_RGBA && dk != DataKind.PIXEL_DEPTH && dk != DataKind.PIXEL_YUV) {
            ...
            int size = 1;
            switch (m9-getandroid-renderscript-Element$DataKindSwitchesValues()[dk.ordinal()]) {
                case 1:
                    size = 2;
                    break;
                case 2:

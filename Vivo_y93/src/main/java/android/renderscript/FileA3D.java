...
public class FileA3D extends BaseObj {
    ...
    public static class IndexEntry {
        ...
        private static final /* synthetic */ int[] f24-android-renderscript-FileA3D$EntryTypeSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m11-getandroid-renderscript-FileA3D$EntryTypeSwitchesValues() {
            if (f24-android-renderscript-FileA3D$EntryTypeSwitchesValues != null) {
                return f24-android-renderscript-FileA3D$EntryTypeSwitchesValues;
            }
            ...
            f24-android-renderscript-FileA3D$EntryTypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        static synchronized BaseObj internalCreate(RenderScript rs, IndexEntry entry) {
            synchronized (IndexEntry.class) {
                ...
                if (entry.mLoadedObj != null) {
                    ...
                    switch (m11-getandroid-renderscript-FileA3D$EntryTypeSwitchesValues()[entry.mEntryType.ordinal()]) {
                        case 1:

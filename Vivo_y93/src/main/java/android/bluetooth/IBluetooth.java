...
public interface IBluetooth extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetooth {
        ...
        static final int TRANSACTION_getAutoPlayAccessPermission = 47;
        ...
        static final int TRANSACTION_getSocketOpt = 70;
        ...
        static final int TRANSACTION_isCarKitDevice = 66;
        ...
        static final int TRANSACTION_setAutoPlayAccessPermission = 48;
        ...
        static final int TRANSACTION_setSocketOpt = 69;
        ...
        private static class Proxy implements IBluetooth {
            ...
            public int getAutoPlayAccessPermission(BluetoothDevice device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setAutoPlayAccessPermission(BluetoothDevice device, int value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isCarKitDevice(BluetoothDevice device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 47:
                    ...
                    _result2 = getAutoPlayAccessPermission(_arg0);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 48:
                    ...
                    _result = setAutoPlayAccessPermission(_arg0, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 49:
    ...
    int getAutoPlayAccessPermission(BluetoothDevice bluetoothDevice) throws RemoteException;
    ...
    boolean isCarKitDevice(BluetoothDevice bluetoothDevice) throws RemoteException;
    ...
    boolean setAutoPlayAccessPermission(BluetoothDevice bluetoothDevice, int i) throws RemoteException;

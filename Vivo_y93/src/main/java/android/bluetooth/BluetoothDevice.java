...
public final class BluetoothDevice implements Parcelable {
    ...
    public static final int REQUEST_TYPE_AUTO_PLAY_ACCESS = 10;
    ...
    public boolean isCarKitDevice() {
        ...
        try {
            return sService.isCarKitDevice(this);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
            return false;
        }
    ...
    public int getAutoPlayAccessPermission() {
        IBluetooth service = sService;
        if (service == null) {
            return 0;
        }
        try {
            return service.getAutoPlayAccessPermission(this);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
            return 0;
        }
    ...
    public boolean setAutoPlayAccessPermission(int value) {
        IBluetooth service = sService;
        if (service == null) {
            return false;
        }
        try {
            return service.setAutoPlayAccessPermission(this, value);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
            return false;
        }

...
public class PopupWindow {
    ...
    private class PopupDecorView extends FrameLayout {
        ...
        /* renamed from: lambda$-android_widget_PopupWindow$PopupDecorView_93357 */
        /* synthetic */ void m37lambda$-android_widget_PopupWindow$PopupDecorView_93357(TransitionListener listener, Transition transition, View anchorRoot) {
    ...
    /* renamed from: -android_widget_PopupWindow-mthref-0 */
    /* synthetic */ void m35-android_widget_PopupWindow-mthref-0() {
        alignToAnchor();
    }

    /* renamed from: lambda$-android_widget_PopupWindow_9628 */
    /* synthetic */ void m36lambda$-android_widget_PopupWindow_9628(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        alignToAnchor();
    }

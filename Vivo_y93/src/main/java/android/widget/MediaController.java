...
public class MediaController extends FrameLayout {
    ...
    protected View makeControllerView() {
        ...
        if (VivoThemeUtil.isVigourTheme(this.mContext)) {
            try {
                this.mRoot = inflate.inflate((int) com.vivo.internal.R.layout.vigour_media_controller, null);
            } catch (Exception e) {
                Log.e("MediaController", "Inflate failed layoutId : 50528294", e);
                this.mRoot = inflate.inflate((int) R.layout.media_controller, null);
            }
        } else {
            this.mRoot = inflate.inflate((int) R.layout.media_controller, null);
        }

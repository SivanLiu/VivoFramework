...
public class TextView extends View implements OnPreDrawListener {
    ...
    static final int ID_TEXT_SEARCH = 51183624;
    ...
    boolean mCanShowCursorWhenInputTypeNull;
    ...
    private boolean mEditToolbarEnabled;
    private Factory mEditableFactory;
    private Editor mEditor;
    private TruncateAt mEllipsize;
    boolean mEndCursorSupport;
    boolean mEndCursorSupportFlag;
    ...
    private boolean mOnTouchFinished;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x02c7 A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:27:0x02bc} */
    /* JADX WARNING: Removed duplicated region for block: B:119:0x0615 A:{ExcHandler: java.lang.UnsupportedOperationException (e java.lang.UnsupportedOperationException), Splitter: B:114:0x0607} */
    ...
    public TextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mShowToobar = true;
        this.mOnTouchFinished = true;
        this.mEndCursorSupport = FtBuild.getRomVersion() >= 3.5f;
        this.mEndCursorSupportFlag = false;
        ...
        this.mEditToolbarEnabled = false;
        this.mCanShowCursorWhenInputTypeNull = false;
    ...
    private void setText(CharSequence text, BufferType type, boolean notifyBefore, int oldlen) {
        ...
        if (this.mAutoLinkMask != 0) {
            ...
            if (Linkify.addLinks(s2, this.mAutoLinkMask, VivoThemeUtil.isVigourTheme(getContext()))) {
                text = s2;
    ...
    protected void onFocusChanged(boolean focused, int direction, Rect previouslyFocusedRect) {
        ...
        if (focused) {
            ...
            if (!this.mOnTouchFinished) {
                this.mShowToobar = false;
            }
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        this.mEndCursorSupportFlag = true;
        if (this.mEditor != null) {
        ...
        if (this.mEditor != null && this.mEditor.mDiscardNextActionUp && action == 1) {
            ...
            if ((this.mMovement != null || onCheckIsTextEditor()) && isEnabled() && (this.mText instanceof Spannable) && this.mLayout != null) {
                ...
                if (touchIsFinished && (isTextEditable() || textIsSelectable)) {
                    InputMethodManager imm = InputMethodManager.peekInstance();
                    viewClicked(imm);
                    boolean immShowing = false;
                    if (imm != null) {
                        immShowing = imm.getInputMethodWindowVisibleHeight() > 0;
                    }
                    if (isTextEditable() && this.mEditor.mShowSoftInputOnFocus && imm != null) {
                        imm.showSoftInput(this, 0);
                    }
                    this.mEditor.onTouchUpEvent(event);
                    Log.d(LOG_TAG, "touchFinish handled:" + handled + "    --- mShowToolbar=" + this.mShowToobar);
                    if (handled && this.mEditor.hasInsertionController()) {
                        CharSequence paste = ((ClipboardManager) getContext().getSystemService("clipboard")).getText();
                        if (TextUtils.isEmpty(this.mText) && (TextUtils.isEmpty(paste) ^ 1) != 0) {
                            if (this.mShowToobar && immShowing) {
                                this.mEditor.startInsertionActionMode();
                            } else {
                                this.mShowToobar = true;
                            }
    ...
    public boolean onTextContextMenuItem(int id) {
        ...
        switch (id) {
            ...
            case 16908320:
                ...
                Toast.makeText(new ContextThemeWrapper(this.mContext, VivoThemeUtil.getSystemThemeStyle(ThemeType.SYSTEM_DEFAULT)), (int) com.vivo.internal.R.string.text_cut_toast, 0).show();
                return true;
            case 16908321:
                setPrimaryClip(ClipData.newPlainText(null, getTransformedText(min, max)));
                stopTextActionMode();
                Toast.makeText(new ContextThemeWrapper(this.mContext, VivoThemeUtil.getSystemThemeStyle(ThemeType.SYSTEM_DEFAULT)), (int) com.vivo.internal.R.string.text_copy_toast, 0).show();
                return true;
            case 16908322:
                paste(min, max, true);
                return true;
            case 16908324:
                ...
                return true;
            case 16908328:
                boolean restartActionMode = (this.mEditor == null || this.mEditor.mTextActionMode == null) ? false : true;
                stopTextActionMode();
                if (restartActionMode) {
                    this.mEditor.checkMinOffset();
                    this.mEditor.startSelectionActionModeAsync(false);
                }
                return true;
            case 16908337:
    ...
    boolean canSearch() {
        return canCopy() && FtBuild.getRomVersion() >= 3.0f;
    }
    ...
    private void searchSelectedText() {
        ...
        bundle.putString("BBKNEWTAB", "true");
        i.putExtras(bundle);
        i.putExtra(SuggestionColumns.QUERY, query);
        i.setPackage(BrowserContract.AUTHORITY);
    ...
    int getOffsetAtCoordinate(int line, float x) {
        ...
        if (!this.mEndCursorSupport || x < ((float) ((getLeft() + getRight()) / 2)) || (this.mEndCursorSupportFlag ^ 1) != 0) {
            return getLayout().getOffsetForHorizontal(line, x);
        }
        int offset = getLayout().getOffsetForHorizontal(line, x, 0);
        char last = 0;
        if (offset > 0) {
            last = getText().charAt(offset - 1);
        }
        if (last == 10) {
            return offset - 1;
        }
    ...
    public void setCanShowCursorWhenInputTypeNull() {
        this.mCanShowCursorWhenInputTypeNull = true;
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean isEditToolbarEnabled() {
        return this.mEditToolbarEnabled;
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void setEditToolbarEnable(boolean enable) {
        this.mEditToolbarEnabled = enable;
    }
}

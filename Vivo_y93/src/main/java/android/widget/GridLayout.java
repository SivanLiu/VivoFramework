...
public class GridLayout extends ViewGroup {
    ...
    final class Axis {
        ...
        static final /* synthetic */ boolean f120-assertionsDisabled = (Axis.class.desiredAssertionStatus() ^ 1);
        ...
        private Arc[] topologicalSort(final Arc[] arcs) {
            return new Object() {
                /* renamed from: -assertionsDisabled */
                static final /* synthetic */ boolean f121-assertionsDisabled = (AnonymousClass1.class.desiredAssertionStatus() ^ 1);
                ...
                Arc[] sort() {
                    ...
                    if (f121-assertionsDisabled || this.cursor == -1) {
                        return this.result;
                    }
                    throw new AssertionError();
                }

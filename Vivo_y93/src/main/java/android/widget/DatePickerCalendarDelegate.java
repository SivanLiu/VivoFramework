...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    /* synthetic */ void m42lambda$-android_widget_DatePickerCalendarDelegate_11048(View v) {
        tryVibrate();
        switch (v.getId()) {
            case R.id.date_picker_header_date /*16908816*/:
                setCurrentView(0);
                return;
            case R.id.date_picker_header_year /*16908817*/:
                setCurrentView(1);
                return;
            default:
                return;
    ...
    /* synthetic */ void m43lambda$-android_widget_DatePickerCalendarDelegate_13424() {

...
final /* synthetic */ class -$Lambda$jt22v7S6acXavRq-_4QCBipXsH8 implements Runnable {
    ...
    private final /* synthetic */ void $m$0() {
        ((Callback) this.f42-$f0).onRemoteRttRequest((RemoteConnection) this.f43-$f1);
    }

    private final /* synthetic */ void $m$1() {
        ((Callback) this.f42-$f0).onRttInitiationSuccess((RemoteConnection) this.f43-$f1);
    }

    private final /* synthetic */ void $m$2() {
        ((Callback) this.f42-$f0).onRttSessionRemotelyTerminated((RemoteConnection) this.f43-$f1);
    }

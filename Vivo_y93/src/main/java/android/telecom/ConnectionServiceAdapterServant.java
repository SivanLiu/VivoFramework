...
final class ConnectionServiceAdapterServant {
    ...
    private final IConnectionServiceAdapter mStub = new Stub() {
        ...
        public VivoTelephonyApiParams vivoTelephonyApi(VivoTelephonyApiParams v) {
            try {
                return ConnectionServiceAdapterServant.this.mDelegate.vivoTelephonyApi(v);
            } catch (RemoteException e) {
                return null;
            }
        }
        ...
        public VivoTelephonyApiParams registerVivoApiCallback(VivoTelephonyApiParams v, IVivoTelephonyApiCallback callback) {
            try {
                return ConnectionServiceAdapterServant.this.mDelegate.registerVivoApiCallback(v, callback);
            } catch (RemoteException e) {
                return null;
            }
        }
        ...
        public VivoTelephonyApiParams unregisterVivoApiCallback(VivoTelephonyApiParams v, IVivoTelephonyApiCallback callback) {
            try {
                return ConnectionServiceAdapterServant.this.mDelegate.unregisterVivoApiCallback(v, callback);
            } catch (RemoteException e) {
                return null;
            }
        }

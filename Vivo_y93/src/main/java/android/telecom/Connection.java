...
public abstract class Connection extends Conferenceable {
    ...
    public static abstract class Listener {
        ...
        public void lambda$-android_telecom_Connection_105743(Connection c) {
        }

        /* renamed from: onRttInitiationFailure */
        public void lambda$-android_telecom_Connection_106352(Connection c, int reason) {
        }

        /* renamed from: onRttSessionRemotelyTerminated */
        public void lambda$-android_telecom_Connection_106666(Connection c) {
        }

        /* renamed from: onRemoteRttRequest */
        public void lambda$-android_telecom_Connection_106977(Connection c) {
        }
    ...
    public static abstract class VideoProvider {
        ...
        private static final int MSG_SET_PARAMETERS = 13;
        ...
        private final class VideoProviderBinder extends Stub {
            ...
            public void setParameters(String[] params) {
                VideoProvider.this.mMessageHandler.obtainMessage(13, params).sendToTarget();
            }
        }
                ...
                switch (msg.what) {
                    ...
                    case 13:
                        if (msg.obj != null && (msg.obj instanceof String[])) {
                            VideoProvider.this.onSetParameters((String[]) msg.obj);
                            return;
                        }
                        return;
                    default:
        ...
        @VivoHook(hookType = VivoHookType.NEW_METHOD)
        public void onSetParameters(String[] params) {
        }

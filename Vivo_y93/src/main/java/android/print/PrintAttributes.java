...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_3x5, Weather.WEATHERVERSION_ROM_3_0, Weather.WEATHERVERSION_ROM_4_0);
        public static final MediaSize NA_INDEX_4X6 = new MediaSize("NA_INDEX_4X6", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_4x6, Weather.WEATHERVERSION_ROM_3_5, Weather.WEATHERVERSION_ROM_4_5);
        public static final MediaSize NA_INDEX_5X8 = new MediaSize("NA_INDEX_5X8", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_5x8, Weather.WEATHERVERSION_ROM_4_0, 8000);
        public static final MediaSize NA_JUNIOR_LEGAL = new MediaSize("NA_JUNIOR_LEGAL", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_junior_legal, 8000, Weather.WEATHERVERSION_ROM_4_0);

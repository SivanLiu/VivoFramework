...
public class ProgressDialog extends AlertDialog {
    ...
    public ProgressDialog(Context context) {
        int i;
        if (!VivoThemeUtil.isVigourTheme(context) || ((double) FtBuild.getRomVersion()) < 4.0d) {
            i = 0;
        } else {
            i = 51315050;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mProgressStyle == 1) {
            ...
            this.mProgressNumber = (TextView) view.findViewById(16909181);
            this.mProgressPercent = (TextView) view.findViewById(16909182);
            setView(view);
        } else {

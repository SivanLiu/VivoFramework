...
public final class LoadedApk {
    ...
    static final /* synthetic */ boolean f49-assertionsDisabled = (LoadedApk.class.desiredAssertionStatus() ^ 1);
        ...
        final class Args extends PendingResult {
            ...
            public Args(Intent intent, int resultCode, String resultData, Bundle resultExtras, boolean ordered, boolean sticky, int sendingUser) {
                ...
                if (this.mCurIntent != null) {
                    this.mAction = this.mCurIntent.getAction();
                }
            }
            ...
            /* renamed from: lambda$-android_app_LoadedApk$ReceiverDispatcher$Args_53080 */
            /* synthetic */ void m21lambda$-android_app_LoadedApk$ReceiverDispatcher$Args_53080() {
                ...
                Jank.getInstance().handleBroadcastTimeout(intent.getAction(), false, SystemClock.uptimeMillis() - time);
                Trace.traceEnd(64);
            }

            public String toString() {
                if (this.mString == null) {
                    this.mString = Args.class.getName() + "{intent=" + this.mAction + ", receiver=" + ReceiverDispatcher.this.mReceiver + "}";
                }
                return this.mString;
            }
        }
    ...
    static final class ServiceDispatcher {
        ...
        private final class RunConnection implements Runnable {
            ...
            public String toString() {
                return "cmp:" + this.mName + ", dead:" + this.mDead + ", service:" + this.mService;
            }
        }
    ...
    void installSystemApplicationInfo(ApplicationInfo info, ClassLoader classLoader) {
        if (f49-assertionsDisabled || info.packageName.equals("android")) {
    ...
    public Resources getResources() {
        if (this.mResources == null) {
            try {
                this.mResources = ResourcesManager.getInstance().getResources(null, this.mResDir, getSplitPaths(null), this.mOverlayDirs, this.mApplicationInfo.sharedLibraryFiles, 0, null, getCompatibilityInfo(), getClassLoader());
                if (this.mResources != null) {
                    this.mResources.initResource(this.mPackageName);
                }
            } catch (NameNotFoundException e) {
                throw new AssertionError("null split not found");
            }

...
public interface IBackupAgent extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBackupAgent {
        ...
        static final int TRANSACTION_doBackupByZip = 9;
        ...
        static final int TRANSACTION_doRestoreByZip = 10;
        static final int TRANSACTION_doRestoreFile = 6;
        static final int TRANSACTION_doRestoreFinished = 7;
        static final int TRANSACTION_doRestoreFinishedWithCmd = 11;
        ...
        private static class Proxy implements IBackupAgent {
            ...
            public void doBackupByZip(int fd, ParcelFileDescriptor data, String[] dirs, boolean asDual, IVivoBackupManager callbackBinder) throws RemoteException {
                int i = 1;
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                try {
            ...
            public void doRestoreByZip(int fd, ParcelFileDescriptor data, IVivoBackupManager callbackBinder, String[] cmdList) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    doBackupByZip(_arg02, _arg1, data.createStringArray(), data.readInt() != 0, vivo.app.backup.IVivoBackupManager.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt();
                    ...
                    doRestoreByZip(_arg02, _arg1, vivo.app.backup.IVivoBackupManager.Stub.asInterface(data.readStrongBinder()), data.createStringArray());
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    doRestoreFinishedWithCmd(data.readInt(), android.app.backup.IBackupManager.Stub.asInterface(data.readStrongBinder()), data.createStringArray());
                    return true;
    ...
    void doBackupByZip(int i, ParcelFileDescriptor parcelFileDescriptor, String[] strArr, boolean z, IVivoBackupManager iVivoBackupManager) throws RemoteException;
    ...
    void doRestoreByZip(int i, ParcelFileDescriptor parcelFileDescriptor, IVivoBackupManager iVivoBackupManager, String[] strArr) throws RemoteException;
    ...
    void doRestoreFinishedWithCmd(int i, IBackupManager iBackupManager, String[] strArr) throws RemoteException;

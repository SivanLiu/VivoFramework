...
public class ActivityManager {
    ...
    public static final int FLAG_FORZEN_DEFAULT = 417;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_ALLOW_KILL_EMPTY = 256;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_AUTO_FROCE_STOP = 128;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_CANCLE_NOTIFICATION = 32;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_DISABLE_NETWORK = 2048;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_DISCONNCET_SERVICE = 1;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_FINISH_ACTIVITY = 2;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_FOREGROUND_PACKAGE = 512;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_FROCE_TRIM_MEMORY = 64;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_REMOVE_ALARM = 16;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_REMOVE_BROADCAST = 8;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_REMOVE_PROVIDER = 4;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_FROZEN_SUCCESS_BROADCAST = 1024;
    ...
    public static final int START_BACK_GROUND_DENIED = 4002;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int START_VIVO_PERMISSION_DENIED = 400;
    ...
    public static class StackId {
        ...
        public static boolean normallyFullscreenWindows(int stackId) {
            return (stackId == 4 || stackId == 2) ? false : true;
        }
    ...
    public boolean addPreloadProcess(String procName) {
        return addPreloadProcess(procName, 1000);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean addPreloadProcess(String procName, long delay) {
        if (procName == null) {
            return false;
        }
        try {
            return getService().addPreloadProcess(procName, delay);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean removePreloadProcess(String procName) {
        return removePreloadProcess(procName, 1000);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean removePreloadProcess(String procName, long delay) {
        if (procName == null) {
            return false;
        }
        try {
            return getService().removePreloadProcess(procName, delay);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceFreezeSelfAsUser(int userId, long delay, long unfreezeTime) {
        try {
            ActivityThread thread = ActivityThread.currentActivityThread();
            String packageName = thread.mInitialApplication.mLoadedApk.mPackageName;
            if (packageName == null) {
                return -1;
            }
            long j;
            ...
            return iActivityManager.forceFreezePackage(applicationThread, packageName, userId, j, unfreezeTime, null, FLAG_FORZEN_DEFAULT);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceFreezeSelf(long delay, long unfreezeTime, int flag) {
        ActivityThread thread = ActivityThread.currentActivityThread();
        String packageName = thread.mInitialApplication.mLoadedApk.mPackageName;
        if (packageName == null) {
            return -1;
        ...
        if (flag == 0) {
            flag = FLAG_FORZEN_DEFAULT;
        }
        try {
            return ActivityManagerNative.getDefault().forceFreezePackage(thread.getApplicationThread(), packageName, UserHandle.myUserId(), delay, unfreezeTime, null, flag);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceFreezePackage(String packageName) {
        return forceFreezePackage(packageName, 0, 0, FLAG_FORZEN_DEFAULT);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceFreezePackageAsUser(String packageName, int userId, long delay, long unfreezeTime, int flag) {
        if (flag == 0) {
            flag = FLAG_FORZEN_DEFAULT;
        }
        try {
            return ActivityManagerNative.getDefault().forceFreezePackage(null, packageName, userId, delay, unfreezeTime, null, flag);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceFreezePackage(String packageName, long delay, long unfreezeTime, int flag) {
        if (flag == 0) {
            flag = FLAG_FORZEN_DEFAULT;
        }
        try {
            return ActivityManagerNative.getDefault().forceFreezePackage(null, packageName, UserHandle.myUserId(), delay, unfreezeTime, null, flag);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceUnfreezePackageAsUser(String packageName, int userId, long delay) {
        try {
            return ActivityManagerNative.getDefault().forceUnfreezePackage(null, packageName, userId, delay, null);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceUnfreezePackage(String packageName) {
        return forceUnfreezePackage(packageName, 0);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public int forceUnfreezePackage(String packageName, long delay) {
        try {
            return ActivityManagerNative.getDefault().forceUnfreezePackage(null, packageName, UserHandle.myUserId(), delay, null);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    public boolean isFrozenPackage(String packageName) {
        try {
            return ActivityManagerNative.getDefault().isFrozenPackage(packageName, UserHandle.myUserId());
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public static void showCustomDebugModeOverlay() {
        try {
            getService().showCustomDebugModeOverlay();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

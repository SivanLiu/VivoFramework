...
public class Application extends ContextWrapper implements ComponentCallbacks2 {
    ...
    private static AbsVivoUserProfilingManager mUserProfilingManager;
    ...
    public AbsVivoUserProfilingManager getUserProfilingManager() {
        if (mUserProfilingManager != null) {
            return mUserProfilingManager;
        }
        AbsVivoUserProfilingManager absVivoUserProfilingManager;
        synchronized (LOCKOBJ) {
            if (VivoFrameworkFactory.getFrameworkFactoryImpl() != null) {
                mUserProfilingManager = VivoFrameworkFactory.getFrameworkFactoryImpl().getVivoUserProfilingManager();
            }
            absVivoUserProfilingManager = mUserProfilingManager;
        }
        return absVivoUserProfilingManager;
    }
}

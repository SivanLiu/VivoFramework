...
public class AlarmManager {
    ...
    public void setNextBootTime(long nextBootTime, String packageName) {
        try {
            this.mService.setNextBootTime(nextBootTime, packageName);
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }

    public long getNextBootTime() {
        try {
            return this.mService.getNextBootTime();
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean onUnfrozenPackage(String packageName) {
        try {
            return this.mService.onUnfrozenPackage(packageName);
        } catch (RemoteException e) {
            return false;
        }
    }

...
class FragmentTransition {
    ...
    static /* synthetic */ void m13lambda$-android_app_FragmentTransition_18686(Transition enterTransition, View nonExistentView, Fragment inFragment, ArrayList sharedElementsIn, ArrayList enteringViews, ArrayList exitingViews, Transition exitTransition) {
        if (enterTransition != null) {
    ...
    static /* synthetic */ void m14lambda$-android_app_FragmentTransition_26843(Fragment inFragment, Fragment outFragment, boolean inIsPop, ArrayMap inSharedElements, View epicenterView, Rect epicenter) {
    ...
    static /* synthetic */ void m15lambda$-android_app_FragmentTransition_32404(ArrayMap nameOverrides, TransitionSet finalSharedElementTransition, FragmentContainerTransition fragments, ArrayList sharedElementsIn, View nonExistentView, Fragment inFragment, Fragment outFragment, boolean inIsPop, ArrayList sharedElementsOut, Transition enterTransition, Rect inEpicenter) {

...
public class Notification implements Parcelable {
    ...
    public int internalGroupPriority;
    public int internalPriority;
    public int internalType;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public int isKeyguardNotification;
    public int isStandardNotification;
    @Deprecated
    ...
    public static class BigPictureStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            contentView.setImageViewBitmap(16908740, this.mPicture);
            return contentView;
        }
    ...
    public static class BigTextStyle extends Style {
        ...
        static void applyBigTextContentView(Builder builder, RemoteViews contentView, CharSequence bigTextText) {
            contentView.setTextViewText(16908741, builder.processTextSpans(bigTextText));
            builder.setTextViewColorSecondary(contentView, 16908741);
            contentView.setViewVisibility(16908741, TextUtils.isEmpty(bigTextText) ? 8 : 0);
            contentView.setBoolean(16908741, "setHasImage", builder.mN.hasLargeIcon());
        }
    }
    ...
    public static class Builder {
        ...
        private int tempIsKeyguardNotification;
        private int tempIsStandardNotification;
        ...
        public Builder(Context context, Notification toAdopt) {
            ...
            this.tempIsStandardNotification = 0;
            this.tempIsKeyguardNotification = 0;
        ...
        private Drawable getProfileBadgeDrawable() {
            ...
            if (DoubleAppSwitcher.sEnabled && this.mContext.getUserId() == UserManager.get(this.mContext).getDoubleAppUserId()) {
                return null;
            }
        ...
        private Bitmap getProfileBadge() {
            ...
            int size = this.mContext.getResources().getDimensionPixelSize(51118316);
        ...
        private void bindProfileBadge(RemoteViews contentView) {
            ...
            if (profileBadge != null) {
                ...
                if (isColorized()) {
                    contentView.setDrawableParameters(16909176, false, -1, getPrimaryTextColor(), Mode.SRC_ATOP, -1);
                }
            }
        }
        ...
        private void resetNotificationHeader(RemoteViews contentView) {
            ...
            contentView.setTextViewText(16908716, null);
            contentView.setViewVisibility(16908786, 8);
        ...
        private RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p) {
            ...
            bindSubHeader(contentView, showProgress);
            if (p.text != null) {
                int textId;
                if (showProgress) {
                    textId = 16909362;
                ...
                if (showProgress) {
                    contentView.setViewVisibility(16909362, 0);
                    contentView.setTextViewText(16909362, null);
                }
            ...
            if (showProgress) {
                contentView.setViewVisibility(51183735, 0);
            } else {
                contentView.setViewVisibility(51183735, 8);
            }
            this.tempIsStandardNotification = 1;
            this.tempIsKeyguardNotification = 0;
            return contentView;
        }
        ...
        private void updateBackgroundColor(RemoteViews contentView) {
            if (isColorized()) {
                contentView.setInt(16909317, "setBackgroundColor", getBackgroundColor());
            } else {
        ...
        void setContentMinHeight(RemoteViews remoteView, boolean hasMinHeight) {
            int minHeight = 0;
            if (hasMinHeight) {
                minHeight = this.mContext.getResources().getDimensionPixelSize(51118300);
            }
        ...
        private boolean handleProgressBar(boolean hasProgress, RemoteViews contentView, Bundle ex) {
            ...
            contentView.setProgressBackgroundTintList(R.id.progress, ColorStateList.valueOf(this.mContext.getColor(17170671)));
            if (this.mN.color != 0) {
        ...
        private void bindLargeIcon(RemoteViews contentView) {
            ...
            if (this.mN.mLargeIcon != null) {
                ...
                contentView.setViewLayoutMarginEndDimen(16909011, 17105167);
                contentView.setViewLayoutMarginEndDimen(16909335, 17105167);
                contentView.setViewLayoutMarginEndDimen(R.id.progress, 17105167);
                contentView.setViewLayoutMarginEndDimen(51183735, 17105167);
                ...
                contentView.setViewVisibility(16909198, i);
                if (action != null) {
                    int contrastColor = resolveContrastColor();
                    contentView.setDrawableParameters(16909198, true, -1, contrastColor, Mode.SRC_ATOP, -1);
                    contentView.setDrawableParameters(16909198, false, -1, NotificationColorUtil.isColorLight(contrastColor) ? -16777216 : -1, Mode.SRC_ATOP, -1);
        ...
        private void bindSubHeader(RemoteViews contentView, boolean showProgress) {
            bindSubHeaderChronometerAndTime(contentView);
            bindSubHeaderText(contentView, showProgress);
        }

        private void bindExpandButton(RemoteViews contentView) {
            int color = getPrimaryHighlightColor();
            contentView.setDrawableParameters(16908851, false, -1, color, Mode.SRC_ATOP, -1);
            contentView.setInt(16909094, "setOriginalNotificationColor", color);
        }
        ...
        private void bindHeaderChronometerAndTime(RemoteViews contentView) {
            if (showsTimeOrChronometer()) {
                ...
                setTextViewColorSecondary(contentView, 16909368);
                if (this.mN.extras.getBoolean(Notification.EXTRA_SHOW_CHRONOMETER)) {
                    contentView.setViewVisibility(16908786, 0);
                    contentView.setLong(16908786, "setBase", this.mN.when + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(16908786, "setStarted", true);
                    contentView.setChronometerCountDown(16908786, this.mN.extras.getBoolean(Notification.EXTRA_CHRONOMETER_COUNT_DOWN));
                    setTextViewColorSecondary(contentView, 16908786);
                    return;
                }
                contentView.setViewVisibility(16909364, 0);
                contentView.setLong(16909364, "setTime", this.mN.when);
                setTextViewColorSecondary(contentView, 16909364);
                return;
            }
            contentView.setLong(16909364, "setTime", this.mN.when != 0 ? this.mN.when : this.mN.creationTime);
        }
        ...
        private void bindHeaderText(RemoteViews contentView) {
            ...
            if (headerText != null) {
                contentView.setTextViewText(16908925, processTextSpans(processLegacyText(headerText)));
                ...
                setTextViewColorSecondary(contentView, 16908926);
            }
        }

        private void bindSubHeaderChronometerAndTime(RemoteViews contentView) {
            if (!showsTimeOrChronometer()) {
                contentView.setViewVisibility(51183619, 8);
                contentView.setLong(51183620, "setTime", this.mN.when != 0 ? this.mN.when : this.mN.creationTime);
            } else if (this.mN.extras.getBoolean(Notification.EXTRA_SHOW_CHRONOMETER)) {
                contentView.setViewVisibility(51183621, 0);
                contentView.setLong(51183621, "setBase", this.mN.when + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                contentView.setBoolean(51183621, "setStarted", true);
                contentView.setChronometerCountDown(51183621, this.mN.extras.getBoolean(Notification.EXTRA_CHRONOMETER_COUNT_DOWN));
            } else {
                contentView.setViewVisibility(51183619, 0);
                contentView.setViewVisibility(51183620, 0);
                contentView.setLong(51183620, "setTime", this.mN.when);
            }
        }

        private void bindSubHeaderText(RemoteViews contentView, boolean showProgress) {
            CharSequence headerText = this.mN.extras.getCharSequence(Notification.EXTRA_SUB_TEXT);
            if (headerText == null && this.mStyle != null && this.mStyle.mSummaryTextSet && this.mStyle.hasSummaryInHeader()) {
                headerText = this.mStyle.mSummaryText;
            }
            ...
            if (headerText != null && (headerText.equals("") ^ 1) != 0) {
                Slog.d(Notification.TAG, "DEBUG_NLAYOUT:bindSubHeaderText headerText= " + headerText);
                if (showProgress) {
                    contentView.setViewVisibility(51183617, 8);
                    contentView.setTextViewText(51183736, processLegacyText(headerText));
                    contentView.setViewVisibility(51183736, 0);
                    contentView.setViewVisibility(16909362, 0);
                    return;
                }
                contentView.setTextViewText(51183618, processLegacyText(headerText));
                contentView.setViewVisibility(51183618, 0);
                contentView.setViewVisibility(51183617, 0);
            }
        }
        ...
        private void bindHeaderAppName(RemoteViews contentView, boolean ambient) {
            contentView.setTextViewText(16908716, loadHeaderAppName());
            if (!isColorized() || (ambient ^ 1) == 0) {
                contentView.setTextColor(16908716, ambient ? resolveAmbientColor() : resolveContrastColor());
            } else {
                setTextViewColorPrimary(contentView, 16908716);
            }
        }
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p) {
            ...
            if (N > 0) {
                big.setViewVisibility(16908683, 0);
                big.setViewVisibility(16908682, 0);
                big.setViewLayoutMarginBottomDimen(16909092, 51118292);
                if (N > 3) {
                    N = 3;
                }
                for (int i = 0; i < N; i++) {
                    ...
                    big.addView(16908682, generateActionButton(action, false, i % 2 != 0, p.ambient));
                }
            } else {
                big.setViewVisibility(16908683, 8);
            }
            ...
            if (!(p.ambient || !validRemoteInput || replyText == null || replyText.length <= 0 || (TextUtils.isEmpty(replyText[0]) ^ 1) == 0)) {
                ...
                big.setTextViewText(16909097, processTextSpans(replyText[0]));
                setTextViewColorSecondary(big, 16909097);
                if (replyText.length > 1 && (TextUtils.isEmpty(replyText[1]) ^ 1) != 0) {
                    big.setViewVisibility(16909098, 0);
                    big.setTextViewText(16909098, processTextSpans(replyText[1]));
                    ...
                    if (replyText.length > 2 && (TextUtils.isEmpty(replyText[2]) ^ 1) != 0) {
                        ...
                        big.setTextViewText(16909099, processTextSpans(replyText[2]));
        ...
        public RemoteViews makeNotificationHeader(boolean ambient) {
            ...
            RemoteViews header = new BuilderRemoteViews(this.mContext.getApplicationInfo(), 50528305);
        ...
        public RemoteViews makeAmbientNotification() {
            return applyStandardTemplateWithActions(50528308, this.mParams.reset().ambient(true).fillTextsFrom(this).hasProgress(false));
        }
        ...
        private RemoteViews makePublicView(boolean ambient) {
            ...
            publicExtras.putCharSequence(Notification.EXTRA_TITLE, this.mContext.getString(17040425));
        ...
        private CharSequence createSummaryText() {
            ...
            if (!(titleText == null || contentText == null)) {
                summary.append(bidi.unicodeWrap(this.mContext.getText(17040424)));
            }
            if (contentText != null) {
        ...
        private RemoteViews generateActionButton(Action action, boolean emphazisedMode, boolean oddAction, boolean ambient) {
            ...
            if (!tombstone) {
                button.setOnClickPendingIntent(16908659, action.actionIntent);
            }
            button.setContentDescription(16908659, action.title);
            if (action.mRemoteInputs != null) {
                button.setRemoteInputs(16908659, action.mRemoteInputs);
            }
            if (emphazisedMode) {
                int bgColor;
                if (isColorized()) {
                    ...
                    if (oddAction) {
                        emphasizedActionLayoutResource = 17170664;
                    } else {
                        emphasizedActionLayoutResource = 17170665;
                    }
                    bgColor = context.getColor(emphasizedActionLayoutResource);
                }
                button.setDrawableParameters(16908761, true, -1, bgColor, Mode.SRC_ATOP, -1);
                ...
                button.setTextViewText(16908659, processTextSpans(title));
                setTextViewColorPrimary(button, 16908659);
                if (outResultColor != null && outResultColor[0] != null) {
                    button.setTextColor(16908659, outResultColor[0]);
                } else if (!(this.mN.color == 0 || (isColorized() ^ 1) == 0 || !this.mTintActionButtons)) {
                    button.setTextColor(16908659, resolveContrastColor());
                }
            } else {
                button.setTextViewText(16908659, processTextSpans(processLegacyText(action.title)));
                if (isColorized() && (ambient ^ 1) != 0) {
                    setTextViewColorPrimary(button, 16908659);
                } else if (this.mN.color != 0 && this.mTintActionButtons) {
                    button.setTextColor(16908659, ambient ? resolveAmbientColor() : resolveContrastColor());
                }
            }
            return button;
        }
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView, boolean ambient) {
            ...
            contentView.setInt(16909094, str, color);
        }
        ...
        int resolveContrastColor() {
            ...
            if (this.mBackgroundColorHint == 1) {
                background = this.mContext.getColor(17170668);
            }
            if (this.mN.color == 0) {
                ensureColors();
        ...
        public Notification buildUnstyled() {
            ...
            this.mN.isStandardNotification = this.tempIsStandardNotification;
            this.mN.isKeyguardNotification = this.tempIsKeyguardNotification;
            return this.mN;
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private void buildIntoRemoteViewContent(RemoteViews remoteViews, RemoteViews customContent) {
            if (customContent != null) {
                ...
                remoteViews.removeAllViewsExceptId(16909095, R.id.progress);
                remoteViews.addView(16909095, customContent, 0);
                remoteViews.setReapplyDisallowed();
            }
            int endMargin = 17105164;
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews generateMediaActionButton(Action action, int color) {
            int tintColor;
            boolean tombstone = action.actionIntent == null;
            RemoteViews button = new BuilderRemoteViews(this.mBuilder.mContext.getApplicationInfo(), 50528302);
            button.setImageViewIcon(16908659, action.getIcon());
            ...
            button.setDrawableParameters(16908659, false, -1, tintColor, Mode.SRC_ATOP, -1);
            if (!tombstone) {
                button.setOnClickPendingIntent(16908659, action.actionIntent);
            }
            button.setContentDescription(16908659, action.title);
        ...
        private RemoteViews makeMediaContentView() {
            int N;
            RemoteViews view = this.mBuilder.applyStandardTemplate(50528320, false);
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    view.addView(16909036, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i]), getPrimaryHighlightColor()));
                }
            }
            handleImage(view);
            int endMargin = 17105164;
        ...
        private RemoteViews makeMediaBigContentView() {
            ...
            RemoteViews big = this.mBuilder.applyStandardTemplate(50528312, false);
            if (actionCount > 0) {
                big.removeAllViews(16909036);
                for (int i = 0; i < actionCount; i++) {
                    big.addView(16909036, generateMediaActionButton((Action) this.mBuilder.mActions.get(i), getPrimaryHighlightColor()));
                }
            }
            handleImage(big);
            return big;
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public RemoteViews makeContentView(boolean increasedHeight) {
            return buildIntoRemoteView(super.makeContentView(false), 16909093, this.mBuilder.mN.contentView);
        }
        ...
        private RemoteViews makeBigContentViewWithCustomContent(RemoteViews customRemoteView) {
            ...
            if (remoteViews != null) {
                return buildIntoRemoteView(remoteViews, 16909095, customRemoteView);
            }
            if (customRemoteView != this.mBuilder.mN.contentView) {
                return buildIntoRemoteView(super.makeContentView(false), 16909093, customRemoteView);
            }
            return null;
        }
    ...
    public static class InboxStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            int[] rowIds = new int[]{16908951, 16908952, 16908953, 16908954, 16908955, 16908956, 16908957};
            for (int rowId : rowIds) {
                contentView.setViewVisibility(rowId, 8);
            }
            int i = 0;
            int topPadding = this.mBuilder.mContext.getResources().getDimensionPixelSize(51118315);
            boolean first = true;
            int onlyViewId = 0;
            ...
            if (onlyViewId != 0) {
                contentView.setViewPadding(onlyViewId, 0, this.mBuilder.mContext.getResources().getDimensionPixelSize(51118314), 0, 0);
            }
            return contentView;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        private void fixTitleAndTextExtras(Bundle extras) {
            ...
            if (TextUtils.isEmpty(this.mConversationTitle)) {
                ...
                BidiFormatter bidi = BidiFormatter.getInstance();
                title = this.mBuilder.mContext.getString(17040428, bidi.unicodeWrap(this.mConversationTitle), bidi.unicodeWrap(m.mSender));
            }
            if (title != null) {
        ...
        public RemoteViews makeBigContentView() {
            ...
            int i = 0;
            contentView.setViewLayoutMarginBottomDimen(16909011, hasTitle ? 17105193 : 0);
            String str = "setNumIndentLines";
            int i2 = !this.mBuilder.mN.hasLargeIcon() ? 0 : hasTitle ? 1 : 2;
            contentView.setInt(16909100, str, i2);
    ...
    public Notification() {
        this.isStandardNotification = 0;
        this.isKeyguardNotification = 0;
        this.internalType = 0;
        this.internalPriority = 0;
        this.internalGroupPriority = 0;
        this.internalFlag = 0;
        this.number = 0;
    ...
    private void readFromParcelImpl(Parcel parcel) {
        ...
        this.isStandardNotification = parcel.readInt();
        this.isKeyguardNotification = parcel.readInt();
        this.internalType = parcel.readInt();
        this.internalPriority = parcel.readInt();
        this.internalGroupPriority = parcel.readInt();
        this.internalFlag = parcel.readInt();
    ...
    public void cloneInto(Notification that, boolean heavy) {
        ...
        that.isStandardNotification = this.isStandardNotification;
        that.isKeyguardNotification = this.isKeyguardNotification;
        that.internalType = this.internalType;
        that.internalPriority = this.internalPriority;
        that.internalGroupPriority = this.internalGroupPriority;
        that.internalFlag = this.internalFlag;
    ...
    /* renamed from: lambda$-android_app_Notification_86403 */
    /* synthetic */ void m7lambda$-android_app_Notification_86403(Parcel parcel, PendingIntent intent, Parcel out, int outFlags) {
        if (parcel == out) {
    ...
    private void writeToParcelImpl(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.isStandardNotification);
        parcel.writeInt(this.isKeyguardNotification);
        parcel.writeInt(this.internalType);
        parcel.writeInt(this.internalPriority);
        parcel.writeInt(this.internalGroupPriority);
        parcel.writeInt(this.internalFlag);
    ...
    public String toString() {
        ...
        sb.append(this.internalType);
        sb.append(" internalPriority=");
        sb.append(this.internalPriority);
        sb.append(" internalGroupPriority=");
        sb.append(this.internalGroupPriority);
        sb.append(" internalFlag=");
        sb.append(this.internalFlag);
        sb.append(")");
        return sb.toString();
    }

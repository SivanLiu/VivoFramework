...
public interface IApplicationThread extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IApplicationThread {
        ...
        static final int TRANSACTION_scheduleSetActivityMustFullScreen = 64;
        static final int TRANSACTION_scheduleSetAppAllowSplit = 63;
        ...
        private static class Proxy implements IApplicationThread {
            ...
            public void scheduleSetAppAllowSplit(boolean isAllowSplit) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void scheduleSetActivityMustFullScreen(boolean isActivityMustFullScreen) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!isActivityMustFullScreen) {
                        i = 0;
                    }
                    _data.writeInt(i);
            ...
            public void requestContentNode(IBinder binder, Bundle bundle, int token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void requestContentOther(IBinder binder, Bundle bundle, int token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(binder);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    scheduleLaunchActivity(_arg02, _arg17, _arg22, _arg34, _arg4, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg122, _arg132, _arg142, _arg152, _arg16);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    scheduleReceiver(_arg02, _arg18, _arg23, _arg3, _arg42, _arg52, data.readInt() != 0, data.readInt(), data.readInt());
                    return true;
                case 10:
                    ServiceInfo _arg19;
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    scheduleCreateService(_arg0, _arg19, _arg23, data.readInt());
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    ...
                    bindApplication(_arg03, _arg110, _arg25, _arg35, _arg43, _arg52, _arg62, _arg72, _arg82, _arg92, _arg102, _arg112, _arg123, _arg133, _arg143, _arg153, _arg162, data.readString(), data.readFloat());
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleExit();
                ...
                case 35:
                    ...
                    dumpHeap(_arg05, _arg15, _arg2, _arg32, _arg46);
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 56:
                    ...
                    scheduleMultiWindowModeChanged(_arg0, _arg15, _arg24);
                    return true;
                case 57:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    ...
                    schedulePictureInPictureModeChanged(_arg0, _arg15, _arg24);
                    return true;
                case 58:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 63:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleSetAppAllowSplit(data.readInt() != 0);
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleSetActivityMustFullScreen(data.readInt() != 0);
                    return true;
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
    ...
    void bindApplication(String str, ApplicationInfo applicationInfo, List<ProviderInfo> list, ComponentName componentName, ProfilerInfo profilerInfo, Bundle bundle, IInstrumentationWatcher iInstrumentationWatcher, IUiAutomationConnection iUiAutomationConnection, int i, boolean z, boolean z2, boolean z3, boolean z4, Configuration configuration, CompatibilityInfo compatibilityInfo, Map map, Bundle bundle2, String str2, float f) throws RemoteException;
    ...
    void scheduleSetActivityMustFullScreen(boolean z) throws RemoteException;

    void scheduleSetAppAllowSplit(boolean z) throws RemoteException;

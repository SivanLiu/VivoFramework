...
public interface IActivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityManager {
        ...
        static final int TRANSACTION_checkGrantUriPermission = 114;
        ...
        static final int TRANSACTION_clearPendingBackup = 155;
        ...
        static final int TRANSACTION_crashApplication = 109;
        ...
        static final int TRANSACTION_enableVivoFreeFormRuntime = 305;
        static final int TRANSACTION_enterPictureInPictureMode = 248;
        static final int TRANSACTION_enterResizeMode = 303;
        ...
        static final int TRANSACTION_finishActivityAffinity = 143;
        static final int TRANSACTION_finishHeavyWeightApp = 104;
        ...
        static final int TRANSACTION_finishWeChatWebViewUI = 316;
        static final int TRANSACTION_finishWebViewAndBottomDlgUI = 317;
        static final int TRANSACTION_forceFreezePackage = 312;
        static final int TRANSACTION_forceStopPackage = 72;
        static final int TRANSACTION_forceUnfreezePackage = 313;
        ...
        static final int TRANSACTION_getAssistContextExtras = 157;
        ...
        static final int TRANSACTION_getContentProviderExternal = 135;
        static final int TRANSACTION_getCurrentUser = 139;
        static final int TRANSACTION_getDeviceConfigurationInfo = 78;
        static final int TRANSACTION_getDoubleInstanceConfig = 292;
        static final int TRANSACTION_getFocusedStackId = 212;
        static final int TRANSACTION_getFreeformStackInfo = 302;
        static final int TRANSACTION_getFrontActivityScreenCompatMode = 119;
        ...
        static final int TRANSACTION_getLaunchedFromUid = 144;
        ...
        static final int TRANSACTION_getMyMemoryState = 137;
        static final int TRANSACTION_getPackageAskScreenCompat = 123;
        ...
        static final int TRANSACTION_getPackageScreenCompatMode = 121;
        ...
        static final int TRANSACTION_getProcessPss = 132;
        static final int TRANSACTION_getProcessesInErrorState = 70;
        static final int TRANSACTION_getProviderMimeType = 110;
        ...
        static final int TRANSACTION_getRunningExternalApplications = 103;
        static final int TRANSACTION_getRunningServiceControlPanel = 25;
        static final int TRANSACTION_getRunningUserIds = 151;
        ...
        static final int TRANSACTION_grantUriPermissionFromOwner = 112;
        static final int TRANSACTION_handleApplicationCrash = 2;
        static final int TRANSACTION_handleApplicationStrictModeViolation = 105;
        ...
        static final int TRANSACTION_inputDispatchingTimedOut = 154;
        ...
        static final int TRANSACTION_isFrozenPackage = 314;
        static final int TRANSACTION_isImmersive = 106;
        ...
        static final int TRANSACTION_killAllBackgroundProcesses = 134;
        ...
        static final int TRANSACTION_killProcessesBelowForeground = 138;
        ...
        static final int TRANSACTION_miniMizeWindowFreeformMode = 301;
        ...
        static final int TRANSACTION_navigateUpTo = 141;
        static final int TRANSACTION_newUriPermissionOwner = 111;
        ...
        static final int TRANSACTION_notifyEnterAnimationComplete = 198;
        static final int TRANSACTION_notifyLaunchTaskBehindComplete = 196;
        ...
        static final int TRANSACTION_registerActivityObserver = 306;
        static final int TRANSACTION_registerIntentSenderCancelListener = 57;
        static final int TRANSACTION_registerProcessObserver = 128;
        ...
        static final int TRANSACTION_registerUserSwitchObserver = 149;
        ...
        static final int TRANSACTION_removeContentProviderExternal = 136;
        static final int TRANSACTION_removePreloadProcess = 295;
        static final int TRANSACTION_removeStack = 263;
        static final int TRANSACTION_removeTask = 127;
        static final int TRANSACTION_removeTaskByTaskId = 318;
        static final int TRANSACTION_reportActivityFullyDrawn = 171;
        static final int TRANSACTION_reportAssistContextExtras = 158;
        ...
        static final int TRANSACTION_requestContentNode = 308;
        static final int TRANSACTION_requestContentOther = 309;
        ...
        static final int TRANSACTION_revokeUriPermissionFromOwner = 113;
        ...
        static final int TRANSACTION_setDoubleInstanceConfig = 293;
        static final int TRANSACTION_setDumpHeapDebugLimit = 217;
        static final int TRANSACTION_setEnteringMultiWindow = 299;
        static final int TRANSACTION_setFocusedStack = 166;
        static final int TRANSACTION_setFocusedTask = 126;
        static final int TRANSACTION_setFrontActivityScreenCompatMode = 120;
        static final int TRANSACTION_setHasTopUi = 275;
        static final int TRANSACTION_setImmersive = 107;
        static final int TRANSACTION_setLockScreenShown = 142;
        static final int TRANSACTION_setPackageAskScreenCompat = 124;
        static final int TRANSACTION_setPackageScreenCompatMode = 122;
        ...
        static final int TRANSACTION_setShowWhenLocked = 310;
        static final int TRANSACTION_setTaskDescription = 187;
        static final int TRANSACTION_setTaskResizeable = 213;
        static final int TRANSACTION_setTurnScreenOn = 311;
        static final int TRANSACTION_setUserIsMonkey = 161;
        static final int TRANSACTION_setVivoActivityController = 296;
        ...
        static final int TRANSACTION_shouldUpRecreateTask = 140;
        static final int TRANSACTION_showAssistFromActivity = 231;
        static final int TRANSACTION_showBootMessage = 133;
        static final int TRANSACTION_showCustomDebugModeOverlay = 98;
        ...
        static final int TRANSACTION_startActivities = 116;
        static final int TRANSACTION_startActivity = 3;
        static final int TRANSACTION_startActivityAndWait = 100;
        static final int TRANSACTION_startActivityAsCaller = 199;
        static final int TRANSACTION_startActivityAsUser = 147;
        static final int TRANSACTION_startActivityFromRecents = 197;
        static final int TRANSACTION_startActivityIntentSender = 94;
        static final int TRANSACTION_startActivityWithConfig = 102;
        ...
        static final int TRANSACTION_startMultiWindow = 297;
        ...
        static final int TRANSACTION_switchUser = 125;
        ...
        static final int TRANSACTION_unregisterActivityObserver = 307;
        static final int TRANSACTION_unregisterIntentSenderCancelListener = 58;
        static final int TRANSACTION_unregisterProcessObserver = 129;
        ...
        static final int TRANSACTION_unregisterUserSwitchObserver = 150;
        static final int TRANSACTION_unstableProviderDied = 145;
        ...
        private static class Proxy implements IActivityManager {
            ...
            public void showCustomDebugModeOverlay() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void activitySlept(IBinder token) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(token);
                    this.mRemote.transact(118, _data, null, 1);
                } finally {
                    _data.recycle();
                }
            }
            ...
            public List<String> getDoubleInstanceConfig(int type) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_getDoubleInstanceConfig, _data, _reply, 0);
                    _reply.readException();
            ...
            public void setDoubleInstanceConfig(boolean enabled, Map map) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    _data.writeMap(map);
                    this.mRemote.transact(Stub.TRANSACTION_setDoubleInstanceConfig, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean addPreloadProcess(String procName, long delay) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_addPreloadProcess, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean removePreloadProcess(String procName, long delay) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(procName);
                    _data.writeLong(delay);
                    this.mRemote.transact(Stub.TRANSACTION_removePreloadProcess, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setVivoActivityController(IVivoActivityController watcher, boolean imAMonkey) throws RemoteException {
                IBinder iBinder = null;
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setVivoActivityController, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void startMultiWindow() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_startMultiWindow, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void updateMultiWindowConfig(Map configsMap) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeMap(configsMap);
                    this.mRemote.transact(Stub.TRANSACTION_updateMultiWindowConfig, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setEnteringMultiWindow(boolean enteringMultiWindow) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setEnteringMultiWindow, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isSupportSplitscreen(String pkgName, String activityName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void miniMizeWindowFreeformMode(IBinder token, boolean mini) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public StackInfo getFreeformStackInfo(int stackId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    StackInfo _result;
            ...
            public void enterResizeMode(IBinder token, boolean enter) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void updateFreeFormConfig(Map configsMap) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void enableVivoFreeFormRuntime(boolean enable, boolean inDirectFreeformState) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void registerActivityObserver(IActivityObserver observer) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void unregisterActivityObserver(IActivityObserver observer) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean requestContentNode(ComponentName component, Bundle bundle, int token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean requestContentOther(ComponentName component, Bundle bundle, int token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int forceFreezePackage(IApplicationThread caller, String packageName, int userId, long delay, long unfreezeTime, String reason, int flag) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(userId);
                    _data.writeLong(delay);
                    _data.writeLong(unfreezeTime);
                    _data.writeString(reason);
                    _data.writeInt(flag);
                    this.mRemote.transact(Stub.TRANSACTION_forceFreezePackage, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int forceUnfreezePackage(IApplicationThread caller, String packageName, int userId, long delay, String reason) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeLong(delay);
                    _data.writeString(reason);
                    this.mRemote.transact(Stub.TRANSACTION_forceUnfreezePackage, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public boolean isFrozenPackage(String packageName, int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    _data.writeInt(userId);
                    this.mRemote.transact(Stub.TRANSACTION_isFrozenPackage, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean isKeepFrozen(IApplicationThread caller, String packageName, int type, String reason) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(type);
                    _data.writeString(reason);
                    this.mRemote.transact(Stub.TRANSACTION_isKeepFrozen, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void finishWeChatWebViewUI() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_finishWeChatWebViewUI, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void finishWebViewAndBottomDlgUI() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_finishWebViewAndBottomDlgUI, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public boolean removeTaskByTaskId(int taskId, boolean killProcess) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_removeTaskByTaskId, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 115:
                    ...
                    _result2 = dumpHeap(_arg08, _arg12, _arg27, _arg34, _arg45, _arg5, _arg65);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 116:
                ...
                case 158:
                    ...
                    reportAssistContextExtras(_arg0, _arg14, _arg212, _arg313, _arg46);
                    reply.writeNoException();
                    return true;
                case 159:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 167:
                    data.enforceInterface(DESCRIPTOR);
                    _result10 = getStackInfo(data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                ...
                case 206:
                    ...
                    _result2 = launchAssistIntent(_arg07, _arg12, _arg22, _arg315, _arg47);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 207:
                ...
                case 239:
                    ...
                    _result2 = moveTaskToDockedStack(_arg03, _arg12, _arg27, _arg34, _arg44);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 240:
                ...
                case TRANSACTION_backgroundWhitelistUid /*291*/:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getDoubleInstanceConfig /*292*/:
                    data.enforceInterface(DESCRIPTOR);
                    List<String> _result35 = getDoubleInstanceConfig(data.readInt());
                    reply.writeNoException();
                    reply.writeStringList(_result35);
                    return true;
                case TRANSACTION_setDoubleInstanceConfig /*293*/:
                    data.enforceInterface(DESCRIPTOR);
                    setDoubleInstanceConfig(data.readInt() != 0, data.readHashMap(getClass().getClassLoader()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_addPreloadProcess /*294*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = addPreloadProcess(data.readString(), data.readLong());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_removePreloadProcess /*295*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = removePreloadProcess(data.readString(), data.readLong());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_setVivoActivityController /*296*/:
                    data.enforceInterface(DESCRIPTOR);
                    setVivoActivityController(android.app.IVivoActivityController.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_startMultiWindow /*297*/:
                    data.enforceInterface(DESCRIPTOR);
                    startMultiWindow();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_updateMultiWindowConfig /*298*/:
                    data.enforceInterface(DESCRIPTOR);
                    updateMultiWindowConfig(data.readHashMap(getClass().getClassLoader()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setEnteringMultiWindow /*299*/:
                    data.enforceInterface(DESCRIPTOR);
                    setEnteringMultiWindow(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 300:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isSupportSplitscreen(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 301:
                    data.enforceInterface(DESCRIPTOR);
                    miniMizeWindowFreeformMode(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 302:
                    data.enforceInterface(DESCRIPTOR);
                    _result10 = getFreeformStackInfo(data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);
                ...
                case 303:
                    data.enforceInterface(DESCRIPTOR);
                    enterResizeMode(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 304:
                    data.enforceInterface(DESCRIPTOR);
                    updateFreeFormConfig(data.readHashMap(getClass().getClassLoader()));
                    reply.writeNoException();
                    return true;
                case 305:
                    data.enforceInterface(DESCRIPTOR);
                    enableVivoFreeFormRuntime(data.readInt() != 0, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 306:
                    data.enforceInterface(DESCRIPTOR);
                    registerActivityObserver(vivo.contentcatcher.IActivityObserver.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 307:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterActivityObserver(vivo.contentcatcher.IActivityObserver.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 308:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result2 = requestContentNode(_arg04, _arg14, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 309:
                    ...
                    _result2 = requestContentOther(_arg04, _arg14, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_setShowWhenLocked /*310*/:
                    data.enforceInterface(DESCRIPTOR);
                    setShowWhenLocked(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setTurnScreenOn /*311*/:
                    data.enforceInterface(DESCRIPTOR);
                    setTurnScreenOn(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_forceFreezePackage /*312*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = forceFreezePackage(android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt(), data.readLong(), data.readLong(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_forceUnfreezePackage /*313*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = forceUnfreezePackage(android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt(), data.readLong(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_isFrozenPackage /*314*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isFrozenPackage(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_isKeepFrozen /*315*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isKeepFrozen(android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_finishWeChatWebViewUI /*316*/:
                    data.enforceInterface(DESCRIPTOR);
                    finishWeChatWebViewUI();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_finishWebViewAndBottomDlgUI /*317*/:
                    data.enforceInterface(DESCRIPTOR);
                    finishWebViewAndBottomDlgUI();
                    reply.writeNoException();
                    return true;
                case TRANSACTION_removeTaskByTaskId /*318*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = removeTaskByTaskId(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
    ...
    boolean addPreloadProcess(String str, long j) throws RemoteException;
    ...
    void enableVivoFreeFormRuntime(boolean z, boolean z2) throws RemoteException;

    boolean enterPictureInPictureMode(IBinder iBinder, PictureInPictureParams pictureInPictureParams) throws RemoteException;

    void enterResizeMode(IBinder iBinder, boolean z) throws RemoteException;
    ...
    void finishWeChatWebViewUI() throws RemoteException;

    void finishWebViewAndBottomDlgUI() throws RemoteException;

    int forceFreezePackage(IApplicationThread iApplicationThread, String str, int i, long j, long j2, String str2, int i2) throws RemoteException;

    void forceStopPackage(String str, int i) throws RemoteException;

    int forceUnfreezePackage(IApplicationThread iApplicationThread, String str, int i, long j, String str2) throws RemoteException;
    ...
    List<String> getDoubleInstanceConfig(int i) throws RemoteException;

    int getFocusedStackId() throws RemoteException;

    StackInfo getFreeformStackInfo(int i) throws RemoteException;
    ...
    boolean isFrozenPackage(String str, int i) throws RemoteException;
    ...
    boolean isKeepFrozen(IApplicationThread iApplicationThread, String str, int i, String str2) throws RemoteException;

    boolean isRootVoiceInteraction(IBinder iBinder) throws RemoteException;

    boolean isSupportSplitscreen(String str, String str2) throws RemoteException;
    ...
    void miniMizeWindowFreeformMode(IBinder iBinder, boolean z) throws RemoteException;
    ...
    void registerActivityObserver(IActivityObserver iActivityObserver) throws RemoteException;
    ...
    boolean removePreloadProcess(String str, long j) throws RemoteException;

    void removeStack(int i) throws RemoteException;

    boolean removeTask(int i) throws RemoteException;

    boolean removeTaskByTaskId(int i, boolean z) throws RemoteException;
    ...
    void setDoubleInstanceConfig(boolean z, Map map) throws RemoteException;

    void setDumpHeapDebugLimit(String str, int i, long j, String str2) throws RemoteException;

    void setEnteringMultiWindow(boolean z) throws RemoteException;
    ...
    void setVivoActivityController(IVivoActivityController iVivoActivityController, boolean z) throws RemoteException;
    ...
    void showCustomDebugModeOverlay() throws RemoteException;
    ...
    void startMultiWindow() throws RemoteException;
    ...
    void unregisterActivityObserver(IActivityObserver iActivityObserver) throws RemoteException;
    ...
    void updateFreeFormConfig(Map map) throws RemoteException;

    void updateLockTaskPackages(int i, String[] strArr) throws RemoteException;

    void updateMultiWindowConfig(Map map) throws RemoteException;

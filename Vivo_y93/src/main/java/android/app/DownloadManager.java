...
public class DownloadManager {
    ...
    static final /* synthetic */ boolean f58-assertionsDisabled = (DownloadManager.class.desiredAssertionStatus() ^ 1);
    ...
    private static class CursorTranslator extends CursorWrapper {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f59-assertionsDisabled = (CursorTranslator.class.desiredAssertionStatus() ^ 1);
        ...
        private int translateStatus(int status) {
            switch (status) {
                ...
                case 200:
                    return 8;
                default:
                    if (f59-assertionsDisabled || Impl.isStatusError(status)) {
                        return 16;
                    }
    ...
    public static class Request {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f60-assertionsDisabled = (Request.class.desiredAssertionStatus() ^ 1);
        @Deprecated
        ...
        ContentValues toContentValues(String packageName) {
            ...
            if (f60-assertionsDisabled || this.mUri != null) {
    ...
    static String[] getWhereArgsForIds(long[] ids, String[] args) {
        if (f58-assertionsDisabled || args.length >= ids.length) {
            for (int i = 0; i < ids.length; i++) {

...
public final class DeviceAdminInfo implements Parcelable {
    ...
    static {
        sPoliciesDisplayOrder.add(new PolicyInfo(4, "wipe-data", 17041121, 17041110, 17041122, 17041111));
        sPoliciesDisplayOrder.add(new PolicyInfo(2, "reset-password", 17041118, 17041106));
        sPoliciesDisplayOrder.add(new PolicyInfo(0, "limit-password", 17041117, 17041105));
        sPoliciesDisplayOrder.add(new PolicyInfo(1, "watch-login", 17041120, 17041108, 17041120, 17041109));
        sPoliciesDisplayOrder.add(new PolicyInfo(3, "force-lock", 17041116, 17041104));
        sPoliciesDisplayOrder.add(new PolicyInfo(5, "set-global-proxy", 17041119, 17041107));
        sPoliciesDisplayOrder.add(new PolicyInfo(6, "expire-password", 17041115, 17041103));
        sPoliciesDisplayOrder.add(new PolicyInfo(7, "encrypted-storage", 17041114, 17041102));
        sPoliciesDisplayOrder.add(new PolicyInfo(8, "disable-camera", 17041112, 17041100));
        sPoliciesDisplayOrder.add(new PolicyInfo(9, "disable-keyguard-features", 17041113, 17041101));

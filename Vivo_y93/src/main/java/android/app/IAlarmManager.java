...
public interface IAlarmManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlarmManager {
        ...
        static final int TRANSACTION_getNextBootTime = 9;
        static final int TRANSACTION_getNextWakeFromIdleTime = 5;
        static final int TRANSACTION_onFronzenPackage = 10;
        static final int TRANSACTION_onUnfrozenPackage = 11;
        static final int TRANSACTION_remove = 4;
        static final int TRANSACTION_set = 1;
        static final int TRANSACTION_setNextBootTime = 8;
        ...
        private static class Proxy implements IAlarmManager {
            ...
            public boolean setNextBootTime(long nextBootTime, String packageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeLong(nextBootTime);
            ...
            public long getNextBootTime() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean onUnfrozenPackage(String packageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getNextWakeFromIdleTime();
                    reply.writeNoException();
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setNextBootTime(data.readLong(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getNextBootTime();
                    reply.writeNoException();
                    reply.writeLong(_result2);
                    return true;
                case 10:
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    _result = onUnfrozenPackage(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
    ...
    boolean setNextBootTime(long j, String str) throws RemoteException;

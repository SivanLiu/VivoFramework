...
import com.vivo.gamewatch.service.VGTServer;
...
import vivo.contentcatcher.AIEngineContentCatcherManagerFactory;
import vivo.contentcatcher.ContentCatcherManagerFactory;
import vivo.contentcatcher.IContentCatcherManager;
...
public final class ActivityThread {
    ...
    private IContentCatcherManager mContentCatcherManager = null;
    ...
    static final class ActivityClientRecord {
        ...
        /* renamed from: lambda$-android_app_ActivityThread$ActivityClientRecord_17453 */
        /* synthetic */ void m4lambda$-android_app_ActivityThread$ActivityClientRecord_17453(Configuration overrideConfig, int newDisplayId) {
            ...
            if (componentName == null || !"android.server.cts/.TestActivity".equals(componentName.flattenToShortString())) {
    ...
    private class ApplicationThread extends Stub {
        ...
        public final void bindApplication(String processName, ApplicationInfo appInfo, List<ProviderInfo> providers, ComponentName instrumentationName, ProfilerInfo profilerInfo, Bundle instrumentationArgs, IInstrumentationWatcher instrumentationWatcher, IUiAutomationConnection instrumentationUiConnection, int debugMode, boolean enableBinderTracking, boolean trackAllocation, boolean isRestrictedBackupMode, boolean persistent, Configuration config, CompatibilityInfo compatInfo, Map services, Bundle coreSettings, String buildSerial, float scale) {
            if (services != null) {
        ...
        public void scheduleSetAppAllowSplit(boolean isAllowSplit) {
            ActivityThread.this.sendMessage(300, null, isAllowSplit ? 1 : 0);
        }

        @VivoHook(hookType = VivoHookType.NEW_METHOD)
        public void scheduleSetActivityMustFullScreen(boolean isActivityMustFullScreen) {
            ActivityThread.this.sendMessage(301, null, isActivityMustFullScreen ? 1 : 0);
        }

        @VivoHook(hookType = VivoHookType.NEW_METHOD)
        public void requestContentNode(IBinder binder, Bundle bundle, int token) {
            Slog.d(ActivityThread.TAG, "requestContentNode");
            ActivityClientRecord clientRecord = (ActivityClientRecord) ActivityThread.this.mActivities.get(binder);
            String appPkg = bundle.getString("appPkgName");
            Slog.d(ActivityThread.TAG, "requestContentNode_appPkg=" + appPkg);
            if (clientRecord == null) {
                Slog.w(ActivityThread.TAG, "mActivities.get " + binder + " is null");
                return;
            }
            if (ActivityThread.this.mContentCatcherManager != null) {
                ActivityThread.this.mContentCatcherManager.updateToken(token, clientRecord.activity);
            } else if (appPkg == null || !appPkg.equals("aiengine")) {
                ActivityThread.this.mContentCatcherManager = ContentCatcherManagerFactory.createContentCatcherManager(token, clientRecord.activity);
            } else {
                ActivityThread.this.mContentCatcherManager = AIEngineContentCatcherManagerFactory.createContentCatcherManager(token, clientRecord.activity);
            }
            ActivityThread.this.sendMessage(302, new RequestContentNode(bundle));
        }

        @VivoHook(hookType = VivoHookType.NEW_METHOD)
        public void requestContentOther(IBinder binder, Bundle bundle, int token) {
            Slog.d(ActivityThread.TAG, "requestContentOther");
            ActivityClientRecord clientRecord = (ActivityClientRecord) ActivityThread.this.mActivities.get(binder);
            String appPkg = bundle.getString("appPkgName");
            Slog.d(ActivityThread.TAG, "requestContentOther_appPkg=" + appPkg);
            if (clientRecord == null) {
                Slog.w(ActivityThread.TAG, "mActivities.get " + binder + " is null");
                return;
            }
            ...
            ActivityThread.this.sendMessage(303, new RequestContentOther(bundle));
        }
    }
    ...
    private class H extends Handler {
        ...
        public static final int REQUEST_CONTENT_NODE = 302;
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int REQUEST_CONTENT_OTHER = 303;
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int REQUEST_SET_ACTIVITY_MUST_FULL_SCREEN = 301;
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int REQUEST_SET_APP_ALLOW_SPLIT = 300;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 157:
                    ...
                    break;
                case 300:
                    Trace.traceBegin(64, "scheduleSetAppAllowSplit");
                    ActivityThread.this.handleSetAppAllowSplit(msg.arg1 > 0);
                    Trace.traceEnd(64);
                    break;
                case 301:
                    Trace.traceBegin(64, "scheduleSetActivityMustFullScreen");
                    ActivityThread.this.handleSetActivityMustFullScreen(msg.arg1 > 0);
                    Trace.traceEnd(64);
                    break;
                case 302:
                    ...
                    break;
                case 303:
                    ActivityThread.this.handleRequestOther((RequestContentOther) msg.obj);
                    break;
            }
            Object obj = msg.obj;
            ...
            Jank.getInstance().handleEventTimeout(msg.what, SystemClock.uptimeMillis() - time);
        }
    }
    ...
    class RequestContentNode {
        ...
        RequestContentNode(Bundle bundle) {
            this.data = bundle;
        }
    }
    ...
    class RequestContentOther {
        ...
        RequestContentOther(Bundle bundle) {
            this.data = bundle;
        }
    }
    ...
    private void handleRequestNode(RequestContentNode requestContentNode) {
        try {
            this.mContentCatcherManager.copyNode(requestContentNode.data);
        } catch (Exception e) {
            Slog.e(TAG, "copyNode get exception: ", e);
        }
    }

    private void handleRequestOther(RequestContentOther requestContentOther) {
        try {
            this.mContentCatcherManager.processImageAndWebview(requestContentOther.data);
        } catch (Exception e) {
    ...
    private Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        try {
            ...
            if (activity != null) {
                ...
                if (theme != 0) {
                    if ("{com.google.android.packageinstaller/com.android.packageinstaller.permission.ui.GrantPermissionsActivity     }".equals(r.intent.getComponent().toShortString())) {
                        activity.setTheme(51315049);
                    } else {
    ...
    void performNewIntents(IBinder token, List<ReferrerIntent> intents, boolean andPause) {
        ...
        if (DEBUG_ORDER) {
            Slog.d(TAG, "performNewIntents r: " + r);
        }
        if (r != null) {
    ...
    private void handleReceiver(ReceiverData data) {
        ...
        try {
            ...
            Jank.getInstance().handleBroadcastTimeout(data.intent.getAction(), true, SystemClock.uptimeMillis() - time);
        } catch (Exception e2) {
            data.sendFinished(mgr);
    ...
    final void handleResumeActivity(IBinder token, boolean clearHide, boolean isForward, boolean reallyResume, int seq, String reason) {
        if (checkAndUpdateLifecycleSeq(seq, (ActivityClientRecord) this.mActivities.get(token), "resumeActivity")) {
            ...
            if (r != null) {
                ...
                Jank.getInstance().resumeActivity(a.getClass().getName());
    ...
    private void handlePauseActivity(IBinder token, boolean finished, boolean userLeaving, int configChanges, boolean dontReport, int seq) {
        ...
        if (checkAndUpdateLifecycleSeq(seq, r, "pauseActivity") && r != null) {
            ...
            Jank.getInstance().pauseActivity();
            if (r.isPreHoneycomb()) {
                QueuedWork.waitToFinish();
            }
            if (!dontReport) {
    ...
    private void performPauseActivityIfNeeded(ActivityClientRecord r, String reason) {
        if (r.paused) {
            if (DEBUG_ORDER) {
                Slog.d(TAG, "performPauseActivityIfNeeded paused.");
            }
            return;
        }
        try {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:46:0x00f9 A:{Catch:{ RemoteException -> 0x015a, all -> 0x0153 }} */
    /* JADX WARNING: Removed duplicated region for block: B:48:0x0102 A:{Catch:{ RemoteException -> 0x015a, all -> 0x0153 }} */
    /* JADX WARNING: Removed duplicated region for block: B:50:0x0108 A:{Catch:{ RemoteException -> 0x015a, all -> 0x0153 }} */
    /* JADX WARNING: Missing block: B:54:0x011a, code:
            if (DEBUG_ORDER == false) goto L_?;
     */
    /* JADX WARNING: Missing block: B:55:0x011c, code:
    ...
    /* JADX WARNING: Missing block: B:52:0x00fa, code:
            if (r6.mPreserveWindow != false) goto L_0x0100;
     */
    /* JADX WARNING: Missing block: B:54:0x00fe, code:
            if (r6.onlyLocalRequest == false) goto L_0x010d;
     */
    /* JADX WARNING: Missing block: B:55:0x0100, code:
            android.view.WindowManagerGlobal.getWindowSession().prepareToReplaceWindows(r6.token, r6.onlyLocalRequest ^ 1);
     */
    /* JADX WARNING: Missing block: B:57:0x010f, code:
            if (r6.paused != false) goto L_0x011d;
     */
    ...
    /* JADX WARNING: Missing block: B:60:0x011f, code:
            if (r6.state != null) goto L_0x0132;
     */
    /* JADX WARNING: Missing block: B:62:0x0125, code:
            if ((r6.stopped ^ 1) == 0) goto L_0x0132;
     */
    /* JADX WARNING: Missing block: B:64:0x012d, code:
            if ((r6.isPreHoneycomb() ^ 1) == 0) goto L_0x0132;
     */
    /* JADX WARNING: Missing block: B:65:0x012f, code:
    ...
    /* JADX WARNING: Missing block: B:66:0x0132, code:
            ...
            r6.nextIdle = null;
     */
    /* JADX WARNING: Missing block: B:67:0x0141, code:
            if (r15.pendingResults == null) goto L_0x014b;
     */
    /* JADX WARNING: Missing block: B:69:0x0145, code:
            if (r6.pendingResults != null) goto L_0x0182;
     */
    /* JADX WARNING: Missing block: B:70:0x0147, code:
            r6.pendingResults = r15.pendingResults;
     */
    /* JADX WARNING: Missing block: B:72:0x014d, code:
            if (r15.pendingIntents == null) goto L_0x0157;
     */
    /* JADX WARNING: Missing block: B:74:0x0151, code:
            if (r6.pendingIntents != null) goto L_0x018a;
     */
    /* JADX WARNING: Missing block: B:75:0x0153, code:
            r6.pendingIntents = r15.pendingIntents;
     */
    /* JADX WARNING: Missing block: B:76:0x0157, code:
     ...
     */
    /* JADX WARNING: Missing block: B:77:0x0167, code:
            if (r15.onlyLocalRequest != false) goto L_0x017b;
     */
    ...
    /* JADX WARNING: Missing block: B:80:0x0174, code:
            if (r6.window == null) goto L_0x017b;
     */
    /* JADX WARNING: Missing block: B:81:0x0176, code:
            r6.window.reportActivityRelaunched();
     */
    /* JADX WARNING: Missing block: B:82:0x017b, code:
            return;
     */
    /* JADX WARNING: Missing block: B:83:0x017c, code:
            r4 = move-exception;
     */
    /* JADX WARNING: Missing block: B:85:0x0181, code:
            throw r4.rethrowFromSystemServer();
     */
    /* JADX WARNING: Missing block: B:86:0x0182, code:
            r6.pendingResults.addAll(r15.pendingResults);
     */
    /* JADX WARNING: Missing block: B:87:0x018a, code:
            r6.pendingIntents.addAll(r15.pendingIntents);
     */
    /* JADX WARNING: Missing block: B:88:0x0192, code:
            r4 = move-exception;
     */
    ...
    /* JADX WARNING: Missing block: B:47:0x0131, code:
     ...
     */
    /* JADX WARNING: Missing block: B:49:0x013f, code:
            r2 = r4.size();
            r9 = 0;
     */
    /* JADX WARNING: Missing block: B:50:0x0144, code:
            if (r9 >= r2) goto L_0x0178;
     */
    /* JADX WARNING: Missing block: B:51:0x0146, code:
            r5 = (android.content.ComponentCallbacks2) r4.get(r9);
     */
    /* JADX WARNING: Missing block: B:52:0x014e, code:
            if ((r5 instanceof android.app.Activity) == false) goto L_0x016e;
     */
     ...
     */
    /* JADX WARNING: Missing block: B:54:0x0168, code:
            r9 = r9 + 1;
     */
    /* JADX WARNING: Missing block: B:58:0x016e, code:
    ...
    final void handleConfigurationChanged(Configuration config, CompatibilityInfo compat) {
        ...
        synchronized (this.mResourcesManager) {
            ...
            if (this.mConfiguration == null) {
                Log.d(TAG, "firstBoot is true!");
                firstBoot = true;
                this.mConfiguration = new Configuration();
            }
            if (this.mConfiguration.isOtherSeqNewer(config) || compat != null) {
                int configDiff = this.mConfiguration.diff(config);
                if (!firstBoot && (1073741824 & configDiff) != 0 && Math.abs(this.mConfiguration.fontScale - config.fontScale) <= 0.01f && Math.abs(this.mConfiguration.fontScale - config.fontScale) > 0.0f) {
                    Log.d(TAG, "ActivityThread reload font : " + configDiff);
                    Typeface.reloadVivoFont(false);
                    Canvas.freeCaches();
    ...
    private void updateDefaultDensity() {
        ...
        if (this.mScale != 1.0f) {
            ...
            ResourcesImpl.setLoadDensityDpi((int) ((((float) densityDpi) / this.mScale) + 0.5f));
            return;
        }
        ...
        ResourcesImpl.setLoadDensityDpi(0);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:178:0x0626 A:{Splitter: B:45:0x01ab, ExcHandler: java.lang.NoSuchFieldException (e java.lang.NoSuchFieldException)} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void handleBindApplication(AppBindData data) {
        InstrumentationInfo ii;
        this.mScale = data.scale;
        int i = (this.mScale > 1.0f ? 1 : (this.mScale == 1.0f ? 0 : -1));
        ...
        if (this.mConfiguration.densityDpi != DisplayMetrics.DENSITY_DEVICE) {
            ResourcesImpl.clearPreloadedDrawables();
        }
        this.mProfiler = new Profiler();
        ...
        VGTServer.getInstance().initialize(appContext, data.processName, data.appInfo);
        ...
        try {
            ...
            if (ANRManager.isEnableMonitor(data.appInfo.packageName)) {
                ANRMonitor.init(appContext, sMainThreadHandler.getLooper());
            }
    ...
    public final IContentProvider acquireProvider(Context c, String auth, int userId, boolean stable) {
        ...
        if (DoubleAppSwitcher.sEnabled && userId == UserManager.get(c).getDoubleAppUserId() && auth != null && (auth.equals("com.google.android.apps.docs.storage.legacy") || auth.equals("settings") || auth.equals("com.facebook.orca.notify.MessengerLoggedInUserProvider") || auth.equals("jp.scn.android.provider") || auth.equals("cn.wps.moffice_eng.fileprovider"))) {
            Slog.d(TAG, "we cannot find provider for " + auth + " under doubleAppUser, so change userId to SYSTEM");
            userId = 0;
        }
        try {
    ...
    /* JADX WARNING: Missing block: B:42:0x00c1, code:
            return r6;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final IContentProvider acquireExistingProvider(Context c, String auth, int userId, boolean stable) {
        synchronized (this.mProviderMap) {
            ...
            try {
                if (!(pr.mHolder == null || pr.mHolder.info == null || pr.mHolder.info.packageName == null || this.mBoundApplication == null || this.mBoundApplication.info == null || this.mBoundApplication.info.mPackageName == null || pr.mHolder.info.packageName.equals(this.mBoundApplication.info.mPackageName) || !ActivityManagerNative.getDefault().isKeepFrozen(this.mAppThread, pr.mHolder.info.packageName, 4, "acquireExistingProvider"))) {
                    Log.d(TAG, "acquireExistingProvider is intercepted by vivo frozen");
                    return null;
                }
            } catch (Exception e) {
            }
    ...
    /* renamed from: lambda$-android_app_ActivityThread_295714 */
    /* synthetic */ void m3lambda$-android_app_ActivityThread_295714(Configuration globalConfig) {
        synchronized (this.mResourcesManager) {
    ...
    public static void main(String[] args) {
        ...
        DEBUG_ORDER = "yes".equals(SystemProperties.get(SystemSensorManager.KEY_VIVO_LOG_CTRL, "no"));
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    final void handleSetAppAllowSplit(boolean isAllowSplit) {
        try {
            int i;
            int NAPP = this.mAllApplications.size();
            for (i = 0; i < NAPP; i++) {
                Application app = (Application) this.mAllApplications.get(i);
                if (app != null) {
                    if (app.getResources() != null) {
                        app.getResources().setAppAllowSplit(isAllowSplit);
                    }
                    if (!(app.getBaseContext() == null || app.getBaseContext().getResources() == null)) {
                        app.getBaseContext().getResources().setAppAllowSplit(isAllowSplit);
                    }
                }
            }
            int NSVC = this.mServices.size();
            for (i = 0; i < NSVC; i++) {
                Service sr = (Service) this.mServices.valueAt(i);
                if (sr.getResources() != null) {
                    sr.getResources().setAppAllowSplit(isAllowSplit);
                }
                if (!(sr.getBaseContext() == null || sr.getBaseContext().getResources() == null)) {
                    sr.getBaseContext().getResources().setAppAllowSplit(isAllowSplit);
                }
            }
        } catch (Exception e) {
            Slog.e(TAG, "this=" + this + " isAllowSplit=" + isAllowSplit, e);
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    final void handleSetActivityMustFullScreen(boolean isActivityMustFullScreen) {
        try {
            int i;
            int NAPP = this.mAllApplications.size();
            for (i = 0; i < NAPP; i++) {
                ...
                if (app != null) {
                    if (app.getResources() != null) {
                        app.getResources().setActivityMustFullScreen(isActivityMustFullScreen);
                    }
                    if (!(app.getBaseContext() == null || app.getBaseContext().getResources() == null)) {
                        app.getBaseContext().getResources().setActivityMustFullScreen(isActivityMustFullScreen);
                    }
                }
            }
            int NSVC = this.mServices.size();
            for (i = 0; i < NSVC; i++) {
                Service sr = (Service) this.mServices.valueAt(i);
                if (sr.getResources() != null) {
                    sr.getResources().setActivityMustFullScreen(isActivityMustFullScreen);
                }
                if (!(sr.getBaseContext() == null || sr.getBaseContext().getResources() == null)) {
                    sr.getBaseContext().getResources().setActivityMustFullScreen(isActivityMustFullScreen);
                }
            }
        } catch (Exception e) {
            Slog.e(TAG, "this=" + this + " isActivityMustFullScreen=" + isActivityMustFullScreen, e);
        }
    }
}

...
public interface IJobScheduler extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IJobScheduler {
        ...
        static final int TRANSACTION_cancelByUid = 9;
        ...
        static final int TRANSACTION_getPendingJobsByUid = 8;
        ...
        private static class Proxy implements IJobScheduler {
            ...
            public List<JobInfo> getPendingJobsByUid(int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void cancelByUid(int uid, int jobId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getPendingJobsByUid(data.readInt());
                    reply.writeNoException();
                    reply.writeTypedList(_result2);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    cancelByUid(data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
    ...
    void cancelByUid(int i, int i2) throws RemoteException;
    ...
    List<JobInfo> getPendingJobsByUid(int i) throws RemoteException;

...
final class SystemServiceRegistry {
    ...
    static {
        ...
        VivoSystemReflect.registerMangerService();
    }
    ...
    public static <T> void registerSystemService(String serviceName, Class<T> serviceClass, ServiceFetcher<T> serviceFetcher) {

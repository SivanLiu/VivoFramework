...
public interface INotificationManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INotificationManager {
        ...
        static final int TRANSACTION_addAutomaticZenRule = 82;
        static final int TRANSACTION_applyAdjustmentFromAssistant = 55;
        static final int TRANSACTION_applyAdjustmentsFromAssistant = 56;
        static final int TRANSACTION_applyEnqueuedAdjustmentFromAssistant = 54;
        static final int TRANSACTION_applyRestore = 88;
        static final int TRANSACTION_areMoreNotificationsEnabledForPackage = 91;
        static final int TRANSACTION_areNotificationsEnabled = 12;
        static final int TRANSACTION_areNotificationsEnabledForPackage = 11;
        static final int TRANSACTION_canShowBadge = 9;
        static final int TRANSACTION_cancelAllNotifications = 1;
        static final int TRANSACTION_cancelAllNotificationsForFrozen = 93;
        static final int TRANSACTION_cancelNotificationFromListener = 34;
        static final int TRANSACTION_cancelNotificationWithTag = 7;
        static final int TRANSACTION_cancelNotificationsFromListener = 35;
        static final int TRANSACTION_cancelToast = 4;
        static final int TRANSACTION_clearData = 2;
        static final int TRANSACTION_createNotificationChannelGroups = 14;
        static final int TRANSACTION_createNotificationChannels = 15;
        static final int TRANSACTION_createNotificationChannelsForPackage = 16;
        static final int TRANSACTION_deleteNotificationChannel = 22;
        static final int TRANSACTION_deleteNotificationChannelGroup = 27;
        ...
        static final int TRANSACTION_getActiveNotifications = 30;
        static final int TRANSACTION_getActiveNotificationsFromListener = 43;
        static final int TRANSACTION_getAppActiveNotifications = 89;
        static final int TRANSACTION_getAutomaticZenRule = 80;
        static final int TRANSACTION_getBackupPayload = 87;
        static final int TRANSACTION_getDeletedChannelCount = 26;
        static final int TRANSACTION_getEffectsSuppressor = 58;
        static final int TRANSACTION_getEnabledNotificationListenerPackages = 68;
        static final int TRANSACTION_getEnabledNotificationListeners = 69;
        static final int TRANSACTION_getHintsFromListener = 46;
        static final int TRANSACTION_getHistoricalNotifications = 31;
        static final int TRANSACTION_getInterruptionFilterFromListener = 48;
        static final int TRANSACTION_getNotificationChannel = 20;
        static final int TRANSACTION_getNotificationChannelForPackage = 21;
        static final int TRANSACTION_getNotificationChannelGroupForPackage = 18;
        static final int TRANSACTION_getNotificationChannelGroups = 28;
        static final int TRANSACTION_getNotificationChannelGroupsForPackage = 17;
        static final int TRANSACTION_getNotificationChannelGroupsFromPrivilegedListener = 53;
        static final int TRANSACTION_getNotificationChannels = 23;
        static final int TRANSACTION_getNotificationChannelsForPackage = 24;
        static final int TRANSACTION_getNotificationChannelsFromPrivilegedListener = 52;
        static final int TRANSACTION_getNotificationPolicy = 75;
        static final int TRANSACTION_getNumNotificationChannelsForPackage = 25;
        static final int TRANSACTION_getPackageImportance = 13;
        static final int TRANSACTION_getRuleInstanceCount = 86;
        static final int TRANSACTION_getSnoozedNotificationsFromListener = 44;
        static final int TRANSACTION_getZenMode = 70;
        static final int TRANSACTION_getZenModeConfig = 71;
        static final int TRANSACTION_getZenRules = 81;
        static final int TRANSACTION_hasJoinVivoPush = 90;
        static final int TRANSACTION_isNotificationAssistantAccessGranted = 63;
        static final int TRANSACTION_isNotificationListenerAccessGranted = 61;
        static final int TRANSACTION_isNotificationListenerAccessGrantedForUser = 62;
        static final int TRANSACTION_isNotificationPolicyAccessGranted = 74;
        static final int TRANSACTION_isNotificationPolicyAccessGrantedForPackage = 77;
        static final int TRANSACTION_isSystemConditionProviderEnabled = 60;
        static final int TRANSACTION_matchesCallFilter = 59;
        static final int TRANSACTION_notifyConditions = 73;
        static final int TRANSACTION_onlyHasDefaultChannel = 29;
        static final int TRANSACTION_registerListener = 32;
        static final int TRANSACTION_removeAutomaticZenRule = 84;
        static final int TRANSACTION_removeAutomaticZenRules = 85;
        static final int TRANSACTION_requestBindListener = 38;
        static final int TRANSACTION_requestBindProvider = 40;
        static final int TRANSACTION_requestHintsFromListener = 45;
        static final int TRANSACTION_requestInterruptionFilterFromListener = 47;
        static final int TRANSACTION_requestUnbindListener = 39;
        static final int TRANSACTION_requestUnbindProvider = 41;
        static final int TRANSACTION_setInterruptionFilter = 50;
        static final int TRANSACTION_setMoreNotificationsEnabledForPackage = 92;
        static final int TRANSACTION_setNotificationAssistantAccessGranted = 65;
        static final int TRANSACTION_setNotificationAssistantAccessGrantedForUser = 67;
        static final int TRANSACTION_setNotificationListenerAccessGranted = 64;
        static final int TRANSACTION_setNotificationListenerAccessGrantedForUser = 66;
        static final int TRANSACTION_setNotificationPolicy = 76;
        static final int TRANSACTION_setNotificationPolicyAccessGranted = 78;
        static final int TRANSACTION_setNotificationPolicyAccessGrantedForUser = 79;
        static final int TRANSACTION_setNotificationsEnabledForPackage = 10;
        static final int TRANSACTION_setNotificationsShownFromListener = 42;
        static final int TRANSACTION_setOnNotificationPostedTrimFromListener = 49;
        static final int TRANSACTION_setShowBadge = 8;
        static final int TRANSACTION_setZenMode = 72;
        static final int TRANSACTION_snoozeNotificationUntilContextFromListener = 36;
        static final int TRANSACTION_snoozeNotificationUntilFromListener = 37;
        static final int TRANSACTION_unregisterListener = 33;
        static final int TRANSACTION_unsnoozeNotificationFromAssistant = 57;
        static final int TRANSACTION_updateAutomaticZenRule = 83;
        static final int TRANSACTION_updateNotificationChannelForPackage = 19;
        static final int TRANSACTION_updateNotificationChannelFromPrivilegedListener = 51;
        ...
        private static class Proxy implements INotificationManager {
            ...
            public boolean hasJoinVivoPush(String pkg, int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean areMoreNotificationsEnabledForPackage(String pkg, int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setMoreNotificationsEnabledForPackage(String pkg, int uid, boolean enabled) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void cancelAllNotificationsForFrozen(String pkg, int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    _result = hasJoinVivoPush(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 91:
                    data.enforceInterface(DESCRIPTOR);
                    _result = areMoreNotificationsEnabledForPackage(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 92:
                    data.enforceInterface(DESCRIPTOR);
                    setMoreNotificationsEnabledForPackage(data.readString(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 93:
                    data.enforceInterface(DESCRIPTOR);
                    cancelAllNotificationsForFrozen(data.readString(), data.readInt());
                    reply.writeNoException();
                    return true;
    ...
    boolean areMoreNotificationsEnabledForPackage(String str, int i) throws RemoteException;
    ...
    void cancelAllNotificationsForFrozen(String str, int i) throws RemoteException;
    ...
    boolean hasJoinVivoPush(String str, int i) throws RemoteException;
    ...
    void setMoreNotificationsEnabledForPackage(String str, int i, boolean z) throws RemoteException;

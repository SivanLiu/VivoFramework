...
public class SearchDialog extends Dialog {
    ...
    private void createContentView() {
        ...
        this.mSearchView = (SearchView) findViewById(16909238);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(16909229);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909237);
        this.mAppIcon = (ImageView) findViewById(16909228);
        this.mSearchPlate = this.mSearchView.findViewById(16909236);
        this.mWorkingSpinner = getContext().getDrawable(17303330);
        setWorking(false);

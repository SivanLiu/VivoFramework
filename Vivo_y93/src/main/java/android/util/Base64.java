...
public class Base64 {
    ...
    static final /* synthetic */ boolean f19-assertionsDisabled = (Base64.class.desiredAssertionStatus() ^ 1);
    ...
    static class Encoder extends Coder {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f20-assertionsDisabled = (Encoder.class.desiredAssertionStatus() ^ 1);
        ...
        public boolean process(byte[] input, int offset, int len, boolean finish) {
            ...
            if (v != -1) {
                ...
                if (finish) {
                    ...
                    if (!f20-assertionsDisabled && this.tailLen != 0) {
                        throw new AssertionError();
                    } else if (!(f20-assertionsDisabled || p == len)) {
                        throw new AssertionError();
                    }
                } else if (p == len - 1) {
                    bArr = this.tail;
    ...
    public static byte[] encode(byte[] input, int offset, int len, int flags) {
        ...
        if (f19-assertionsDisabled || encoder.op == output_len) {

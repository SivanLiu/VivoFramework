...
public class KeyboardView extends View implements OnClickListener {
    ...
    private void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        if (this.mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                case -6:
                    text = this.mContext.getString(17040074);
                    break;
                case -5:
                    text = this.mContext.getString(17040076);
                    break;
                case -4:
                    text = this.mContext.getString(17040077);
                    break;
                case -3:
                    text = this.mContext.getString(17040075);
                    break;
                case -2:
                    text = this.mContext.getString(17040079);
                    break;
                case -1:
                    text = this.mContext.getString(17040080);
                    break;
                case 10:
                    text = this.mContext.getString(17040078);
                    break;
                default:

...
public class InputMethodService extends AbstractInputMethodService {
    private static final String ACTION_ENTER_ACTION = "android.inputmethodservice.enter_action";
    ...
    private static final String SYSTEM_PROP_SKILL_LEARNING = "persist.sys.agent_skill_learning";
    static final String TAG = "InputMethodService";
    private static final String VIVO_AIAGENT_PKG = "com.vivo.agent";
    private boolean isSendEnter = false;
    final OnClickListener mActionClickListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            if (ei != null && ic != null) {
                if (ei.actionId != 0) {
                    InputMethodService.this.sendEnterActionBroadcast();
    ...
    public void onCreate() {
        boolean z;
        if (this.mTheme == 0) {
            this.mTheme = VivoThemeUtil.getSystemThemeStyle(ThemeType.INPUT_METHOD);
        }
        ...
        this.mWindow = new SoftInputWindow(this, InputMethodUtils.VIVO_SECURE_INPUTMETHOD_PACKAGENAME.equals(getPackageName()) ? "SecureInputMethod" : "InputMethod", this.mTheme, null, null, this.mDispatcherState, 2011, 80, false);
        initViews();
    ...
    void initViews() {
        ...
        this.mFullscreenArea = (ViewGroup) this.mRootView.findViewById(16908911);
    ...
    public void setExtractView(View view) {
        ...
        if (view != null) {
            ...
            this.mExtractAction = view.findViewById(16908964);
            if (this.mExtractAction != null) {
                this.mExtractAccessories = (ViewGroup) view.findViewById(16908963);
            }
            startExtractingText(false);
            return;
        }
    ...
    public View onCreateExtractTextView() {
        ...
        View root = this.mInflater.inflate(50528260, null);
        View action = root.findViewById(16908964);
        float density = getResources().getDisplayMetrics().density;
        MarginLayoutParams lp = (MarginLayoutParams) action.getLayoutParams();
        if (SystemProperties.getInt("qemu.hw.mainkeys", 0) == 1) {
            lp.setMarginEnd((int) (16.0f * density));
    ...
    public void sendDownUpKeyEvents(int keyEventCode) {
        ...
        if (ic != null) {
            ...
            if (keyEventCode == 66 && this.mInputEditorInfo != null && "com.tencent.mm".equals(this.mInputEditorInfo.packageName)) {
                sendEnterActionBroadcast();
            }
        }
    }
    ...
    public CharSequence getTextForImeAction(int imeOptions) {
        switch (imeOptions & 255) {
            case 1:
                return null;
            case 2:
                return getText(17040044);
            case 3:
                return getText(17040047);
            case 4:
                return getText(17040048);
            case 5:
                return getText(17040045);
            case 6:
                return getText(17040043);
            case 7:
                return getText(17040046);
            default:
    ...
    private void sendEnterActionBroadcast() {
        String isSkillLearning = SystemProperties.get(SYSTEM_PROP_SKILL_LEARNING, "no");
        Log.i(TAG, "sendEnterActionBroadcast : " + this.isSendEnter + " ; prop : " + isSkillLearning);
        if ("yes".equals(isSkillLearning) && !this.isSendEnter) {
            Log.i(TAG, "sendEnterActionBroadcast real");
            this.mHandler.post(new Runnable() {
                public void run() {
                    Intent intent = new Intent(InputMethodService.ACTION_ENTER_ACTION);
                    intent.setPackage(InputMethodService.VIVO_AIAGENT_PKG);
                    InputMethodService.this.sendBroadcast(intent);
                    InputMethodService.this.isSendEnter = true;
                }
            });
            this.mHandler.postDelayed(new Runnable() {
                public void run() {
                    InputMethodService.this.isSendEnter = false;
                }
            }, 500);
        }
    }

...
public class Intent implements Parcelable, Cloneable {
    ...
    public static final String ACTION_PACKAGE_FREEZE = "android.intent.action.PACKAGE_FREEZE";
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final String ACTION_PACKAGE_UNFREEZE = "android.intent.action.PACKAGE_UNFREEZE";
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FLAG_ACTIVITY_FROM_SECURE = 2048;
    ...
    private Intent(Intent o, int copyMode) {
        ...
        this.mIsVivoWidget = o.mIsVivoWidget;
        this.mTargetUserId = o.mTargetUserId;
        this.mForceStart = o.mForceStart;
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void setIsVivoWidget(boolean isVivoWidget) {
        this.mIsVivoWidget = isVivoWidget;
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public boolean getIsVivoWidget() {
        return this.mIsVivoWidget;
    }
    ...
    public int fillIn(Intent other, int flags) {
        ...
        if (other.mIsVivoWidget) {
            this.mIsVivoWidget = true;
        }
        this.mTargetUserId = other.mTargetUserId;
        this.mForceStart = other.mForceStart;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        if (this.mCategories != null) {
            ...
            for (int i3 = 0; i3 < N; i3++) {
                out.writeString((String) this.mCategories.valueAt(i3));
            }
        } else {
            out.writeInt(0);
        }
        ...
        if (this.mIsVivoWidget) {
            i = 1;
        } else {
            i = 0;
        }
        out.writeInt(i);
        out.writeInt(this.mTargetUserId);
        if (!this.mForceStart) {
            i2 = 0;
        }
        out.writeInt(i2);
    ...
    public void readFromParcel(Parcel in) {
        ...
        this.mIsVivoWidget = in.readInt() == 1;
        this.mTargetUserId = in.readInt();
        if (in.readInt() != 1) {
            z = false;
        }
        this.mForceStart = z;

...
public class Resources {
    ...
    private boolean mIsActivityMustFullScreen;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private boolean mIsAllowSplit;
    ...
    public final class Theme {
        ...
        public TypedArray obtainStyledAttributes(int[] attrs) {
            return this.mThemeImpl.getTypedArray(this.mThemeImpl.obtainStyledAttributes(this, null, attrs, 0, 0));
        }

        public TypedArray obtainStyledAttributes(int resId, int[] attrs) throws NotFoundException {
            return this.mThemeImpl.getTypedArray(this.mThemeImpl.obtainStyledAttributes(this, null, attrs, 0, resId));
        }

        public TypedArray obtainStyledAttributes(AttributeSet set, int[] attrs, int defStyleAttr, int defStyleRes) {
            return this.mThemeImpl.getTypedArray(this.mThemeImpl.obtainStyledAttributes(this, set, attrs, defStyleAttr, defStyleRes));
        }
    ...
    public Resources(ClassLoader classLoader) {
        ...
        this.mIsAllowSplit = false;
        this.mIsActivityMustFullScreen = false;
        if (classLoader == null) {
    ...
    private Resources() {
        ...
        this.mResourcesImpl.init(this, "android");
    }

    public void setImpl(ResourcesImpl impl) {
        if (impl != this.mResourcesImpl) {
            this.mResourcesImpl = impl;
            if (!(this.mResourcesImpl == null || this.mPackageName == null || (this.mPackageName.contains("webkit") ^ 1) == 0 || (this.mPackageName.contains("webview") ^ 1) == 0)) {
                this.mResourcesImpl.init(this, this.mPackageName);
            }
    ...
    public CharSequence getText(int id) throws NotFoundException {
        CharSequence res = this.mResourcesImpl.getText(id);
        if (res != null) {
            return res;
        }
    ...
    public CharSequence getText(int id, CharSequence def) {
        CharSequence res = id != 0 ? this.mResourcesImpl.getText(id) : null;
        if (res != null) {
            return res;
        }
        return def;
    ...
    public CharSequence[] getTextArray(int id) throws NotFoundException {
        CharSequence[] res = this.mResourcesImpl.getTextArray(id);
        if (res != null) {
            return res;
        }
    ...
    public String[] getStringArray(int id) throws NotFoundException {
        String[] res = this.mResourcesImpl.getStringArray(id);
        if (res != null) {
            return res;
        }
    ...
    public int[] getIntArray(int id) throws NotFoundException {
        int[] res = this.mResourcesImpl.getIntArray(id);
        if (res != null) {
            return res;
        }
    ...
    public TypedArray obtainTypedArray(int id) throws NotFoundException {
        ...
        array.mIndices[0] = 0;
        return impl.getTypedArray(array);
    }
    ...
    public TypedArray obtainAttributes(AttributeSet set, int[] attrs) {
        ...
        array.mXml = parser;
        return this.mResourcesImpl.getTypedArray(array);
    }
    ...
    public final void finishPreloading() {
        ...
        this.mResourcesImpl.closeVivoThemeFileForPreloaded();
    }
    ...
    public void initResource(String pkg) {
        if (this.mPackageName == null) {
            this.mPackageName = pkg;
        }
        if (this.mResourcesImpl != null) {
            this.mResourcesImpl.init(this, pkg);
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public void setAppAllowSplit(boolean isAllowSplit) {
        this.mIsAllowSplit = isAllowSplit;
    }

    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public boolean getAppAllowSplit() {
        return this.mIsAllowSplit;
    }

    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public void setActivityMustFullScreen(boolean isActivityMustFullScreen) {
        this.mIsActivityMustFullScreen = isActivityMustFullScreen;
    }

    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public boolean getActivityMustFullScreen() {
        return this.mIsActivityMustFullScreen;
    }
}

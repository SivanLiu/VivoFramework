...
public class SyncActivityTooManyDeletes extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter(this, R.layout.simple_list_item_1, R.id.text1, new CharSequence[]{getResources().getText(17041386), getResources().getText(17041389), getResources().getText(17041385)});
        ListView listView = new ListView(this);
        listView.setAdapter(adapter);
        listView.setItemsCanFocus(true);
        listView.setOnItemClickListener(this);
        TextView textView = new TextView(this);
        textView.setText(String.format(getResources().getText(17041388).toString(), new Object[]{Long.valueOf(this.mNumDeletes), this.mProvider, this.mAccount.name}));

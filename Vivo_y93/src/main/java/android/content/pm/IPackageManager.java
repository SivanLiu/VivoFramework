...
public interface IPackageManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPackageManager {
        ...
        static final int TRANSACTION_deleteHybridPackageInfo = 187;
        static final int TRANSACTION_deleteHybridRule = 189;
        ...
        static final int TRANSACTION_getHybridCallingPackage = 191;
        ...
        static final int TRANSACTION_getUninstallSysAppMap = 185;
        ...
        static final int TRANSACTION_grantTheRestPermissions = 184;
        static final int TRANSACTION_hasSystemFeature = 106;
        static final int TRANSACTION_hasSystemUidErrors = 110;
        static final int TRANSACTION_insertHybridPackageInfo = 186;
        static final int TRANSACTION_insertHybridRule = 188;
        static final int TRANSACTION_insertNewHybridRule = 190;
        ...
        private static class Proxy implements IPackageManager {
            ...
            public void grantTheRestPermissions(boolean onlySystem) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public Map getUninstallSysAppMap() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void insertHybridPackageInfo(String packageName, PackageInfo packageInfo) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void deleteHybridPackageInfo(String packageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void insertHybridRule(String callingPkgname, String xcxPkgname, String platfromPkgname, String realActitityname) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(callingPkgname);
                    _data.writeString(xcxPkgname);
                    _data.writeString(platfromPkgname);
                    _data.writeString(realActitityname);
            ...
            public void deleteHybridRule(String xcxPkgname) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void insertNewHybridRule(String callingPkgname, String xcxPkgname, String platfromPkgname, String realActitityname, String action, Bundle extras) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String getHybridCallingPackage(int callinguid, String action) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    ...
                    _result = activitySupportsIntent(_arg02, _arg14, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 16:
                ...
                case 46:
                    ...
                    _result5 = queryIntentActivityOptions(_arg02, _arg15, _arg23, _arg32, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 56:
                    ...
                    querySyncProviders(_arg07, _arg16);
                    reply.writeNoException();
                ...
                case 69:
                    ...
                    setLastChosenActivity(_arg04, _arg1, _arg2, _arg33, _arg4, _arg5);
                    reply.writeNoException();
                    return true;
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    addPreferredActivity(_arg05, _arg12, _arg22, _arg3, data.readInt());
                    reply.writeNoException();
                    return true;
                case 71:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    replacePreferredActivity(_arg05, _arg12, _arg22, _arg3, data.readInt());
                    reply.writeNoException();
                    return true;
                case 72:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 156:
                    ...
                    _result = isPackageSignedByKeySet(_arg06, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 157:
                    ...
                    _result = isPackageSignedByKeySetExactly(_arg06, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 158:
                ...
                case 184:
                    data.enforceInterface(DESCRIPTOR);
                    grantTheRestPermissions(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 185:
                    data.enforceInterface(DESCRIPTOR);
                    Map _result25 = getUninstallSysAppMap();
                    reply.writeNoException();
                ...
                case 186:
                    ...
                    _arg06 = data.readString();
                    if (data.readInt() != 0) {
                        _arg110 = (PackageInfo) PackageInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg110 = null;
                    }
                    insertHybridPackageInfo(_arg06, _arg110);
                    reply.writeNoException();
                    return true;
                case 187:
                    data.enforceInterface(DESCRIPTOR);
                    deleteHybridPackageInfo(data.readString());
                    reply.writeNoException();
                    return true;
                case 188:
                    data.enforceInterface(DESCRIPTOR);
                    insertHybridRule(data.readString(), data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 189:
                    data.enforceInterface(DESCRIPTOR);
                    deleteHybridRule(data.readString());
                    reply.writeNoException();
                    return true;
                case 190:
                    Bundle _arg52;
                    ...
                    insertNewHybridRule(_arg06, _arg1, _arg24, _arg35, _arg42, _arg52);
                    reply.writeNoException();
                    return true;
                case 191:
                    data.enforceInterface(DESCRIPTOR);
                    _result9 = getHybridCallingPackage(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeString(_result9);
                    return true;
    ...
    void deleteHybridPackageInfo(String str) throws RemoteException;

    void deleteHybridRule(String str) throws RemoteException;
    ...
    String getHybridCallingPackage(int i, String str) throws RemoteException;
    ...
    Map getUninstallSysAppMap() throws RemoteException;
    ...
    void grantTheRestPermissions(boolean z) throws RemoteException;

    boolean hasSystemFeature(String str, int i) throws RemoteException;

    boolean hasSystemUidErrors() throws RemoteException;

    void insertHybridPackageInfo(String str, PackageInfo packageInfo) throws RemoteException;

    void insertHybridRule(String str, String str2, String str3, String str4) throws RemoteException;

    void insertNewHybridRule(String str, String str2, String str3, String str4, String str5, Bundle bundle) throws RemoteException;

...
public abstract class PackageManager {
    ...
    public static final int DELETE_VIVO_SYS_APP = 1048576;
    ...
    public static final int INSTALL_FAILED_APK_SOURCE_NOT_IN_TRUSTED_LIST = -301;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int INSTALL_FAILED_CANCELLED_BY_USER = -200;
    ...
    public static final int INSTALL_FROM_3THPART = 262144;
    public static final int INSTALL_FROM_ADB = 32;
    public static final int INSTALL_FROM_VENDING = 1073741824;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int INSTALL_FROM_VIVO_ADB = 131072;
    public static final int INSTALL_FROM_VIVO_BUILDIN_APP = 134217728;
    public static final int INSTALL_FROM_VIVO_CUSTOM_SYS_APP = 536870912;
    ...
    public static final int INSTALL_INTERNAL_U_DISK = 524288;
    ...
    public static final int MOVE_INTERNAL_U_DISK = 4;

...
public interface IKeystoreService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeystoreService {
        ...
        static final int TRANSACTION_isSystemCredentialEmpty = 40;
        ...
        static final int TRANSACTION_vivoKeyStoreReadString = 43;
        static final int TRANSACTION_vivoKeyStoreRemoveString = 44;
        static final int TRANSACTION_vivoKeyStoreWriteString = 42;
        static final int TRANSACTION_vivoSecurityKeyOperate = 41;
        static final int TRANSACTION_vivo_keystore_encrypt = 39;
        ...
        private static class Proxy implements IKeystoreService {
            ...
            public byte[] vivo_keystore_encrypt(int encrypt_type, byte[] plain_text) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(encrypt_type);
                    _data.writeByteArray(plain_text);
            ...
            public int isSystemCredentialEmpty(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public VivoSecurityKeyResult vivoSecurityKeyOperate(int operateMode, int operateType, int encryptType, int keyType, String packageName, int keyVersion, String keyName, String publicKey, byte[] inData) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    VivoSecurityKeyResult _result;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(operateMode);
                    _data.writeInt(operateType);
                    _data.writeInt(encryptType);
                    _data.writeInt(keyType);
                    _data.writeString(packageName);
                    _data.writeInt(keyVersion);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (VivoSecurityKeyResult) VivoSecurityKeyResult.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            public int vivoKeyStoreWriteString(int uid, byte[] packageName, byte[] signature, byte[] string) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(uid);
                    _data.writeByteArray(packageName);
                    _data.writeByteArray(signature);
                    _data.writeByteArray(string);
            ...
            public byte[] vivoKeyStoreReadString(int uid, byte[] packageName, byte[] signature) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int vivoKeyStoreRemoveString(int uid, byte[] packageName, byte[] signature) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = vivo_keystore_encrypt(data.readInt(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isSystemCredentialEmpty(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    VivoSecurityKeyResult _result9 = vivoSecurityKeyOperate(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readString(), data.readInt(), data.readString(), data.readString(), data.createByteArray());
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
                ...
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    _result = vivoKeyStoreWriteString(data.readInt(), data.createByteArray(), data.createByteArray(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = vivoKeyStoreReadString(data.readInt(), data.createByteArray(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeByteArray(_result2);
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    _result = vivoKeyStoreRemoveString(data.readInt(), data.createByteArray(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
    ...
    int isSystemCredentialEmpty(int i) throws RemoteException;
    ...
    byte[] vivoKeyStoreReadString(int i, byte[] bArr, byte[] bArr2) throws RemoteException;

    int vivoKeyStoreRemoveString(int i, byte[] bArr, byte[] bArr2) throws RemoteException;

    int vivoKeyStoreWriteString(int i, byte[] bArr, byte[] bArr2, byte[] bArr3) throws RemoteException;

    VivoSecurityKeyResult vivoSecurityKeyOperate(int i, int i2, int i3, int i4, String str, int i5, String str2, String str3, byte[] bArr) throws RemoteException;

    byte[] vivo_keystore_encrypt(int i, byte[] bArr) throws RemoteException;
}

...
public final class DisplayManagerGlobal {
    ...
    public void stopWifiDisplayScan() {
        synchronized (this.mLock) {
            ...
            if (i == 0) {
                ...
                Log.d(TAG, "Wifi display scan nest count became negative: " + this.mWifiDisplayScanNestCount);
    ...
    public void turnDisplayOff() {
        try {
            this.mDm.turnDisplayOff();
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }

    public void turnDisplayDoze() {
        try {
            this.mDm.turnDisplayDoze();
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }

    public void turnDozeSuspendDisplay() {
        try {
            this.mDm.turnDozeSuspendDisplay();
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }

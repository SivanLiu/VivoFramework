...
public interface IDisplayManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDisplayManager {
        ...
        static final int TRANSACTION_turnDisplayDoze = 21;
        static final int TRANSACTION_turnDisplayOff = 20;
        static final int TRANSACTION_turnDisplayOn = 19;
        static final int TRANSACTION_turnDozeSuspendDisplay = 22;
        static final int TRANSACTION_updateDisplay = 23;
        ...
        private static class Proxy implements IDisplayManager {
            ...
            public void turnDisplayOn() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void turnDisplayOff() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void turnDisplayDoze() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void turnDozeSuspendDisplay() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void turnDisplayDoze() throws RemoteException;

    void turnDisplayOff() throws RemoteException;

    void turnDisplayOn() throws RemoteException;

    void turnDozeSuspendDisplay() throws RemoteException;

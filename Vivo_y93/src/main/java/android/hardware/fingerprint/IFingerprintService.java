...
public interface IFingerprintService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFingerprintService {
        ...
        static final int TRANSACTION_getHomekeyState = 20;
        ...
        static final int TRANSACTION_sendCommand = 22;
        static final int TRANSACTION_sendOtherMessage = 23;
        static final int TRANSACTION_setActiveUser = 15;
        static final int TRANSACTION_setHomekeyState = 21;
        ...
        private static class Proxy implements IFingerprintService {
            ...
            public int getHomekeyState() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setHomekeyState(int state) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int sendCommand(IBinder token, int command, int extras, IFingerprintServiceReceiver receiver, int flag, String opPackageName) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public int sendOtherMessage(IBinder token, int command, int extras, byte[] cryptoToken, long longParam, String strParam) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getHomekeyState();
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    setHomekeyState(data.readInt());
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = sendCommand(data.readStrongBinder(), data.readInt(), data.readInt(), android.hardware.fingerprint.IFingerprintServiceReceiver.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = sendOtherMessage(data.readStrongBinder(), data.readInt(), data.readInt(), data.createByteArray(), data.readLong(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
    ...
    int getHomekeyState() throws RemoteException;
    ...
    int sendCommand(IBinder iBinder, int i, int i2, IFingerprintServiceReceiver iFingerprintServiceReceiver, int i3, String str) throws RemoteException;

    int sendOtherMessage(IBinder iBinder, int i, int i2, byte[] bArr, long j, String str) throws RemoteException;

    void setActiveUser(int i) throws RemoteException;

    void setHomekeyState(int i) throws RemoteException;
}

...
public final class Sensor {
    ...
    public static final String SENSOR_STRING_TYPE_AMBIENT_LIGHT_SCENE = "android.sensor.ambient_light_scene";
    ...
    public static final String STRING_TYPE_AMD = "android.sensor.amd";
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final String STRING_TYPE_ANGLE = "android.sensor.angle";
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final String STRING_TYPE_ANGLE_DIRECTION = "android.sensor.angle_direction";
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final String STRING_TYPE_ANGLE_JUDGE = "android.sensor.angle_judge";
    public static final String STRING_TYPE_DEVICE_ORIENTATION = "android.sensor.device_orientation";
    public static final String STRING_TYPE_DROP_DET = "android.sensor.drop_det";
    ...
    public static final String STRING_TYPE_MAG_CALI_RT = "android.sensor.mag_cali_rt";
    ...
    public static final String STRING_TYPE_PUTDOWN_DETECT = "android.sensor.raiseup_detect";
    public static final String STRING_TYPE_RAISEUP_DETECT = "android.sensor.raiseup_detect";
    ...
    public static final String STRING_TYPE_SMART_SCRN = "android.sensor.smart_scrn";
    ...
    public static final String STRING_TYPE_VIVOMOTION_DETECT = "android.sensor.vivomotion_detect";
    public static final String STRING_TYPE_WAKE_GESTURE = "android.sensor.wake_gesture";
    public static final String STRING_TYPE_WINDOW_ORIENTATION = "android.sensor.window_orientation";
    ...
    public static final int TYPE_AMD = 33171006;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int TYPE_ANGLE = 66541;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int TYPE_ANGLE_DIRECTION = 66543;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int TYPE_ANGLE_JUDGE = 66542;
    public static final int TYPE_DEVICE_ORIENTATION = 27;
    public static final int TYPE_DEVICE_PRIVATE_BASE = 65536;
    public static final int TYPE_DROP_DET = 66548;
    public static final int TYPE_DYNAMIC_SENSOR_META = 32;
    public static final int TYPE_GAME_ROTATION_VECTOR = 15;
    public static final int TYPE_GEOMAGNETIC_ROTATION_VECTOR = 20;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final int TYPE_GESTURE = 31;
    ...
    public static final int TYPE_MAG_CALI_RT = 66545;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int TYPE_PROXIMITY_RAW = 32;
    public static final int TYPE_PUTDOWN_DETECT = 66539;
    public static final int TYPE_RAISEUP_DETECT = 66538;
    public static final int TYPE_RELATIVE_HUMIDITY = 12;
    public static final int TYPE_ROTATION_VECTOR = 11;
    public static final int TYPE_SIGNIFICANT_MOTION = 17;
    public static final int TYPE_SMART_SCRN = 66549;
    ...
    public static final int TYPE_WINDOW_ORIENTATION = 66537;
    public static final int TYPE_WRIST_TILT_GESTURE = 26;
    private static final int[] sSensorReportingModes = new int[]{0, 3, 3, 3, 3, 9, 1, 1, 3, 3, 3, 5, 1, 1, 6, 4, 6, 1, 1, 1, 5, 1, 1, 1, 1, 1, 1, 1, 16, 1, 1, 1, 2, 16, 1, 6};

...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    private static SparseArray<CapabilityInfo> getCapabilityInfoSparseArray(Context context) {
        if (sAvailableCapabilityInfos == null) {
            ...
            sAvailableCapabilityInfos.put(1, new CapabilityInfo(1, 17039612, 17039605));
            sAvailableCapabilityInfos.put(2, new CapabilityInfo(2, 17039611, 17039604));
            sAvailableCapabilityInfos.put(8, new CapabilityInfo(8, 17039610, 17039603));
            sAvailableCapabilityInfos.put(16, new CapabilityInfo(16, 17039607, 17039600));
            sAvailableCapabilityInfos.put(32, new CapabilityInfo(32, 17039608, 17039601));
            if (context == null || fingerprintAvailable(context)) {
                sAvailableCapabilityInfos.put(64, new CapabilityInfo(64, 17039606, 17039599));
            }
        }

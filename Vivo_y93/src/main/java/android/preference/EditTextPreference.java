...
public class EditTextPreference extends DialogPreference {
    ...
    public EditTextPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (VivoThemeUtil.isVigourTheme(getContext())) {
            this.mEditText = createEditText(context, attrs, defStyleAttr);
        } else {
    ...
    private EditText createEditText(Context context, AttributeSet attr, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(null, new int[]{R.attr.editTextStyle}, defStyleAttr, 0);
        EditText edit = new EditText(context, attr, 0, a.getResourceId(0, 0));
        a.recycle();
        return edit;
    }
    ...
    protected void onAddEditTextToDialogView(View dialogView, EditText editText) {
        ViewGroup container = (ViewGroup) dialogView.findViewById(16908843);
        if (container != null) {

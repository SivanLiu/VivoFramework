...
public final class PreferenceScreen extends PreferenceGroup implements OnItemClickListener, OnDismissListener {
    ...
    private VivoPreferenceManager mVivoPreferenceManager;
    ...
    protected ListAdapter onCreateRootAdapter() {
        ...
        if (this.mVivoPreferenceManager == null) {
            this.mVivoPreferenceManager = new VivoPreferenceManager(this);
        }
        return this.mVivoPreferenceManager.getPreferenceGroupAdapter();
    }
    ...
    public void bind(ListView listView) {
        ...
        if (VivoThemeUtil.isVigourTheme(getContext())) {
            ...
            this.mVivoPreferenceManager.bindList(listView);
        }

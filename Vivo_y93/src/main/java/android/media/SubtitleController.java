...
public class SubtitleController {
    ...
    static final /* synthetic */ boolean f87-assertionsDisabled = (SubtitleController.class.desiredAssertionStatus() ^ 1);
    ...
    private void checkAnchorLooper() {
        if (!f87-assertionsDisabled && this.mHandler == null) {
            throw new AssertionError("Should have a looper already");
        } else if (!f87-assertionsDisabled && Looper.myLooper() != this.mHandler.getLooper()) {

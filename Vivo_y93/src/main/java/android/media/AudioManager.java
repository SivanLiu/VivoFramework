...
public class AudioManager {
    ...
    public void forceVolumeControlStream(int streamType) {
        try {
            ...
            Log.d(TAG, "forceVolumeControlStream streamType:" + streamType + " by " + getContext().getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setSpeakerphoneOn(boolean on) {
        ...
        try {
            service.setSpeakerphoneOn(on, this.mICallBack, this.mApplicationContext.getOpPackageName());
            Log.d(TAG, "setSpeakerphoneOn " + on + " by " + getContext().getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isBluetoothScoAvailableOffCall() {
        boolean retval = getContext().getResources().getBoolean(17956903);
    ...
    public void startBluetoothSco() {
        ...
        try {
            ...
            Log.d(TAG, "startBluetoothSco  by " + getContext().getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void stopBluetoothSco() {
        ...
        try {
            ...
            Log.d(TAG, "stopBluetoothSco  by " + getContext().getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setBluetoothScoOn(boolean on) {
        ...
        try {
            Log.d(TAG, "setBluetoothScoOn " + on + " by " + getContext().getOpPackageName());
            service.setBluetoothScoOn(on, this.mICallBack, this.mApplicationContext.getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setParameters(String keyValuePairs) {
        try {
            getService().updateParameters(keyValuePairs, this.mICallBack);
        } catch (RemoteException e) {
            Log.e(TAG, "Dead object in setParameters" + e);
        }
    ...
    public String getParameters(String keys) {
        try {
            if (getService().isKTVSurpported(keys, getContext().getPackageName())) {
                return keys;
            }
        } catch (RemoteException e) {
            Log.e(TAG, "Dead object in setParameters" + e);
    ...
    public int abandonAudioFocus(OnAudioFocusChangeListener l, AudioAttributes aa) {
        ...
        try {
            int status = getService().abandonAudioFocus(this.mAudioFocusDispatcher, getIdForAudioFocusListener(l), aa, getContext().getOpPackageName());
            Log.d(TAG, "abandonAudioFocus  by " + getContext().getOpPackageName());
            return status;
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public void avrcpSupportsAbsoluteVolume(String address, boolean support) {
        IAudioService service = getService();
        try {
            Log.d(TAG, "avrcpSupportsAbsoluteVolume : " + support + " by " + getContext().getOpPackageName());
    ...
    public void setWiredDeviceConnectionState(int type, int state, String address, String name) {
        ...
        try {
            ...
            Log.d(TAG, "setWiredDeviceConnectionState state:" + state + " by " + getContext().getOpPackageName());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int setBluetoothA2dpDeviceConnectionState(BluetoothDevice device, int state, int profile) {
        try {
            int delay = getService().setBluetoothA2dpDeviceConnectionState(device, state, profile);
            Log.d(TAG, "setBluetoothA2dpDeviceConnectionState state:" + state + " by " + getContext().getOpPackageName());
            return delay;
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }

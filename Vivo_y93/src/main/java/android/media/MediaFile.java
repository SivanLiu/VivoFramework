...
public class MediaFile {
    ...
    public static final int FILE_TYPE_3GPP3 = 219;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_APK = 112;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_APK_1 = 115;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_DOCX = 109;
    public static final int FILE_TYPE_DSD = 218;
    public static final int FILE_TYPE_DTS = 210;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_EBK3 = 114;
    public static final int FILE_TYPE_EC3 = 215;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_EPUB = 113;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_MP1 = 220;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_MP2 = 221;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int FILE_TYPE_XLSX = 110;
    ...
    private static final int LAST_AUDIO_FILE_TYPE_EXT = 221;
    ...
    static {
        ...
        if (isWMAEnabled()) {
            ...
            addFileType("WMA", 6, "audio/x-ms-asf", MtpConstants.FORMAT_WMA, false);
        }
        ...
        addFileType("VCF", 108, "text/x-vcard");
        addFileType("DOCX", 109, "application/msword", MtpConstants.FORMAT_MS_WORD_DOCUMENT, false);
        addFileType("XLSX", 110, "application/vnd.ms-excel", MtpConstants.FORMAT_MS_EXCEL_SPREADSHEET, false);
        addFileType("PPTX", 111, "application/mspowerpoint", MtpConstants.FORMAT_MS_POWERPOINT_PRESENTATION, false);
        addFileType("APK", 112, "application/vnd.android.package-archive");
        addFileType("EPUB", 113, "application/epub+zip");
        addFileType("EBK3", 114, "application/x-expandedbook");
        addFileType(WifiEnterpriseConfig.ENGINE_ENABLE, 115, "application/apk_1");
        ...
        addFileType("3gp", 219, MediaFormat.MIMETYPE_AUDIO_AMR_NB);
        addFileType("3GPP", 219, MediaFormat.MIMETYPE_AUDIO_AMR_NB, MtpConstants.FORMAT_3GP_CONTAINER, false);
        addFileType("MP1", 220, MediaFormat.MIMETYPE_AUDIO_MPEG);
        addFileType("MP2", 221, MediaFormat.MIMETYPE_AUDIO_MPEG);
        addFileType("RMVB", 204, "video/x-real");
        addFileType("RM", 204, "video/x-real");
        addFileType("RAM", 204, "video/x-real");
        addFileType("RV", 204, "video/x-real");
        addFileType("MOV", 205, "video/quicktime");
        addFileType("QT", 205, "video/quicktime");
        addFileType("TP", 206, "video/mp2ts");
        addFileType("TP", 206, "video/mp2tp");
        addFileType("RAR", 116, "application/x-rar-compressed");
        addFileType("APE", 217, "application/ape");
        addFileType("APE", 217, "audio/ape");
        addFileType("F4V", 203, "video/x-flv");
        addFileType("VOB", 21, "video/mpeg");
        addFileType("M2TS", 28, "video/mp2ts");
        addFileType("MTS", 28, "video/mp2ts");
        addFileType("MPG", 28, "video/mp2ts");
        addFileType("MOV", 21, "video/quicktime", 12299, false);
        addFileType("DTS", 210, "audio/x-dts");
    }

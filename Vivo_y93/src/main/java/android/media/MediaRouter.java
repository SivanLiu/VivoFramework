...
public class MediaRouter {
    ...
    static final /* synthetic */ boolean f61-assertionsDisabled = (MediaRouter.class.desiredAssertionStatus() ^ 1);
    ...
    static class Static implements DisplayListener {
        ...
        final IAudioRoutesObserver.Stub mAudioRoutesObserver = new IAudioRoutesObserver.Stub() {
            public void dispatchAudioRoutesChanged(final AudioRoutesInfo newRoutes) {
                Log.v(MediaRouter.TAG, "dispatchAudioRoutesChanged: " + newRoutes + this);
        ...
        Static(Context appContext) {
            ...
            this.mSystemCategory = new RouteCategory(17039786, 3, false);
        ...
        void startMonitoringRoutes(Context appContext) {
            Log.v(MediaRouter.TAG, "startMonitoringRoutes: " + this);
            this.mDefaultAudioVideo = new RouteInfo(this.mSystemCategory);
            this.mDefaultAudioVideo.mNameResId = 17039787;
            ...
            if (!TextUtils.equals(newRoutes.bluetoothName, this.mCurAudioRoutesInfo.bluetoothName)) {
                ...
                if (this.mCurAudioRoutesInfo.bluetoothName != null) {
                    if (this.mBluetoothA2dpRoute == null) {
                        ...
                        info.mDescription = this.mResources.getText(17039588);
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        ...
        if (f61-assertionsDisabled || route != null) {
            ...
            Log.d(TAG, "updateAudioRoutes currentSystemRoute :" + currentSystemRoute + ",mDefaultAudioVideo:" + sStatic.mDefaultAudioVideo);
            ...
            if (route.matchesTypes(types)) {
                ...
                if (sStatic.isPlaybackActive() && btRoute != null && (types & 1) != 0 && (route == btRoute || route == sStatic.mDefaultAudioVideo)) {
                    try {
                        Log.v(TAG, "selectRouteStatic setBluetoothA2dpOn:" + (route == btRoute));
                ...
                Log.d(TAG, "selectRouteStatic  set mSelectedRoute:" + route);
                if (oldRoute != null) {
    ...
    static RouteInfo makeWifiDisplayRoute(WifiDisplay display, WifiDisplayStatus wfdStatus) {
        ...
        newRoute.mDescription = sStatic.mResources.getText(17041569);

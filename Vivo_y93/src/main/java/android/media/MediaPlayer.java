...
public class MediaPlayer extends PlayerBase implements Listener, VolumeAutomation {
    ...
    private boolean mZenModeFlag = false;
    ...
    static class AnonymousClass7 implements Runnable {
        ...
        AnonymousClass7(MediaPlayer mediaPlayer) {
    ...
    private class EventHandler extends Handler {
        ...
        /* JADX WARNING: Missing block: B:46:0x017d, code:
            return;
     */
        /* JADX WARNING: Missing block: B:61:0x01da, code:
            r25 = android.media.MediaPlayer.-get21(r30.this$0);
     */
        /* JADX WARNING: Missing block: B:62:0x01e4, code:
            if (r25 == null) goto L_0x01ef;
     */
        /* JADX WARNING: Missing block: B:63:0x01e6, code:
            r25.onSeekComplete(r30.mMediaPlayer);
     */
        /* JADX WARNING: Missing block: B:64:0x01ef, code:
            return;
     */
    ...
    public void setDataSource(FileDescriptor fd, long offset, long length) throws IOException, IllegalArgumentException, IllegalStateException {
        this.mZenModeFlag = false;
        AudioFeatures mAudioFeatures = new AudioFeatures(ActivityThread.currentApplication(), null, null);
        if (mAudioFeatures == null) {
            Log.w(TAG, "Couldn't get audio mAudioFeatures");
        } else if (mAudioFeatures.SetZenModeUtils("vivo_zen_mode", fd, length)) {
            Log.d(TAG, "setDataSource mute this stream length:" + length);
            _setVolume(0.0f, 0.0f);
            this.mZenModeFlag = true;
        }
    ...
    void playerSetVolume(boolean muting, float leftVolume, float rightVolume) {
        if (this.mZenModeFlag) {
            Log.d(TAG, "playerSetVolume return because zenmode effect");
            return;
        }
        if (muting) {
            leftVolume = 0.0f;
    ...
    public TrackInfo[] getTrackInfoHook() throws IllegalStateException {
    ...
    private static void postEventFromNative(Object mediaplayer_ref, int what, int arg1, int arg2, Object obj) {
        ...
        if (mp != null) {
            ...
            switch (what) {
                ...
                case 200:
                    if (arg1 == 2) {
                        new Thread(new AnonymousClass7(mp)).start();
                        Thread.yield();
                        break;
                    }
                    break;

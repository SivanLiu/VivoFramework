...
class WebVttParser {
    ...
    private final Phase mParseCueId = new Phase() {
        ...
        static final /* synthetic */ boolean f89-assertionsDisabled = (AnonymousClass4.class.desiredAssertionStatus() ^ 1);

        public void parse(String line) {
            if (line.length() != 0) {
                if (f89-assertionsDisabled || WebVttParser.this.mCue == null) {
    ...
    private final Phase mParseCueTime = new Phase() {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f90-assertionsDisabled = (AnonymousClass5.class.desiredAssertionStatus() ^ 1);
            ...
            for (String setting : rest.split(" +")) {
                ...
                if (colonAt > 0 && colonAt != setting.length() - 1) {
                    ...
                    if (name.equals(TtmlUtils.TAG_REGION)) {
                        ...
                        try {
                            if (!f90-assertionsDisabled && value.indexOf(32) >= 0) {
                                throw new AssertionError();
                        ...
                        if (value.equals(AudioFeatures.TAG_FD_START)) {
    ...
    private final Phase mParseHeader = new Phase() {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f88-assertionsDisabled = (AnonymousClass3.class.desiredAssertionStatus() ^ 1);
                    ...
                    if (name.equals(Instrumentation.REPORT_KEY_IDENTIFIER)) {
                        ...
                        if (value.matches(".*[^0-9].*")) {
                            ...
                            try {
                                ...
                                if (!f88-assertionsDisabled && region.mLines < 0) {
                                    throw new AssertionError();
                                }
                            } catch (NumberFormatException e2) {

...
class TextTrackCue extends Cue {
    ...
    public String toString() {
        ...
        str = this.mAlignment == 202 ? TtmlUtils.ATTR_END : this.mAlignment == 203 ? "left" : this.mAlignment == 200 ? "middle" : this.mAlignment == 204 ? "right" : this.mAlignment == 201 ? AudioFeatures.TAG_FD_START : "INVALID";

...
public interface IAudioService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAudioService {
        ...
        static final int TRANSACTION_AdjustZenModeUtils = 86;
        static final int TRANSACTION_PlaybackDetectionCallBack = 88;
        ...
        static final int TRANSACTION_getAudioFeature = 77;
        ...
        static final int TRANSACTION_getStreamVolumeDelta = 83;
        static final int TRANSACTION_getStreamVolumeMaxDelta = 84;
        ...
        static final int TRANSACTION_isKTVSurpported = 81;
        static final int TRANSACTION_isMasterMute = 6;
        static final int TRANSACTION_isMotorModeSupportPlayback = 87;
        ...
        static final int TRANSACTION_isZenmodSurpported = 85;
        ...
        static final int TRANSACTION_registerAudioFeatureCallback = 78;
        ...
        static final int TRANSACTION_setAudioFeature = 76;
        ...
        static final int TRANSACTION_setStreamVolumeDelta = 82;
        ...
        static final int TRANSACTION_unregisterAudioFeatureCallback = 79;
        ...
        static final int TRANSACTION_updateParameters = 80;
        ...
        private static class Proxy implements IAudioService {
            ...
            public void setSpeakerphoneOn(boolean on, IBinder cb, String callingPackage) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setBluetoothScoOn(boolean on, IBinder cb, String callingPackage) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public String setAudioFeature(String feature, IBinder cb) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String getAudioFeature(String feature) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String registerAudioFeatureCallback(IAudioFeatureCallback callback, String arg0, IBinder cb) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public String unregisterAudioFeatureCallback(IAudioFeatureCallback callback, String arg0) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void updateParameters(String para, IBinder cb) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isKTVSurpported(String keys, String pkgname) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setStreamVolumeDelta(int streamType, int index, int flags, String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getStreamVolumeDelta(int streamType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getStreamVolumeMaxDelta(int streamType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isZenmodSurpported(String keys, String pkgname, String FilePath, long length) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean AdjustZenModeUtils(String pkgname) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isMotorModeSupportPlayback(String pkgname) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void PlaybackDetectionCallBack(String tag, String state, String packageName, int usage, String mPlayerAddr, PlayerIdCard pic) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    setSpeakerphoneOn(data.readInt() != 0, data.readStrongBinder(), data.readString());
                    reply.writeNoException();
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    setBluetoothScoOn(data.readInt() != 0, data.readStrongBinder(), data.readString());
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 36:
                    ...
                    _result2 = abandonAudioFocus(_arg04, _arg1, _arg2, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 37:
                ...
                case 58:
                    ...
                    _result3 = registerAudioPolicy(_arg05, android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0, data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 69:
                    ...
                    _arg02 = data.readInt();
                    if (data.readInt() != 0) {
                        _arg12 = (AudioAttributes) AudioAttributes.CREATOR.createFromParcel(data);
                    } else {
                        _arg12 = null;
                    }
                ...
                case 73:
                    ...
                    _result2 = getFocusRampTimeMs(_arg02, _arg12);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 74:
                ...
                case 76:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = setAudioFeature(data.readString(), data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getAudioFeature(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = registerAudioFeatureCallback(android.media.IAudioFeatureCallback.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 79:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = unregisterAudioFeatureCallback(android.media.IAudioFeatureCallback.Stub.asInterface(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 80:
                    data.enforceInterface(DESCRIPTOR);
                    updateParameters(data.readString(), data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 81:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isKTVSurpported(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 82:
                    data.enforceInterface(DESCRIPTOR);
                    setStreamVolumeDelta(data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    return true;
                case 83:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getStreamVolumeDelta(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 84:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getStreamVolumeMaxDelta(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 85:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isZenmodSurpported(data.readString(), data.readString(), data.readString(), data.readLong());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 86:
                    data.enforceInterface(DESCRIPTOR);
                    _result = AdjustZenModeUtils(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 87:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isMotorModeSupportPlayback(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 88:
                    ...
                    if (data.readInt() != 0) {
                        _arg5 = (PlayerIdCard) PlayerIdCard.CREATOR.createFromParcel(data);
                    } else {
                        _arg5 = null;
                    }
                    PlaybackDetectionCallBack(_arg09, _arg1, _arg22, _arg3, _arg4, _arg5);
                    reply.writeNoException();
                    return true;
    ...
    boolean AdjustZenModeUtils(String str) throws RemoteException;

    void PlaybackDetectionCallBack(String str, String str2, String str3, int i, String str4, PlayerIdCard playerIdCard) throws RemoteException;
    ...
    String getAudioFeature(String str) throws RemoteException;
    ...
    int getStreamVolumeDelta(int i) throws RemoteException;

    int getStreamVolumeMaxDelta(int i) throws RemoteException;
    ...
    boolean isKTVSurpported(String str, String str2) throws RemoteException;

    boolean isMasterMute() throws RemoteException;

    boolean isMotorModeSupportPlayback(String str) throws RemoteException;
    ...
    boolean isZenmodSurpported(String str, String str2, String str3, long j) throws RemoteException;
    ...
    String registerAudioFeatureCallback(IAudioFeatureCallback iAudioFeatureCallback, String str, IBinder iBinder) throws RemoteException;
    ...
    String setAudioFeature(String str, IBinder iBinder) throws RemoteException;
    ...
    void setBluetoothScoOn(boolean z, IBinder iBinder, String str) throws RemoteException;
    ...
    void setSpeakerphoneOn(boolean z, IBinder iBinder, String str) throws RemoteException;

    void setStreamVolume(int i, int i2, int i3, String str) throws RemoteException;

    void setStreamVolumeDelta(int i, int i2, int i3, String str) throws RemoteException;
    ...
    String unregisterAudioFeatureCallback(IAudioFeatureCallback iAudioFeatureCallback, String str) throws RemoteException;
    ...
    void updateParameters(String str, IBinder iBinder) throws RemoteException;
}

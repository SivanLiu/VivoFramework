...
public class FontFamily {
    ...
    private static native boolean nReplaceFont(long j, int i, ByteBuffer byteBuffer);
    ...
    public boolean replaceFont(ByteBuffer fontBuffer, int index) {
        return nReplaceFont(this.mNativePtr, index, fontBuffer);
    }
}

...
public abstract class ColorSpace {
    ...
    public static class Rgb extends ColorSpace {
        ...
        static /* synthetic */ double m33lambda$-android_graphics_ColorSpace$Rgb_113213(double gamma, double x) {
            if (x < 0.0d) {
                x = 0.0d;
            }
        ...
        static /* synthetic */ double m34lambda$-android_graphics_ColorSpace$Rgb_113354(double gamma, double x) {
            if (x < 0.0d) {
                x = 0.0d;
            }
        ...
        /* renamed from: -android_graphics_ColorSpace$Rgb-mthref-0 */
        /* synthetic */ double m35-android_graphics_ColorSpace$Rgb-mthref-0(double d) {
            return clamp(d);
        }

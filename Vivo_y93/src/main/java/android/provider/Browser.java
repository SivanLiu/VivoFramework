...
public class Browser {
    public static final Uri BOOKMARKS_URI = Uri.parse("content://vivobrowser/bookmarks");
    ...
    public static final Uri SEARCHES_URI = Uri.parse("content://vivobrowser/searches");

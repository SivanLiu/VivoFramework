...
public final class Settings {
    ...
    private static List<String> mUseUserOwnerList;
    ...
    public static final class Global extends NameValueTable {
        ...
        public static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            ...
            } else if (DoubleAppSwitcher.sEnabled && UserHandle.myUserId() != 0 && Settings.useUserOwner(name) && UserManager.get(ActivityThread.currentApplication()).getDoubleAppUserId() == UserHandle.myUserId()) {
                return sNameValueCache.getStringForUser(resolver, name, 0);
            } else {
    ...
    private static class NameValueCache {
        ...
        public boolean putStringForUser(ContentResolver cr, String name, String value, String tag, boolean makeDefault, int userHandle) {
            try {
                ...
                if (DoubleAppSwitcher.sEnabled && UserHandle.myUserId() != 0 && Settings.useUserOwner(name) && UserManager.get(ActivityThread.currentApplication()).getDoubleAppUserId() == UserHandle.myUserId()) {
                    arg.putInt(Settings.CALL_METHOD_USER_KEY, 0);
                }
     ...
     */
        ...
        /* renamed from: lambda$-android_provider_Settings$NameValueCache_72768 */
        /* synthetic */ void m0lambda$-android_provider_Settings$NameValueCache_72768() {
            synchronized (this) {
    ...
    public static final class Secure extends NameValueTable {
        ...
        @Deprecated
        public static final String WIFI_ON = "wifi_on";
        public static final String WIFI_SOFTAP_ACS_ENABLED = "wifi_softap_acs_enabled";
        @Deprecated
        ...
        public static final boolean setLocationProviderEnabledForUser(ContentResolver cr, String provider, boolean enabled, int userId) {
            synchronized (Settings.mLocationSettingsLock) {
                if ("gps".equals(provider)) {
                    int gps_rectriction = getInt(cr, com.vivo.provider.VivoSettings.Secure.CT_PERIPHERAL_LOCATION_GPS, 1);
                    if (enabled && gps_rectriction == 0) {
                        return false;
                    } else if (!enabled && gps_rectriction == 2) {
                        return false;
                    }
                }
                if ("network".equals(provider)) {
                    int network_rectriction = getInt(cr, com.vivo.provider.VivoSettings.Secure.CT_PERIPHERAL_LOCATION_NETWORK, 1);
                    if (enabled && network_rectriction == 0) {
                        return false;
                    } else if (!enabled && network_rectriction == 2) {
                        return false;
                    }
                }
                if (enabled) {
                ...
                boolean putStringForUser = putStringForUser(cr, "location_providers_allowed", provider, userId);
    ...
    public static final class System extends NameValueTable {
        ...
        @Deprecated
        public static final String BLUETOOTH_ON = "bluetooth_on";
        public static final String CALENDER = "calendar_sound";
        public static final String CALENDER_CACHE = "calendar_sound_cache";
        public static final Uri CALENDER_CACHE_URI = getUriFor(CALENDER_CACHE);
        private static final Validator CALENDER_VALIDATOR = sUriValidator;
        @Deprecated
        public static final String CAR_DOCK_SOUND = "car_dock_sound";
        @Deprecated
        public static final String CAR_UNDOCK_SOUND = "car_undock_sound";
        ...
        public static final Uri DEFAULT_CALENDER_URI = getUriFor(CALENDER);
        private static final float DEFAULT_FONT_SCALE = 1.0f;
        public static final Uri DEFAULT_MESSAGE_SIM2_URI = getUriFor("message_sound_sim2");
        public static final Uri DEFAULT_MESSAGE_URI = getUriFor("message_sound");
        ...
        public static final String MESSAGE = "message_sound";
        public static final String MESSAGE_CACHE = "message_sound_cache";
        public static final Uri MESSAGE_CACHE_URI = getUriFor(MESSAGE_CACHE);
        public static final String MESSAGE_SIM2 = "message_sound_sim2";
        public static final String MESSAGE_SIM2_CACHE = "message_sound_sim2_cache";
        public static final Uri MESSAGE_SIM2_CACHE_URI = getUriFor(MESSAGE_SIM2_CACHE);
        private static final Validator MESSAGE_SIM2_VALIDATOR = sUriValidator;
        private static final Validator MESSAGE_VALIDATOR = sUriValidator;
        @Deprecated
        public static final String MODE_RINGER = "mode_ringer";
        ...
        private static final Validator RINGTONE_SIM2_VALIDATOR = sUriValidator;
        ...
        @Deprecated
        public static final String STAY_ON_WHILE_PLUGGED_IN = "stay_on_while_plugged_in";
        public static final String STREAM_ASSISTANT = "volume_assistant";
        ...
        public static final String[] VOLUME_SETTINGS = new String[]{VOLUME_VOICE, VOLUME_SYSTEM, VOLUME_RING, VOLUME_MUSIC, VOLUME_ALARM, VOLUME_NOTIFICATION, VOLUME_BLUETOOTH_SCO, STREAM_ASSISTANT};
        public static final String[] VOLUME_SETTINGS_INT = new String[]{VOLUME_VOICE, VOLUME_SYSTEM, VOLUME_RING, VOLUME_MUSIC, VOLUME_ALARM, VOLUME_NOTIFICATION, VOLUME_BLUETOOTH_SCO, "", "", "", VOLUME_ACCESSIBILITY, STREAM_ASSISTANT};
        ...
        static {
            ...
            VivoSettings.addVivoPublicSettings((ArraySet) PUBLIC_SETTINGS);
    ...
    private static boolean useUserOwner(String key) {
        if (key == null) {
            return false;
        }
        boolean result = false;
        if (mUseUserOwnerList == null || mUseUserOwnerList.isEmpty()) {
            try {
                mUseUserOwnerList = ActivityManagerNative.getDefault().getDoubleInstanceConfig(10);
            } catch (RemoteException e) {
                Log.e(TAG, "get mUseUserOwnerList exception:" + e);
            }
        }
        if (mUseUserOwnerList != null) {
            for (String str : mUseUserOwnerList) {
                if (key.equals(str)) {
                    result = true;
                    break;
                }
        ...
        Log.d(TAG, "mUseUserOwnerList is null");
        return result;
    }
}

...
final /* synthetic */ class -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg implements Runnable {
    ...
    private final /* synthetic */ void $m$0() {
        ((FontRequestCallback) this.f18-$f0).onTypefaceRequestFailed(-1);
    }

    private final /* synthetic */ void $m$1() {
        ((FontRequestCallback) this.f18-$f0).onTypefaceRequestFailed(-2);
    }

    private final /* synthetic */ void $m$2() {
        ((FontRequestCallback) this.f18-$f0).onTypefaceRequestFailed(-3);
    }
    ...
    private final /* synthetic */ void $m$7() {
        ((NameValueCache) this.f18-$f0).m0lambda$-android_provider_Settings$NameValueCache_72768();
    }

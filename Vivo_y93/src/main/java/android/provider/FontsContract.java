...
public class FontsContract {
    ...
    static /* synthetic */ void m5lambda$-android_provider_FontsContract_13824(FontRequest request, String id, AtomicReference holder, Lock lock, AtomicBoolean timeout, AtomicBoolean waiting, Condition cond) {
        try {
    ...
    static /* synthetic */ void m6lambda$-android_provider_FontsContract_20965(Context context, CancellationSignal cancellationSignal, FontRequest request, Handler callerThreadHandler, FontRequestCallback callback) {
        int i = 0;
        try {
    ...
    static /* synthetic */ int m7lambda$-android_provider_FontsContract_31229(byte[] l, byte[] r) {

...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_AI = 308;
    ...
    public static final int KEYCODE_BAR_SWIPE = 301;
    ...
    public static final int KEYCODE_CUSTOM_GESTURE = 303;
    ...
    public static final int KEYCODE_FINGERPRINT_KEY = 305;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int KEYCODE_FINGERPRINT_SCREENSHOT = 306;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int KEYCODE_FINGERPRINT_WAKE = 304;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int KEYCODE_FINGERPRINT_WAKE_DFP = 309;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int KEYCODE_SYSTEM_NAVIGATION_CLICK = 307;
    ...
    public static final int KEYCODE_TS_LARGE_SUPPRESSION = 300;
    ...
    public static final int KEYCODE_WAKEUP_SWIPE = 302;
    ...
    private static final int LAST_KEYCODE = 309;
    @Deprecated

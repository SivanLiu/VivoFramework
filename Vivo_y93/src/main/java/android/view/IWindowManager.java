...
public interface IWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowManager {
        ...
        static final int TRANSACTION_applyNavColorForWindow = 94;
        ...
        static final int TRANSACTION_fetchSystemSetting = 96;
        static final int TRANSACTION_forceHideNavBar = 89;
        ...
        static final int TRANSACTION_getCurFocusWindowVisibleFrame = 105;
        ...
        static final int TRANSACTION_hideKeyguard = 97;
        static final int TRANSACTION_inKeyguardRestrictedInputMode = 41;
        static final int TRANSACTION_inputMethodClientHasFocus = 5;
        static final int TRANSACTION_isAspectRestricted = 95;
        static final int TRANSACTION_isFreeFormStackMax = 103;
        static final int TRANSACTION_isInDirectFreeformState = 104;
        static final int TRANSACTION_isInFreeForm = 102;
        static final int TRANSACTION_isInMultiWindow = 101;
        static final int TRANSACTION_isKeyguardLocked = 39;
        static final int TRANSACTION_isKeyguardSecure = 40;
        static final int TRANSACTION_isMultiWindowMinimized = 100;
        static final int TRANSACTION_isNavigationbarVisible = 106;
        ...
        static final int TRANSACTION_monitorInput = 91;
        ...
        static final int TRANSACTION_overridePendingAppTransitionThumbFromLauncher = 92;
        ...
        static final int TRANSACTION_sendFingerprintResult = 98;
        ...
        static final int TRANSACTION_setDockedStackResizing = 78;
        ...
        static final int TRANSACTION_statusBarVisibilityChanged = 68;
        ...
        private static class Proxy implements IWindowManager {
            ...
            public void forceHideNavBar(IBinder token, boolean hide) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void overridePendingAppTransitionThumbFromLauncher(GraphicBuffer srcThumb, int startX, int startY, boolean scaleUp, boolean animateExit, IRemoteCallback animateCallback) throws RemoteException {
                IBinder iBinder = null;
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    ...
                    if (animateCallback != null) {
                        iBinder = animateCallback.asBinder();
                    }
                    _data.writeStrongBinder(iBinder);
            ...
            public String getNavigationBarPolicy(IWindow window) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void applyNavColorForWindow(IWindow window, int color) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean isAspectRestricted(IWindow window) throws RemoteException {
                IBinder iBinder = null;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public String fetchSystemSetting(String keyword) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void hideKeyguard(int flag) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getFocusStackSide() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isMultiWindowMinimized() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isInMultiWindow() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isInFreeForm() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isFreeFormStackMax() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean isInDirectFreeformState() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public Rect getCurFocusWindowVisibleFrame() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    Rect _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 32:
                    ...
                    Configuration _result6 = updateOrientationFromAppTokens(_arg03, data.readStrongBinder(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 33:
                    ...
                    int[] _result7 = setNewDisplayOverrideConfiguration(_arg03, data.readInt());
                    reply.writeNoException();
                ...
                case 89:
                    data.enforceInterface(DESCRIPTOR);
                    forceHideNavBar(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    setInputFilter(android.view.IInputFilter.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 91:
                    data.enforceInterface(DESCRIPTOR);
                    InputChannel _result12 = monitorInput(data.readString());
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 92:
                    ...
                    overridePendingAppTransitionThumbFromLauncher(_arg02, data.readInt(), data.readInt(), data.readInt() != 0, data.readInt() != 0, android.os.IRemoteCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 93:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getNavigationBarPolicy(android.view.IWindow.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    applyNavColorForWindow(android.view.IWindow.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case 95:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isAspectRestricted(android.view.IWindow.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 96:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = fetchSystemSetting(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case 97:
                    data.enforceInterface(DESCRIPTOR);
                    hideKeyguard(data.readInt());
                    reply.writeNoException();
                    return true;
                case 98:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 99:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getFocusStackSide();
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 100:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isMultiWindowMinimized();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 101:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isInMultiWindow();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 102:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isInFreeForm();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 103:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isFreeFormStackMax();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 104:
                    data.enforceInterface(DESCRIPTOR);
                    _result = isInDirectFreeformState();
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 105:
                    data.enforceInterface(DESCRIPTOR);
                    Rect _result13 = getCurFocusWindowVisibleFrame();
                    reply.writeNoException();
                    if (_result13 != null) {
                        reply.writeInt(1);
    ...
    void applyNavColorForWindow(IWindow iWindow, int i) throws RemoteException;
    ...
    String fetchSystemSetting(String str) throws RemoteException;

    void forceHideNavBar(IBinder iBinder, boolean z) throws RemoteException;
    ...
    Rect getCurFocusWindowVisibleFrame() throws RemoteException;
    ...
    int getFocusStackSide() throws RemoteException;
    ...
    String getNavigationBarPolicy(IWindow iWindow) throws RemoteException;
    ...
    void hideKeyguard(int i) throws RemoteException;
    ...
    boolean isAspectRestricted(IWindow iWindow) throws RemoteException;

    boolean isFreeFormStackMax() throws RemoteException;

    boolean isInDirectFreeformState() throws RemoteException;

    boolean isInFreeForm() throws RemoteException;

    boolean isInMultiWindow() throws RemoteException;

    boolean isKeyguardLocked() throws RemoteException;

    boolean isKeyguardSecure() throws RemoteException;

    boolean isMultiWindowMinimized() throws RemoteException;
    ...
    void overridePendingAppTransitionThumbFromLauncher(GraphicBuffer graphicBuffer, int i, int i2, boolean z, boolean z2, IRemoteCallback iRemoteCallback) throws RemoteException;

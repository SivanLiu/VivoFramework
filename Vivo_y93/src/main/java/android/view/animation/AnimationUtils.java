...
public class AnimationUtils {
    ...
    public static Animation loadAnimation(Context context, int id, String packageName) {
        mTargetPackageName = packageName;
        Animation anim = loadAnimation(context, id);
        ...
        while (true) {
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    } else if (name.equals("translate_ref")) {
                        anim = new TranslateAnimationRefPos(c, attrs);
                    } else if (name.equals("translate_evade")) {
                        anim = new TranslateAnimationEvade(c, attrs, mTargetPackageName);
                    } else {
        ...
        while (true) {
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    String name = parser.getName();
                    if (name.equals("vivoAccelerateDecelerateInterpolator")) {
                        interpolator = new VivoAccelerateDecelerateInterpolator();
                    } else if (name.equals("linearInterpolator")) {

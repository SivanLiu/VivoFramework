...
public abstract class WindowManagerInternal {
    ...
    public abstract boolean isFreeFormStackMax();

    public abstract boolean isHardKeyboardAvailable();

    public abstract boolean isInDirectFreeformState();

    public abstract boolean isInFreeForm();

    public abstract boolean isKeyguardLocked();

    public abstract boolean isKeyguardShowingAndNotOccluded();

    public abstract boolean isMultiWindowValid();

    public abstract boolean isStackVisible(int i);

    public abstract boolean isVivoFreeFormValid();

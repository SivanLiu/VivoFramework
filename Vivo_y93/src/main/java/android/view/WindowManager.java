...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        public static final int HOME_INDICATOR_CHANGED = 134217728;
        public static final int HOME_INDICATOR_DIM_DARK = 2;
        public static final int HOME_INDICATOR_DIM_LIGHT = 3;
        public static final int HOME_INDICATOR_DISABLE = 5;
        ...
        public static final int PRIVATE_FLAG_DISABLE_HOMEKEY_LONGPRESS = 1073741824;
        ...
        public static final int PRIVATE_FLAG_FORCE_HIDE_BELOW = 268435456;
        public static final int PRIVATE_FLAG_FORCE_STATUS_BAR_VISIBLE_TRANSPARENT = 4096;
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int PRIVATE_FLAG_HIDE_NAVIGATION = 1048576;
        ...
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int PRIVATE_FLAG_HOMEKEY_DOUBLE_CLICK = Integer.MIN_VALUE;
        ...
        @VivoHook(hookType = VivoHookType.NEW_FIELD)
        public static final int PRIVATE_FLAG_NOTIFY_SYSTEMUI = 4194304;
        ...
        public static final int TYPE_HOME_INDICATOR = 2998;
        ...
        public static final int TYPE_RATIO_CHANGE = 2999;
        ...
        public float alpha;
        public int bottomCoverColor;
        public int bottomCoverEnable;
        ...
        public int homeIndicatorState;
        public float horizontalMargin;
        @ExportedProperty
        public float horizontalWeight;
        public int inputFeatures;
        public int internalFlag;
        public int keepFullScreen;
        ...
        public int topCoverColor;
        public int topCoverEnable;
        public int traditonToast;
        ...
        public LayoutParams() {
            ...
            this.statusbarVisible = 1;
            this.statusbarIconColor = -1;
            this.traditonToast = 0;
            this.homeIndicatorState = -1;
            this.topCoverColor = 0;
            this.bottomCoverColor = 0;
            this.topCoverEnable = 0;
            this.bottomCoverEnable = 0;
            this.keepFullScreen = 0;
            this.internalFlag = 0;
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(this.statusbarVisible);
            out.writeInt(this.statusbarIconColor);
            out.writeInt(this.traditonToast);
            out.writeInt(this.homeIndicatorState);
            out.writeInt(this.topCoverColor);
            out.writeInt(this.bottomCoverColor);
            out.writeInt(this.topCoverEnable);
            out.writeInt(this.bottomCoverEnable);
            out.writeInt(this.keepFullScreen);
            out.writeInt(this.internalFlag);
        }
        ...
        public LayoutParams(Parcel in) {
            ...
            this.statusbarVisible = in.readInt();
            this.statusbarIconColor = in.readInt();
            this.traditonToast = in.readInt();
            this.homeIndicatorState = in.readInt();
            this.topCoverColor = in.readInt();
            this.bottomCoverColor = in.readInt();
            this.topCoverEnable = in.readInt();
            this.bottomCoverEnable = in.readInt();
            this.keepFullScreen = in.readInt();
            this.internalFlag = in.readInt();
        }
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            if (this.statusbarVisible != o.statusbarVisible) {
                this.statusbarVisible = o.statusbarVisible;
            }
            if (this.statusbarIconColor != o.statusbarIconColor) {
                this.statusbarIconColor = o.statusbarIconColor;
            }
            if (this.traditonToast != o.traditonToast) {
                this.traditonToast = o.traditonToast;
            }
            if (this.homeIndicatorState != o.homeIndicatorState) {
                this.homeIndicatorState = o.homeIndicatorState;
                changes |= 134217728;
            }
            if (this.topCoverColor != o.topCoverColor) {
                this.topCoverColor = o.topCoverColor;
            }
            if (this.bottomCoverColor != o.bottomCoverColor) {
                this.bottomCoverColor = o.bottomCoverColor;
            }
            if (this.topCoverEnable != o.topCoverEnable) {
                this.topCoverEnable = o.topCoverEnable;
            }
            if (this.bottomCoverEnable != o.bottomCoverEnable) {
                this.bottomCoverEnable = o.bottomCoverEnable;
            }
            if (this.keepFullScreen != o.keepFullScreen) {
                this.keepFullScreen = o.keepFullScreen;
            }
            if (this.internalFlag != o.internalFlag) {
                this.internalFlag = o.internalFlag;
            }
            return changes;
        }
        ...
        public String toString() {
            ...
            sb.append(" homeIndicatorState=").append(this.homeIndicatorState);
            sb.append(" keepFullScreen=").append(this.keepFullScreen);
            sb.append(" internalFlag=0x");
            sb.append(Integer.toHexString(this.internalFlag));
            sb.append('}');
            return sb.toString();
        }

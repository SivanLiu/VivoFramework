...
public class FocusFinder {
    ...
    static final class FocusSorter {
        ...
        /* synthetic */ int m21lambda$-android_view_FocusFinder$FocusSorter_31343(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        /* synthetic */ int m22lambda$-android_view_FocusFinder$FocusSorter_31803(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = (Rect) this.mRectByView.get(first);
    ...
    static /* synthetic */ View m19lambda$-android_view_FocusFinder_1877(View r, View v) {
    ...
    static /* synthetic */ View m20lambda$-android_view_FocusFinder_2135(View r, View v) {

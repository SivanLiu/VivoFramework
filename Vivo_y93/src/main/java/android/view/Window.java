...
public abstract class Window {
    ...
    public interface WindowControllerCallback {
        ...
        void enterResizeMode(boolean z) throws RemoteException;
        ...
        void miniMizeWindowFreeformMode(boolean z) throws RemoteException;
    }
    ...
    public boolean shouldCloseOnTouch4Vivo(Context context, MotionEvent event) {
        boolean isOutside;
        if (VivoThemeUtil.isVigourTheme(context)) {
            isOutside = (event.getAction() == 1 && isOutOfBounds(context, event)) ? true : event.getAction() == 4;
            return this.mCloseOnTouchOutside && peekDecorView() != null && isOutside;
        } else {
            isOutside = (event.getAction() == 0 && isOutOfBounds(context, event)) ? true : event.getAction() == 4;
            return this.mCloseOnTouchOutside && peekDecorView() != null && isOutside;
        }
    }
    ...
    public void setAlienScreenCoverColor(int upColor, int bottomColor) {
    }
}

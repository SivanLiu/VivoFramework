...
public class Surface implements Parcelable {
    ...
    private boolean mHasSubSurface = false;
    ...
    public void copyFrom(SurfaceControl other) {
        ...
        if (other instanceof SurfaceControlWithSubSurface) {
            SurfaceControl subSurfaceControl = ((SurfaceControlWithSubSurface) other).getSubSurface();
            if (subSurfaceControl != null) {
                if (this.mSubSurface == null) {
                    this.mSubSurface = new Surface();
                    this.mSubSurface.setHasSubSurface(true);
                } else {
                    this.mSubSurface.release();
                }
                this.mSubSurface.copyFrom(subSurfaceControl);
            }
        }
    }
    ...
    public void readFromParcel(Parcel source) {
        ...
        if (this.mHasSubSurface && source.readInt() != 0) {
            if (this.mSubSurface == null) {
                this.mSubSurface = new Surface();
                this.mSubSurface.setHasSubSurface(true);
            } else {
            ...
            this.mSubSurface.readFromParcel(source);
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (this.mHasSubSurface) {
            if (this.mSubSurface != null) {
                dest.writeInt(1);
                this.mSubSurface.writeToParcel(dest, flags);
            } else {
                dest.writeInt(0);
            }
        }
    ...
    public void setHasSubSurface(boolean hasSubSurface) {
        this.mHasSubSurface = hasSubSurface;
    }

    public Object getSurfaceSyncObj() {
        return this.mLock;
    }
}

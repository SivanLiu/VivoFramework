...
public class TelephonyManager {
    ...
    private static final /* synthetic */ int[] f29x22a12f3f = null;
    ...
    private static /* synthetic */ int[] m24xa4bc86e3() {
        if (f29x22a12f3f != null) {
            return f29x22a12f3f;
        }
    ...
    private String getOpPackageNameOrThrow() {
        String packageName = getOpPackageName();
        if (packageName != null) {
            return packageName;
        }
    ...
    public int getPhoneCount() {
        switch (m24xa4bc86e3()[getMultiSimConfiguration().ordinal()]) {
            case 1:
            case 2:
                return 2;
            case 3:
    ...
    public String getDeviceSoftwareVersion(int slotIndex) {
        ...
        try {
            return telephony.getDeviceSoftwareVersionForSlot(slotIndex, getOpPackageNameOrThrow());
    ...
    public String getDeviceId() {
        try {
            ...
            return telephony.getDeviceId(getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getDeviceId(int slotIndex) {
        Rlog.d(TAG, "getDeviceId() slotId=" + slotIndex);
        int[] subId = SubscriptionManager.getSubId(slotIndex);
        if (subId != null && subId.length != 0 && getCurrentPhoneType(subId[0]) == 1) {
            return getImei(slotIndex);
        }
        if (getPhoneCount() > 1 && "1".equals(SystemProperties.get("persist.radio.msim.stackid_0", ""))) {
        ...
        try {
            ...
            return info.getDeviceIdForPhone(slotIndex, getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getImei(int slotIndex) {
        ...
        Rlog.d(TAG, "getImei() slotId=" + slotIndex);
        if (getPhoneCount() > 1 && "1".equals(SystemProperties.get("persist.vendor.radio.msim.stackid_0", ""))) {
            slotIndex = slotIndex == 0 ? 1 : 0;
        }
        try {
            return telephony.getImeiForSlot(slotIndex, getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getNai(int slotIndex) {
        ...
        try {
            ...
            String nai = info.getNaiForSubscriber(subId[0], getOpPackageNameOrThrow());
    ...
    public CellLocation getCellLocation() {
        ...
        try {
            ...
            Bundle bundle = telephony.getCellLocation(getOpPackageNameOrThrow());
            if (bundle.isEmpty()) {
                Rlog.d(TAG, "getCellLocation returning null because bundle is empty");
                return null;
            }
            switch (getCurrentPhoneType(SubscriptionManager.getDefaultDataSubscriptionId())) {
                case 1:
    ...
    public CellLocation getCellLocation(int slotId) {
        ...
        try {
            ...
            Bundle data = null;
            if (iTelephony != null) {
                VivoTelephonyApiParams param = new VivoTelephonyApiParams("API_TAG_getCellLocation");
                param.put(PhoneConstants.SLOT_KEY, Integer.valueOf(slotId));
                VivoTelephonyApiParams ret = iTelephony.vivoTelephonyApi(param);
                if (ret != null) {
                    data = (Bundle) ret.getAsObject("cellLocation");
                    if (data.isEmpty()) {
                        return null;
                    }
                }
                switch (getDefault().getCurrentPhoneType(SubscriptionManager.getSubId(slotId)[0])) {
                    case 1:
                        cellLocation = new GsmCellLocation(data);
                        break;
                    case 2:
                        cellLocation = new CdmaCellLocation(data);
                        break;
                    default:
                        cellLocation = null;
                        break;
    ...
    public List<NeighboringCellInfo> getNeighboringCellInfo() {
        ...
        try {
            ...
            return telephony.getNeighboringCellInfo(getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getNetworkOperatorName() {
        try {
            return getNetworkOperatorName(getDefaultDataSubscriptionId());
        } catch (Exception e) {
    ...
    public String getNetworkOperator() {
        try {
            return getNetworkOperatorForPhone(SubscriptionManager.getPhoneId(getDefaultDataSubscriptionId()));
        } catch (Exception e) {
            Rlog.d(TAG, e.toString());
            return getNetworkOperatorForPhone(getDefaultDataSubscriptionId());
        }
    }
    ...
    public String getNetworkCountryIso() {
        try {
            return getNetworkCountryIsoForPhone(SubscriptionManager.getPhoneId(getDefaultDataSubscriptionId()));
        } catch (Exception e) {
            Rlog.d(TAG, e.toString());
            return getNetworkCountryIsoForPhone(getDefaultDataSubscriptionId());
        }
    }
    ...
    public String getSimSerialNumber(int subId) {
        ...
        try {
            ...
            return info.getIccSerialNumberForSubscriber(subId, getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getSubscriberId(int subId) {
        ...
        try {
            ...
            return info.getSubscriberIdForSubscriber(subId, getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getGroupIdLevel1() {
        try {
            ...
            return info.getGroupIdLevel1(getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getGroupIdLevel1(int subId) {
        try {
            ...
            return info.getGroupIdLevel1ForSubscriber(subId, getOpPackageNameOrThrow());
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
            return null;
    ...
    public String getLine1Number(int subId) {
        ...
        try {
            ITelephony telephony = getITelephony();
            if (telephony != null) {
                number = telephony.getLine1NumberForDisplay(subId, getOpPackageNameOrThrow());
            }
        } catch (RemoteException e) {
        } catch (NullPointerException e2) {
        }
        ...
        try {
            ...
            return info.getLine1NumberForSubscriber(subId, getOpPackageNameOrThrow());
    ...
    public static void setTelephonyProperty(int phoneId, String property, String value) {
        ...
        if (SubscriptionManager.isValidPhoneId(phoneId)) {
            ...
            if (TextUtils.equals(SystemProperties.get(property, ""), propVal) ^ 1) {
                try {
    ...
    public void setBasebandVersionForPhone(int phoneId, String version) {
        if (SubscriptionManager.isValidPhoneId(phoneId)) {
            ...
            if (TextUtils.equals(SystemProperties.get(prop, ""), version) ^ 1) {
                try {

...
public class SntpClient {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x014a  */
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0154  */
    ...
    public boolean requestTime(InetAddress address, int port, int timeout) {
        ...
        try {
            ...
            try {
                ...
                long clockOffset = (((receiveTime - originateTime) + (transmitTime - responseTime)) / 2) - OFFSET_1900_TO_1970;
    ...
    private long readTimeStamp(byte[] buffer, int offset) {
        ...
        return (seconds * 1000) + ((fraction * 1000) / 4294967296L);
    }

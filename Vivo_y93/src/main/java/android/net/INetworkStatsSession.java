...
public interface INetworkStatsSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkStatsSession {
        ...
        static final int TRANSACTION_getHistoryForPack = 10;
        ...
        static final int TRANSACTION_getSummaryForAllPack = 9;
        ...
        private static class Proxy implements INetworkStatsSession {
            ...
            public NetworkStats getSummaryForAllPack(NetworkTemplate template, long start, long end, boolean includeTags) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public NetworkStatsHistory getHistoryForPack(NetworkTemplate template, String packInfo, int uid, int set, int tag, int fields) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    NetworkStatsHistory _result;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    _result = getSummaryForAllPack(_arg0, data.readLong(), data.readLong(), data.readInt() != 0);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 10:
                    ...
                    _result2 = getHistoryForPack(_arg0, data.readString(), data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
    ...
    NetworkStatsHistory getHistoryForPack(NetworkTemplate networkTemplate, String str, int i, int i2, int i3, int i4) throws RemoteException;
    ...
    NetworkStats getSummaryForAllPack(NetworkTemplate networkTemplate, long j, long j2, boolean z) throws RemoteException;

...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        ...
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909378)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909380)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909382)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909254)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16908764)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16908766)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16908768)).setText(issuedBy.getUName());
        }
        ((TextView) certificateView.findViewById(16908984)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16908853)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909261)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909259)).setText(getDigest(this.mX509Certificate, "SHA1"));

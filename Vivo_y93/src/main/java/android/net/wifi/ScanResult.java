...
public class ScanResult implements Parcelable {
    ...
    public static final Creator<ScanResult> CREATOR = new Creator<ScanResult>() {
        public ScanResult createFromParcel(Parcel in) {
            ...
            n = in.readInt();
            if (n != 0) {
                sr.ouiInformations = new ArrayList();
                for (i = 0; i < n; i++) {
                    sr.ouiInformations.add(in.readString());
                }
            }
            return sr;
        }
    ...
    public List<String> ouiInformations;
    public long seen;
    ...
    public ScanResult(ScanResult source) {
        if (source != null) {
            ...
            this.ouiInformations = source.ouiInformations;
        }
    }
    ...
    public String toString() {
        ...
        append.append(str).append(", level: ").append(this.level).append(", frequency: ").append(this.frequency).append(", timestamp: ").append(this.timestamp);
        ...
        StringBuffer append2 = sb.append(", Oui information: ");
        if (this.ouiInformations != null) {
            none = this.ouiInformations.toString();
        }
        append2.append(none);
        return sb.toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (this.ouiInformations != null) {
            dest.writeInt(this.ouiInformations.size());
            for (i = 0; i < this.ouiInformations.size(); i++) {
                dest.writeString((String) this.ouiInformations.get(i));
            }
            return;
        }
        dest.writeInt(0);

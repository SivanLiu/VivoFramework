...
public class WifiManager {
    ...
    public static final int ADD_NETWORK = 151575;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final boolean AUTH_LOOP_OUT = true;
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String EXTRA_ENABLE = "app_enable";
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String EXTRA_KEY_ERROR_TIMES = "key_error_times";
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String EXTRA_SUPPLICANT_CURREN_INFO_NET_ID = "current_supplicant_info_netid";
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String EXTRA_SUPPLICANT_CURREN_INFO_SSID = "current_supplicant_info_ssid";
    public static final String EXTRA_SUPPLICANT_ERROR = "supplicantError";
    public static final String EXTRA_SUPPLICANT_ERROR_REASON = "supplicantErrorReason";
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String EXTRA_SUPPLICANT_KEY_LOOP_ERROR = "wifi_auth_loop";
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    public static final String WIFI_OPEN_NOTIFICATION = "android.net.wifi.WIFI_OPEN_NOFIFY";
    ...
    private static int mWpsNetworkId;
    ...
    public interface ActionListenerProxy {
        void onFailure(int i);
        ...
        private void dispatchMessageToListeners(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiManager.WPS_COMPLETED /*151565*/:
                    if (listener != null) {
                        WifiManager.mWpsNetworkId = message.arg1;
    ...
    public int getWifiState() {
        try {
            if (this.mContext != null) {
                return this.mService.getVivoWifiEnabledState(this.mContext.getOpPackageName());
            }
    ...
    public boolean setAutoLoginVariable(int netId, int value) {
        try {
            return this.mService.setAutoLoginVariable(netId, value);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public int getAutoLoginVariable(int netId) {
        try {
            return this.mService.getAutoLoginVariable(netId);
        } catch (RemoteException e) {
            return -1;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public List<HotspotClient> getBlockedClients() {
        try {
            return this.mService.getBlockedClients();
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    public String getClientName(String macAddress) {
        try {
            return this.mService.getClientName(macAddress);
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public WifiConfiguration getBakeupWifiApConfiguration() {
        try {
            return this.mService.getBakeupWifiApConfiguration();
        } catch (RemoteException e) {
            return null;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public void addNewNetwork(List<WifiConfiguration> configs, final ActionListenerProxy listener) {
        ...
        for (WifiConfiguration config : configs) {
            getChannel().sendMessage(ADD_NETWORK, 0, putListener(ls), config);
        }
        saveConfiguration();
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public int getWpsNetworkId() {
        return mWpsNetworkId;
    }

    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setFailedNotify(int id, boolean notify) {
        try {
            return this.mService.setFailedNotify(id, notify);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean startFastScan(String packageName) {
        try {
            return this.mService.startFastScan(packageName);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setVivoGameingMode(boolean enabled) {
        try {
            return this.mService.setVivoGameingMode(enabled);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setAntennaMode(int mode) {
        try {
            return this.mService.setAntennaMode(mode);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setKingGloryData(int delay, String ip) {
        try {
            return this.mService.setKingGloryData(delay, ip);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public String getWifiInfo() {
        try {
            return this.mService.getWifiInfo();
        } catch (RemoteException e) {
            return "";
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setGameState(int state, String packageName) {
        try {
            return this.mService.setGameState(state, packageName);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.PUBLIC_API_METHOD)
    public boolean setDnsSecureChannelEnable(boolean enable) {
        try {
            return this.mService.setDnsSecureChannelEnable(enable);
        } catch (RemoteException e) {
            return false;
        }
    }

    public void enableSla(boolean enable) {
    }

    public SlaConfigure getSlaConfig() {
        return null;
    }

    public boolean addSlaValidApps(int[] uids) {
        return false;
    }

    public boolean removeSlaValidApps(int[] uids) {
        return false;
    }

    public Map getSlaData(int type) {
        return null;
    }
}

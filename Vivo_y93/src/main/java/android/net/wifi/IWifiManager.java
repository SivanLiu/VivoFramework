...
public interface IWifiManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWifiManager {
        ...
        static final int TRANSACTION_getAutoLoginVariable = 74;
        static final int TRANSACTION_getBakeupWifiApConfiguration = 82;
        static final int TRANSACTION_getBlockedClients = 81;
        static final int TRANSACTION_getClientIp = 83;
        static final int TRANSACTION_getClientName = 80;
        ...
        static final int TRANSACTION_getHotspotClients = 77;
        ...
        static final int TRANSACTION_getVivoWifiEnabledState = 85;
        ...
        static final int TRANSACTION_getWifiInfo = 91;
        ...
        static final int TRANSACTION_setAntennaMode = 88;
        static final int TRANSACTION_setAutoLoginVariable = 73;
        static final int TRANSACTION_setCountryCode = 26;
        static final int TRANSACTION_setDnsSecureChannelEnable = 92;
        static final int TRANSACTION_setEnableAutoJoinWhenAssociated = 60;
        static final int TRANSACTION_setFailedNotify = 84;
        static final int TRANSACTION_setGameState = 90;
        static final int TRANSACTION_setKingGloryData = 89;
        static final int TRANSACTION_setVivoGameingMode = 87;
        ...
        static final int TRANSACTION_startFastScan = 86;
        ...
        static final int TRANSACTION_suspendNotification = 75;
        static final int TRANSACTION_syncGetConnectingNetworkId = 76;
        ...
        private static class Proxy implements IWifiManager {
            ...
            public boolean setAutoLoginVariable(int netId, int value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int getAutoLoginVariable(int netId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String getClientName(String macAddress) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public List<HotspotClient> getBlockedClients() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public WifiConfiguration getBakeupWifiApConfiguration() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    WifiConfiguration _result;
            ...
            public boolean setFailedNotify(int id, boolean notify) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public int getVivoWifiEnabledState(String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean startFastScan(String callingPackageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setVivoGameingMode(boolean enabled) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public boolean setAntennaMode(int mode) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setKingGloryData(int delay, String ip) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setGameState(int state, String packageName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public String getWifiInfo() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean setDnsSecureChannelEnable(boolean enable) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 73:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setAutoLoginVariable(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 74:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getAutoLoginVariable(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 75:
                ...
                case 80:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = getClientName(data.readString());
                    reply.writeNoException();
                    reply.writeString(_result5);
                    return true;
                case 81:
                    data.enforceInterface(DESCRIPTOR);
                    _result6 = getBlockedClients();
                    reply.writeNoException();
                    reply.writeTypedList(_result6);
                    return true;
                case 82:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getBakeupWifiApConfiguration();
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
                ...
                case 84:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setFailedNotify(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 85:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getVivoWifiEnabledState(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 86:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = startFastScan(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 87:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setVivoGameingMode(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 88:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setAntennaMode(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 89:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setKingGloryData(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 90:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setGameState(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
                case 91:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = getWifiInfo();
                    reply.writeNoException();
                    reply.writeString(_result5);
                    return true;
                case 92:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = setDnsSecureChannelEnable(data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result4 ? 1 : 0);
                    return true;
    ...
    int getAutoLoginVariable(int i) throws RemoteException;

    WifiConfiguration getBakeupWifiApConfiguration() throws RemoteException;

    List<HotspotClient> getBlockedClients() throws RemoteException;

    String getClientIp(String str) throws RemoteException;

    String getClientName(String str) throws RemoteException;
    ...
    int getVivoWifiEnabledState(String str) throws RemoteException;
    ...
    String getWifiInfo() throws RemoteException;
    ...
    boolean setAntennaMode(int i) throws RemoteException;

    boolean setAutoLoginVariable(int i, int i2) throws RemoteException;

    void setCountryCode(String str, boolean z) throws RemoteException;

    boolean setDnsSecureChannelEnable(boolean z) throws RemoteException;

    boolean setEnableAutoJoinWhenAssociated(boolean z) throws RemoteException;

    boolean setFailedNotify(int i, boolean z) throws RemoteException;

    boolean setGameState(int i, String str) throws RemoteException;

    boolean setKingGloryData(int i, String str) throws RemoteException;

    boolean setVivoGameingMode(boolean z) throws RemoteException;
    ...
    boolean startFastScan(String str) throws RemoteException;

...
public class WifiConfiguration implements Parcelable {
    ...
    public static final Creator<WifiConfiguration> CREATOR = new Creator<WifiConfiguration>() {
        public WifiConfiguration createFromParcel(Parcel in) {
            ...
            config.vivoWifiConfiguration = (VivoWifiConfiguration) in.readParcelable(null);
            return config;
        }
    ...
    public VivoWifiConfiguration vivoWifiConfiguration;
    @VivoHook(hookType = VivoHookType.PUBLIC_API_FIELD)
    ...
    public WifiConfiguration() {
        ...
        this.dtimInterval = 0;
        this.SIMNum = 0;
        this.vivoWifiConfiguration = new VivoWifiConfiguration();
    }
    ...
    public String toString() {
        ...
        sbuf.append(this.vivoWifiConfiguration.toString());
    ...
    public WifiConfiguration(WifiConfiguration source) {
        ...
        if (source != null) {
            ...
            this.vivoWifiConfiguration = new VivoWifiConfiguration(source.vivoWifiConfiguration);
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.vivoWifiConfiguration, flags);
    }

...
import org.apache.http.impl.client.AbstractHttpClient.HttpRequestCheckHandler;
...
public final class Proxy {
    ...
    private static class DefaultHttpRequestCheckHandler implements HttpRequestCheckHandler {
        ...
        public boolean checkRequest(HttpRequest request) {
            return VivoPermissionManager.checkCallingVivoPermission("android.permission.SEND_MMS");
        }
    }

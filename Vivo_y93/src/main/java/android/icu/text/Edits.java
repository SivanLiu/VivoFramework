...
public final class Edits {
    ...
    public static final class Iterator {
        ...
        static final /* synthetic */ boolean f7-assertionsDisabled = (Iterator.class.desiredAssertionStatus() ^ 1);
        ...
        private int readLength(int head) {
            ...
            if (head < 62) {
                if (!f7-assertionsDisabled && this.index >= this.length) {
                    throw new AssertionError();
                } else if (f7-assertionsDisabled || this.array[this.index] >= 32768) {
            ...
            } else if (!f7-assertionsDisabled && this.index + 2 > this.length) {
                throw new AssertionError();
            } else if (!f7-assertionsDisabled && this.array[this.index] < 32768) {
                throw new AssertionError();
            } else if (f7-assertionsDisabled || this.array[this.index + 1] >= 32768) {
        ...
        private boolean next(boolean onlyChanges) {
            ...
            if (this.remaining > 0) {
                ...
                } else if (f7-assertionsDisabled || u <= 32767) {

...
public abstract class Normalizer2 {
    ...
    private static final /* synthetic */ int[] f37-android-icu-text-Normalizer2$ModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m9-getandroid-icu-text-Normalizer2$ModeSwitchesValues() {
        if (f37-android-icu-text-Normalizer2$ModeSwitchesValues != null) {
            return f37-android-icu-text-Normalizer2$ModeSwitchesValues;
        }
        ...
        f37-android-icu-text-Normalizer2$ModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static Normalizer2 getInstance(InputStream data, String name, Mode mode) {
        ...
        switch (m9-getandroid-icu-text-Normalizer2$ModeSwitchesValues()[mode.ordinal()]) {
            case 1:

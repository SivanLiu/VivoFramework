...
public class RuleBasedBreakIterator extends BreakIterator {
    ...
    static final /* synthetic */ boolean f52-assertionsDisabled = (RuleBasedBreakIterator.class.desiredAssertionStatus() ^ 1);
    ...
    private static class LookAheadResults {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f53-assertionsDisabled = (LookAheadResults.class.desiredAssertionStatus() ^ 1);
        int[] fKeys = new int[8];
        ...
        void setPosition(int key, int position) {
            ...
            this.fKeys[i] = key;
            this.fPositions[i] = position;
            if (f53-assertionsDisabled || this.fUsedSlotLimit == i) {
        ...
        while (true) {
            ...
            if (current < rangeEnd && (category & 16384) == 0) {
                ...
                if (lbe != null) {
                    ...
                    if (!f52-assertionsDisabled && this.fText.getIndex() <= startingIdx) {
                        throw new AssertionError();
                    }
                }
                c = CharacterIteration.current32(this.fText);
                ...
                if (f52-assertionsDisabled || foundBreakCount == breaks.size()) {

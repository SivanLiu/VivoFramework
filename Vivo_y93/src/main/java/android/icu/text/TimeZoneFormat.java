...
public class TimeZoneFormat extends UFormat implements Freezable<TimeZoneFormat>, Serializable {
    ...
    private static final /* synthetic */ int[] f30-android-icu-text-TimeZoneFormat$StyleSwitchesValues = null;
    /* renamed from: -android-icu-text-TimeZoneNames$NameTypeSwitchesValues */
    private static final /* synthetic */ int[] f31-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f32-assertionsDisabled = (TimeZoneFormat.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m6-getandroid-icu-text-TimeZoneFormat$StyleSwitchesValues() {
        if (f30-android-icu-text-TimeZoneFormat$StyleSwitchesValues != null) {
            return f30-android-icu-text-TimeZoneFormat$StyleSwitchesValues;
        }
        ...
        f30-android-icu-text-TimeZoneFormat$StyleSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues */
    private static /* synthetic */ int[] m7-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
        if (f31-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
            return f31-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
        }
        ...
        f31-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public String format(Style style, TimeZone tz, long date, Output<TimeType> timeType) {
        ...
        switch (m6-getandroid-icu-text-TimeZoneFormat$StyleSwitchesValues()[style.ordinal()]) {
            case 1:
        ...
        if (f32-assertionsDisabled || result != null) {
            return result;
        }
        throw new AssertionError();
    }
    ...
    public TimeZone parse(Style style, String text, ParsePosition pos, EnumSet<ParseOption> options, Output<TimeType> timeType) {
        ...
        switch (m6-getandroid-icu-text-TimeZoneFormat$StyleSwitchesValues()[style.ordinal()]) {
            ...
            case 18:
                ...
                } else if (f32-assertionsDisabled || style == Style.SPECIFIC_SHORT) {
                ...
                if (parseTZDBAbbrev && style == Style.SPECIFIC_SHORT) {
                    if (!f32-assertionsDisabled && !nameTypes.contains(NameType.SHORT_STANDARD)) {
                        throw new AssertionError();
                    } else if (f32-assertionsDisabled || nameTypes.contains(NameType.SHORT_DAYLIGHT)) {
        ...
        if (parsedPos <= startIdx) {
            ...
            if (!f32-assertionsDisabled && parsedPos >= 0) {
                throw new AssertionError();
            } else if (f32-assertionsDisabled || parsedOffset == Integer.MAX_VALUE) {
                ...
                if (parsedPos < maxPos && ((evaluated & 128) == 0 || (evaluated & 256) == 0)) {
                    ...
                    if (parsePosition.getErrorIndex() == -1) {
                        ...
                        if (parsedPos < parsePosition.getIndex()) {
                            ...
                            parsedPos = parsePosition.getIndex();
                            if (!(f32-assertionsDisabled || parsedPos == startIdx + 1)) {
                                throw new AssertionError();
                            }
                        }
                    }
    ...
    public final TimeZone parse(String text) throws ParseException {
        ...
        } else if (f32-assertionsDisabled || tz != null) {
            return tz;
        } else {
            throw new AssertionError();
        }
    ...
    public StringBuffer format(Object obj, StringBuffer toAppendTo, FieldPosition pos) {
        ...
        if (f32-assertionsDisabled || tz != null) {
    ...
    private String formatOffsetISO8601(int offset, boolean isBasic, boolean useUtcIndicator, boolean isShort, boolean ignoreSeconds) {
        ...
        if (!f32-assertionsDisabled && (fields[0] < 0 || fields[0] > 23)) {
            throw new AssertionError();
        } else if (!f32-assertionsDisabled && (fields[1] < 0 || fields[1] > 59)) {
            throw new AssertionError();
        } else if (f32-assertionsDisabled || (fields[2] >= 0 && fields[2] <= 59)) {
            int idx;
    ...
    private String formatSpecific(TimeZone tz, NameType stdType, NameType dstType, long date, Output<TimeType> timeType) {
        if (!f32-assertionsDisabled && stdType != NameType.LONG_STANDARD && stdType != NameType.SHORT_STANDARD) {
            throw new AssertionError();
        } else if (f32-assertionsDisabled || dstType == NameType.LONG_DAYLIGHT || dstType == NameType.SHORT_DAYLIGHT) {
            String name;
    ...
    private String getTimeZoneID(String tzID, String mzID) {
        String id = tzID;
        if (tzID == null) {
            if (f32-assertionsDisabled || mzID != null) {
    ...
    private TimeType getTimeType(NameType nameType) {
        switch (m7-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[nameType.ordinal()]) {
            case 1:
            case 3:
    ...
    private void appendOffsetDigits(StringBuilder buf, int n, int minDigits) {
        if (f32-assertionsDisabled || (n >= 0 && n < 60)) {
    ...
    private int parseOffsetFields(String text, int start, boolean isShort, int[] parsedLen) {
        ...
        while (true) {
            ...
            if (f32-assertionsDisabled || items != null) {
    ...
    private int parseOffsetFieldsWithPattern(String text, int start, Object[] patternItems, boolean forceSingleHourDigit, int[] fields) {
        if (f32-assertionsDisabled || (fields != null && fields.length >= 3)) {
            fields[2] = 0;
            fields[1] = 0;
            fields[0] = 0;
            ...
            while (i < patternItems.length) {
                if (patternItems[i] instanceof String) {
                    ...
                    idx += len;
                } else if (f32-assertionsDisabled || (patternItems[i] instanceof GMTOffsetField)) {
    ...
    private int parseAbuttingOffsetFields(String text, int start, int[] parsedLen) {
        ...
        while (numDigits > 0) {
            ...
            int min = 0;
            int sec = 0;
            if (f32-assertionsDisabled || (numDigits > 0 && numDigits <= 6)) {
                switch (numDigits) {
                    case 1:
                        hour = digits[0];
                        break;

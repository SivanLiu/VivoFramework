...
public class SimpleDateFormat extends DateFormat {
    ...
    private static final /* synthetic */ int[] f48-android-icu-text-DisplayContextSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f49-assertionsDisabled = (SimpleDateFormat.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m15-getandroid-icu-text-DisplayContextSwitchesValues() {
        if (f48-android-icu-text-DisplayContextSwitchesValues != null) {
            return f48-android-icu-text-DisplayContextSwitchesValues;
        }
        ...
        f48-android-icu-text-DisplayContextSwitchesValues = iArr;
        return iArr;
    }
        ...
        if (patternCharIndex != -1) {
            ...
            switch (patternCharIndex) {
                ...
                case 36:
                    ...
                    if (f49-assertionsDisabled || periodType != null) {
                        int index;
                        toAppend = null;
            ...
            if (fieldNum == 0 && capitalizationContext != null && UCharacter.isLowerCase(buf.codePointAt(bufstart))) {
                ...
                switch (m15-getandroid-icu-text-DisplayContextSwitchesValues()[capitalizationContext.ordinal()]) {
                    case 1:
                        titlecase = true;
                        break;
                    case 2:
    ...
    public void parse(String text, Calendar cal, ParsePosition parsePos) {
        ...
        if (output.value != null) {
            ...
            if (cal.isSet(10) || (cal.isSet(11) ^ 1) == 0) {
                ...
                if (!f49-assertionsDisabled && (hourOfDay < 0 || hourOfDay > 23)) {
                    throw new AssertionError();

...
public class SpoofChecker {
    ...
    public static class Builder {
        ...
        private static class ConfusabledataBuilder {
            ...
            static final /* synthetic */ boolean f129-assertionsDisabled = (ConfusabledataBuilder.class.desiredAssertionStatus() ^ 1);
            ...
            void build(Reader confusables, SpoofData dest) throws ParseException, IOException {
                ...
                while (matcher.find()) {
                    ...
                    if (matcher.start(7) < 0) {
                        ...
                        if (f129-assertionsDisabled || mapString.length() >= 1) {
                ...
                for (String keyCharStr : this.fKeySet) {
                    ...
                    if (!f129-assertionsDisabled && targetMapping == null) {
                        throw new AssertionError();
                ...
                while (i < numKeys) {
                    ...
                    if (f129-assertionsDisabled || codePoint > previousCodePoint) {
                        dest.fCFUKeys[i] = key;
                ...
                if (f129-assertionsDisabled || numKeys == numValues) {
                    dest.fCFUValues = new short[numValues];
                    i = 0;
                    for (Integer intValue : this.fValueVec) {
                        value = intValue.intValue();
                        if (f129-assertionsDisabled || value < 65535) {
                            int i2 = i + 1;
    ...
    private static final class ConfusableDataUtils {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f130-assertionsDisabled = (ConfusableDataUtils.class.desiredAssertionStatus() ^ 1);
        ...
        public static final int codePointAndLengthToKey(int codePoint, int length) {
            if (!f130-assertionsDisabled && (16777215 & codePoint) != codePoint) {
                throw new AssertionError();
            } else if (f130-assertionsDisabled || length <= 256) {

...
public final class CollationElementIterator {
    ...
    static final /* synthetic */ boolean f108-assertionsDisabled = (CollationElementIterator.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class MaxExpSink implements CESink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f109-assertionsDisabled = (MaxExpSink.class.desiredAssertionStatus() ^ 1);
        ...
        public void handleExpansion(long[] ces, int start, int length) {
            if (length > 1) {
                ...
                if (lastHalf == 0) {
                    ...
                    if (!f109-assertionsDisabled && lastHalf == 0) {
    ...
    public int getOffset() {
        ...
        if (f108-assertionsDisabled || i < this.offsets_.size()) {

...
public class UnicodeSet extends UnicodeFilter implements Iterable<String>, Comparable<UnicodeSet>, Freezable<UnicodeSet> {
    ...
    static final /* synthetic */ boolean f4-assertionsDisabled = (UnicodeSet.class.desiredAssertionStatus() ^ 1);
    ...
    private static void appendCodePoint(Appendable app, int c) {
        if (!f4-assertionsDisabled && (c < 0 || c > 1114111)) {
...
*/
    ...
    public UnicodeSet cloneAsThawed() {
        UnicodeSet result = new UnicodeSet(this);
        if (f4-assertionsDisabled || !result.isFrozen()) {
            return result;
        }
        throw new AssertionError();
    }

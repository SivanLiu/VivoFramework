...
public final class MessagePatternUtil {
    ...
    private static final /* synthetic */ int[] f123-android-icu-text-MessagePattern$ArgTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m30-getandroid-icu-text-MessagePattern$ArgTypeSwitchesValues() {
        if (f123-android-icu-text-MessagePattern$ArgTypeSwitchesValues != null) {
            return f123-android-icu-text-MessagePattern$ArgTypeSwitchesValues;
        }
        ...
        f123-android-icu-text-MessagePattern$ArgTypeSwitchesValues = iArr;
        return iArr;
    }

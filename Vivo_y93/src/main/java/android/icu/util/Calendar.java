...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    private static final /* synthetic */ int[] f50-android-icu-util-Calendar$CalTypeSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f51-assertionsDisabled = (Calendar.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m16-getandroid-icu-util-Calendar$CalTypeSwitchesValues() {
        if (f50-android-icu-util-Calendar$CalTypeSwitchesValues != null) {
            return f50-android-icu-util-Calendar$CalTypeSwitchesValues;
        }
        ...
        f50-android-icu-util-Calendar$CalTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private static Calendar createInstance(ULocale locale) {
        ...
        Calendar cal;
        switch (m16-getandroid-icu-util-Calendar$CalTypeSwitchesValues()[calType.ordinal()]) {
            case 1:
    ...
    public final int getRelatedYear() {
        ...
        switch (m16-getandroid-icu-util-Calendar$CalTypeSwitchesValues()[type.ordinal()]) {
            case 2:
                return year - 2637;
            case 3:
                return year + 284;
    ...
    protected void computeTime() {
        ...
        if (this.stamp[15] >= 2 || this.stamp[16] >= 2) {
            ...
            } else if (f51-assertionsDisabled || this.skippedWallTime == 2) {
    ...
    private static Long getPreviousZoneTransitionTime(TimeZone tz, long base, long duration) {
        if (f51-assertionsDisabled || duration > 0) {
            long upper = base;
    ...
    protected int computeZoneOffset(long millis, int millisInDay) {
        ...
        if (this.zone instanceof BasicTimeZone) {
            ...
            if (this.repeatedWallTime == 1) {
                ...
                if (!f51-assertionsDisabled && offsetDelta <= -21600000) {

...
public final class CharsTrie implements Cloneable, Iterable<Entry> {
    ...
    static final /* synthetic */ boolean f61-assertionsDisabled = (CharsTrie.class.desiredAssertionStatus() ^ 1);
    ...
    public int getValue() {
        ...
        if (f61-assertionsDisabled || leadUnit >= 64) {
    ...
    private static int readNodeValue(CharSequence chars, int pos, int leadUnit) {
        if (!f61-assertionsDisabled && (64 > leadUnit || leadUnit >= 32768)) {
            throw new AssertionError();

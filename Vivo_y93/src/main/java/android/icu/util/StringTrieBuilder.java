...
public abstract class StringTrieBuilder {
    ...
    private static final /* synthetic */ int[] f55-android-icu-util-StringTrieBuilder$StateSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f56-assertionsDisabled = (StringTrieBuilder.class.desiredAssertionStatus() ^ 1);
    ...
    private static class ValueNode extends Node {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f57-assertionsDisabled = (ValueNode.class.desiredAssertionStatus() ^ 1);
        ...
        public final void setValue(int v) {
            if (f57-assertionsDisabled || !this.hasValue) {
                this.hasValue = true;
                this.value = v;
                return;
            }
    ...
    private static final class ListBranchNode extends BranchNode {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f58-assertionsDisabled = (ListBranchNode.class.desiredAssertionStatus() ^ 1);
        private Node[] equal;
        private int length;
        private char[] units;
        private int[] values;
            ...
            while (true) {
                ...
                if (unitNumber >= 0) {
                    ...
                    if (this.equal[unitNumber] == null) {
                        ...
                        isFinal = true;
                    } else if (f58-assertionsDisabled || this.equal[unitNumber].getOffset() > 0) {
    ...
    private static final class SplitBranchNode extends BranchNode {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f59-assertionsDisabled = (SplitBranchNode.class.desiredAssertionStatus() ^ 1);
        ...
        public void write(StringTrieBuilder builder) {
            ...
            if (f59-assertionsDisabled || this.lessThan.getOffset() > 0) {
    ...
    private static /* synthetic */ int[] m17-getandroid-icu-util-StringTrieBuilder$StateSwitchesValues() {
        if (f55-android-icu-util-StringTrieBuilder$StateSwitchesValues != null) {
            return f55-android-icu-util-StringTrieBuilder$StateSwitchesValues;
        }
        ...
        f55-android-icu-util-StringTrieBuilder$StateSwitchesValues = iArr;
        return iArr;
    }
    ...
    protected final void buildImpl(Option buildOption) {
        switch (m17-getandroid-icu-util-StringTrieBuilder$StateSwitchesValues()[this.state.ordinal()]) {
            case 1:
                if (this.root != null) {
    ...
    private final Node registerNode(Node newNode) {
        ...
        if (f56-assertionsDisabled || oldNode == null) {
            return newNode;
        }
        throw new AssertionError();
    }

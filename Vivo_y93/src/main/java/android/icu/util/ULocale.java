...
public final class ULocale implements Serializable, Comparable<ULocale> {
    ...
    private static final class JDKLocaleHelper {
        ...
        private static final /* synthetic */ int[] f5-android-icu-util-ULocale$CategorySwitchesValues = null;
        ...
        private static /* synthetic */ int[] m1-getandroid-icu-util-ULocale$CategorySwitchesValues() {
            if (f5-android-icu-util-ULocale$CategorySwitchesValues != null) {
                return f5-android-icu-util-ULocale$CategorySwitchesValues;
            }
            ...
            f5-android-icu-util-ULocale$CategorySwitchesValues = iArr;
            return iArr;
        }

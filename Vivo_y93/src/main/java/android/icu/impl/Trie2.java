...
public abstract class Trie2 implements Iterable<Range> {
    ...
    private static final /* synthetic */ int[] f38-android-icu-impl-Trie2$ValueWidthSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m10-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues() {
        if (f38-android-icu-impl-Trie2$ValueWidthSwitchesValues != null) {
            return f38-android-icu-impl-Trie2$ValueWidthSwitchesValues;
        }
        ...
        f38-android-icu-impl-Trie2$ValueWidthSwitchesValues = iArr;
        return iArr;
    }
        ...
        try {
            ...
            switch (header.signature) {
                ...
                case 1416784178:
                    ...
                    switch (m10-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues()[width.ordinal()]) {
                        case 1:
                            This.data32 = null;

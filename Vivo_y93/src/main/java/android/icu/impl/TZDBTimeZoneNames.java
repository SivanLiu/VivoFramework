...
public class TZDBTimeZoneNames extends TimeZoneNames {
    ...
    private static class TZDBNameSearchHandler implements ResultHandler<TZDBNameInfo> {
        ...
        static final /* synthetic */ boolean f67-assertionsDisabled = (TZDBNameSearchHandler.class.desiredAssertionStatus() ^ 1);
        ...
        TZDBNameSearchHandler(EnumSet<NameType> nameTypes, String region) {
            ...
            if (f67-assertionsDisabled || region != null) {
                this._region = region;
                return;
            }
    ...
    private static class TZDBNames {
        ...
        private static final /* synthetic */ int[] f68-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m20-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
            if (f68-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
                return f68-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
            }
            ...
            f68-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
            return iArr;
        }
        ...
        String getName(NameType type) {
            ...
            String name = null;
            switch (m20-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[type.ordinal()]) {
                case 1:
                    name = this._names[1];
                    break;
                case 2:

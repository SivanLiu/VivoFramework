...
public class TimeZoneGenericNames implements Serializable, Freezable<TimeZoneGenericNames> {
    ...
    private static final /* synthetic */ int[] f69x63d98256 = null;
    /* renamed from: -android-icu-text-TimeZoneNames$NameTypeSwitchesValues */
    private static final /* synthetic */ int[] f70-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f71-assertionsDisabled = (TimeZoneGenericNames.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m21xcc7d80fa() {
        if (f69x63d98256 != null) {
            return f69x63d98256;
        }
    ...
    private static /* synthetic */ int[] m22-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
        if (f70-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
            return f70-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
        }
        ...
        f70-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public String getDisplayName(TimeZone tz, GenericNameType type, long date) {
        ...
        switch (m21xcc7d80fa()[type.ordinal()]) {
            case 1:
    ...
    private String formatGenericNonLocationName(TimeZone tz, GenericNameType type, long date) {
        if (f71-assertionsDisabled || type == GenericNameType.LONG || type == GenericNameType.SHORT) {
    ...
    private GenericMatchInfo createGenericMatchInfo(MatchInfo matchInfo) {
        ...
        switch (m22-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[matchInfo.nameType().ordinal()]) {
            case 1:
        ...
        if (tzID == null) {
            ...
            if (f71-assertionsDisabled || mzID != null) {
                tzID = this._tznames.getReferenceZoneID(mzID, getTargetRegion());
            } else {
                throw new AssertionError();
            }
        }
        if (f71-assertionsDisabled || tzID != null) {

...
public class Trie2Writable extends Trie2 {
    ...
    private static final /* synthetic */ int[] f40-android-icu-impl-Trie2$ValueWidthSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f41-assertionsDisabled = (Trie2Writable.class.desiredAssertionStatus() ^ 1);
    ...
    private static /* synthetic */ int[] m11-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues() {
        if (f40-android-icu-impl-Trie2$ValueWidthSwitchesValues != null) {
            return f40-android-icu-impl-Trie2$ValueWidthSwitchesValues;
        }
        ...
        f40-android-icu-impl-Trie2$ValueWidthSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void freeze(Trie2 dest, ValueWidth valueBits) {
        ...
        switch (m11-getandroid-icu-impl-Trie2$ValueWidthSwitchesValues()[valueBits.ordinal()]) {
            case 1:
                if (f41-assertionsDisabled || destIdx2 == dataMove) {

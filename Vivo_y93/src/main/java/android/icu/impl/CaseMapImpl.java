...
public final class CaseMapImpl {
    ...
    static final /* synthetic */ boolean f6-assertionsDisabled = (CaseMapImpl.class.desiredAssertionStatus() ^ 1);
                    ...
                    if (titleStart + 1 >= index || caseLocale != 5) {
                        ...
                        if (c1 == UCharacterProperty.LATIN_SMALL_LETTER_I_ || c1 == 'I') {
                            ...
                            if (c2 == 'j') {
                                ...
                                if (!f6-assertionsDisabled && c3 != c2) {
                                    throw new AssertionError();
                                } else if (!(f6-assertionsDisabled || titleLimit == stringContextIterator.getCPLimit())) {
                                    throw new AssertionError();
                                }
                            } else if (c2 == 'J') {

...
public class CurrencyData {
    ...
    public static final class CurrencySpacingInfo {
        ...
        static final /* synthetic */ boolean f15-assertionsDisabled = (CurrencySpacingInfo.class.desiredAssertionStatus() ^ 1);
        ...
        public enum SpacingPattern {
            ...
            private SpacingPattern(int value) {
                if (!f16-assertionsDisabled && value != ordinal()) {
        ...
        public CurrencySpacingInfo(String... strings) {
            if (f15-assertionsDisabled || strings.length == 6) {
                int k = 0;

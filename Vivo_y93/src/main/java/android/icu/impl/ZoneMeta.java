...
public final class ZoneMeta {
    ...
    private static final /* synthetic */ int[] f33-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f34-assertionsDisabled = (ZoneMeta.class.desiredAssertionStatus() ^ 1);
    ...
    private static class CustomTimeZoneCache extends SoftCache<Integer, SimpleTimeZone, int[]> {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f35-assertionsDisabled = (CustomTimeZoneCache.class.desiredAssertionStatus() ^ 1);
        ...
        protected SimpleTimeZone createInstance(Integer key, int[] data) {
            if (!f35-assertionsDisabled && data.length != 4) {
                throw new AssertionError();
            } else if (!f35-assertionsDisabled && data[0] != 1 && data[0] != -1) {
                throw new AssertionError();
            } else if (!f35-assertionsDisabled && (data[1] < 0 || data[1] > 23)) {
                throw new AssertionError();
            } else if (!f35-assertionsDisabled && (data[2] < 0 || data[2] > 59)) {
                throw new AssertionError();
            } else if (f35-assertionsDisabled || (data[3] >= 0 && data[3] <= 59)) {
                boolean z;
                int i = data[1];
                int i2 = data[2];
                int i3 = data[3];
    ...
    private static /* synthetic */ int[] m8-getandroid-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues() {
        if (f33-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues != null) {
            return f33-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues;
        }
        ...
        f33-android-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static Set<String> getAvailableIDs(SystemTimeZoneType type, String region, Integer rawOffset) {
        Set<String> baseSet;
        switch (m8-getandroid-icu-util-TimeZone$SystemTimeZoneTypeSwitchesValues()[type.ordinal()]) {
            case 1:
    ...
    public static String getCanonicalCountry(String tzid, Output<Boolean> isPrimary) {
        ...
        if (singleZone == null) {
            ...
            if (f34-assertionsDisabled || ids.size() >= 1) {
                if (ids.size() > 1) {
                    z = false;
                }

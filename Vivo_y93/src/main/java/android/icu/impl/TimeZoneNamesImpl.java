...
public class TimeZoneNamesImpl extends TimeZoneNames {
    ...
    private static class NameSearchHandler implements ResultHandler<NameInfo> {
        ...
        static final /* synthetic */ boolean f62-assertionsDisabled = (NameSearchHandler.class.desiredAssertionStatus() ^ 1);
        ...
        public boolean handlePrefixMatch(int matchLength, Iterator<NameInfo> values) {
            while (values.hasNext()) {
                ...
                if (this._nameTypes == null || (this._nameTypes.contains(ninfo.type) ^ 1) == 0) {
                    ...
                    } else if (f62-assertionsDisabled || ninfo.mzID != null) {
    ...
    private static class ZNames {
        ...
        private static final /* synthetic */ int[] f63x1bd5c820 = null;
        /* renamed from: -android-icu-text-TimeZoneNames$NameTypeSwitchesValues */
        private static final /* synthetic */ int[] f64-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m18xeb74adc4() {
            if (f63x1bd5c820 != null) {
                return f63x1bd5c820;
            }
        ...
        private static /* synthetic */ int[] m19-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues() {
            if (f64-android-icu-text-TimeZoneNames$NameTypeSwitchesValues != null) {
                return f64-android-icu-text-TimeZoneNames$NameTypeSwitchesValues;
            }
            ...
            f64-android-icu-text-TimeZoneNames$NameTypeSwitchesValues = iArr;
            return iArr;
        }

        private static int getNameTypeIndex(NameType type) {
            switch (m19-getandroid-icu-text-TimeZoneNames$NameTypeSwitchesValues()[type.ordinal()]) {
                case 1:
        ...
        private static NameType getNameType(int index) {
            switch (m18xeb74adc4()[NameTypeIndex.values[index].ordinal()]) {
                case 1:
    ...
    private static final class ZNamesLoader extends Sink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f65-assertionsDisabled = (ZNamesLoader.class.desiredAssertionStatus() ^ 1);
        ...
        void loadNames(ICUResourceBundle zoneStrings, String key) {
            if (!f65-assertionsDisabled && zoneStrings == null) {
                throw new AssertionError();
            } else if (!f65-assertionsDisabled && key == null) {
                throw new AssertionError();
            } else if (f65-assertionsDisabled || key.length() > 0) {
                this.names = null;
                try {
        ...
        private void setNameIfEmpty(Key key, Value value) {
            ...
            if (index != null) {
                if (f65-assertionsDisabled || index.ordinal() < 7) {
        ...
        public void put(Key key, Value value, boolean noFallback) {
            ...
            while (namesTable.getKeyAndValue(i, key, value)) {
                if (f65-assertionsDisabled || value.getType() == 0) {
    ...
    private final class ZoneStringsLoader extends Sink {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f66-assertionsDisabled = (ZoneStringsLoader.class.desiredAssertionStatus() ^ 1);
        ...
        public void put(Key key, Value value, boolean noFallback) {
            ...
            while (timeZonesTable.getKeyAndValue(j, key, value)) {
                if (f66-assertionsDisabled || !value.isNoInheritanceMarker()) {
                    if (value.getType() == 2) {

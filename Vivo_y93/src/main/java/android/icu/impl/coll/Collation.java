...
public final class Collation {
    ...
    static final /* synthetic */ boolean f74-assertionsDisabled = (Collation.class.desiredAssertionStatus() ^ 1);
    ...
    static long ceFromSimpleCE32(int ce32) {
        if (f74-assertionsDisabled || (ce32 & 255) < 192) {
    ...
    static long ceFromCE32(int ce32) {
        ...
        if (f74-assertionsDisabled || (tertiary & 15) == 2) {
    ...
    static long decTwoBytePrimaryByOneStep(long basePrimary, boolean isCompressible, int step) {
        if (f74-assertionsDisabled || (step > 0 && step <= 127)) {

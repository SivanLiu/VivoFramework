...
public final class CollationRuleParser {
    ...
    static final /* synthetic */ boolean f83-assertionsDisabled = (CollationRuleParser.class.desiredAssertionStatus() ^ 1);
            ...
            if (raw.startsWith("reorder") && (raw.length() == 7 || raw.charAt(7) == ' ')) {
                ...
                if (raw.equals("strength") && v.length() == 1) {
                    ...
                    if (value != -1) {
                        ...
                        if (f83-assertionsDisabled || this.settings.variableTop != 0) {
                            this.ruleIndex = j;
                            return;
                        }

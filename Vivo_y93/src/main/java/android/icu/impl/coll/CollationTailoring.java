...
public final class CollationTailoring {
    ...
    static final /* synthetic */ boolean f91-assertionsDisabled = (CollationTailoring.class.desiredAssertionStatus() ^ 1);
    ...
    CollationTailoring(Reference<CollationSettings> baseSettings) {
        ...
        } else if (!f91-assertionsDisabled && ((CollationSettings) baseSettings.readOnly()).reorderCodes.length != 0) {
            throw new AssertionError();
        } else if (!f91-assertionsDisabled && ((CollationSettings) baseSettings.readOnly()).reorderTable != null) {
            throw new AssertionError();
        } else if (f91-assertionsDisabled || ((CollationSettings) baseSettings.readOnly()).minHighNoReorder == 0) {
    ...
    void setRules(String r) {
        if (f91-assertionsDisabled || (this.rules == null && this.rulesResource == null)) {
            this.rules = r;
            return;
        }
        throw new AssertionError();

...
public final class CollationKeys {
    ...
    static final /* synthetic */ boolean f96-assertionsDisabled = (CollationKeys.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class SortKeyLevel {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f97-assertionsDisabled = (SortKeyLevel.class.desiredAssertionStatus() ^ 1);
        ...
        void appendWeight16(int w) {
            if (f97-assertionsDisabled || (DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH & w) != 0) {
                byte b0 = (byte) (w >>> 8);
                byte b1 = (byte) w;
        ...
        void appendTo(SortKeyByteSink sink) {
            if (f97-assertionsDisabled || (this.len > 0 && this.buffer[this.len - 1] == (byte) 1)) {
            ...
            while (true) {
                ...
                if (lower32 != 0) {
                    ...
                    if ((levels & 8) != 0 && (CollationSettings.getStrength(options) != 0 ? (lower32 >>> 16) == 0 : p == 0)) {
                        int c = (lower32 >>> 8) & 255;
                        if (!f96-assertionsDisabled && (c & 192) == 192) {
                            throw new AssertionError();
                        } else if ((c & 192) != 0 || c <= 1) {
                            if ((options & 256) == 0) {
                    ...
                    if ((levels & 16) != 0) {
                        ...
                        if (!f96-assertionsDisabled && (Collation.CASE_MASK & lower32) == 49152) {
                            throw new AssertionError();
                        } else if (t == 1280) {
                            commonTertiaries++;
                            ...
                            if (t > 256) {
                                ...
                                } else if (f96-assertionsDisabled || (34304 <= t && t <= 49151)) {
                                    t += 16384;
                                }
                            }
                            if (commonTertiaries != 0) {
                        ...
                        if ((levels & 8) != 0) {
                            if (callback.needToWrite(3)) {
                                ...
                                while (i3 < length2) {
                                    ...
                                    if (f96-assertionsDisabled || ((c2 & 15) == 0 && c2 != (byte) 0)) {
                                        if (b3 == 0) {
                                            b3 = c2;
                                        } else {

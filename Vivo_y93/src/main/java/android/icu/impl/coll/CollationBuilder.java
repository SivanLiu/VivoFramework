...
public final class CollationBuilder extends Sink {
    ...
    private static final /* synthetic */ int[] f78x5b9f57fe = null;
    /* renamed from: -assertionsDisabled */
    static final /* synthetic */ boolean f79-assertionsDisabled = (CollationBuilder.class.desiredAssertionStatus() ^ 1);
    ...
    private static final class CEFinalizer implements CEModifier {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f80-assertionsDisabled = (CEFinalizer.class.desiredAssertionStatus() ^ 1);
        ...
        public long modifyCE32(int ce32) {
            if (!f80-assertionsDisabled && Collation.isSpecialCE32(ce32)) {
    ...
    private static /* synthetic */ int[] m23xbaa87bda() {
        if (f78x5b9f57fe != null) {
            return f78x5b9f57fe;
        }
    ...
    void addReset(int strength, CharSequence str) {
        if (f79-assertionsDisabled || str.length() != 0) {
            if (str.charAt(0) == 65534) {
                this.ces[0] = getSpecialResetPosition(str);
                this.cesLength = 1;
                if (!(f79-assertionsDisabled || (this.ces[0] & 49344) == 0)) {
                    throw new AssertionError();
                }
            }
            ...
            if (strength != 15) {
                if (f79-assertionsDisabled || (strength >= 0 && strength <= 2)) {
                    ...
                    if (strengthFromNode(node) == strength && isTailoredNode(node)) {
                        ...
                        if (strengthFromNode(node) == strength) {
                            ...
                            if (weight16 == 0) {
                            ...
                            } else if (f79-assertionsDisabled || weight16 > 256) {
                                ...
                                while (true) {
                                    ...
                                    } else if (f79-assertionsDisabled || weight16 >= Collation.COMMON_WEIGHT16 || i == previousIndex) {
    ...
    private int getWeight16Before(int index, long node, int level) {
        if (f79-assertionsDisabled || strengthFromNode(node) < level || !isTailoredNode(node)) {
            int t;
            ...
            if (level == 1) {
                ...
                if (!(f79-assertionsDisabled || (weight16 & -16192) == 0)) {
                    throw new AssertionError();
                }
            }
            return weight16;
    ...
    private long getSpecialResetPosition(CharSequence str) {
        if (f79-assertionsDisabled || str.length() == 2) {
            long ce;
            long node;
            int index;
            int strength = 0;
            ...
            switch (m23xbaa87bda()[pos.ordinal()]) {
                case 1:
                ...
                case 2:
                    ...
                    if (isTailoredNode(node)) {
                        if (nodeHasBefore3(node)) {
                            ...
                            if (!(f79-assertionsDisabled || isTailoredNode(this.nodes.elementAti(index)))) {
                                throw new AssertionError();
                            }
                        }
                ...
                case 4:
                    ...
                    if (index != 0) {
                        node = this.nodes.elementAti(index);
                        if (!f79-assertionsDisabled && strengthFromNode(node) > 2) {
                            throw new AssertionError();
            ...
            if ((pos.ordinal() & 1) == 0) {
                if (!nodeHasAnyBefore(node) && isBoundary) {
                    ...
                    if (index != 0) {
                        node = this.nodes.elementAti(index);
                        if (f79-assertionsDisabled || isTailoredNode(node)) {
                            ce = tempCEFromIndexAndStrength(index, strength);
                        } else {
                            throw new AssertionError();
                        }
                    } else if (f79-assertionsDisabled || strength == 0) {
                        long p = ce >>> 32;
    ...
    void addRelation(int strength, CharSequence prefix, CharSequence str, CharSequence extension) {
        ...
        if (strength != 15) {
            int index = findOrInsertNodeForCEs(strength);
            if (f79-assertionsDisabled || this.cesLength > 0) {
    ...
    private int findOrInsertNodeForCEs(int strength) {
        if (f79-assertionsDisabled || (strength >= 0 && strength <= 3)) {
            long ce;
    ...
    private int findOrInsertNodeForRootCE(long ce, int strength) {
        if (!f79-assertionsDisabled && ((int) (ce >>> 56)) == 254) {
            throw new AssertionError();
        } else if (f79-assertionsDisabled || (192 & ce) == 0) {
    ...
    private int findOrInsertWeakNode(int index, int weight16, int level) {
        if (!f79-assertionsDisabled && (index < 0 || index >= this.nodes.size())) {
            throw new AssertionError();
        } else if (!f79-assertionsDisabled && (1 > level || level > 2)) {
            throw new AssertionError();
        } else if (weight16 == Collation.COMMON_WEIGHT16) {
            return findCommonNode(index, level);
        } else {
            long node = this.nodes.elementAti(index);
            if (f79-assertionsDisabled || strengthFromNode(node) < level) {
                int nextIndex;
    ...
    private int insertNodeBetween(int index, int nextIndex, long node) {
        if (!f79-assertionsDisabled && previousIndexFromNode(node) != 0) {
            throw new AssertionError();
        } else if (!f79-assertionsDisabled && nextIndexFromNode(node) != 0) {
            throw new AssertionError();
        } else if (f79-assertionsDisabled || nextIndexFromNode(this.nodes.elementAti(index)) == nextIndex) {
    ...
    private int findCommonNode(int index, int strength) {
        if (f79-assertionsDisabled || (1 <= strength && strength <= 2)) {
            long node = this.nodes.elementAti(index);
            if (strengthFromNode(node) >= strength) {
                return index;
            }
            ...
            if (f79-assertionsDisabled || (!isTailoredNode(node) && strengthFromNode(node) == strength && weight16FromNode(node) < Collation.COMMON_WEIGHT16)) {
                while (true) {
                    index = nextIndexFromNode(node);
                    node = this.nodes.elementAti(index);
                    if (!f79-assertionsDisabled && strengthFromNode(node) < strength) {
                        throw new AssertionError();
                    } else if (!isTailoredNode(node) && strengthFromNode(node) <= strength && weight16FromNode(node) >= Collation.COMMON_WEIGHT16) {
                        if (f79-assertionsDisabled || weight16FromNode(node) == Collation.COMMON_WEIGHT16) {
                            return index;
                        }
                        throw new AssertionError();
                    }
    ...
    private void setCaseBits(CharSequence nfdString) {
        ...
        if (f79-assertionsDisabled || numTailoredPrimaries <= 31) {
            long ce;
            long cases = 0;
            if (numTailoredPrimaries > 0) {
                ...
                if (f79-assertionsDisabled || (baseCEsLength >= 0 && baseCEs.getCE(baseCEsLength) == Collation.NO_CE)) {
                    int lastCase = 0;
                    ...
                    for (i = 0; i < baseCEsLength; i++) {
                        ...
                        if ((ce >>> 32) != 0) {
                            numBasePrimaries++;
                            int c = (((int) ce) >> 14) & 3;
                            if (!f79-assertionsDisabled && c != 0 && c != 2) {
                                throw new AssertionError();
        ...
        while (indexAfterLastStarter != 0) {
            ...
            if (this.nfd.getCombiningClass(lastStarter) != 0) {
                ...
                if (this.nfcImpl.getCanonStartSet(lastStarter, composites)) {
                    ...
                    while (iter.next()) {
                        if (f79-assertionsDisabled || iter.codepoint != UnicodeSetIterator.IS_STRING) {
    ...
    private boolean mergeCompositeIntoString(CharSequence nfdString, int indexAfterLastStarter, int composite, CharSequence decomp, StringBuilder newNFDString, StringBuilder newString) {
        if (f79-assertionsDisabled || Character.codePointBefore(nfdString, indexAfterLastStarter) == Character.codePointAt(decomp, 0)) {
            ...
            while (true) {
                if (sourceChar < 0) {
                    ...
                    if (!f79-assertionsDisabled && sourceCC == 0) {
                        throw new AssertionError();
                    }
                }
            ...
            if (!f79-assertionsDisabled && !this.nfd.isNormalized(newNFDString)) {
                throw new AssertionError();
            } else if (!f79-assertionsDisabled && !this.fcd.isNormalized(newString)) {
                throw new AssertionError();
            } else if (f79-assertionsDisabled || this.nfd.normalize(newString).equals(newNFDString.toString())) {
                return true;
            } else {
                throw new AssertionError();
            }
    ...
    private static boolean sameCEs(long[] ces1, int ces1Length, long[] ces2, int ces2Length) {
        ...
        if (f79-assertionsDisabled || ces1Length <= 31) {
                ...
                if (strength != 3) {
                    if (strength != 2) {
                        if (strength == 1) {
                            if (isTailoredNode(node)) {
                                if (!sIsTailored) {
                                    ...
                                    } else if (f79-assertionsDisabled || s == 1280) {
                                ...
                                if (!f79-assertionsDisabled && s == -1) {
                                    throw new AssertionError();
                                }
                            }
                            s = weight16FromNode(node);
                            sIsTailored = false;
                        } else if (f79-assertionsDisabled || isTailoredNode(node)) {
                            if (!pIsTailored) {
                            ...
                            if (f79-assertionsDisabled || p != 4294967295L) {
                                s = Collation.COMMON_WEIGHT16;
                                sIsTailored = false;
                            } else {
                                throw new AssertionError();
                        ...
                        if (!tIsTailored) {
                            ...
                            } else if (f79-assertionsDisabled || t == 1280) {
                                tLimit = this.rootElements.getTertiaryBoundary();
                            } else {
                                throw new AssertionError();
                            }
                            if (f79-assertionsDisabled || tLimit == 16384 || (tLimit & -16192) == 0) {

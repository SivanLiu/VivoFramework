...
public final class CollationCompare {
    ...
    static final /* synthetic */ boolean f76-assertionsDisabled = (CollationCompare.class.desiredAssertionStatus() ^ 1);
            ...
            if (leftPrimary != 0) {
                ...
                if (leftPrimary != rightPrimary) {
                    ...
                    if (CollationSettings.getStrength(options) >= 1) {
                        ...
                        if ((options & 2048) == 0) {
                            ...
                            while (true) {
                                ...
                                if (f76-assertionsDisabled || left.getCE(leftLimit) == right.getCE(rightLimit)) {
                                    if (p == 1) {
                                        break;
                                    }
                    ...
                    while (true) {
                        ...
                        if (f76-assertionsDisabled || (leftLower32 & Collation.ONLY_TERTIARY_MASK) != 0 || (Collation.CASE_AND_QUATERNARY_MASK & leftLower32) == 0) {
                            ...
                            if (leftTertiary == 0) {
                                ...
                                while (true) {
                                    ...
                                    if (f76-assertionsDisabled || (rightLower32 & Collation.ONLY_TERTIARY_MASK) != 0 || (Collation.CASE_AND_QUATERNARY_MASK & rightLower32) == 0) {

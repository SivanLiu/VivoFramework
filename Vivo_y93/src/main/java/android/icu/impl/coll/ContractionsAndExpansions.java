...
public final class ContractionsAndExpansions {
    ...
    static final /* synthetic */ boolean f94-assertionsDisabled = (ContractionsAndExpansions.class.desiredAssertionStatus() ^ 1);
        ...
        while ((ce32 & 255) >= 192) {
            ...
            switch (Collation.tagFromCE32(ce32)) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    if (f94-assertionsDisabled || (start == 0 && end == 0)) {
                ...
                case 12:
                    if (this.sink != null) {
                        ...
                        while (c <= end) {
                            ...
                            if (f94-assertionsDisabled || (length >= 2 && iter.getCE(length - 1) == Collation.NO_CE)) {
    ...
    void handleContractions(int start, int end, int ce32) {
        ...
        if ((ce32 & 256) == 0) {
            ...
            if (f94-assertionsDisabled || !Collation.isContractionCE32(ce32)) {
                handleCE32(start, end, ce32);
            } else {
                throw new AssertionError();
            }
        } else if (!f94-assertionsDisabled && this.unreversedPrefix.length() == 0) {
            throw new AssertionError();
        }

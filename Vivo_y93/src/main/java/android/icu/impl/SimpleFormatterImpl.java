...
public final class SimpleFormatterImpl {
    ...
    static final /* synthetic */ boolean f36-assertionsDisabled = (SimpleFormatterImpl.class.desiredAssertionStatus() ^ 1);
        ...
        if (min <= 2 && 2 <= max) {
            ...
            while (i < length) {
                ...
                if (!pair[0].contentEquals(pattern)) {
                    i++;
                } else if (f36-assertionsDisabled || pair[1].charAt(0) == 2) {
                    return pair[1];
                } else {

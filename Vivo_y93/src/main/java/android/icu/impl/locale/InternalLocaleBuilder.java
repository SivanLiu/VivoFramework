...
public final class InternalLocaleBuilder {
    ...
    static final /* synthetic */ boolean f100-assertionsDisabled = (InternalLocaleBuilder.class.desiredAssertionStatus() ^ 1);
    ...
    static String removePrivateuseVariant(String privuseVal) {
        ...
        if (f100-assertionsDisabled || prefixStart == 0 || prefixStart > 1) {
    ...
    private void setUnicodeLocaleExtension(String subtags) {
        ...
        while (!itr.isDone()) {
            ...
            if (key != null) {
                ...
                } else if (f100-assertionsDisabled || typeStart == -1 || typeEnd != -1) {
            ...
            if (itr.hasNext()) {
                ...
                if (f100-assertionsDisabled || typeStart == -1 || typeEnd != -1) {
                    type = typeStart == -1 ? "" : subtags.substring(typeStart, typeEnd);
                    if (this._ukeywords == null) {
                        this._ukeywords = new HashMap(4);
                    }

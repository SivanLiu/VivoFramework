...
public class LocaleExtensions {
    ...
    static final /* synthetic */ boolean f104-assertionsDisabled = (LocaleExtensions.class.desiredAssertionStatus() ^ 1);
    ...
    public Set<String> getUnicodeLocaleAttributes() {
        ...
        if (f104-assertionsDisabled || (ext instanceof UnicodeLocaleExtension)) {

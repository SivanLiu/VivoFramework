...
public class LocaleValidityChecker {
    ...
    private static final /* synthetic */ int[] f105-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues = null;
    /* renamed from: -android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues */
    private static final /* synthetic */ int[] f106-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues = null;
    /* renamed from: -android-icu-impl-locale-LocaleValidityChecker$SpecialCaseSwitchesValues */
    private static final /* synthetic */ int[] f107xbda2f04f = null;
    ...
    private static /* synthetic */ int[] m26-getandroid-icu-impl-ValidIdentifiers$DatatypeSwitchesValues() {
        if (f105-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues != null) {
            return f105-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues;
        }
        ...
        f105-android-icu-impl-ValidIdentifiers$DatatypeSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues */
    private static /* synthetic */ int[] m27-getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues() {
        if (f106-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues != null) {
            return f106-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues;
        }
        ...
        f106-android-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues = iArr;
        return iArr;
    }

    /* renamed from: -getandroid-icu-impl-locale-LocaleValidityChecker$SpecialCaseSwitchesValues */
    private static /* synthetic */ int[] m28x211efcf3() {
        if (f107xbda2f04f != null) {
            return f107xbda2f04f;
        }
        ...
        if (isValid(Datatype.language, language, where)) {
            ...
            for (Character c : extensionKeys) {
                try {
                    ...
                    switch (m26-getandroid-icu-impl-ValidIdentifiers$DatatypeSwitchesValues()[datatype.ordinal()]) {
                        case 1:
                        case 2:
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                if (subtag.length() == 2 && (tBuffer == null || subtag.charAt(1) <= '9')) {
                    ...
                    typeCount++;
                    switch (m27-getandroid-icu-impl-locale-KeyTypeData$ValueTypeSwitchesValues()[valueType.ordinal()]) {
                        case 1:
                            if (typeCount != 1) {
                    ...
                    switch (m28x211efcf3()[specialCase.ordinal()]) {
                        case 1:
                            continue;
                        case 2:
                            try {

...
public class VCardUtils {
    ...
    private static final Map<String, Integer> sKnownCombinationTypeMap = new HashMap();
    ...
    static {
        ...
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_OTHER_FAX, Integer.valueOf(13));
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_TLX, Integer.valueOf(15));
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_MSG, Integer.valueOf(20));
        ...
        sKnownImPropNameMap_ItoS.put(Integer.valueOf(-1), VCardConstants.PROPERTY_X_CUSTOM_IM);
    ...
    public static Object getPhoneTypeFromStrings(Collection<String> types, String number) {
        ...
        if (types != null) {
            if (types.size() >= 2) {
                for (String key : sKnownCombinationTypeMap.keySet()) {
                    ...
                    if (isExist) {
                        return Integer.valueOf(((Integer) sKnownCombinationTypeMap.get(key)).intValue());
                    }
                }
            }

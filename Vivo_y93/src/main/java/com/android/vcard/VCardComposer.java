...
public class VCardComposer {
    ...
    private String createOneEntryInternal(long contactId, Method getEntityIteratorMethod) {
        ...
        if (entityIterator == null) {
            ...
            while (entityIterator.hasNext()) {
                ...
                Iterator namedContentValues$iterator = entity.getSubValues().iterator();
                while (true) {
    ...
    private void setPhoneTypeToMobileByAas(Entity entity, ContentValues contentValues, String key) {
        String accountType = entity.getEntityValues().getAsString("account_type");
        if ("vnd.android.cursor.item/phone_v2".equals(key) && isAasEnabled(accountType)) {
    ...
    private boolean isAasEnabled(String accountType) {
        if ("OP03".equals(SystemProperties.get("ro.operator.optr")) && "USIM Account".equals(accountType)) {
            return true;
        }
        return DEBUG;
    }

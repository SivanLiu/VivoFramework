        ...
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
                ...
                if (protocolAsObject != null) {
                    List parameterList;
                    if (-1 == protocolAsObject.intValue()) {
                        String tmep = VCardConstants.PROPERTY_X_CUSTOM_IM;
                        String customTypeName = contentValues.getAsString("data6");
                        parameterList = new ArrayList();
                        if (!(customTypeName == null || (customTypeName.isEmpty() ^ 1) == 0)) {
                            parameterList.add(customTypeName);
                        }
                        appendLineWithCharsetAndQPDetection(tmep, parameterList, contentValues.getAsString("data1"));
                    } else {
    ...
    public void appendTelLine(Integer typeAsInteger, String label, String encodedValue, boolean isPrimary) {
        ...
        switch (type) {
            ...
            case 15:
                ...
                break;
            case GroupChat.STATUS_GROUP_FULL /*16*/:

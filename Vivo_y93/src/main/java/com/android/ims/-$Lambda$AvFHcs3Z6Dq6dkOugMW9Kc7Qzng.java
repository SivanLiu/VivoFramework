...
final /* synthetic */ class -$Lambda$AvFHcs3Z6Dq6dkOugMW9Kc7Qzng implements Consumer {
    ...
    final /* synthetic */ class AnonymousClass1 implements INotifyStatusChanged {
        ...
        private final /* synthetic */ void $m$0() {
            ((ImsManager) this.f0-$f0).m3lambda$-com_android_ims_ImsManager_97845();
        }
    ...
    final /* synthetic */ class AnonymousClass2 implements Runnable {
        ...
        private final /* synthetic */ void $m$0() {
            ((ImsManager) this.f1-$f0).m0-com_android_ims_ImsManager-mthref-0();
        }
    ...
    final /* synthetic */ class AnonymousClass3 implements Consumer {
        ...
        private final /* synthetic */ void $m$0(Object arg0) {
            ((ImsConnectionStateListener) arg0).registrationAssociatedUriChanged((Uri[]) this.f2-$f0);
        }

        private final /* synthetic */ void $m$1(Object arg0) {
            ((ImsConnectionStateListener) arg0).onImsDisconnected((ImsReasonInfo) this.f2-$f0);
        }
    ...
    final /* synthetic */ class AnonymousClass4 implements Consumer {
        ...
        private final /* synthetic */ void $m$0(Object arg0) {
            ((ImsConnectionStateListener) arg0).onImsConnected(this.f3-$f0);
        }

        private final /* synthetic */ void $m$1(Object arg0) {
            ((ImsConnectionStateListener) arg0).onImsProgressing(this.f3-$f0);
        }

        private final /* synthetic */ void $m$2(Object arg0) {
            ((ImsConnectionStateListener) arg0).onVoiceMessageCountChanged(this.f3-$f0);
        }
    ...
    final /* synthetic */ class AnonymousClass5 implements Runnable {
        ...
        private final /* synthetic */ void $m$0() {
            ((ImsManager) this.f5-$f1).m1lambda$-com_android_ims_ImsManager_46201(this.f4-$f0);
        }

        private final /* synthetic */ void $m$1() {
            ((ImsManager) this.f5-$f1).m2lambda$-com_android_ims_ImsManager_49537(this.f4-$f0);
        }
    ...
    final /* synthetic */ class AnonymousClass6 implements Consumer {
        ...
        private final /* synthetic */ void $m$0(Object arg0) {
            ((ImsConnectionStateListener) arg0).onRegistrationChangeFailed(this.f6-$f0, (ImsReasonInfo) this.f7-$f1);
        }
    ...
    final /* synthetic */ class AnonymousClass7 implements Consumer {
        ...
        private final /* synthetic */ void $m$0(Object arg0) {
            ((ImsConnectionStateListener) arg0).onFeatureCapabilityChanged(this.f8-$f0, (int[]) this.f9-$f1, (int[]) this.f10-$f2);
        }

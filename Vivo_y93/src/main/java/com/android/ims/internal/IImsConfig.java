...
public interface IImsConfig extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsConfig {
        ...
        static final int TRANSACTION_getEvsConfigValue = 10;
        ...
        static final int TRANSACTION_setEvsConfigValue = 11;
        ...
        private static class Proxy implements IImsConfig {
            ...
            public int getEvsConfigValue(int item) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int setEvsConfigValue(int item, int value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getEvsConfigValue(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setEvsConfigValue(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
    ...
    int getEvsConfigValue(int i) throws RemoteException;
    ...
    int setEvsConfigValue(int i, int i2) throws RemoteException;

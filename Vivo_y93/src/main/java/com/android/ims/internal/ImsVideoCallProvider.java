...
public abstract class ImsVideoCallProvider {
    ...
    private static final int MSG_SET_PARAMETERS = 12;
            ...
            switch (msg.what) {
                ...
                case 12:
                    if (msg.obj != null && (msg.obj instanceof String[])) {
                        ImsVideoCallProvider.this.onSetParameters((String[]) msg.obj);
                        return;
                    }
                    return;
                default:
    ...
    private final class ImsVideoCallProviderBinder extends Stub {
        ...
        public void setParameters(String[] params) {
            ImsVideoCallProvider.this.mProviderHandler.obtainMessage(12, params).sendToTarget();
        }
    }

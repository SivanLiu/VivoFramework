...
public class ImsManager {
    ...
    private class ImsRegistrationListenerProxy extends Stub {
        ...
        public void registrationDisconnected(ImsReasonInfo imsReasonInfo) {
            ...
            synchronized (ImsManager.this.mRegistrationListeners) {
                ImsManager.this.mRegistrationListeners.forEach(new com.android.ims.-$Lambda$AvFHcs3Z6Dq6dkOugMW9Kc7Qzng.AnonymousClass3((byte) 1, imsReasonInfo));
            }
        }
        ...
        public void registrationAssociatedUriChanged(Uri[] uris) {
            ...
            synchronized (ImsManager.this.mRegistrationListeners) {
                ImsManager.this.mRegistrationListeners.forEach(new com.android.ims.-$Lambda$AvFHcs3Z6Dq6dkOugMW9Kc7Qzng.AnonymousClass3((byte) 0, uris));
            }
        }
    ...
    public static void setEnhanced4gLteModeSetting(Context context, boolean enabled) {
        ...
        onEnhanced4gLteModeSettingChanged(context, SubscriptionManager.from(context).getDefaultDataPhoneId(), enabled, DBG);
    ...
    public void setEnhanced4gLteModeSettingForSlot(boolean enabled) {
        ...
        onEnhanced4gLteModeSettingChanged(this.mContext, this.mPhoneId, enabled, DBG);
    ...
    public static boolean isVolteEnabledByPlatform(Context context) {
        ...
        if (SubscriptionManager.from(context).getDefaultDataPhoneId() == 0) {
            if ((SystemProperties.getInt("persist.radio.vivo.volte", 0) & 1) != 1) {
                z = false;
            }
        } else if ((SystemProperties.getInt("persist.radio.vivo.volte.sim2", 0) & 1) != 1) {
            z = false;
        }
        return z;
    }
    ...
    public static boolean isVolteProvisionedOnDevice(Context context) {
        if (getBooleanCarrierConfig(context, "carrier_volte_provisioning_required_bool")) {
            ImsManager mgr = getInstance(context, SubscriptionManager.from(context).getDefaultDataPhoneId());
            if (mgr != null) {
    ...
    public static boolean isVtEnabledByPlatform(Context context) {
        ...
        if (SubscriptionManager.from(context).getDefaultDataPhoneId() == 0) {
            if ((SystemProperties.getInt("persist.radio.vivo.volte", 0) & 2) != 2) {
                z = false;
            }
        } else if ((SystemProperties.getInt("persist.radio.vivo.volte.sim2", 0) & 2) != 2) {
            z = false;
        }
        return z;
    }
    ...
    /* renamed from: lambda$-com_android_ims_ImsManager_46201 */
    /* synthetic */ void m1lambda$-com_android_ims_ImsManager_46201(int value) {
        try {
    ...
    /* renamed from: lambda$-com_android_ims_ImsManager_49537 */
    /* synthetic */ void m2lambda$-com_android_ims_ImsManager_49537(int value) {
        try {
    ...
    public static void updateImsServiceConfig(Context context, int phoneId, boolean force) {
        if (force || ((TelephonyManager) context.getSystemService("phone")).getSimState(phoneId) == 5) {
            ...
            if (imsManager != null && (!imsManager.mConfigUpdated || force)) {
                try {
                    refreshDatabaseSwitchByUiSwitch(context, phoneId);
        ...
        if (force || ((TelephonyManager) this.mContext.getSystemService("phone")).getSimState(this.mPhoneId) == 5) {
            ...
            if (SubscriptionManager.from(this.mContext).isActiveSubId(subId)) {
                if (!this.mConfigUpdated || force) {
                    try {
                        refreshDatabaseSwitchByUiSwitch(this.mContext, this.mPhoneId);
    ...
    private boolean updateVolteFeatureValue() throws ImsException {
        ...
        z = getVolteSwitchUIState(this.mContext, this.mPhoneId);
        if (!available) {
            isNonTty = false;
        }
        z &= isNonTty;
        log("updateVolteFeatureValue(" + this.mPhoneId + ") isFeatureOn = " + z);
    ...
    private boolean updateVideoCallFeatureValue() throws ImsException {
        ...
        boolean ignoreDataEnabledChanged = getBooleanCarrierConfigForSlot("ignore_data_enabled_changed_for_video_calls");
        if (available && enabled) {
            z = isNonTty;
        }
        z = getVolteSwitchUIState(this.mContext, this.mPhoneId);
        ...
        z &= i;
        log("updateVideoCallFeatureValue(" + this.mPhoneId + ") isFeatureOn = " + z);
        log("updateVideoCallFeatureValue: available = " + available + ", enabled = " + enabled + ", nonTTY = " + isNonTty + ", data enabled = " + isDataEnabled);
        ImsConfig configInterface = getConfigInterface();
        if (z) {
            i2 = 1;
        }
        configInterface.setFeatureValue(1, 13, i2, this.mImsConfigListener);
        return z;
    }
    ...
    public ImsManager(Context context, int phoneId) {
        ...
        if (Looper.getMainLooper() != null) {
            this.mProvisionBackoff = new ExponentialBackoff(BACKOFF_INITIAL_DELAY_MS, BACKOFF_MAX_DELAY_MS, 2, new Handler(Looper.getMainLooper()), new com.android.ims.-$Lambda$AvFHcs3Z6Dq6dkOugMW9Kc7Qzng.AnonymousClass2(this));
        }
        createImsService();
    }

    /* renamed from: -com_android_ims_ImsManager-mthref-0 */
    /* synthetic */ void m0-com_android_ims_ImsManager-mthref-0() {
        handleUpdateProvisionedValues();
    }
    ...
    public ImsUtInterface getSupplementaryServiceConfiguration() throws ImsException {
        ...
        try {
            ...
            this.mUt = new ImsUt(iUt, this.mContext);
            if (this.mUt != null) {
    ...
    /* renamed from: lambda$-com_android_ims_ImsManager_97845 */
    /* synthetic */ void m3lambda$-com_android_ims_ImsManager_97845() {
    ...
    private void turnOnIms() throws ImsException {
        ...
        try {
            ...
            onImsOnOffActionTriggered(this.mPhoneId, DBG);
        } catch (RemoteException e) {
        ...
        try {
            ...
            if (config != null) {
                ...
                if (isVolteEnabledByPlatformForSlot()) {
                    boolean ignoreDataEnabledChanged = getBooleanCarrierConfigForSlot("ignore_data_enabled_changed_for_video_calls");
                    if (!(turnOn ? isVtEnabledByUserForSlot() : false)) {
                        i = 0;
                    }
                    config.setFeatureValue(1, 13, i, this.mImsConfigListener);
                }
    ...
    private void turnOffIms() throws ImsException {
        ...
        try {
            ...
            onImsOnOffActionTriggered(this.mPhoneId, false);
        } catch (RemoteException e) {
    ...
    private void registerBroadcastReceiver() {
        if (this.mContext != null && !this.mBroadcastReceiverRegistered) {
            this.mHandler = new Handler(Looper.getMainLooper()) {
                public void handleMessage(Message msg) {
                    if (ImsManager.this.mContext != null && 1 == msg.what && SubscriptionManager.isValidPhoneId(msg.arg1)) {
                        ImsManager.refreshDatabaseSwitchByUiSwitch(ImsManager.this.mContext, msg.arg1);
                    }
                }
            };
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if ("android.intent.action.SIM_STATE_CHANGED".equals(action)) {
                        ...
                        if ("LOADED".equals(simState)) {
                            ImsManager.this.mHandler.sendMessage(ImsManager.this.mHandler.obtainMessage(1, phoneId, -1));
                            ImsManager.log("mBroadcastReceiver simState:" + simState);
                        }
                    } else if ("android.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED".equals(action)) {
                        ImsManager.this.mHandler.sendMessage(ImsManager.this.mHandler.obtainMessage(1, SubscriptionManager.getPhoneId(intent.getIntExtra("subscription", -1)), -1));
                        ImsManager.log("mBroadcastReceiver simState:" + action);
                    }
                }
            };
            this.mBroadcastReceiverRegistered = DBG;
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static void refreshDatabaseSwitchByUiSwitch(Context context, int phoneId) {
        getVolteSwitchUIState(context, phoneId);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public static boolean getVolteSwitchUIState(Context context, int phoneId) {
        boolean enabled = false;
        ImsManager instance = getInstance(context, phoneId);
        if (instance != null) {
            enabled = instance.isEnhanced4gLteModeSettingEnabledByUserForSlot();
        }
        int uiVolteSwitch = getVolteSwitchUIState(phoneId);
        if (uiVolteSwitch != -1) {
            boolean switchMismatched = false;
            uiVolteSwitch &= 1;
            if (uiVolteSwitch == 1) {
                switchMismatched = enabled ^ 1;
                enabled = DBG;
            } else if (uiVolteSwitch == 0) {
                switchMismatched = enabled;
                enabled = false;
            }
            if (switchMismatched && SubscriptionManager.isValidPhoneId(phoneId)) {
                try {
                    loge("getVolteSwitchUIState() database switch override with ui switch");
                    if (instance != null && ((TelephonyManager) instance.mContext.getSystemService("phone")).getSimState(phoneId) == 5) {
                        instance.setEnhanced4gLteModeSettingForSlot(enabled);
                    }
                } catch (Exception e) {
                }
            }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static int getVoltePhoneId(Context context, int phoneId) {
        if (phoneId == -1) {
            phoneId = SubscriptionManager.from(context).getDefaultDataPhoneId();
        }
        if (phoneId != 0 || !TelephonyManager.getDefault().isMultiSimEnabled()) {
            return phoneId;
        }
        TelephonyManager tm = (TelephonyManager) context.getSystemService("phone");
        int sim1State = tm.getSimState(0);
        int sim2State = tm.getSimState(1);
        boolean sim1Inserted = sim1State != 1 ? sim1State != 0 ? DBG : false : false;
        boolean sim2Inserted = sim2State != 1 ? sim2State != 0 ? DBG : false : false;
        if (!sim2Inserted || (sim1Inserted ^ 1) == 0) {
            return phoneId;
        }
        loge("getVoltePhoneId() phoneId change to 1, sim1Inserted=" + sim1Inserted + ", sim2Inserted=" + sim2Inserted);
        return 1;
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static VivoTelephonyApiParams invokeVivoTelephonyApi(VivoTelephonyApiParams param) {
        try {
            return ITelephony.Stub.asInterface(ServiceManager.getService("phone")).vivoTelephonyApi(param);
        } catch (RemoteException e) {
            log("invokeVivoTelephonyApi()  catch RemoteException!");
        } catch (NullPointerException e2) {
            log("invokeVivoTelephonyApi()  catch NullPointerException!");
        } catch (Exception e3) {
            log("invokeVivoTelephonyApi()  catch Exception!");
        }
        return null;
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static int getVolteSwitchUIState(int phoneId) {
        VivoTelephonyApiParams param = new VivoTelephonyApiParams("API_TAG_getVolteSwitchUIState");
        param.put("phoneId", Integer.valueOf(phoneId));
        VivoTelephonyApiParams ret = invokeVivoTelephonyApi(param);
        if (ret != null) {
            return ret.getAsInteger("uiState").intValue();
        }
        return -1;
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static void onEnhanced4gLteModeSettingChanged(Context context, int phoneId, boolean enabled, boolean updateConfig) {
        VivoTelephonyApiParams param = new VivoTelephonyApiParams("API_TAG_onEnhanced4gLteModeSettingChanged");
        param.put("packageName", context.getPackageName());
        param.put("phoneId", Integer.valueOf(phoneId));
        param.put("enabled", Boolean.valueOf(enabled));
        param.put("updateConfig", Boolean.valueOf(updateConfig));
        invokeVivoTelephonyApi(param);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private static void onImsOnOffActionTriggered(int phoneId, boolean enabled) {
        VivoTelephonyApiParams param = new VivoTelephonyApiParams("API_TAG_onImsOnOffActionTriggered");
        param.put("phoneId", Integer.valueOf(phoneId));
        param.put("enabled", Boolean.valueOf(enabled));
        invokeVivoTelephonyApi(param);
    }

...
public class SystemNotificationChannels {
    ...
    public static String VIVO_USB = "VIVO_USB";
    ...
    public static void createAll(Context context) {
        ...
        channelsList.add(new NotificationChannel(VIVO_USB, context.getString(R.string.notification_channel_usb), 2));
        channelsList.add(new NotificationChannel(ZEN_MODE, context.getString(com.vivo.internal.R.string.zen_mode_channel_name), 2));

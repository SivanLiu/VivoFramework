...
import com.android.internal.telephony.RoamingStatusCollectHelper;
...
public class IccCardProxy extends Handler implements IccCard {
    ...
    private static final /* synthetic */ int[] f19x8dbfd0b5 = null;
    /* renamed from: -com-android-internal-telephony-uicc-IccCardApplicationStatus$AppStateSwitchesValues */
    private static final /* synthetic */ int[] f20x3dee1264 = null;
    ...
    static final String VIVO_ACTION_SIM_STATE_CHANGED = "vivo.intent.action.ACTION_SIM_STATE_CHANGED";
    ...
    private void onRecordsLoaded() {
        RoamingStatusCollectHelper.getInstance().onRecordsLoaded(this.mPhoneId.intValue());
        broadcastInternalIccStateChangedIntent("LOADED", null);
    }

    /* JADX WARNING: Missing block: B:30:0x0067, code:
            if (r8.mUiccCard != r1) goto L_0x003a;
     */
    ...
    private void updateIccAvailability() {
        synchronized (this.mLock) {
            ...
            if (newCard != null) {
                ...
                if (newApp == null) {
                    log("updateIccAvailability newApp is null");
                    if (this.mCurrentAppType == 1) {
                        newApp = newCard.getApplication(2);
                ...
                if (newApp != null) {
                    ...
                    log("updateIccAvailability newApp is still null");
                }
            }
    ...
    /* JADX WARNING: Missing block: B:25:0x0119, code:
            return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    @VivoHook(hookType = VivoHookType.CHANGE_CODE)
    private void broadcastIccStateChangedIntent(String value, String reason) {
        synchronized (this.mLock) {
            if (this.mPhoneId == null || (SubscriptionManager.isValidSlotIndex(this.mPhoneId.intValue()) ^ 1) != 0) {
                ...
                if ("ABSENT".equals(value) || "CARD_IO_ERROR".equals(value) || "LOADED".equals(value)) {
                    Intent vivointent = new Intent(VIVO_ACTION_SIM_STATE_CHANGED);
                    vivointent.addFlags(QtiCallConstants.CAPABILITY_SUPPORTS_DOWNGRADE_TO_VOICE_REMOTE);
                    vivointent.putExtra("phoneName", "Phone");
                    vivointent.putExtra("ss", value);
                    vivointent.putExtra("reason", reason);
                    vivointent.putExtra("phone", this.mPhoneId);
                    SubscriptionManager.putPhoneIdAndSubIdExtra(vivointent, this.mPhoneId.intValue());
                    ActivityManager.broadcastStickyIntent(vivointent, -1);
                }
            }
        }
    }

    /* JADX WARNING: Missing block: B:17:0x00d8, code:
            return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void broadcastInternalIccStateChangedIntent(String value, String reason) {
        synchronized (this.mLock) {
            ...
            if ("ABSENT".equals(value) || "CARD_IO_ERROR".equals(value) || "LOADED".equals(value)) {
                ...
                vivointent.putExtra("phone", this.mPhoneId);
                SubscriptionManager.putPhoneIdAndSubIdExtra(vivointent, this.mPhoneId.intValue());
                log("Sending intent VIVO_ACTION_INTERNAL_SIM_STATE_CHANGED for mPhoneId : " + this.mPhoneId + " value:" + value);
                ActivityManager.broadcastStickyIntent(vivointent, -1);
            }
        }
    }

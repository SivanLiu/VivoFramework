...
public class PhoneConstantConversions {
    ...
    private static final /* synthetic */ int[] f138xce0d2696 = null;
    /* renamed from: -com-android-internal-telephony-PhoneConstants$StateSwitchesValues */
    private static final /* synthetic */ int[] f139xb32e9020 = null;

    /* renamed from: -getcom-android-internal-telephony-PhoneConstants$DataStateSwitchesValues */
    private static /* synthetic */ int[] m61x9dac0c3a() {
        if (f138xce0d2696 != null) {
            return f138xce0d2696;
        }
    ...
    private static /* synthetic */ int[] m62x3549e7c4() {
        if (f139xb32e9020 != null) {
            return f139xb32e9020;
        }
    ...
    public static int convertCallState(State state) {
        switch (m62x3549e7c4()[state.ordinal()]) {
            case 1:
                return 2;
            case 2:
                return 1;
    ...
    public static int convertDataState(DataState state) {
        switch (m61x9dac0c3a()[state.ordinal()]) {
            case 1:
                return 2;
            case 2:
                return 1;

...
public class ApnContext {
    ...
    public boolean isProvisioningApn() {
        String provisioningApn = this.mPhone.getContext().getResources().getString(17040369);
    ...
    public void resetErrorCodeRetries() {
        ...
        String[] config = this.mPhone.getContext().getResources().getStringArray(17235992);
    ...
    private void updateApnStateSpIfNeeded() {
        if (TextUtils.equals(this.mApnType, "mms") || TextUtils.equals(this.mApnType, "default")) {
            VivoCallServiceStateHelper.updateApnStateSP(this.mPhone.getContext(), this.mPhone.getPhoneId(), this.mApnType, this.mState);
        }
    }

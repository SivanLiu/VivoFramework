...
public class ApnSetting {
    ...
    public boolean equals(Object o) {
        ...
        if (Objects.equals(this.carrier, other.carrier) && this.id == other.id && Objects.equals(this.numeric, other.numeric) && Objects.equals(this.apn, other.apn) && Objects.equals(this.proxy, other.proxy) && Objects.equals(this.mmsc, other.mmsc) && Objects.equals(this.mmsProxy, other.mmsProxy) && Objects.equals(this.port, other.port) && this.authType == other.authType && Arrays.deepEquals(this.types, other.types) && Objects.equals(this.protocol, other.protocol) && Objects.equals(this.roamingProtocol, other.roamingProtocol) && this.carrierEnabled == other.carrierEnabled && this.bearer == other.bearer && this.bearerBitmask == other.bearerBitmask && this.profileId == other.profileId && this.modemCognitive == other.modemCognitive && this.maxConns == other.maxConns && this.waitTime == other.waitTime && this.maxConnsTime == other.maxConnsTime && this.mtu == other.mtu && this.mvnoType.equals(other.mvnoType)) {
    ...
    public boolean equals(Object o, boolean isDataRoaming) {
        ...
        ApnSetting other = (ApnSetting) o;
        if (Objects.equals(this.carrier, other.carrier) && Objects.equals(this.numeric, other.numeric) && Objects.equals(this.apn, other.apn) && Objects.equals(this.proxy, other.proxy) && Objects.equals(this.mmsc, other.mmsc) && Objects.equals(this.mmsProxy, other.mmsProxy) && Objects.equals(this.mmsPort, other.mmsPort) && Objects.equals(this.port, other.port) && Objects.equals(this.user, other.user) && Objects.equals(this.password, other.password) && this.authType == other.authType && Arrays.deepEquals(this.types, other.types) && this.typesBitmap == other.typesBitmap && ((isDataRoaming || Objects.equals(this.protocol, other.protocol)) && ((!isDataRoaming || Objects.equals(this.roamingProtocol, other.roamingProtocol)) && this.carrierEnabled == other.carrierEnabled && this.profileId == other.profileId && this.modemCognitive == other.modemCognitive && this.maxConns == other.maxConns && this.waitTime == other.waitTime && this.maxConnsTime == other.maxConnsTime && this.mtu == other.mtu && Objects.equals(this.mvnoType, other.mvnoType)))) {
            z = Objects.equals(this.mvnoMatchData, other.mvnoMatchData);
        }
        return z;
    }

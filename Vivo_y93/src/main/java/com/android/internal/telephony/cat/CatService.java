...
public class CatService extends Handler implements AppInterface {
    ...
    private static final /* synthetic */ int[] f29x72eb89a2 = null;
    /* renamed from: -com-android-internal-telephony-cat-ResultCodeSwitchesValues */
    private static final /* synthetic */ int[] f30-com-android-internal-telephony-cat-ResultCodeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m30xe796fd46() {
        if (f29x72eb89a2 != null) {
            return f29x72eb89a2;
        }
    ...
    private static /* synthetic */ int[] m31-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues() {
        if (f30-com-android-internal-telephony-cat-ResultCodeSwitchesValues != null) {
            return f30-com-android-internal-telephony-cat-ResultCodeSwitchesValues;
        }
        ...
        f30-com-android-internal-telephony-cat-ResultCodeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private void handleCommand(CommandParams cmdParams, boolean isProactiveCmd) {
        ...
        switch (m30xe796fd46()[cmdParams.getCommandType().ordinal()]) {
            case 1:
            ...
            case 6:
                if (((LaunchBrowserParams) cmdParams).mConfirmMsg.text != null && ((LaunchBrowserParams) cmdParams).mConfirmMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17040151);
            ...
            case 17:
                if (((DisplayTextParams) cmdParams).mTextMsg.text != null && ((DisplayTextParams) cmdParams).mTextMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17041262);
            ...
            case 18:
                if (((CallSetupParams) cmdParams).mConfirmMsg.text != null && ((CallSetupParams) cmdParams).mConfirmMsg.text.equals(STK_DEFAULT)) {
                    message = this.mContext.getText(17039429);
        ...
        if (this.mCurrntCmd != null) {
            CatLog.d((Object) this, "STK_TEXT handleCommand mCurrntCmd.mCmdDet: " + this.mCurrntCmd.mCmdDet);
        }
    ...
    private void handleSessionEnd() {
        ...
        if (this.mMenuCmd != null) {
            CatLog.d((Object) this, "STK_TEXT handleSessionEnd mMenuCmd.mCmdDet: " + this.mMenuCmd.mCmdDet);
        }
    ...
    private void encodeOptionalTags(CommandDetails cmdDet, ResultCode resultCode, Input cmdInput, ByteArrayOutputStream buf) {
        ...
        if (cmdType != null) {
            switch (m30xe796fd46()[cmdType.ordinal()]) {
                case 4:
        ...
        switch (msg.what) {
            ...
            case 5:
                ...
                if (this.mMsgDecoder != null) {
                    ...
                    CatLog.d((Object) this, "card is dispose so no need to invoke handleMessage");
                    return;
                }
            case 4:
                if (this.mMsgDecoder != null) {
    ...
    private boolean validateResponse(CatResponseMessage resMsg) {
        ...
        if (this.mCurrntCmd != null) {
            CatLog.d((Object) this, "STK_TEXT validateResponse mCurrntCmd.mCmdDet: " + this.mCurrntCmd.mCmdDet);
        }
        if (resMsg != null) {
            CatLog.d((Object) this, "STK_TEXT validateResponse resMsg.mCmdDet: " + resMsg.mCmdDet);
        }
        if (resMsg.mCmdDet.typeOfCommand == CommandType.SET_UP_EVENT_LIST.value() || resMsg.mCmdDet.typeOfCommand == CommandType.SET_UP_MENU.value()) {
            ...
            CatLog.d((Object) this, "mCurrntCmd is null");
        }
        CatLog.d((Object) this, "validateResponse: " + validResponse);
    ...
    /* JADX WARNING: Missing block: B:11:0x0066, code:
            return;
     */
    /* JADX WARNING: Missing block: B:13:0x006b, code:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.HELP_INFO_REQUIRED) goto L_0x0074;
     */
    ...
    /* JADX WARNING: Missing block: B:16:0x0073, code:
            return;
     */
    /* JADX WARNING: Missing block: B:17:0x0074, code:
            r6 = false;
     */
    ...
    /* JADX WARNING: Missing block: B:20:0x0086, code:
            if (r7.yesNo != false) goto L_0x0096;
     */
     ...
     */
    /* JADX WARNING: Missing block: B:23:0x0096, code:
    ...
    /* JADX WARNING: Missing block: B:25:0x00a2, code:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.TERMINAL_CRNTLY_UNABLE_TO_PROCESS) goto L_0x00aa;
     */
     ...
     */
    /* JADX WARNING: Missing block: B:30:0x00b3, code:
            if (r12.mResCode != com.android.internal.telephony.cat.ResultCode.LAUNCH_BROWSER_ERROR) goto L_0x00bb;
     */
    ...
    /* JADX WARNING: Missing block: B:37:0x00cd, code:
            if (5 != r12.mEventValue) goto L_0x00d9;
     */
    /* JADX WARNING: Missing block: B:38:0x00cf, code:
            eventDownload(r12.mEventValue, 2, 129, r12.mAddedInfo, false);
     */
    /* JADX WARNING: Missing block: B:39:0x00d8, code:
            return;
     */
    /* JADX WARNING: Missing block: B:40:0x00d9, code:
            eventDownload(r12.mEventValue, 130, 129, r12.mAddedInfo, false);
     */
    /* JADX WARNING: Missing block: B:52:0x0103, code:
            r5 = null;
     */
    ...
    private void handleCmdResponse(CatResponseMessage resMsg) {
        if (validateResponse(resMsg)) {
            ...
            CatLog.d((Object) this, "STK_TEXT handleCmdResponse resMsg.mResCode: " + resMsg.mResCode + ", type: " + type);
            switch (m31-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues()[resMsg.mResCode.ordinal()]) {
                case 1:
                case 17:

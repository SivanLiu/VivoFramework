...
public class ImsPhoneConnection extends Connection implements ImsVideoProviderWrapperCallback {
    ...
    private static /* synthetic */ int[] m45-getcom-android-internal-telephony-Call$StateSwitchesValues() {
    ...
    /* synthetic */ void m46x78256a1(String message) {
    ...
    private static int toTelecomCallState(State state) {
        switch (m45-getcom-android-internal-telephony-Call$StateSwitchesValues()[state.ordinal()]) {
            case 1:
                return 4;
            case 2:
                return 1;

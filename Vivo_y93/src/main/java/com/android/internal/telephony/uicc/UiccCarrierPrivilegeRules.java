...
public class UiccCarrierPrivilegeRules extends Handler {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x017a A:{Splitter: B:30:0x00f7, ExcHandler: java.lang.IllegalArgumentException (r16_0 'ex' java.lang.RuntimeException)} */
    /* JADX WARNING: Missing block: B:37:0x017a, code:
            r16 = move-exception;
     */
    /* JADX WARNING: Missing block: B:38:0x017b, code:
        ...
        switch (msg.what) {
            case 1:
                ...
                if (ar.exception == null && ar.result != null) {
                    ...
                    this.mChannelId = i;
                    if (i > 0) {
                        this.mUiccCard.iccTransmitApduLogicalChannel(this.mChannelId, 128, COMMAND, 255, 64, 0, DATA, obtainMessage(2, Integer.valueOf(this.mChannelId)));
                        return;
                    }
                }
                if ((ar.exception instanceof CommandException) && this.mRetryCount < 1 && ((CommandException) ar.exception).getCommandError() == Error.MISSING_RESOURCE) {
                    this.mRetryCount++;
                    removeCallbacks(this.mRetryRunnable);
                    postDelayed(this.mRetryRunnable, VivoNetLowlatency.LEVEL_SET_MINIMUM_TIME_INTERVAL);
                    return;
                }
                    ...
                    if (response.sw1 != 144 || response.sw2 != 0 || response.payload == null || response.payload.length <= 0) {
                        ...
                        try {
                            ...
                            if (isDataComplete()) {
                                ...
                                this.mUiccCard.iccTransmitApduLogicalChannel(this.mChannelId, 128, COMMAND, 255, 96, 0, DATA, obtainMessage(2, Integer.valueOf(this.mChannelId)));
                                return;
                            }

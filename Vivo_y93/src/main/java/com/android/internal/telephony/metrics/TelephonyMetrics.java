...
public class TelephonyMetrics {
    ...
    private static final /* synthetic */ int[] f7xb32e9020 = null;
    ...
    private static /* synthetic */ int[] m6-getcom-android-internal-telephony-Call$StateSwitchesValues() {
    ...
    private static /* synthetic */ int[] m7x3549e7c4() {
        if (f7xb32e9020 != null) {
            return f7xb32e9020;
        }
    ...
    static int toPrivacyFuzzedTimeInterval(long previousTimestamp, long currentTimestamp) {
        ...
        if (diff <= VivoNetLowlatency.LEVEL_SET_MINIMUM_TIME_INTERVAL) {
            return 10;
        }
        if (diff <= 30000) {
            return 11;
    ...
    private void convertConnectionToRilCall(GsmCdmaConnection conn, RilCall call) {
        ...
        switch (m6-getcom-android-internal-telephony-Call$StateSwitchesValues()[conn.getState().ordinal()]) {
            case 1:
                call.state = 2;
                break;
            case 2:
    ...
    public void writePhoneState(int phoneId, PhoneConstants.State phoneState) {
        int state;
        switch (m7x3549e7c4()[phoneState.ordinal()]) {
            case 1:
                state = 1;
                break;
            case 2:
    ...
    public void writeImsCallState(int phoneId, ImsCallSession session, State callState) {
        int state;
        switch (m6-getcom-android-internal-telephony-Call$StateSwitchesValues()[callState.ordinal()]) {
            case 1:
                state = 2;
                break;
            case 2:

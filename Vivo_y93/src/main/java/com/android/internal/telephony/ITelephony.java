...
public interface ITelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephony {
        ...
        static final int TRANSACTION_registerVivoApiCallback = 169;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            VivoTelephonyApiParams _arg04;
            VivoTelephonyApiParams _result10;
            switch (code) {
                case 1:
                ...
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    List<NeighboringCellInfo> _result11 = getNeighboringCellInfo(data.readString());
                    reply.writeNoException();
                ...
                case 82:
                    data.enforceInterface(DESCRIPTOR);
                    List<CellInfo> _result12 = getAllCellInfo(data.readString());
                    reply.writeNoException();
                ...
                case 85:
                    data.enforceInterface(DESCRIPTOR);
                    IccOpenLogicalChannelResponse _result13 = iccOpenLogicalChannel(data.readInt(), data.readString(), data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result13 != null) {
                        reply.writeInt(1);
                ...
                case 98:
                    data.enforceInterface(DESCRIPTOR);
                    IImsServiceController _result14 = getImsServiceControllerAndListen(data.readInt(), data.readInt(), com.android.ims.internal.IImsServiceFeatureListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 100:
                    data.enforceInterface(DESCRIPTOR);
                    CellNetworkScanResult _result15 = getCellNetworkScanResults(data.readInt());
                    reply.writeNoException();
                    if (_result15 != null) {
                        reply.writeInt(1);
                ...
                case 114:
                    ...
                    _result9 = getCarrierPackageNamesForIntentAndPhone(_arg05, data.readInt());
                    reply.writeNoException();
                ...
                case 121:
                    ...
                    _result5 = invokeOemRilRequestRaw(_arg06, _arg16);
                    reply.writeNoException();
                    reply.writeInt(_result5);
                ...
                case 140:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg07 = (PhoneAccount) PhoneAccount.CREATOR.createFromParcel(data);
                    } else {
                        _arg07 = null;
                    }
                    _result5 = getSubIdForPhoneAccount(_arg07);
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 141:
                ...
                case 143:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg08 = (ResultReceiver) ResultReceiver.CREATOR.createFromParcel(data);
                    } else {
                        _arg08 = null;
                    }
                    requestModemActivityInfo(_arg08);
                    return true;
                case 144:
                    data.enforceInterface(DESCRIPTOR);
                    ServiceState _result16 = getServiceStateForSubscriber(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result16 != null) {
                        reply.writeInt(1);
                ...
                case 145:
                    ...
                    Uri _result17 = getVoicemailRingtoneUri(_arg03);
                    reply.writeNoException();
                    if (_result17 != null) {
                        reply.writeInt(1);
                ...
                case 153:
                    data.enforceInterface(DESCRIPTOR);
                    List<TelephonyHistogram> _result18 = getTelephonyHistograms();
                    reply.writeNoException();
                ...
                case 155:
                    data.enforceInterface(DESCRIPTOR);
                    List<CarrierIdentifier> _result19 = getAllowedCarriers(data.readInt());
                    reply.writeNoException();
                ...
                case 159:
                    data.enforceInterface(DESCRIPTOR);
                    NetworkStats _result20 = getVtDataUsage(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    if (_result20 != null) {
                        reply.writeInt(1);
                ...
                case 161:
                    data.enforceInterface(DESCRIPTOR);
                    List<ClientRequestStats> _result21 = getClientRequestStats(data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 167:
                    data.enforceInterface(DESCRIPTOR);
                    SignalStrength _result22 = getSignalStrength(data.readInt());
                    reply.writeNoException();
                    if (_result22 != null) {
                        reply.writeInt(1);
                ...
                case 168:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (VivoTelephonyApiParams) VivoTelephonyApiParams.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    _result10 = vivoTelephonyApi(_arg04);
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                ...
                case 169:
                    ...
                    _result10 = registerVivoApiCallback(_arg04, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);
                ...
                case 170:
                    ...
                    _result10 = unregisterVivoApiCallback(_arg04, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);

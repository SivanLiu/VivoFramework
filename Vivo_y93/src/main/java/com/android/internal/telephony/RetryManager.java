...
public class RetryManager {
    ...
    private void configureRetry() {
        ...
        try {
            ...
            this.mInterApnDelay = b.getLong("carrier_data_call_apn_delay_default_long", 3000);
            this.mFailFastInterApnDelay = b.getLong("carrier_data_call_apn_delay_faster_long", 3000);
            this.mApnRetryAfterDisconnectDelay = b.getLong("carrier_data_call_apn_retry_after_disconnect_long", 10000);

...
public class UiccCardApplication {
    ...
    private static final /* synthetic */ int[] f11x1911c1cf = null;
    /* renamed from: -com-android-internal-telephony-uicc-IccCardApplicationStatus$PersoSubStateSwitchesValues */
    private static final /* synthetic */ int[] f12x16bf601e = null;
    ...
    private static /* synthetic */ int[] m11x31a426ab() {
        if (f11x1911c1cf != null) {
            return f11x1911c1cf;
        }
    ...
    private static /* synthetic */ int[] m12x5ed1affa() {
        if (f12x16bf601e != null) {
            return f12x16bf601e;
        }
    ...
    private static /* synthetic */ int[] m13xc1fb5860() {
    ...
    /* JADX WARNING: Missing block: B:33:0x00d7, code:
            return;
     */
    ...
    private IccFileHandler createIccFileHandler(AppType type) {
        switch (m11x31a426ab()[type.ordinal()]) {
            case 1:
    ...
    private void onQueryFacilityLock(AsyncResult ar) {
        ...
        synchronized (this.mLock) {
            ...
            if (ints.length != 0) {
                ...
                switch (m13xc1fb5860()[this.mPin1State.ordinal()]) {
                    case 1:
                        if (this.mIccLockEnabled) {
    ...
    private static int getAuthContext(AppType appType) {
        switch (m11x31a426ab()[appType.ordinal()]) {
            case 4:
                return 128;
            case 5:
                return 129;
    ...
    public boolean isPersoLocked() {
        switch (m12x5ed1affa()[this.mPersoSubState.ordinal()]) {
            case 1:
            case 2:
            case 3:
                return false;

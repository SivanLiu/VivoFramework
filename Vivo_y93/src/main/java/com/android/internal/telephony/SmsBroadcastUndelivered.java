...
public class SmsBroadcastUndelivered {
    ...
    private static final String[] PDU_PENDING_MESSAGE_PROJECTION = new String[]{"pdu", "sequence", "destination_port", "date", "reference_number", "count", "address", HbpcdLookup.ID, "message_body", "display_originating_addr"};
    ...
    private void scanRawTable() {
        ...
        try {
            ...
            Rlog.e(TAG, "SecurityException:" + se.toString());
        }
        if (cursor == null) {
            try {

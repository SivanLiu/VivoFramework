...
public class ResultException extends CatException {
    ...
    private static final /* synthetic */ int[] f26-com-android-internal-telephony-cat-ResultCodeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m25-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues() {
        if (f26-com-android-internal-telephony-cat-ResultCodeSwitchesValues != null) {
            return f26-com-android-internal-telephony-cat-ResultCodeSwitchesValues;
        }
        ...
        f26-com-android-internal-telephony-cat-ResultCodeSwitchesValues = iArr;
        return iArr;
    }

    public ResultException(ResultCode result) {
        switch (m25-getcom-android-internal-telephony-cat-ResultCodeSwitchesValues()[result.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:

...
public class SipPhone extends SipPhoneBase {
    ...
    private abstract class SipAudioCallAdapter extends Listener {
        ...
        public void onError(SipAudioCall call, int errorCode, String errorMessage) {
            ...
            switch (errorCode) {
                case IccProvider.ERROR_ICC_PROVIDER_EMAIL_FULL /*-12*/:
                    onError(9);
                    return;
                case IccProvider.ERROR_ICC_PROVIDER_ADN_LIST_NOT_EXIST /*-11*/:
                    onError(11);
                    return;
                case IccProvider.ERROR_ICC_PROVIDER_GENERIC_FAILURE /*-10*/:
                    onError(14);
                    return;
                case -8:
                    onError(10);

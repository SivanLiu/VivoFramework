...
public abstract class BaseCommands implements CommandsInterface {
    ...
    protected Registrant mAudioPdStateChangeRegistrant;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    protected Registrant mMccChangedRegistrant;
    protected Registrant mMiscInfoRegistrant;
    ...
    protected Registrant mSignalPollRegistrant;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    protected Registrant mUiNotReadyRegistrant;
    ...
    public void setOnSignalPoll(Handler h, int what, Object obj) {
        this.mSignalPollRegistrant = new Registrant(h, what, obj);
    }
    ...
    public void registerForMiscInfo(Handler h, int what, Object obj) {
        this.mMiscInfoRegistrant = new Registrant(h, what, obj);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void unregisterForMiscInfo(Handler h) {
        if (this.mMiscInfoRegistrant != null && this.mMiscInfoRegistrant.getHandler() == h) {
            this.mMiscInfoRegistrant.clear();
            this.mMiscInfoRegistrant = null;
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void setUiNotReadyEvent(Handler h, int what, Object obj) {
        this.mUiNotReadyRegistrant = new Registrant(h, what, obj);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void unSetUiNotReadyEvent(Handler h) {
        if (this.mUiNotReadyRegistrant != null && this.mUiNotReadyRegistrant.getHandler() == h) {
            this.mUiNotReadyRegistrant.clear();
            this.mUiNotReadyRegistrant = null;
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void setAudioPdStateChangeEvent(Handler h, int what, Object obj) {
        this.mAudioPdStateChangeRegistrant = new Registrant(h, what, obj);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void unSetAudioPdStateChangeEvent(Handler h) {
        if (this.mAudioPdStateChangeRegistrant != null && this.mAudioPdStateChangeRegistrant.getHandler() == h) {
            this.mAudioPdStateChangeRegistrant.clear();
            this.mAudioPdStateChangeRegistrant = null;
        }
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void setMccChangedEvent(Handler h, int what, Object obj) {
        this.mMccChangedRegistrant = new Registrant(h, what, obj);
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void unSetMccChangedEvent(Handler h) {
        if (this.mMccChangedRegistrant != null && this.mMccChangedRegistrant.getHandler() == h) {
            this.mMccChangedRegistrant.clear();
            this.mMccChangedRegistrant = null;
        }
    }
}

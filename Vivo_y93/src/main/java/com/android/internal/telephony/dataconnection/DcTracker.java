...
import com.android.internal.telephony.VivoCallServiceStateHelper;
import com.android.internal.telephony.VivoNetLowlatency;
...
public class DcTracker extends Handler {
    ...
    private static final String DATA_ERR_CLEANUP_ALL_CONNECT = "android.vivo.dataerr.cleanupallcon";
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private static final String DATA_ERR_RESTART_RADIO = "android.vivo.dataerr.restartradio";
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static int DELAY_TIME_RESTART_PDP_DELAY = 600000;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_CHILDREN_MODE_CHANGED = 1002;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_CT_DATA_BLOCK_CHANGED = 1007;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_CT_DATA_CONNECT_CHANGED = 1008;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_DATA_BLOCK_DATA_CHANGED = 1005;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_DATA_BLOCK_SIM_CHANGED = 1004;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_DATA_MODE_CHANGED = 1003;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_NCT_DATA_BLOCK_CHANGED = 1009;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int EVENT_PS_RESTART_PDP_DELAY = 1001;
    ...
    private static final int QCRIL_EVT_HOOK_BASE = 524288;
    private static final int QCRIL_EVT_HOOK_MISC_INFO_REQ = 524793;
    private static final boolean RADIO_TESTS = false;
    private static final boolean VDBG = false;
    private static final boolean VDBG_STALL = false;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static int psRestartPdpNum = 0;
    private static int sEnableFailFastRefCounter = 0;
    protected String LOG_TAG;
    private String RADIO_RESET_PROPERTY;
    private int ctvpdnFlag;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private boolean dataconnect_flag;
    ...
    private ApnStateSpListener mApnStateSpListener;
    ...
    private ContentObserver mChildModeDataEnableObserver;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public boolean mChildrenMode;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public boolean mChildrenModeDataOn;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private ContentObserver mChildrenModeObserver;
    private final ConnectivityManager mCm;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private int mCtDataBlock;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mCtDataBlockObserver;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private int mCtDataConnect;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mCtDataConnectObserver;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mDataBlockDataObserver;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mDataBlockSimObserver;
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mDataModeObserver;
    ...
    public boolean mIsOtherPhoneInCallState;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private long mLastRestartRadioTime;
    private boolean mMeteredApnDisabled;
    protected boolean mMvnoMatched;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private int mNCtDataBlock;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private ContentObserver mNctDataBlockObserver;
    private boolean mNetStatPollEnabled;
    private int mNetStatPollPeriod;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private int mNetworkDataBlockData;
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private int mNetworkDataBlockSim;
    private int mNoRecvPollCount;
    private final OnSubscriptionsChangedListener mOnSubscriptionsChangedListener;
    public long mOtherPhoneApnState;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private int mRetryDataCallForPdpRejectConut;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public boolean pdp_status_flag;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private int ps_err_delay_plug;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private String vivo_mtpf_type;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private String vivo_net_entry;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private String vivo_op_entry;
    ...
    private class ApnStateSpListener implements OnSharedPreferenceChangeListener {
        /* renamed from: -com-android-internal-telephony-DctConstants$StateSwitchesValues */
        private static final /* synthetic */ int[] f16-com-android-internal-telephony-DctConstants$StateSwitchesValues = null;
        ...
        private static /* synthetic */ int[] m16xf0fbc33d() {
            if (f16-com-android-internal-telephony-DctConstants$StateSwitchesValues != null) {
                return f16-com-android-internal-telephony-DctConstants$StateSwitchesValues;
            }
            ...
            f16-com-android-internal-telephony-DctConstants$StateSwitchesValues = iArr;
            return iArr;
        }

        /* synthetic */ ApnStateSpListener(DcTracker this$0, ApnStateSpListener -this1) {
            this();
        }

        private ApnStateSpListener() {
        }

        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            int phoneId = DcTracker.this.mPhone.getPhoneId();
            DcTracker.this.log("changed = " + key);
            if (key.startsWith(VivoCallServiceStateHelper.KEY_PHONE_APN_STATE)) {
                String[] keyItems = key.split("-");
                if (keyItems != null && keyItems.length >= 3) {
                    String changedApnType = keyItems[1];
                    if (Integer.parseInt(keyItems[2]) != phoneId) {
                        int apnStateValue = sharedPreferences.getInt(key, 0);
                        if (apnStateValue < State.values().length) {
                            if (changedApnType.equals("mms") || changedApnType.equals("default")) {
                                int index = (DcTracker.this.getApnPriority(changedApnType) * 10) + ApnContext.apnIdForApnName(changedApnType);
                                DcTracker.this.log("mOtherPhoneApnState changedApnType = " + changedApnType + ", index = " + index);
                                switch (m16xf0fbc33d()[State.values()[apnStateValue].ordinal()]) {
                                    case 1:
                                    case 2:
                                        DcTracker.this.mOtherPhoneApnState |= 1 << index;
                                        break;
                                    default:
                                        DcTracker.this.mOtherPhoneApnState &= ~(1 << index);
                                        break;
                                }
                                DcTracker.this.log("mOtherPhoneApnState = " + DcTracker.this.mOtherPhoneApnState);
                                DcTracker.this.notifyDataConnection(null);
                            }
                        }
                    }
                }
            } else if (VivoCallServiceStateHelper.PHONE0_CALL_STATE.equals(key) || VivoCallServiceStateHelper.PHONE1_CALL_STATE.equals(key)) {
                int otherPhoneCallState = VivoCallServiceStateHelper.VOICE_CALL_END;
                if (phoneId == 0) {
                    otherPhoneCallState = sharedPreferences.getInt(VivoCallServiceStateHelper.PHONE1_CALL_STATE, -1);
                } else {
                    otherPhoneCallState = sharedPreferences.getInt(VivoCallServiceStateHelper.PHONE0_CALL_STATE, -1);
                }
                if (otherPhoneCallState == VivoCallServiceStateHelper.VOICE_CALL_START && (DcTracker.this.mIsOtherPhoneInCallState ^ 1) != 0) {
                    DcTracker.this.log("onOtherPhoneVoiceCallStarted");
                    DcTracker.this.mIsOtherPhoneInCallState = true;
                    if (DcTracker.this.isConnected()) {
                        DcTracker.this.notifyDataConnection(PhoneInternalInterface.REASON_VOICE_CALL_STARTED);
                        if (!DcTracker.this.mPhone.getServiceStateTracker().isConcurrentVoiceAndDataAllowed()) {
                            DcTracker.this.stopNetStatPoll();
                            DcTracker.this.stopDataStallAlarm();
                        }
                    }
                } else if (otherPhoneCallState == VivoCallServiceStateHelper.VOICE_CALL_END && DcTracker.this.mIsOtherPhoneInCallState) {
                    DcTracker.this.log("onOtherPhoneVoiceCallEnded");
                    DcTracker.this.mIsOtherPhoneInCallState = false;
                    if (DcTracker.this.isConnected()) {
                        DcTracker.this.notifyDataConnection(PhoneInternalInterface.REASON_VOICE_CALL_ENDED);
                        if (DcTracker.this.mPhone.getServiceStateTracker().isConcurrentVoiceAndDataAllowed()) {
                            DcTracker.this.resetPollStats();
                        } else {
                            DcTracker.this.startNetStatPoll();
                            DcTracker.this.startDataStallAlarm(false);
                        }
                    }
                    DcTracker.this.setupDataOnConnectableApns(PhoneInternalInterface.REASON_VOICE_CALL_ENDED);
                }
            }
        }
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_CLASS)
    private class ChildrenModeObserver extends ContentObserver {
        public ChildrenModeObserver() {
            super(DcTracker.this.mDataConnectionTracker);
        }
        ...
        public void onChange(boolean selfChange) {
            new Thread(new Runnable() {
                public void run() {
                    DcTracker.this.checkChildrenMode();
                    DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1002));
                }
            }).start();
        }
    }
    ...
    private class ProvisionNotificationBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            DcTracker.this.mProvisioningSpinner.setMessage(context.getText(17040262));
    ...
    /* renamed from: -getcom-android-internal-telephony-DctConstants$StateSwitchesValues */
    private static /* synthetic */ int[] m15xf0fbc33d() {
        if (f15-com-android-internal-telephony-DctConstants$StateSwitchesValues != null) {
            return f15-com-android-internal-telephony-DctConstants$StateSwitchesValues;
        }
        int[] iArr = new int[State.values().length];
        try {
            iArr[State.CONNECTED.ordinal()] = 1;
        ...
        f15-com-android-internal-telephony-DctConstants$StateSwitchesValues = iArr;
        return iArr;
    }

    public void sendMiscInfo(int commandId, String buffer, Message onCompleted) {
        byte[] requestInfo = new byte[(((OEM_IDENTIFIER.length() + 8) + 1) + buffer.length())];
        ByteBuffer buf = ByteBuffer.wrap(requestInfo);
        buf.order(ByteOrder.nativeOrder());
        buf.put(OEM_IDENTIFIER.getBytes());
        buf.putInt(QCRIL_EVT_HOOK_MISC_INFO_REQ);
        buf.putInt(buffer.length() + 1);
        buf.put((byte) commandId);
        buf.put(buffer.getBytes());
        this.mPhone.invokeOemRilRequestRaw(requestInfo, onCompleted);
    }
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private void checkChildrenMode() {
        String enable = System.getString(this.mPhone.getContext().getContentResolver(), FLAG_CHILDREN_MODE_ENABLE);
        this.mDataEnabledSettings.setChildrenModeEnabled(Boolean.parseBoolean(enable));
        if (Boolean.parseBoolean(enable)) {
            checkChildrenModeDataEnable();
        }
        this.mChildrenMode = Boolean.parseBoolean(enable);
        log("childrenModeEnable (checkChildrenMode) : " + Boolean.parseBoolean(enable));
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    public void checkChildrenModeDataEnable() {
        String value = "0";
        Cursor cursor = null;
        try {
            cursor = this.mPhone.getContext().getContentResolver().query(Uri.parse("content://com.vivo.mod.child/settings"), new String[]{"set_value"}, "set_name='data_network_enable'", null, null);
            ...
            log("checkChildrenModeDataEnable Exception e = " + e);
            if (cursor != null) {
                cursor.close();
            }
        } catch (Throwable th) {
        ...
        this.mDataEnabledSettings.setChildrenModeDataEnabled("1".equals(value));
        this.mChildrenModeDataOn = this.mDataEnabledSettings.getChildrenModeDataEnabled();
        log("checkChildrenModeDataEnable : " + this.mDataEnabledSettings.getChildrenModeDataEnabled());
    }
    ...
    public DcTracker(Phone phone) {
        ...
        this.mChildrenMode = false;
        this.mChildrenModeDataOn = false;
        this.mDataEnabledSettings = new DataEnabledSettings();
        this.pdp_status_flag = false;
        ...
        this.mIntentReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.intent.action.SCREEN_ON")) {
                    ...
                    DcTracker.this.sendMiscInfo(1, "true", null);
                    ...
                    DcTracker.this.sendMiscInfo(1, "false", null);
                ...
                } else if (action.equals(DcTracker.DATA_ERR_CLEANUP_ALL_CONNECT)) {
                    flag = intent.getIntExtra("code", 0);
                    phoneiddata = intent.getIntExtra("phoneid", 0);
                    if (flag == 1597 && DcTracker.this.mPhone != null && DcTracker.this.mPhone.getPhoneId() == phoneiddata) {
                        isConnected = DcTracker.this.getState("default") == State.CONNECTED;
                        nowTime = SystemClock.elapsedRealtime();
                        DcTracker.this.log("isConnected=" + isConnected + " nowTime=" + nowTime + " mLastCleanUpTime=" + DcTracker.this.mLastCleanUpTime);
                        if (isConnected && nowTime - DcTracker.this.mLastCleanUpTime > 180000) {
                            DcTracker.this.cleanUpAllConnections(PhoneInternalInterface.REASON_PDP_RESET);
                        }
                    }
                } else if (action.equals(DcTracker.DATA_ERR_RESTART_RADIO)) {
                    flag = intent.getIntExtra("code", 0);
                    phoneiddata = intent.getIntExtra("phoneid", 0);
                    if (flag != 1597) {
                        return;
                    ...
                    if (!DcTracker.this.isPhoneStateIdle()) {
                        DcTracker.this.log("Is incall state,do not  restartRadio");
                    } else if (DcTracker.this.mPhone != null && DcTracker.this.mPhone.getPhoneId() == phoneiddata) {
                        DcTracker.this.log("pingtest fail  restartRadio now");
                        isConnected = DcTracker.this.getState("default") == State.CONNECTED;
                        nowTime = SystemClock.elapsedRealtime();
                        DcTracker.this.log("isConnected=" + isConnected + " nowTime=" + nowTime + " mLastRestartRadioTime=" + DcTracker.this.mLastRestartRadioTime);
                        if (isConnected && nowTime - DcTracker.this.mLastRestartRadioTime > 180000) {
        ...
        this.mRetryDataCallForPdpRejectConut = 0;
        this.mSetDataProfileStatus = 0;
        this.mChildModeDataEnableObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                new Thread(new Runnable() {
                    public void run() {
                        DcTracker.this.checkChildrenModeDataEnable();
                        DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1002));
                    }
                }).start();
            }
        };
        this.mApnStateSpListener = new ApnStateSpListener(this, null);
        this.mOtherPhoneApnState = 0;
        this.mIsOtherPhoneInCallState = false;
        ...
        this.mDataModeObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("data mode change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1003));
            }
        };
        this.mDataBlockSimObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("data block sim change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1004));
            }
        };
        this.mDataBlockDataObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("data block data change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1005));
            }
        };
        this.mCtDataBlockObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("Settings change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1007));
            }
        };
        this.mCtDataConnectObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("Settings change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1008));
            }
        };
        this.mNctDataBlockObserver = new ContentObserver(new Handler()) {
            public void onChange(boolean selfChange) {
                DcTracker.this.log("Settings change");
                DcTracker.this.sendMessage(DcTracker.this.obtainMessage(1009));
            }
        };
        this.ps_err_delay_plug = 0;
        this.dataconnect_flag = false;
        this.vivo_net_entry = SystemProperties.get("ro.vivo.net.entry", "no");
        this.vivo_op_entry = SystemProperties.get("ro.vivo.op.entry", "no");
        this.vivo_mtpf_type = SystemProperties.get("persist.sys.mtbf.test", "0");
        this.mPhone = phone;
        log("DCT.constructor");
        ...
        VivoCallServiceStateHelper.updateCallStateSP(this.mPhone.getContext(), this.mPhone.getPhoneId(), VivoCallServiceStateHelper.VOICE_CALL_END);
        ...
        filter.addAction(DATA_ERR_CLEANUP_ALL_CONNECT);
        filter.addAction(DATA_ERR_RESTART_RADIO);
        ...
        this.mChildrenModeObserver = new ChildrenModeObserver();
        phone.getContext().getContentResolver().registerContentObserver(System.getUriFor(FLAG_CHILDREN_MODE_ENABLE), true, this.mChildrenModeObserver);
        try {
            Uri uri = Uri.parse("content://com.vivo.mod.child/settings");
            phone.getContext().getContentResolver().registerContentObserver(uri, false, this.mChildModeDataEnableObserver);
        } catch (Exception e) {
            log("child mode exception e = " + e);
        }
        this.mDataEnabledSettings.setPhone(this.mPhone);
        this.mDataMode = Secure.getInt(this.mResolver, "ct_network_data", 1);
        this.mDataEnabledSettings.setCtNetworkData(this.mDataMode);
        this.mNetworkDataBlockSim = Secure.getInt(this.mResolver, "ct_network_data_blocksim", 0);
        this.mDataEnabledSettings.setCtNetworkDataBolckSim(this.mNetworkDataBlockSim);
        this.mNetworkDataBlockData = Secure.getInt(this.mResolver, "ct_network_data_blockdata", 1);
        this.mDataEnabledSettings.setCtNetworkDataBolckData(this.mNetworkDataBlockData);
        log("mDataMode = " + this.mDataMode + " mNetworkDataBlockSim = " + this.mNetworkDataBlockSim + " mNetworkDataBlockData = " + this.mNetworkDataBlockData);
        phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("ct_network_data"), false, this.mDataModeObserver);
        phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("ct_network_data_blocksim"), false, this.mDataBlockSimObserver);
        phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("ct_network_data_blockdata"), false, this.mDataBlockDataObserver);
        if ("1".equals(SystemProperties.get("ro.build.gn.support", "0"))) {
            this.mCtDataBlock = Secure.getInt(this.mResolver, "ct_data_block", 1);
            this.mDataEnabledSettings.setCtDataBlock(this.mCtDataBlock);
            this.mCtDataConnect = Secure.getInt(this.mResolver, "ct_data_connect", 1);
            this.mDataEnabledSettings.setCtDataConnect(this.mCtDataConnect);
            this.mNCtDataBlock = Secure.getInt(this.mResolver, "nct_data_block", 0);
            this.mDataEnabledSettings.setNCtDataBlock(this.mNCtDataBlock);
            phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("ct_data_block"), false, this.mCtDataBlockObserver);
            phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("ct_data_connect"), false, this.mCtDataConnectObserver);
            phone.getContext().getContentResolver().registerContentObserver(Secure.getUriFor("nct_data_block"), false, this.mNctDataBlockObserver);
        }
        initApnContexts();
        ...
        SharedPreferences apnStateSp = this.mPhone.getContext().getSharedPreferences(VivoCallServiceStateHelper.KEY_PHONE_APN_STATE, 0);
        SharedPreferences callStateSp = this.mPhone.getContext().getSharedPreferences(VivoCallServiceStateHelper.PHONE_CALL_STATE, 0);
        apnStateSp.registerOnSharedPreferenceChangeListener(this.mApnStateSpListener);
        callStateSp.registerOnSharedPreferenceChangeListener(this.mApnStateSpListener);
    }
    ...
    public DcTracker() {
        ...
        this.mRetryDataCallForPdpRejectConut = 0;
        this.mSetDataProfileStatus = 0;
        this.mChildModeDataEnableObserver = /* anonymous class already generated */;
        this.mApnStateSpListener = new ApnStateSpListener(this, null);
        this.mOtherPhoneApnState = 0;
        this.mIsOtherPhoneInCallState = false;
        this.mReregisterOnReconnectFailure = false;
        ...
        this.mAttached = new AtomicBoolean(false);
        this.mImsRegistrationState = false;
        this.mDataModeObserver = /* anonymous class already generated */;
        this.mDataBlockSimObserver = /* anonymous class already generated */;
        this.mDataBlockDataObserver = /* anonymous class already generated */;
        this.mCtDataBlockObserver = /* anonymous class already generated */;
        this.mCtDataConnectObserver = /* anonymous class already generated */;
        this.mNctDataBlockObserver = /* anonymous class already generated */;
        this.ps_err_delay_plug = 0;
        this.dataconnect_flag = false;
        this.vivo_net_entry = SystemProperties.get("ro.vivo.net.entry", "no");
        this.vivo_op_entry = SystemProperties.get("ro.vivo.op.entry", "no");
    ...
    public void dispose() {
        ...
        this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mChildrenModeObserver);
        this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mChildModeDataEnableObserver);
        SharedPreferences apnStateSp = this.mPhone.getContext().getSharedPreferences(VivoCallServiceStateHelper.KEY_PHONE_APN_STATE, 0);
        SharedPreferences callStateSp = this.mPhone.getContext().getSharedPreferences(VivoCallServiceStateHelper.PHONE_CALL_STATE, 0);
        apnStateSp.unregisterOnSharedPreferenceChangeListener(this.mApnStateSpListener);
        callStateSp.unregisterOnSharedPreferenceChangeListener(this.mApnStateSpListener);
        this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mDataModeObserver);
        this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mDataBlockSimObserver);
        this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mDataBlockDataObserver);
        if ("1".equals(SystemProperties.get("ro.build.gn.support", "0"))) {
            this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mCtDataBlockObserver);
            this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mCtDataConnectObserver);
            this.mPhone.getContext().getContentResolver().unregisterContentObserver(this.mNctDataBlockObserver);
        }
    ...
    public void setDataEnabled(boolean enable) {
        int i = 1;
        if (!this.mDataEnabledSettings.getChildrenModeEnabled() || (this.mDataEnabledSettings.getChildrenModeDataEnabled() ^ 1) == 0) {
        ...
        log("do nothing for children mode data forbiden.");
        ChildrenModeHelper.getInstance(this.mPhone.getContext(), 1).makeToast();
    }
    ...
    private void initApnContexts() {
        ...
        for (String networkConfigString : this.mPhone.getContext().getResources().getStringArray(17236050)) {
    ...
    public State getOverallState() {
        ...
        for (ApnContext apnContext : this.mApnContexts.values()) {
            if (apnContext.isEnabled()) {
                isAnyEnabled = true;
                switch (m15xf0fbc33d()[apnContext.getState().ordinal()]) {
                    case 1:
                    case 3:
    ...
    protected void notifyOffApnsOfAvailability(String reason) {
        for (ApnContext apnContext : this.mApnContexts.values()) {
            ...
            } else if (TelephonyPhoneUtils.sIsOversea && "default".equals(apnContext.getApnType()) && this.mPhone.getDataConnectionState("default") == DataState.DISCONNECTED) {
                Intent intent = new Intent("android.intent.action.NOTIFY_OFF_APNS_OF_AVAILABILITY");
                intent.putExtra("subscription", this.mPhone.getSubId());
                intent.putExtra("apnType", "default");
                intent.putExtra("state", DataState.DISCONNECTED.toString());
    ...
    public ApnSetting fetchDunApn() {
        ...
        if (dunCandidates.isEmpty()) {
            String[] apnArrayData = this.mPhone.getContext().getResources().getStringArray(17236032);
        ...
        if (dunCandidates.isEmpty()) {
            ArrayList<ApnSetting> currentAllApnSettings = this.mAllApnSettings;
            if (!ArrayUtils.isEmpty(currentAllApnSettings)) {
                ApnSetting[] allApnSettingsArray = (ApnSetting[]) currentAllApnSettings.toArray(new ApnSetting[currentAllApnSettings.size()]);
                if (allApnSettingsArray != null && allApnSettingsArray.length > 0) {
                    for (ApnSetting apn2 : allApnSettingsArray) {
    ...
    private ApnSetting makeApnSetting(Cursor cursor) {
        return new ApnSetting(cursor.getInt(cursor.getColumnIndexOrThrow(HbpcdLookup.ID)), cursor.getString(cursor.getColumnIndexOrThrow("numeric")), cursor.getString(cursor.getColumnIndexOrThrow("name")), cursor.getString(cursor.getColumnIndexOrThrow("apn")), NetworkUtils.trimV4AddrZeros(cursor.getString(cursor.getColumnIndexOrThrow("proxy"))), cursor.getString(cursor.getColumnIndexOrThrow("port")), NetworkUtils.trimV4AddrZeros(cursor.getString(cursor.getColumnIndexOrThrow("mmsc"))), NetworkUtils.trimV4AddrZeros(cursor.getString(cursor.getColumnIndexOrThrow("mmsproxy"))), cursor.getString(cursor.getColumnIndexOrThrow("mmsport")), cursor.getString(cursor.getColumnIndexOrThrow("user")), cursor.getString(cursor.getColumnIndexOrThrow("password")), cursor.getInt(cursor.getColumnIndexOrThrow("authtype")), parseTypes(cursor.getString(cursor.getColumnIndexOrThrow("type"))), cursor.getString(cursor.getColumnIndexOrThrow("protocol")), cursor.getString(cursor.getColumnIndexOrThrow("roaming_protocol")), cursor.getInt(cursor.getColumnIndexOrThrow("carrier_enabled")) == 1, cursor.getInt(cursor.getColumnIndexOrThrow("bearer")), cursor.getInt(cursor.getColumnIndexOrThrow("bearer_bitmask")), cursor.getInt(cursor.getColumnIndexOrThrow("profile_id")), cursor.getInt(cursor.getColumnIndexOrThrow("modem_cognitive")) == 1, cursor.getInt(cursor.getColumnIndexOrThrow("max_conns")), cursor.getInt(cursor.getColumnIndexOrThrow("wait_time")), cursor.getInt(cursor.getColumnIndexOrThrow("max_conns_time")), cursor.getInt(cursor.getColumnIndexOrThrow("mtu")), cursor.getString(cursor.getColumnIndexOrThrow("mvno_type")), cursor.getString(cursor.getColumnIndexOrThrow("mvno_match_data")));
    }
    ...
    private void onApnChanged() {
        ...
        log("onApnChanged record not load!");
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    private void onChildrenModeChange() {
        boolean bEnable;
        log("onChildrenModeChange mChildrenModeEnable = " + this.mDataEnabledSettings.getChildrenModeEnabled() + " mChildrenModeDataEnable = " + this.mDataEnabledSettings.getChildrenModeDataEnabled() + " mDataEnabledSettings.isUserDataEnabled = " + this.mDataEnabledSettings.isUserDataEnabled());
        if (this.mDataEnabledSettings.getChildrenModeEnabled()) {
            bEnable = this.mDataEnabledSettings.getChildrenModeDataEnabled();
        } else {
            bEnable = this.mDataEnabledSettings.isUserDataEnabled();
        }
        if (bEnable) {
            onTrySetupData(PhoneInternalInterface.REASON_DATA_ENABLED);
        } else {
    ...
    private void restartRadio() {
        ...
        this.mLastRestartRadioTime = SystemClock.elapsedRealtime();
    ...
    private void applyNewState(ApnContext apnContext, boolean enabled, boolean met) {
        ...
        if (apnContext.isReady()) {
            ...
            if (enabled && met) {
                ...
                switch (m15xf0fbc33d()[state.ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
            ...
            if (curDcac != null) {
                ...
                if (dunSetting == null) {
                    if (apnSetting != null && apnSetting.canHandleType(apnType)) {
                        switch (m15xf0fbc33d()[curApnCtx.getState().ordinal()]) {
                            case 1:
    ...
    public boolean getDataEnabled() {
        ...
        return Global.getInt(contentResolver, str, i) != 0;
    }

    public boolean getDataEnabledForCustom() {
        int i = 1;
        if ("1".equals(SystemProperties.get("ro.build.gn.support", "0")) && this.mPhone != null) {
            ...
            if (!TextUtils.isEmpty(imsi)) {
                ...
                if (this.mCtDataBlock == 2 && isCtcc) {
                    return true;
                }
                if (this.mNCtDataBlock == 0 && (isCtcc ^ 1) != 0) {
                    return false;
                }
            }
        } else if (this.mDataMode == 0) {
            return false;
        } else {
            if (this.mDataMode == 4) {
                return true;
            }
            if ((this.mNetworkDataBlockSim == 0 || ((this.mPhone.getPhoneId() == 0 && this.mNetworkDataBlockSim == 1) || (this.mPhone.getPhoneId() == 1 && this.mNetworkDataBlockSim == 2))) && this.mNetworkDataBlockData == 0) {
                return false;
            }
        }
        boolean retVal = "true".equalsIgnoreCase(SystemProperties.get("ro.com.android.mobiledata", "true"));
        ...
        if (apnContext != null) {
            ...
            if (ar.exception == null) {
                ...
                if (dcac == null) {
                    ...
                    if (!(apnContext == null || apn.apn == null || !apnContext.getApnType().equalsIgnoreCase("default"))) {
                        if ("ctvpdn".equals(apn.apn)) {
                            this.ctvpdnFlag = 1;
                        } else {
                            this.ctvpdnFlag = 0;
                        }
                    }
                    log("onDataSetupComplete: success  apn=" + (apn == null ? "unknown" : apn.apn) + ",ctvpdnFlag=" + this.ctvpdnFlag);
    ...
    private void onDataSetupCompleteError(AsyncResult ar) {
        ...
        if (apnContext != null) {
            ...
            } else if (this.mRetryDataCallForPdpRejectConut < 5) {
                apnContext.setState(State.RETRYING);
                startAlarmForReconnect(VivoNetLowlatency.LEVEL_SET_MINIMUM_TIME_INTERVAL, apnContext);
                this.mRetryDataCallForPdpRejectConut++;
                log("onDataSetupCompleteError: PDP request Reject and this is the last apn,so retry to setup data call! mRetryDataCallForPdpRejectConut = " + this.mRetryDataCallForPdpRejectConut);
            } else {
    ...
    private void onVoiceCallStarted() {
        ...
        VivoCallServiceStateHelper.updateCallStateSP(this.mPhone.getContext(), this.mPhone.getPhoneId(), VivoCallServiceStateHelper.VOICE_CALL_START);
    }
    ...
    protected void createAllApnList() {
        ...
        if (this.mAllApnSettings.isEmpty()) {
            ...
            if ("1".equals(SystemProperties.get("ro.build.gn.support", "0")) && this.mPreferredApn == null) {
                setPreferredApn(-1);
                this.mPreferredApn = getPreferredApn();
            }
    ...
    protected void setPreferredApn(int pos) {
        if (this.mCanSetPreferApn) {
            ...
            if (pos < 0 && "1".equals(gn) && ("46003".equals(operator) || "46011".equals(operator))) {
                String sub = Long.toString((long) this.mPhone.getSubId());
                Cursor cursor = null;
                try {
                    cursor = this.mPhone.getContext().getContentResolver().query(Uri.withAppendedPath(PREFERAPN_NO_UPDATE_URI_USING_SUBID, sub), new String[]{HbpcdLookup.ID, "name", "apn"}, null, null, "name ASC");
                    log("setPreferredApn cursor.getCount() = " + cursor.getCount() + " sub = " + sub);
                    if (cursor != null && cursor.getCount() > 0) {
                        cursor.moveToFirst();
                        String selection = "name = '" + cursor.getString(cursor.getColumnIndexOrThrow("name")) + "' and mcc = '460' and mnc = '" + ("46003".equals(operator) ? "03" : "11") + "'";
                        log("setPreferredApn selection = " + selection);
                        Cursor cursor2 = null;
                        try {
                            cursor2 = this.mPhone.getContext().getContentResolver().query(Carriers.CONTENT_URI, null, selection, null, "name ASC");
                            if (cursor2 != null && cursor2.moveToFirst()) {
                                int newId = cursor2.getInt(cursor2.getColumnIndexOrThrow(HbpcdLookup.ID));
                                log("setPreferredApn newId = " + newId);
                                if (newId >= 0) {
                                    resolver.delete(uri, null, null);
                                    values = new ContentValues();
                                    values.put(APN_ID, Integer.valueOf(newId));
                            ...
                            Rlog.e(this.LOG_TAG, "query Exception0 : " + e.toString());
                            if (cursor2 != null) {
                                cursor2.close();
                            }
                        } catch (Throwable th) {
                    ...
                    Rlog.e(this.LOG_TAG, "query Exception1 : " + e2.toString());
                    if (cursor != null) {
                        cursor.close();
                    }
                } catch (Throwable th2) {
    ...
    protected ApnSetting getPreferredApn() {
        if (this.mAllApnSettings == null || this.mAllApnSettings.isEmpty()) {
            log("getPreferredApn: mAllApnSettings is " + (this.mAllApnSettings == null ? "null" : VivoNetLowlatency.MISC_INFO_DEFAULT_SEND_BUFFER));
            return null;
        }
        Cursor cursor = null;
        try {
            int count;
            cursor = this.mPhone.getContext().getContentResolver().query(Uri.withAppendedPath(PREFERAPN_NO_UPDATE_URI_USING_SUBID, Long.toString((long) this.mPhone.getSubId())), new String[]{HbpcdLookup.ID, "name", "apn"}, null, null, "name ASC");
            if (cursor != null) {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case 100:
                ...
                break;
            case 1001:
                log("pdprecovery  handlemessage   EVENT_PS_RESTART_PDP_DELAY  psRestartPdpNum=" + psRestartPdpNum);
                this.ps_err_delay_plug = 0;
                if (psRestartPdpNum < 6) {
                    psRestartPdpNum++;
                    log("pdprecovery  RESET PDP     psRestartPdpNum=" + psRestartPdpNum);
                    Message msgpdp = obtainMessage(270365);
                    msgpdp.obj = PhoneInternalInterface.REASON_PDP_RESET;
                    sendMessage(msgpdp);
                } else {
                    log("pdprecovery   EVENT_PS_RESTART_PDP_DELAY  ps alway err  ");
                    psRestartPdpNum = 0;
                }
                log("pdprecovery  handlemessage   EVENT_PS_RESTART_PDP_DELAY  ps_err_delay_plug=" + this.ps_err_delay_plug + ",,psRestartPdpNum=" + psRestartPdpNum);
                break;
            case 1002:
            ...
            case 1007:
                this.mCtDataBlock = Secure.getInt(this.mResolver, "ct_data_block", 1);
                this.mDataEnabledSettings.setCtDataBlock(this.mCtDataBlock);
                imsi = this.mPhone.getOperatorNumeric();
                log("EVENT_CT_DATA_BLOCK_CHANGED imsi = " + imsi + " mCtDataBlock = " + this.mCtDataBlock);
                if (!TextUtils.isEmpty(imsi)) {
                    if (TelephonyPhoneUtils.getOperatorTypeByImsi(imsi) == 2) {
                        if (this.mCtDataBlock != 1 && this.mCtDataBlock != 2) {
                            cleanUpAllConnections("", null);
                            break;
                        } else {
                            setupDataOnConnectableApns("");
            ...
            case 1008:
                ...
                this.mDataEnabledSettings.setCtDataConnect(this.mCtDataConnect);
                imsi = this.mPhone.getOperatorNumeric();
                log("EVENT_CT_DATA_CONNECT_CHANGED imsi = " + imsi + " mCtDataConnect = " + this.mCtDataConnect);
                if (!TextUtils.isEmpty(imsi)) {
                    if (TelephonyPhoneUtils.getOperatorTypeByImsi(imsi) == 2) {
                        boolean z;
                        if (this.mCtDataConnect == 1) {
                            z = true;
                        } else {
                            z = false;
                        }
            ...
            case 1009:
                ...
                this.mDataEnabledSettings.setNCtDataBlock(this.mNCtDataBlock);
                imsi = this.mPhone.getOperatorNumeric();
                log("EVENT_CT_DATA_CONNECT_CHANGED imsi = " + imsi + " mNCtDataBlock = " + this.mNCtDataBlock);
                if (!TextUtils.isEmpty(imsi)) {
                    if (!(TelephonyPhoneUtils.getOperatorTypeByImsi(imsi) == 2)) {
                        if (this.mNCtDataBlock != 1) {
                            cleanUpAllConnections("", null);
                            break;
                        } else {
                            setupDataOnConnectableApns("");
        ...
        onRadioAvailable();
        if ((!"CMCC".equals(this.vivo_op_entry) && !"CMCC_RWA".equals(this.vivo_op_entry) && !"CMCC_RWA".equals(this.vivo_op_entry)) || !this.vivo_mtpf_type.equals("1")) {
            return;
        }
        if (this.pdp_status_flag || this.mDataEnabledSettings.isUserDataEnabled()) {
            ApnContext apnContext1 = (ApnContext) this.mApnContexts.get("default");
            if (apnContext1 != null) {
                if (apnContext1.getState() == State.CONNECTED || this.ps_err_delay_plug != 0) {
                    if (apnContext1.getState() == State.CONNECTED) {
                        removeMessages(1001);
                        this.ps_err_delay_plug = 0;
                        psRestartPdpNum = 0;
                        log("pdprecovery notifyDataConnection: cancel delay  ps_err_delay_plug=" + this.ps_err_delay_plug);
                        return;
                    }
                    return;
                }
                sendMessageDelayed(obtainMessage(1001, 0, 1, null), (long) DELAY_TIME_RESTART_PDP_DELAY);
                this.ps_err_delay_plug = 1;
                log("pdprecovery notifyDataConnection: start delay  ps_err_delay_plug=" + this.ps_err_delay_plug);
            }
        }
    }
    ...
    private void onUpdateIcc() {
        if (this.mUiccController != null) {
            ...
            if (this.mPhone instanceof GsmCdmaPhone) {
                GsmCdmaPhone phone = this.mPhone;
                if (phone.isPhoneTypeGsm() || phone.isPhoneTypeCdmaLte()) {
                    log("get record from 3GPP");
                    newIccRecords = getUiccRecords(1);
                } else if (phone.isPhoneTypeCdma()) {
                    newIccRecords = getUiccRecords(2);
                    log("get record from 3GPP2");
                }
            }
            IccRecords r = (IccRecords) this.mIccRecords.get();
            if (r != newIccRecords) {
    ...
    private void initEmergencyApnSetting() {
        Cursor cursor = null;
        try {
            cursor = this.mPhone.getContext().getContentResolver().query(Carriers.CONTENT_URI, null, "type=\"emergency\" and numeric=''", null, null);
    ...
    private void doRecovery() {
        if (getOverallState() == State.CONNECTED) {
            if (this.ctvpdnFlag == 1) {
                log("doRecovery() ctvpdnFlag==1  not doRecovery");
                return;
            }
            if (TelephonyPhoneUtils.sIsCTCCEntry) {
                String apnName = getActiveApnString("default");
                if (apnName != null && "ctvpdn".equals(apnName)) {
                    return;
                }
            }
            ...
            switch (recoveryAction) {
                ...
                case 1:
                    ...
                    this.mPhone.sendMiscInfo(50, VivoNetLowlatency.MISC_INFO_DEFAULT_SEND_BUFFER, null);
                    log("detachPs");
                    putRecoveryAction(2);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    log("Is incall state,put recoveryaction data call list");
                    putRecoveryAction(0);
                    break;
                case 4:

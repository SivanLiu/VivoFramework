...
public class InboundSmsTracker {
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    private long mReceivedLoacalTime;
    ...
    public InboundSmsTracker(byte[] pdu, long timestamp, int destPort, boolean is3gpp2, boolean is3gpp2WapPdu, String address, String displayAddress, String messageBody) {
        ...
        this.mReceivedLoacalTime = System.currentTimeMillis();
    }
    ...
    public ContentValues getContentValues() {
        ...
        values.put("recv_time", Long.valueOf(this.mReceivedLoacalTime));
        return values;
    }
    ...
    boolean getCanDeleteFlag() {
        return this.mCanDelete;
    }

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void setCanDeleteFlag(boolean canDelete) {

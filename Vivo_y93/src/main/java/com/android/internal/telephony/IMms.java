...
public interface IMms extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMms {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            Uri _arg12;
            boolean _result2;
            VivoTelephonyApiParams _arg03;
            VivoTelephonyApiParams _result3;
            switch (code) {
                case 1:
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result4 = getCarrierConfigValues(data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (VivoTelephonyApiParams) VivoTelephonyApiParams.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    _result3 = vivoTelephonyApi(_arg03);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 16:
                    ...
                    _result3 = registerVivoApiCallback(_arg03, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
                ...
                case 17:
                    ...
                    _result3 = unregisterVivoApiCallback(_arg03, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);

...
public interface CommandsInterface {
    ...
    void registerForMiscInfo(Handler handler, int i, Object obj);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void sendMiscInfo(int i, String str, Message message);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void setAudioPdStateChangeEvent(Handler handler, int i, Object obj);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void setMccChangedEvent(Handler handler, int i, Object obj);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void setOnSignalPoll(Handler handler, int i, Object obj);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void setUiNotReadyEvent(Handler handler, int i, Object obj);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void unSetAudioPdStateChangeEvent(Handler handler);

    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void unSetMccChangedEvent(Handler handler);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void unSetUiNotReadyEvent(Handler handler);
    ...
    @VivoHook(hookType = VivoHookType.NEW_METHOD)
    void unregisterForMiscInfo(Handler handler);

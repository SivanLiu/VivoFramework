...
public class DeviceStateMonitor extends Handler {
    ...
    private static final int SCREEN_STATE = 3;
    ...
    private final DisplayListener mDisplayListener = new DisplayListener() {
        ...
        public void onDisplayChanged(int displayId) {
            ...
            msg.arg1 = i;
            DeviceStateMonitor.this.sendMessage(msg);
            if (DeviceStateMonitor.this.mPhone != null && DeviceStateMonitor.this.mPhone.getServiceStateTracker() != null) {
                DeviceStateMonitor.this.mPhone.getServiceStateTracker().setScreenOnOffState(screenOn);
            }
        }
    };
        ...
        switch (eventType) {
            case 1:
                if (this.mIsScreenOn != state) {
                    ...
                    sendDeviceState(3, this.mIsScreenOn);
                    break;
                }
                return;
            case 2:

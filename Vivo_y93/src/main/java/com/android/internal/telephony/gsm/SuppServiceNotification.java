...
public class SuppServiceNotification {
    ...
    public static final int MT_CODE_FORWARDED_ALLCONDITIONAL = 35;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int MT_CODE_FORWARDED_ALLFORWARDING = 34;
    public static final int MT_CODE_FORWARDED_CALL = 0;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int MT_CODE_FORWARDED_MOBILEBUSY = 31;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int MT_CODE_FORWARDED_NOREPLY = 32;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int MT_CODE_FORWARDED_UNCONDITIONAL = 30;
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int MT_CODE_FORWARDED_UNREACHABLE = 33;

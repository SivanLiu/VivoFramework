...
public final class GsmMmiCode extends Handler implements MmiCode {
    ...
    static boolean isServiceCodeCallBarring(String sc) {
        ...
        if (sc != null) {
            String[] barringMMI = resource.getStringArray(17235988);
            if (barringMMI != null) {
    ...
    private static boolean isTwoDigitShortCode(Context context, String dialString) {
        ...
        if (sTwoDigitNumberPattern == null) {
            sTwoDigitNumberPattern = context.getResources().getStringArray(17236039);
        }
    ...
    public void processCode() throws CallStateException {
        try {
            ...
            if (isShortCode()) {
                ...
                int isSettingUnconditionalVoice = ((reason == 0 || reason == 4) && ((serviceClass & 1) != 0 || serviceClass == 80 || serviceClass == 0)) ? 1 : 0;
            ...
            this.mMessage = this.mContext.getText(17040366);
    ...
    public void onUssdFinished(String ussdMessage, boolean isUssdRequest) {
        if (this.mState == State.PENDING) {
            if (TextUtils.isEmpty(ussdMessage)) {
                ...
                this.mMessage = this.mContext.getText(17040365);
            } else {
    ...
    private void onSetComplete(Message msg, AsyncResult ar) {
        ...
        if (ar.exception != null) {
                ...
                if (err == Error.PASSWORD_INCORRECT) {
                    if (isPinPukCommand()) {
                        ...
                        if (attemptsRemaining <= 0) {
                            ...
                            sb.append(this.mContext.getResources().getQuantityString(18153511, attemptsRemaining, new Object[]{Integer.valueOf(attemptsRemaining)}));
                        }
                    } else {
                    ...
                    sb.append(this.mContext.getText(17039584));
                    sb.append("\n");
                    sb.append(this.mContext.getText(17040378));
                } else if (err == Error.REQUEST_NOT_SUPPORTED) {
                    if (this.mSc.equals(SC_PIN)) {
                        sb.append(this.mContext.getText(17039854));
                    }
                } else if (err == Error.FDN_CHECK_FAILURE) {
                    Rlog.i(LOG_TAG, "FDN_CHECK_FAILURE");
                    sb.append(this.mContext.getText(17040368));
                    ...
                    sb.append(this.mContext.getText(17040367));
                } else {
                    sb.append(getErrorMessage(ar));
                }
            } else {
                sb.append(this.mContext.getText(17040366));
            }
        } else if (isActivate()) {
            this.mState = State.COMPLETE;
            if (this.mIsCallFwdReg) {
                sb.append(this.mContext.getText(17041277));
            } else {
                sb.append(this.mContext.getText(17041273));
            }
            if (this.mSc.equals(SC_CLIR)) {
            ...
            this.mState = State.COMPLETE;
            sb.append(this.mContext.getText(17041272));
            if (this.mSc.equals(SC_CLIR)) {
            ...
            this.mState = State.COMPLETE;
            sb.append(this.mContext.getText(17041275));
        } else {
            this.mState = State.FAILED;
            sb.append(this.mContext.getText(17040366));
        }
    ...
    private void onGetClirComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            switch (clirArgs[1]) {
                case 0:
                    sb.append(this.mContext.getText(17041276));
                    this.mState = State.COMPLETE;
                    break;
                case 1:
    ...
    private CharSequence serviceClassToCFString(int serviceClass) {
        switch (serviceClass) {
            case 1:
                return this.mContext.getText(17041271);
            case 2:
                return this.mContext.getText(17041264);
            case 4:
                return this.mContext.getText(17041267);
            case 8:
                return this.mContext.getText(17041270);
            case 16:
                return this.mContext.getText(17041266);
            case 32:
                return this.mContext.getText(17041265);
            case 64:
                return this.mContext.getText(17041269);
            case 128:
                return this.mContext.getText(17041268);
            default:
                return null;
        }
    }
    ...
    private CharSequence createQueryCallWaitingResultMessage(int serviceClass) {
        StringBuilder sb = new StringBuilder(this.mContext.getText(17041274));

...
public interface IConnectionService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectionService {
        ...
        static final int TRANSACTION_registerVivoApiCallback = 31;
        ...
        static final int TRANSACTION_unregisterVivoApiCallback = 32;
        static final int TRANSACTION_vivoTelephonyApi = 30;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 30:
                    ...
                    _result = vivoTelephonyApi(_arg04);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                ...
                case 31:
                    ...
                    _result = registerVivoApiCallback(_arg04, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 32:
                    ...
                    _result = unregisterVivoApiCallback(_arg04, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);

...
public interface ITelecomService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelecomService {
        ...
        static final int TRANSACTION_registerVivoApiCallback = 49;
        ...
        static final int TRANSACTION_unregisterVivoApiCallback = 50;
        static final int TRANSACTION_vivoTelephonyApi = 48;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            VivoTelephonyApiParams _result6;
            switch (code) {
                case 1:
                ...
                case 9:
                    ...
                    PhoneAccount _result7 = getPhoneAccount(_arg0);
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    ComponentName _result9 = getDefaultPhoneApp();
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
                ...
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    TelecomAnalytics _result10 = dumpCallAnalytics();
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                ...
                case 36:
                    ...
                    Uri _result11 = getAdnUriForPhoneAccount(_arg0, data.readString());
                    reply.writeNoException();
                    if (_result11 != null) {
                        reply.writeInt(1);
                ...
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    Intent _result12 = createManageBlockedNumbersIntent();
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 48:
                    ...
                    _result6 = vivoTelephonyApi(_arg02);
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 49:
                    ...
                    _result6 = registerVivoApiCallback(_arg02, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                        _result6.writeToParcel(reply, 1);
                ...
                case 50:
                    ...
                    _result6 = unregisterVivoApiCallback(_arg02, com.android.internal.telephony.IVivoTelephonyApiCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                        _result6.writeToParcel(reply, 1);

...
public interface IConnectionServiceAdapter extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectionServiceAdapter {
        ...
        static final int TRANSACTION_registerVivoApiCallback = 36;
        ...
        static final int TRANSACTION_unregisterVivoApiCallback = 37;
        static final int TRANSACTION_vivoTelephonyApi = 35;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    ...
                    queryRemoteConnectionServices(_arg03, _arg1);
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);

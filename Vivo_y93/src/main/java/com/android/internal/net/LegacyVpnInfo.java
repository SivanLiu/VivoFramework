...
public class LegacyVpnInfo implements Parcelable {
    ...
    private static final /* synthetic */ int[] f136-android-net-NetworkInfo$DetailedStateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m53-getandroid-net-NetworkInfo$DetailedStateSwitchesValues() {
        if (f136-android-net-NetworkInfo$DetailedStateSwitchesValues != null) {
            return f136-android-net-NetworkInfo$DetailedStateSwitchesValues;
        }
        ...
        f136-android-net-NetworkInfo$DetailedStateSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static int stateFromNetworkInfo(NetworkInfo info) {
        switch (m53-getandroid-net-NetworkInfo$DetailedStateSwitchesValues()[info.getDetailedState().ordinal()]) {
            case 1:
                return 3;
            case 2:
                return 2;

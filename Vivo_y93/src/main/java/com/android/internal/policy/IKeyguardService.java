...
public interface IKeyguardService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IKeyguardService {
        ...
        static final int TRANSACTION_hideKeyguardByFingerprint = 24;
        ...
        static final int TRANSACTION_onStartedWakingUpForReason = 25;
        static final int TRANSACTION_onSystemReady = 16;
        static final int TRANSACTION_resultKeyguardByFingerprint = 23;
        ...
        private static class Proxy implements IKeyguardService {
            ...
            public void resultKeyguardByFingerprint(boolean isFingerSuccess, String message, int param) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void hideKeyguardByFingerprint(int hide) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(hide);
            ...
            public void onStartedWakingUpForReason(int reason) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(reason);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    resultKeyguardByFingerprint(data.readInt() != 0, data.readString(), data.readInt());
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    hideKeyguardByFingerprint(data.readInt());
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    onStartedWakingUpForReason(data.readInt());
                    return true;
                case 1598968902:
    ...
    void hideKeyguardByFingerprint(int i) throws RemoteException;
    ...
    void onStartedWakingUpForReason(int i) throws RemoteException;

    void onSystemReady() throws RemoteException;

    void resultKeyguardByFingerprint(boolean z, String str, int i) throws RemoteException;

...
public interface ILockSettings extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILockSettings {
        ...
        static final int TRANSACTION_checkPasswordNoCounting = 30;
        static final int TRANSACTION_checkPatternNoCounting = 31;
        static final int TRANSACTION_checkVoldPassword = 12;
        static final int TRANSACTION_clearLockCountDown = 32;
        ...
        private static class Proxy implements ILockSettings {
            ...
            public VerifyCredentialResponse checkPasswordNoCounting(String password, int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    VerifyCredentialResponse _result;
            ...
            public VerifyCredentialResponse checkPatternNoCounting(String pattern, int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    VerifyCredentialResponse _result;
            ...
            public void clearLockCountDown() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = checkPasswordNoCounting(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, 1);
                ...
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = checkPatternNoCounting(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, 1);
    ...
    VerifyCredentialResponse checkPasswordNoCounting(String str, int i) throws RemoteException;

    VerifyCredentialResponse checkPatternNoCounting(String str, int i) throws RemoteException;

    boolean checkVoldPassword(int i) throws RemoteException;

    void clearLockCountDown() throws RemoteException;

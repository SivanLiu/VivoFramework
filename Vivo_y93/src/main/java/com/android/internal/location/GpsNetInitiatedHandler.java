...
import com.vivo.content.Weather.Location;
...
public class GpsNetInitiatedHandler {
    ...
    public GpsNetInitiatedHandler(Context context, INetInitiatedListener netInitiatedListener, boolean isSuplEsEnabled) {
        ...
        this.mLocationManager = (LocationManager) context.getSystemService(Location.TABLENAME);
        updateLocationMode();
    ...
    private synchronized void setNiNotification(GpsNiNotification notif) {
        NotificationManager notificationManager = (NotificationManager) this.mContext.getSystemService(ThreadsColumns.NOTIFICATION);

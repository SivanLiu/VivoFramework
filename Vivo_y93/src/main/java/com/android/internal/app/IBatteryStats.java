...
public interface IBatteryStats extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBatteryStats {
        ...
        static final int TRANSACTION_computeBatteryTimeRemaining = 20;
        static final int TRANSACTION_computeChargeTimeRemaining = 21;
        static final int TRANSACTION_getAwakeTimeBattery = 77;
        static final int TRANSACTION_getAwakeTimePlugged = 78;
        static final int TRANSACTION_getStatistics = 17;
        static final int TRANSACTION_getStatisticsStream = 18;
        static final int TRANSACTION_isCharging = 19;
        ...
        static final int TRANSACTION_noteBluetoothControllerActivity = 85;
        ...
        static final int TRANSACTION_noteModemControllerActivity = 86;
        static final int TRANSACTION_noteNetworkInterfaceType = 73;
        static final int TRANSACTION_noteNetworkStatsEnabled = 74;
        static final int TRANSACTION_notePem = 15;
        static final int TRANSACTION_notePemThree = 16;
        ...
        static final int TRANSACTION_noteResetBleScan = 81;
        ...
        static final int TRANSACTION_noteStartGps = 36;
        ...
        static final int TRANSACTION_noteStopGps = 37;
        ...
        static final int TRANSACTION_noteWifiControllerActivity = 87;
        static final int TRANSACTION_noteWifiMulticastDisabled = 63;
        static final int TRANSACTION_noteWifiMulticastDisabledFromSource = 71;
        static final int TRANSACTION_noteWifiMulticastEnabled = 62;
        static final int TRANSACTION_noteWifiMulticastEnabledFromSource = 70;
        ...
        static final int TRANSACTION_takeUidSnapshot = 83;
        static final int TRANSACTION_takeUidSnapshots = 84;
        ...
        private static class Proxy implements IBatteryStats {
            ...
            public int notePem(int what, int arg1, int arg2) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public int notePemThree(int what, int arg1, int arg2, int arg3) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    _result = notePem(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    _result = notePemThree(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    byte[] _result3 = getStatistics();
                    reply.writeNoException();
                    reply.writeByteArray(_result3);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    ParcelFileDescriptor _result4 = getStatisticsStream();
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result5 = isCharging();
                    reply.writeNoException();
                    reply.writeInt(_result5 ? 1 : 0);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = computeBatteryTimeRemaining();
                    reply.writeNoException();
                    reply.writeLong(_result2);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = computeChargeTimeRemaining();
                    reply.writeNoException();
                    reply.writeLong(_result2);
                    return true;
                case 22:
                ...
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getAwakeTimeBattery();
                    reply.writeNoException();
                    reply.writeLong(_result2);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getAwakeTimePlugged();
                    reply.writeNoException();
                    reply.writeLong(_result2);
                    return true;
                case 79:
                ...
                case 83:
                    data.enforceInterface(DESCRIPTOR);
                    HealthStatsParceler _result6 = takeUidSnapshot(data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 84:
                    data.enforceInterface(DESCRIPTOR);
                    HealthStatsParceler[] _result7 = takeUidSnapshots(data.createIntArray());
                    reply.writeNoException();
    ...
    int notePem(int i, int i2, int i3) throws RemoteException;

    int notePemThree(int i, int i2, int i3, int i4) throws RemoteException;

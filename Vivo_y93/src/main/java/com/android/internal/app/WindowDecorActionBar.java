...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    static final /* synthetic */ boolean f126-assertionsDisabled = (WindowDecorActionBar.class.desiredAssertionStatus() ^ 1);
    ...
    public WindowDecorActionBar(View layout) {
        if (f126-assertionsDisabled || layout.isInEditMode()) {
            init(layout);
            return;
        }

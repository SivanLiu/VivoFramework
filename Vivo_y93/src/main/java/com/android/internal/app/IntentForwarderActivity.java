...
public class IntentForwarderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (newIntent != null) {
            ...
            boolean isDoubleAppUser = false;
            if (DoubleAppSwitcher.sEnabled) {
                isDoubleAppUser = callingUserId == ((UserManager) getSystemService("user")).getDoubleAppUserId();
                if (DoubleAppSwitcher.sDebug) {
                    Slog.d(TAG, "isDoubleAppUser " + isDoubleAppUser);
                }
                if (isDoubleAppUser) {
            ...
            } else if (ri == null || ri.activityInfo == null || (ZenModeConfig.SYSTEM_AUTHORITY.equals(ri.activityInfo.packageName) ^ 1) != 0) {
            ...
            if (DoubleAppSwitcher.sDebug) {
                Slog.d(TAG, "shouldShowDisclosure " + shouldShowDisclosure);
            }
            try {

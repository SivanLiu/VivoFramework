...
public interface IStatusBarService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBarService {
        ...
        static final int TRANSACTION_changeUpslideState = 35;
        ...
        static final int TRANSACTION_notifyInfo = 33;
        static final int TRANSACTION_onClearAllNotifications = 20;
        static final int TRANSACTION_onClearAllNotificationsIgnoreFlags = 38;
        static final int TRANSACTION_onClearNotificationsIgnoreFlags = 39;
        ...
        static final int TRANSACTION_setNetworkSpeed = 37;
        static final int TRANSACTION_setSimcardFlow = 36;
        static final int TRANSACTION_setStatusBarIconColor = 34;
        ...
        private static class Proxy implements IStatusBarService {
            ...
            public void notifyInfo(int reason, Bundle infos) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setStatusBarIconColor(boolean whiteStyle) throws RemoteException {
                int i = 0;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void changeUpslideState(boolean down, boolean canceled) throws RemoteException {
                int i = 1;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public void setSimcardFlow(String flow1, String flow2) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(flow1);
                    _data.writeString(flow2);
            ...
            public void setNetworkSpeed(String speed) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onClearAllNotificationsIgnoreFlags() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onClearNotificationsIgnoreFlags(String pkg) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 33:
                    ...
                    notifyInfo(_arg03, _arg12);
                    reply.writeNoException();
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    setStatusBarIconColor(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    changeUpslideState(data.readInt() != 0, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    setSimcardFlow(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    setNetworkSpeed(data.readString());
                    reply.writeNoException();
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                    onClearAllNotificationsIgnoreFlags();
                    reply.writeNoException();
                    return true;
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    onClearNotificationsIgnoreFlags(data.readString());
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void changeUpslideState(boolean z, boolean z2) throws RemoteException;
    ...
    void notifyInfo(int i, Bundle bundle) throws RemoteException;

    void onClearAllNotifications(int i) throws RemoteException;

    void onClearAllNotificationsIgnoreFlags() throws RemoteException;

    void onClearNotificationsIgnoreFlags(String str) throws RemoteException;
    ...
    void setNetworkSpeed(String str) throws RemoteException;

    void setSimcardFlow(String str, String str2) throws RemoteException;

    void setStatusBarIconColor(boolean z) throws RemoteException;

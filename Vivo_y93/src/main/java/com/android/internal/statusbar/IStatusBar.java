...
public interface IStatusBar extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IStatusBar {
        ...
        static final int TRANSACTION_changeUpslideState = 38;
        ...
        static final int TRANSACTION_notifyInfo = 36;
        ...
        static final int TRANSACTION_setNetworkSpeed = 40;
        static final int TRANSACTION_setSimcardFlow = 39;
        static final int TRANSACTION_setStatusBarIconColor = 37;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    ...
                    setSystemUiVisibility(_arg0, _arg12, _arg2, _arg3, _arg4, _arg5);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);

...
public final class DiskLruCache implements Closeable {
    ...
    static final /* synthetic */ boolean f1-assertionsDisabled = (DiskLruCache.class.desiredAssertionStatus() ^ 1);
     ...
     */
        ...
        public void abort() throws IOException {
            synchronized (DiskLruCache.this) {
                ...
                if (this.entry.currentEditor == this) {
                    DiskLruCache.this.completeEdit(this, DiskLruCache.f1-assertionsDisabled);
                }
                this.done = true;
            }
        }
        ...
        if (!f1-assertionsDisabled && !Thread.holdsLock(this)) {
            ...
            if (this.fileSystem.exists(this.journalFile)) {
                try {
                    ...
                    delete();
                    this.closed = f1-assertionsDisabled;
                }
            }
            rebuildJournal();
            this.initialized = true;
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            /* renamed from: -assertionsDisabled */
            static final /* synthetic */ boolean f2-assertionsDisabled = (AnonymousClass3.class.desiredAssertionStatus() ^ 1);

            protected void onException(IOException e) {
                if (f2-assertionsDisabled || Thread.holdsLock(DiskLruCache.this)) {
    ...
    private synchronized void rebuildJournal() throws IOException {
        ...
        try {
            ...
            this.fileSystem.delete(this.journalFileBackup);
            this.journalWriter = newJournalWriter();
            this.hasJournalErrors = f1-assertionsDisabled;
        } catch (Throwable th) {
            writer.close();
        }
    }
            ...
            public boolean hasNext() {
                ...
                synchronized (DiskLruCache.this) {
                    if (DiskLruCache.this.closed) {
                        return DiskLruCache.f1-assertionsDisabled;
                    }
                    Snapshot snapshot;
                    do {

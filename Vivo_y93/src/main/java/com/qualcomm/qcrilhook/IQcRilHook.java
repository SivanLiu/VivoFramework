...
public interface IQcRilHook {
    ...
    public static final int QCRIL_EVT_HOOK_GET_AVAILABLE_CONFIGS_VIVO = 524795;
    ...
    @VivoHook(hookType = VivoHookType.NEW_FIELD)
    public static final int QCRIL_EVT_HOOK_GET_OEM_VERSION_OF_ID_VIVO = 524794;
    ...
    public static final int QCRIL_EVT_HOOK_SET_TRANSMIT_POWER = 524489;
    ...
    boolean qcRilSetSarPower(byte b);

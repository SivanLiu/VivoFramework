...
class WfdActionListenerImpl extends Stub {
    ...
    private static final /* synthetic */ int[] f1-com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m1-getcom-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues() {
        if (f1-com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues != null) {
            return f1-com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues;
        }
        ...
        f1-com-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues = iArr;
        return iArr;
    }
    ...
    public void onStateUpdate(int newState, int sessionId) throws RemoteException {
        ...
        switch (m1-getcom-qualcomm-wfd-WfdEnums$SessionStateSwitchesValues()[state.ordinal()]) {
            case 1:

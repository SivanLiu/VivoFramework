                    ...
                    while (i < this.mNumSimSlots) {
                        try {
                            ...
                            if (sir == null || sir.getMcc() == 0) {
                                ...
                                QtiUiccCardProvisioner.make(SubsidyLockSettingsObserver.this.mContext, QtiTelephonyComponentFactory.getCommonLooper()).activateUiccCard(i);
                            } else if (mExtTelephony.getCurrentUiccCardProvisioningStatus(i) == 1 && QtiUiccCardProvisioner.make(SubsidyLockSettingsObserver.this.mContext, QtiTelephonyComponentFactory.getCommonLooper()).deactivateUiccCard(i) == 0) {

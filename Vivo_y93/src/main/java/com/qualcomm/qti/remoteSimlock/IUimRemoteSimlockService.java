...
public interface IUimRemoteSimlockService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUimRemoteSimlockService {
        ...
        static final int TRANSACTION_uimRemoteSimlockGenerateRequest = 8;
        ...
        static final int TRANSACTION_uimRemoteSimlockUnlockTimer = 9;
        ...
        private static class Proxy implements IUimRemoteSimlockService {
            ...
            public int uimRemoteSimlockGenerateRequest(int token, int requestType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_uimRemoteSimlockGenerateRequest, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
            ...
            public int uimRemoteSimlockUnlockTimer(int token, int requestType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(token);
                    _data.writeInt(requestType);
                    this.mRemote.transact(Stub.TRANSACTION_uimRemoteSimlockUnlockTimer, _data, _reply, 0);
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
                } finally {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_uimRemoteSimlockGetSimlockStatus /*7*/:
                    ...
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_uimRemoteSimlockGenerateRequest /*8*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = uimRemoteSimlockGenerateRequest(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_uimRemoteSimlockUnlockTimer /*9*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = uimRemoteSimlockUnlockTimer(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
    ...
    int uimRemoteSimlockGenerateRequest(int i, int i2) throws RemoteException;
    ...
    int uimRemoteSimlockUnlockTimer(int i, int i2) throws RemoteException;
}

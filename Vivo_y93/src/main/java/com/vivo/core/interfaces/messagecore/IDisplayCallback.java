...
public interface IDisplayCallback extends IInterface {

    public static abstract class Stub extends Binder implements IDisplayCallback {
        private static final String DESCRIPTOR = "com.vivo.core.interfaces.messagecore.IDisplayCallback";
        ...
        private static class Proxy implements IDisplayCallback {
        ...
        public static IDisplayCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IDisplayCallback)) {
                return new Proxy(obj);
            }
            return (IDisplayCallback) iin;
        }
    ...
    void onCancel(int i, Bundle bundle) throws RemoteException;

    void onClick(int i, Bundle bundle) throws RemoteException;

    void onError(int i, String str, Bundle bundle) throws RemoteException;

    void onShow(int i, Bundle bundle) throws RemoteException;
}

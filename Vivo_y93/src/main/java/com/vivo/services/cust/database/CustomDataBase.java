...
public abstract class CustomDataBase<T> implements IDataExtractor<T> {
    protected Context mContext;
    protected VivoCustomDbHelper mDBHelper;
    ...
    public CustomDataBase(Context context) {
        ...
        this.mDBHelper = VivoCustomDbHelper.getInstance(context);
    }

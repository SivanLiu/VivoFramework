...
public class WlanAttr implements Parcelable {
    ...
    public static final Creator<WlanAttr> CREATOR = new Creator<WlanAttr>() {
        public WlanAttr createFromParcel(Parcel in) {
            boolean z;
            boolean z2 = true;
            WlanAttr na = new WlanAttr(in.readString());
        ...
        public WlanAttr[] newArray(int size) {
            return new WlanAttr[size];
        }
    };
    ...
    public WlanAttr(String iccid, boolean bList, boolean wList, String r1, String r2, String r3, String r4, boolean r5, boolean r6, boolean r7, String ctype) {
        this.iccid = iccid;

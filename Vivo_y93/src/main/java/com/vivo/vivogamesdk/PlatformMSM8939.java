...
public class PlatformMSM8939 implements VivoPlatform {
    ...
    private static final int LIMIT_TEMPERATURE_BAD_PD1515A = 70;
    private static final int LIMIT_TEMPERATURE_MEDIUM_PD1515A = 67;
    private static final int LIMIT_TEMPERATURE_UP_PD1515A = 63;
    private static final String NTC_TEMPERATURE_NODE_MSM8939 = "/sys/devices/virtual/thermal/thermal_zone4/temp";
    private static final String PRODUCT_MODEL_BBK_PD1515A = "PD1515A";
    ...
    public PlatformMSM8939() {
        if (SystemProperties.get(AblConfig.PROP_PRODUCT_MODEL, "unknown").equals(PRODUCT_MODEL_BBK_PD1515A)) {
            this.isProductSupport = true;
            this.limitTemperatureNode = NTC_TEMPERATURE_NODE_MSM8939;
            this.limitUpcomingLevelTemperature = LIMIT_TEMPERATURE_UP_PD1515A;
            this.limitMediumLevelTemperature = LIMIT_TEMPERATURE_MEDIUM_PD1515A;
            this.limitBadLevelTemperature = LIMIT_TEMPERATURE_BAD_PD1515A;
            return;
        }
    ...
    public int getFreqLimitLevel() {
        ...
        if (DEBUG) {
            Log.d(TAG, "NTCTemp is " + temperature + ".");
        }
        if (temperature < 0) {
            limitLevel = -1;

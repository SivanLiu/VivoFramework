...
public class SlipListItem extends RelativeLayout {
    ...
    public SlipListItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlipListItem(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public SlipListItem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {

...
public final class Weather {
    ...
    public static String[] CURRENTCITY_PROJECTION = new String[]{"_id", CurrentCity.POSITION, CurrentCity.POSITION2};
    ...
    public static String[] LOCATION_PROJECTION = new String[]{"_id", Location.LAC, "city"};
    ...
    private String str_CLOUDY = Events.DEFAULT_SORT_ORDER;
    private String str_FOG = Events.DEFAULT_SORT_ORDER;
    private String str_FREEZING = Events.DEFAULT_SORT_ORDER;
    private String str_ICE = Events.DEFAULT_SORT_ORDER;
    private String str_RAIN = Events.DEFAULT_SORT_ORDER;
    private String str_RAINBIG = Events.DEFAULT_SORT_ORDER;
    private String str_RAINMEDIUM = Events.DEFAULT_SORT_ORDER;
    private String str_RAINSMALL = Events.DEFAULT_SORT_ORDER;
    private String str_RAINSNOW = Events.DEFAULT_SORT_ORDER;
    private String str_RAINSTORMBIG = Events.DEFAULT_SORT_ORDER;
    private String str_RAINSTORMMEDIUM = Events.DEFAULT_SORT_ORDER;
    private String str_RAINSTORMSMALL = Events.DEFAULT_SORT_ORDER;
    private String str_RAINTHUNDER = Events.DEFAULT_SORT_ORDER;
    private String str_SANDMEDIUM = Events.DEFAULT_SORT_ORDER;
    private String str_SANDSMALL = Events.DEFAULT_SORT_ORDER;
    private String str_SANDSTORM = Events.DEFAULT_SORT_ORDER;
    private String str_SNOW = Events.DEFAULT_SORT_ORDER;
    private String str_SNOWBIG = Events.DEFAULT_SORT_ORDER;
    private String str_SNOWMEDIUM = Events.DEFAULT_SORT_ORDER;
    private String str_SNOWSMALL = Events.DEFAULT_SORT_ORDER;
    private String str_SNOWSTORE = Events.DEFAULT_SORT_ORDER;
    private String str_SUN = Events.DEFAULT_SORT_ORDER;
    private String str_YIN = Events.DEFAULT_SORT_ORDER;
    ...
    public class CityWeatherEntry {
        private String entryAreaId = Events.DEFAULT_SORT_ORDER;
        private int entryBackground = 0;
        private String entryCity = Events.DEFAULT_SORT_ORDER;
        private String entryCondition = Events.DEFAULT_SORT_ORDER;
        private String entryCurrentTemp = Events.DEFAULT_SORT_ORDER;
        private String entryHighTemp = Events.DEFAULT_SORT_ORDER;
        private int entryIcon = 0;
        private String entryLowTemp = Events.DEFAULT_SORT_ORDER;
        private String entryRealTime = Events.DEFAULT_SORT_ORDER;
        private String entrySunrise = Events.DEFAULT_SORT_ORDER;
        private String entrySunset = Events.DEFAULT_SORT_ORDER;
        private String entryWindDir = Events.DEFAULT_SORT_ORDER;
        private String entryWindPow = Events.DEFAULT_SORT_ORDER;
        ...
        try {
            ...
            if (pkgInfo != null) {
                ...
                if (this.mWeatherVersionCode == 2) {
                    this.mIsRom1_5 = true;
                } else if (this.mWeatherVersionCode > 2 && this.mWeatherVersionCode <= WEATHERVERSION_ROM_2_0) {
                    this.mIsRom2_0 = true;
                } else if (this.mWeatherVersionCode > WEATHERVERSION_ROM_2_5_1) {
                    this.mIsRom3_0 = true;
                }
            }
    ...
    public String getCurrentCity(boolean lbsState) {
        String city = Events.DEFAULT_SORT_ORDER;
        Cursor cursor = null;
        try {
    ...
    private void sendBroadcast(boolean lbsState, int position) {
        try {
            ...
            if (!this.mIsRom1_5) {
                values.put(CurrentCity.POSITION, Integer.valueOf(position));
            } else if (lbsState) {
                values.put(CurrentCity.POSITION, Integer.valueOf(position - 1));
    ...
    private Cursor queryCurrentWeatherNewSdk(boolean lbsState, int position, int needfivedays) {
        ...
        try {
            ...
            if (cursor2 != null && cursor2.moveToFirst()) {
                if (!Events.DEFAULT_SORT_ORDER.equals(getDayBegin(cursor2))) {
    ...
    public CityWeatherEntry getWidgetWeatherInfo(boolean local, boolean isDoubleClock) {
        ...
        String city = Events.DEFAULT_SORT_ORDER;
        String areaId = Events.DEFAULT_SORT_ORDER;
        ...
        try {
            ...
            if (realTime != null && realTime.length == 2) {
                String realDateStr = realTime[0].replace("-", Events.DEFAULT_SORT_ORDER);
    ...
    public String getDayBegin(Cursor cursor) {
        String dayBegin = Events.DEFAULT_SORT_ORDER;
        String updateTimeStr = Events.DEFAULT_SORT_ORDER;
        String currentDateStr = Events.DEFAULT_SORT_ORDER;
        ...
        try {
            ...
            int invalid = cursor.getInt(invalidIndex);
            if (updateTimeStr.equals(Events.DEFAULT_SORT_ORDER) || currentDateStr.equals(Events.DEFAULT_SORT_ORDER) || invalid == 1) {
                currentDateStr = Events.DEFAULT_SORT_ORDER;
                return dayBegin;
            }
            int dayMargin;
            ...
            if (localDiff <= 0) {
                ...
                dayMargin = (currentDateHour.getHours() + ((int) ((simpleDateFormat.parse(simpleDateFormat.format(validDate)).getTime() - currentDateHour.getTime()) / 3600000))) / 24;
            }
            return dateFormat.format(new Date(currentDate.getTime() + (((long) dayMargin) * 86400000)));
        } catch (Exception e) {
            e.printStackTrace();
            return dayBegin;
        }
    ...
    private long getRealTime(String localTime, String internetTime, int invalid) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd", Locale.ENGLISH);
        if (Events.DEFAULT_SORT_ORDER.equals(localTime) || Events.DEFAULT_SORT_ORDER.equals(internetTime) || invalid == 1) {
    ...
    public ArrayList<String> backup() {
        ...
        try {
            ...
            do {
                ...
                if (!(city == null || (city.equals(Events.DEFAULT_SORT_ORDER) ^ 1) == 0)) {
                    cityList.add(city);
                }
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                if (count >= 9) {
                    ...
                    if (!Events.DEFAULT_SORT_ORDER.equals(cursor.getString(cursor.getColumnIndex("local")))) {
                        ContentValues values = new ContentValues();
    ...
    public int del(String city) {
        try {
            ...
            curPosValues.put(CurrentCity.POSITION, Integer.valueOf(0));

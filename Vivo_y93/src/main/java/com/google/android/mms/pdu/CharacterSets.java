...
public class CharacterSets {
    ...
    static final /* synthetic */ boolean f23-assertionsDisabled = (CharacterSets.class.desiredAssertionStatus() ^ 1);
    ...
    static {
        if (f23-assertionsDisabled || MIBENUM_NUMBERS.length == MIME_NAMES.length) {

...
public final class MapController implements OnKeyListener {
    /* renamed from: -com-google-android-maps-MapController$HorizPanStateSwitchesValues */
    private static final /* synthetic */ int[] f0xf149266b = null;
    /* renamed from: -com-google-android-maps-MapController$VertPanStateSwitchesValues */
    private static final /* synthetic */ int[] f1x74bfde92 = null;
    ...
    /* renamed from: -getcom-google-android-maps-MapController$HorizPanStateSwitchesValues */
    private static /* synthetic */ int[] m0x73647e0f() {
        if (f0xf149266b != null) {
            return f0xf149266b;
        }
    ...
    /* renamed from: -getcom-google-android-maps-MapController$VertPanStateSwitchesValues */
    private static /* synthetic */ int[] m1xd3c9026e() {
        if (f1x74bfde92 != null) {
            return f1x74bfde92;
        }
    ...
    int[] getDeltas() {
        switch (m0x73647e0f()[this.mHorizPan.ordinal()]) {
            case 1:
        ...
        switch (m1xd3c9026e()[this.mVertPan.ordinal()]) {
            case 1:

...
public abstract class AbstractMessageParser {
    ...
    private static final /* synthetic */ int[] f149xd645f97b = null;
    ...
    public static class Video extends Token {
        ...
        public static String getURL(String docid, String extraParams) {
            if (extraParams == null) {
                ...
                extraParams = extraParams + Contants.QSTRING_SPLIT;
            }
    ...
    private static /* synthetic */ int[] m64xfa83c857() {
        if (f149xd645f97b != null) {
            return f149xd645f97b;
        }
        ...
        for (Part part : this.parts) {
            ...
            for (Token token : part.getTokens()) {
                if (token.isHtml()) {
                    ...
                    switch (m64xfa83c857()[token.getType().ordinal()]) {
                        case 1:

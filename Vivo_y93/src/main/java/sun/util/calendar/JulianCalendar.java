...
public class JulianCalendar extends BaseCalendar {
    ...
    static final /* synthetic */ boolean f147-assertionsDisabled = (JulianCalendar.class.desiredAssertionStatus() ^ 1);
    private static final int BCE = 0;
    private static final int CE = 1;
    private static final int JULIAN_EPOCH = -1;
    private static final Era[] eras = new Era[]{new Era("BeforeCommonEra", "B.C.E.", Long.MIN_VALUE, f147-assertionsDisabled), new Era("CommonEra", "C.E.", -62135709175808L, true)};
    ...
    public long getFixedDate(int jyear, int month, int dayOfMonth, sun.util.calendar.BaseCalendar.Date cache) {
        boolean isJan1 = (month == 1 && dayOfMonth == 1) ? true : f147-assertionsDisabled;
    ...
    public void getCalendarDateFromFixedDate(CalendarDate date, long fixedDate) {
        ...
        if (f147-assertionsDisabled || dayOfWeek > 0) {

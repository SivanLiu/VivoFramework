...
public class LocaleExtensions {
    ...
    static final /* synthetic */ boolean f151-assertionsDisabled = (LocaleExtensions.class.desiredAssertionStatus() ^ 1);
    ...
    public Set<String> getUnicodeLocaleAttributes() {
        ...
        if (f151-assertionsDisabled || (ext instanceof UnicodeLocaleExtension)) {

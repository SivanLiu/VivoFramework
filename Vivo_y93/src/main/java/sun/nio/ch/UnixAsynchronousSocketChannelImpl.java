...
class UnixAsynchronousSocketChannelImpl extends AsynchronousSocketChannelImpl implements PollableChannel {
    ...
    static final /* synthetic */ boolean f273-assertionsDisabled = (UnixAsynchronousSocketChannelImpl.class.desiredAssertionStatus() ^ 1);
    ...
    private void updateEvents() {
        if (f273-assertionsDisabled || Thread.holdsLock(this.updateLock)) {
            int events = 0;
            if (this.readPending) {
                events = Net.POLLIN | 0;
            }

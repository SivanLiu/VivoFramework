...
public class Util {
    ...
    static final /* synthetic */ boolean f256-assertionsDisabled = (Util.class.desiredAssertionStatus() ^ 1);
    ...
    private static class BufferCache {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f257-assertionsDisabled = (BufferCache.class.desiredAssertionStatus() ^ 1);
        ...
        ByteBuffer removeFirst() {
            if (f257-assertionsDisabled || this.count > 0) {
    ...
    static void offerFirstTemporaryDirectBuffer(ByteBuffer buf) {
        if (!f256-assertionsDisabled && buf == null) {
            throw new AssertionError();

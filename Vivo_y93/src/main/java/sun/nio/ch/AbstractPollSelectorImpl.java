...
abstract class AbstractPollSelectorImpl extends SelectorImpl {
    ...
    static final /* synthetic */ boolean f255-assertionsDisabled = (AbstractPollSelectorImpl.class.desiredAssertionStatus() ^ 1);
    ...
    protected void implClose() throws IOException {
        synchronized (this.closeLock) {
            ...
            while (i < this.totalChannels) {
                ...
                if (f255-assertionsDisabled || ski.getIndex() != -1) {
                    ski.setIndex(-1);
                    deregister(ski);
    ...
    protected void implDereg(SelectionKeyImpl ski) throws IOException {
        int i = ski.getIndex();
        if (f255-assertionsDisabled || i >= 0) {

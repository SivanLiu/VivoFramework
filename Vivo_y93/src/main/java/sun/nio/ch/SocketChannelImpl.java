...
class SocketChannelImpl extends SocketChannel implements SelChImpl {
    ...
    static final /* synthetic */ boolean f268-assertionsDisabled = (SocketChannelImpl.class.desiredAssertionStatus() ^ 1);
    ...
    SocketChannelImpl(SelectorProvider sp) throws IOException {
        ...
        this.readyToConnect = f268-assertionsDisabled;
    ...
    private boolean ensureReadOpen() throws ClosedChannelException {
        synchronized (this.stateLock) {
            if (!isOpen()) {
                ...
                return f268-assertionsDisabled;
            }
        }
    }
        ...
        synchronized (this.readLock) {
            if (ensureReadOpen()) {
                try {
                    ...
                    readerCleanup();
                    boolean z = (0 > 0 || 0 == -2) ? true : f268-assertionsDisabled;
                    end(z);
                    synchronized (this.stateLock) {
                        if (0 <= 0) {
                            if ((this.isInputOpen ^ 1) != 0) {
    ...
    public boolean isConnected() {
        boolean z;
        synchronized (this.stateLock) {
            z = this.state == 2 ? true : f268-assertionsDisabled;
        }
        return z;
    }
            ...
            synchronized (this.writeLock) {
                ...
                synchronized (blockingLock()) {
                    try {
                        ...
                        readerCleanup();
                        boolean z = (null > null || 0 == -2) ? true : f268-assertionsDisabled;
                        end(z);
                        if (!f268-assertionsDisabled && !IOStatus.check(0)) {
                            AssertionError assertionError = new AssertionError();
                        }
    ...
    L_0x005e:
        ...
        r2 = f268-assertionsDisabled;	 Catch:{ IOException -> 0x0071 }
    ...
    L_0x00e8:
        r14.end(r3);	 Catch:{ IOException -> 0x0071 }
        r3 = f268-assertionsDisabled;	 Catch:{ IOException -> 0x0071 }
        ...
        synchronized (this.stateLock) {
            if (!isOpen()) {
                ...
                if (this.isInputOpen) {
                    ...
                    this.isInputOpen = f268-assertionsDisabled;
                }
            } else {
                throw new NotYetConnectedException();
            }
        ...
        synchronized (this.stateLock) {
            if (!isOpen()) {
                ...
                if (this.isOutputOpen) {
                    ...
                    this.isOutputOpen = f268-assertionsDisabled;
                }
            } else {
                throw new NotYetConnectedException();
            }
    ...
    int poll(int events, long timeout) throws IOException {
        boolean z = f268-assertionsDisabled;
        if (f268-assertionsDisabled || (Thread.holdsLock(blockingLock()) && !isBlocking())) {
            synchronized (this.readLock) {
                try {
                    begin();
                    synchronized (this.stateLock) {

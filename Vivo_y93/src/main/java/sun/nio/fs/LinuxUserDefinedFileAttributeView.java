...
class LinuxUserDefinedFileAttributeView extends AbstractUserDefinedFileAttributeView {
    ...
    static final /* synthetic */ boolean f278-assertionsDisabled = (LinuxUserDefinedFileAttributeView.class.desiredAssertionStatus() ^ 1);
    ...
    public List<String> list() throws IOException {
        if (System.getSecurityManager() != null) {
            checkAccess(this.file.getPathForPermissionCheck(), true, f278-assertionsDisabled);
        }
    ...
    public int read(String name, ByteBuffer dst) throws IOException {
        ...
        int lim = dst.limit();
        if (f278-assertionsDisabled || pos <= lim) {
            NativeBuffer nb;
            long address;
    ...
    public int write(String name, ByteBuffer src) throws IOException {
        if (System.getSecurityManager() != null) {
            checkAccess(this.file.getPathForPermissionCheck(), f278-assertionsDisabled, true);
        }

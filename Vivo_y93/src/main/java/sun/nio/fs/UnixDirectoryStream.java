...
class UnixDirectoryStream implements DirectoryStream<Path> {
    ...
    private class UnixDirectoryIterator implements Iterator<Path> {
        ...
        static final /* synthetic */ boolean f282-assertionsDisabled = (UnixDirectoryIterator.class.desiredAssertionStatus() ^ 1);
        ...
        private Path readNextEntry() {
            if (f282-assertionsDisabled || Thread.holdsLock(this)) {
                Path entry;
                while (true) {

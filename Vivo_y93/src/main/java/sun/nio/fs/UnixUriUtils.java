...
class UnixUriUtils {
    ...
    static final /* synthetic */ boolean f281-assertionsDisabled = (UnixUriUtils.class.desiredAssertionStatus() ^ 1);
        ...
        if (!uri.isAbsolute()) {
            ...
            if (scheme == null || (scheme.equalsIgnoreCase("file") ^ 1) != 0) {
                ...
                while (pos < len) {
                    ...
                    char c = p.charAt(pos);
                    if (c == '%') {
                        if (f281-assertionsDisabled || pos2 + 2 <= len) {
                            pos = pos2 + 1;
                    ...
                    } else if (f281-assertionsDisabled || c < 128) {
                        b = (byte) c;
                    } else {
                        throw new AssertionError();
                    }
    ...
    static URI toUri(UnixPath up) {
        ...
        if (f281-assertionsDisabled || path[0] == (byte) 47) {

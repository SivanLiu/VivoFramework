...
abstract class AbstractPoller implements Runnable {
    ...
    private static final /* synthetic */ int[] f270-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m151-getsun-nio-fs-AbstractPoller$RequestTypeSwitchesValues() {
        if (f270-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues != null) {
            return f270-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues;
        }
        ...
        f270-sun-nio-fs-AbstractPoller$RequestTypeSwitchesValues = iArr;
        return iArr;
    }
        ...
        synchronized (this.requestList) {
            while (true) {
                ...
                if (req != null) {
                    ...
                    switch (m151-getsun-nio-fs-AbstractPoller$RequestTypeSwitchesValues()[req.type().ordinal()]) {
                        case 1:

...
class UnixFileModeAttribute {
    ...
    private static final /* synthetic */ int[] f279-java-nio-file-attribute-PosixFilePermissionSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m153-getjava-nio-file-attribute-PosixFilePermissionSwitchesValues() {
        if (f279-java-nio-file-attribute-PosixFilePermissionSwitchesValues != null) {
            return f279-java-nio-file-attribute-PosixFilePermissionSwitchesValues;
        }
        ...
        f279-java-nio-file-attribute-PosixFilePermissionSwitchesValues = iArr;
        return iArr;
    }
    ...
    static int toUnixMode(Set<PosixFilePermission> perms) {
        ...
        for (PosixFilePermission perm : perms) {
            if (perm != null) {
                switch (m153-getjava-nio-file-attribute-PosixFilePermissionSwitchesValues()[perm.ordinal()]) {
                    case 1:

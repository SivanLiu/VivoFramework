...
class UnixChannelFactory {
    ...
    protected static class Flags {
        ...
        private static final /* synthetic */ int[] f280-java-nio-file-StandardOpenOptionSwitchesValues = null;
        boolean append;
        boolean create;
        boolean createNew;
        ...
        private static /* synthetic */ int[] m154-getjava-nio-file-StandardOpenOptionSwitchesValues() {
            if (f280-java-nio-file-StandardOpenOptionSwitchesValues != null) {
                return f280-java-nio-file-StandardOpenOptionSwitchesValues;
            }
            ...
            f280-java-nio-file-StandardOpenOptionSwitchesValues = iArr;
            return iArr;
        }
        ...
        static Flags toFlags(Set<? extends OpenOption> options) {
            ...
            for (Object option : options) {
                if (option instanceof StandardOpenOption) {
                    switch (m154-getjava-nio-file-StandardOpenOptionSwitchesValues()[((StandardOpenOption) option).ordinal()]) {
                        case 1:
                            flags.append = true;
                            break;
                        case 2:

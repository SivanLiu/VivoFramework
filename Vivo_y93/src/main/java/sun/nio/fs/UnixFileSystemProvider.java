...
public abstract class UnixFileSystemProvider extends AbstractFileSystemProvider {
    ...
    private static final /* synthetic */ int[] f274-java-nio-file-AccessModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m152-getjava-nio-file-AccessModeSwitchesValues() {
        if (f274-java-nio-file-AccessModeSwitchesValues != null) {
            return f274-java-nio-file-AccessModeSwitchesValues;
        }
        ...
        f274-java-nio-file-AccessModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public void checkAccess(Path obj, AccessMode... modes) throws IOException {
        ...
        if (modes.length == 0) {
            ...
            while (i < length) {
                switch (m152-getjava-nio-file-AccessModeSwitchesValues()[modes[i].ordinal()]) {
                    case 1:
                    case 2:
                    case 3:
                        r = true;

...
public class FormattedFloatingDecimal {
    ...
    static final /* synthetic */ boolean f145-assertionsDisabled = (FormattedFloatingDecimal.class.desiredAssertionStatus() ^ 1);
    /* renamed from: -sun-misc-FormattedFloatingDecimal$FormSwitchesValues */
    private static final /* synthetic */ int[] f146-sun-misc-FormattedFloatingDecimal$FormSwitchesValues = null;
    ...
    private static /* synthetic */ int[] m85-getsun-misc-FormattedFloatingDecimal$FormSwitchesValues() {
        if (f146-sun-misc-FormattedFloatingDecimal$FormSwitchesValues != null) {
            return f146-sun-misc-FormattedFloatingDecimal$FormSwitchesValues;
        }
        ...
        f146-sun-misc-FormattedFloatingDecimal$FormSwitchesValues = iArr;
        return iArr;
    }
    ...
    private FormattedFloatingDecimal(int precision, Form form, BinaryToASCIIConverter fdConverter) {
        ...
        int exp;
        switch (m85-getsun-misc-FormattedFloatingDecimal$FormSwitchesValues()[form.ordinal()]) {
            case 1:
                exp = decExp;

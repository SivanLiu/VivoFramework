...
public class FpUtils {
    ...
    static final /* synthetic */ boolean f252-assertionsDisabled = (FpUtils.class.desiredAssertionStatus() ^ 1);
    ...
    public static int ilogb(double d) {
        ...
        switch (exponent) {
            case -1023:
                ...
                if (f252-assertionsDisabled || transducer != 0) {
                    while (transducer < 4503599627370496L) {
                        transducer *= 2;
                        exponent--;
                    }
                    exponent++;
                    if (f252-assertionsDisabled || (exponent >= DoubleConsts.MIN_SUB_EXPONENT && exponent < -1022)) {
                        return exponent;
                    }
            ...
            case 1024:
                ...
                return 268435456;
            default:
                if (f252-assertionsDisabled || (exponent >= -1022 && exponent <= 1023)) {
                    return exponent;
                }
                throw new AssertionError();
        }
        ...
        switch (exponent) {
            case -127:
                ...
                if (f252-assertionsDisabled || transducer != 0) {
                    ...
                    exponent++;
                    if (f252-assertionsDisabled || (exponent >= FloatConsts.MIN_SUB_EXPONENT && exponent < -126)) {
                        return exponent;
                    }
                    throw new AssertionError();
                }
            ...
            case 128:
                ...
                return 268435456;
            default:
                if (f252-assertionsDisabled || (exponent >= -126 && exponent <= 127)) {
                    return exponent;
                }
                throw new AssertionError();
        }

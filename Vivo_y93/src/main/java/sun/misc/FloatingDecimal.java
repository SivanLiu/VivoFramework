...
public class FloatingDecimal {
    ...
    static final /* synthetic */ boolean f23-assertionsDisabled = (FloatingDecimal.class.desiredAssertionStatus() ^ 1);
    ...
    private static final BinaryToASCIIConverter B2AC_NOT_A_NUMBER = new ExceptionalBinaryToASCIIBuffer(NAN_REP, f23-assertionsDisabled);
    private static final BinaryToASCIIConverter B2AC_POSITIVE_INFINITY = new ExceptionalBinaryToASCIIBuffer(INFINITY_REP, f23-assertionsDisabled);
    private static final BinaryToASCIIConverter B2AC_POSITIVE_ZERO = new BinaryToASCIIBuffer(f23-assertionsDisabled, new char[]{'0'});
    ...
    static class ASCIIToBinaryBuffer implements ASCIIToBinaryConverter {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f24-assertionsDisabled = (ASCIIToBinaryBuffer.class.desiredAssertionStatus() ^ 1);
        ...
        public double doubleValue() {
            ...
            do {
                ...
                } else if (f24-assertionsDisabled || bigBbits != 0) {
                ...
                if (cmpResult <= 0) {
                    ...
                    overvalue = FloatingDecimal.f23-assertionsDisabled;
    ...
    static class BinaryToASCIIBuffer implements BinaryToASCIIConverter {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f25-assertionsDisabled = (BinaryToASCIIBuffer.class.desiredAssertionStatus() ^ 1);
        ...
        BinaryToASCIIBuffer() {
            ...
            this.exactDecimalConversion = FloatingDecimal.f23-assertionsDisabled;
            this.decimalDigitsRoundedUp = FloatingDecimal.f23-assertionsDisabled;
        ...
        public void appendTo(Appendable buf) {
            ...
            } else if (!f25-assertionsDisabled) {
        ...
        public boolean isExceptional() {
            return FloatingDecimal.f23-assertionsDisabled;
        }
        ...
        private void developLongDigits(int decExponent, long lvalue, int insignificantDigits) {
            ...
            if (lvalue > 2147483647L) {
                ...
                this.digits[digitno2] = (char) (c + 48);
                digitno = digitno2;
            } else if (f25-assertionsDisabled || lvalue > 0) {
        ...
        private void dtoa(int binExp, long fractBits, int nSignificantBits, boolean isCompatibleFormat) {
            if (!f25-assertionsDisabled && fractBits <= 0) {
                throw new AssertionError();
            } else if (f25-assertionsDisabled || (FloatingDecimal.FRACT_HOB & fractBits) != 0) {
                ...
                if (binExp > FloatingDecimal.MAX_SMALL_BIN_EXP || binExp < FloatingDecimal.MIN_SMALL_BIN_EXP || nTinyBits >= FDBigInteger.LONG_5_POW.length || N_5_BITS[nTinyBits] + nFractBits >= 64 || nTinyBits != 0) {
                    ...
                    if (Bbits >= 64 || tenSbits >= 64) {
                        ...
                        low = Bval.cmp(Mval) < 0 ? true : FloatingDecimal.f23-assertionsDisabled;
                        high = tenSval.addAndCmp(Bval, Mval) <= 0 ? true : FloatingDecimal.f23-assertionsDisabled;
                        if (f25-assertionsDisabled || q < 10) {
                            if (q != 0 || (high ^ 1) == 0) {
                                ndigit = 1;
                            ...
                            if (!isCompatibleFormat || decExp < -3 || decExp >= 8) {
                                low = FloatingDecimal.f23-assertionsDisabled;
                                high = FloatingDecimal.f23-assertionsDisabled;
                                ndigit2 = ndigit;
                            } else {
                                ndigit2 = ndigit;
                            }
                            ...
                            this.exactDecimalConversion = Bval.cmp(FDBigInteger.ZERO) == 0 ? true : FloatingDecimal.f23-assertionsDisabled;
                            ndigit = ndigit2;
                        } else {
                            throw new AssertionError(Integer.valueOf(q));
                        }
                        ...
                        low = b < m ? true : FloatingDecimal.f23-assertionsDisabled;
                        high = b + m > tens ? true : FloatingDecimal.f23-assertionsDisabled;
                        if (f25-assertionsDisabled || q < 10) {
                            if (q != 0 || (high ^ 1) == 0) {
                                ndigit = 1;
                                this.digits[0] = (char) (q + 48);
                            ...
                            this.exactDecimalConversion = b == 0 ? true : FloatingDecimal.f23-assertionsDisabled;
                            ndigit = ndigit2;
                        } else {
                            throw new AssertionError(Integer.valueOf(q));
                        }
                        ...
                        low = b2 < m2 ? true : FloatingDecimal.f23-assertionsDisabled;
                        high = b2 + m2 > tens2 ? true : FloatingDecimal.f23-assertionsDisabled;
                        if (f25-assertionsDisabled || q < 10) {
                            boolean z;
                            if (q != 0 || (high ^ 1) == 0) {
                                ndigit = 1;
                            ...
                            if (b2 == 0) {
                                ...
                                z = FloatingDecimal.f23-assertionsDisabled;
                            }
        ...
        static int estimateDecExp(long fractBits, int binExp) {
            ...
            boolean isNegative = (Long.MIN_VALUE & dBits) != 0 ? true : FloatingDecimal.f23-assertionsDisabled;
        ...
        private int getChars(char[] result) {
            if (f25-assertionsDisabled || this.nDigits <= 19) {
                int i = 0;
                if (this.isNegative) {
                    result[0] = '-';
                    i = 1;
    ...
    private static class ExceptionalBinaryToASCIIBuffer implements BinaryToASCIIConverter {
        /* renamed from: -assertionsDisabled */
        static final /* synthetic */ boolean f26-assertionsDisabled = (ExceptionalBinaryToASCIIBuffer.class.desiredAssertionStatus() ^ 1);
    ...
    static BinaryToASCIIConverter getBinaryToASCIIConverter(double d, boolean isCompatibleFormat) {
        long dBits = Double.doubleToRawLongBits(d);
        boolean isNegative = (Long.MIN_VALUE & dBits) != 0 ? true : f23-assertionsDisabled;
    ...
    private static BinaryToASCIIConverter getBinaryToASCIIConverter(float f) {
        ...
        boolean isNegative = (Integer.MIN_VALUE & fBits) != 0 ? true : f23-assertionsDisabled;
    ...
    static ASCIIToBinaryConverter readJavaFormatString(String in) throws NumberFormatException {
        boolean isNegative = f23-assertionsDisabled;
        boolean signSeen = f23-assertionsDisabled;
        try {
            in = in.trim();
            int len = in.length();
            if (len == 0) {
            ...
            if (c == 'N') {
                ...
                int nDigits2 = 0;
                boolean decSeen = f23-assertionsDisabled;
                int decPt = 0;
                int nLeadZero = 0;
                int nTrailZero = 0;
                while (i < len) {
                    ...
                    if (c == '0') {
                        ...
                        isZero = nDigits2 != 0 ? true : f23-assertionsDisabled;
                        if (!(isZero && nLeadZero == 0)) {
                            ...
                            if (i < len) {
                                ...
                                if (c == 'e' || c == 'E') {
                                    int expSign = 1;
                                    int expVal = 0;
                                    boolean expOverflow = f23-assertionsDisabled;
                                    i++;
                                    switch (in.charAt(i)) {
                                        case '+':
                                            break;
    ...
    static ASCIIToBinaryConverter parseHexString(String s) {
        ...
        if (m.matches()) {
            ...
            if (group1 != null) {
                ...
                isNegative = f23-assertionsDisabled;
            }
            int rightDigits = 0;
            ...
            try {
                ...
                boolean round = f23-assertionsDisabled;
                boolean sticky = f23-assertionsDisabled;
                ...
                if (i < signifLength) {
                    ...
                    switch (nextShift) {
                        case -4:
                            round = (8 & currentDigit) != 0 ? true : f23-assertionsDisabled;
                            if ((7 & currentDigit) == 0) {
                                sticky = f23-assertionsDisabled;
                                break;
                            }
                            sticky = true;
                            break;
                        case -3:
                            ...
                            round = (4 & currentDigit) != 0 ? true : f23-assertionsDisabled;
                            if ((3 & currentDigit) == 0) {
                                sticky = f23-assertionsDisabled;
                                break;
                            }
                        ...
                        case -2:
                            ...
                            round = (2 & currentDigit) != 0 ? true : f23-assertionsDisabled;
                            if ((1 & currentDigit) == 0) {
                                sticky = f23-assertionsDisabled;
                                break;
                            }
                ...
                if (exponent >= -126) {
                    ...
                    if (!f23-assertionsDisabled && threshShift < 29) {
                        throw new AssertionError();
                    } else if (f23-assertionsDisabled || threshShift < 53) {
                ...
                if (exponent <= 1023 && exponent >= -1022) {
                    ...
                    if (f23-assertionsDisabled || (bitsDiscarded >= 1 && bitsDiscarded <= 53)) {
                        round = ((1 << (bitsDiscarded + -1)) & significand) != 0 ? true : f23-assertionsDisabled;
                        if (bitsDiscarded > 1) {
                            sticky = (sticky || (significand & (~(-1 << (bitsDiscarded - 1)))) != 0) ? true : f23-assertionsDisabled;
                        }
                ...
                boolean leastZero = (1 & significand) == 0 ? true : f23-assertionsDisabled;

...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    public final HttpResponse execute(HttpHost target, HttpRequest request, HttpContext context) throws IOException, ClientProtocolException {
        ...
        try {
            if (mCheckHandler == null || !isMoMMS(request) || (mCheckHandler.checkRequest(request) ^ 1) == 0) {
    ...
    public static void setHttpRequestCheckHandler(HttpRequestCheckHandler clientCheckHandler) {
